 ...
 * session
 */
require_once(BASE_PATH.DS.'api'.DS.'wx'.DS.'comm'.DS."session.php");
...
$_SESSION["appid"]    = trim($data['wx_appid']);

//申请到的appkey
//$_SESSION["appkey"]   = "yourappkey"; 
$_SESSION["appkey"]   = trim($data['wx_appkey']);

//微信登录成功后跳转的地址,请确保地址真实可用，否则会导致登录失败。
//$_SESSION["callback"] = "http://your domain/oauth/get_access_token.php"; 
$_SESSION["callback"] = urlencode(SHOP_SITE_URL."/api.php?act=towx&op=g&display=".$_GET['display']);
