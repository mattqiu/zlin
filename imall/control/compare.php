...
class compareControl extends BaseHomeControl{
    ...
    public function addcompareOp(){
        ...
        setIMCookie('comparegoods', $comparegoods_str);
    ...
    public function showcompareOp(){
        ...
        if($gid_arr){
            ...
            if ($goods_listtmp){
                ...
                //更新cookie数据
                setIMCookie('comparegoods', $goodsid_arr?implode(',',$goodsid_arr):'');
            } else {
                //更新cookie数据
                setIMCookie('comparegoods','',-3600);
            }
        }
    ...
    public function delcompareOp(){
        ...
        //更新cookie数据
        if($gid_str){
            setIMCookie('comparegoods', $gid_str);
        } else {
            setIMCookie('comparegoods','',-3600);
        }
