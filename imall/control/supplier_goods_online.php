...
class supplier_goods_onlineControl extends BaseSupplierControl {
    ...
    public function goods_listOp() {
        ...
        Tpl::showpage('supplier_goods_list.online');
    }
    ...
    public function edit_goodsOp() {
        ...
        Tpl::showpage('supplier_goods_add.step2');
    }
    ...
    public function edit_save_goodsOp() {
        ...
        if ($result['state']) {
            ...
            //回滚事务
            showDialog($result['msg'], urlShop('supplier_goods_online', 'index'));
        }
    }
    ...
    public function edit_imageOp() {
        ...
        Tpl::output('edit_goods_sign', true);
        Tpl::showpage('supplier_goods_add.step3');
    }
    ...
    public function edit_save_imageOp() {
        if (chksubmit()) {
            ...
            if ($rs['state']) {
                ...
                showDialog(L('nc_common_save_fail'), urlShop('supplier_goods_online', 'index'));
            }
        }
    }
    ...
    public function edit_classOp() {
        ...
        Tpl::output('edit_goods_sign', true);
        Tpl::showpage('supplier_goods_add.step1');
    }
    ...
    public function goods_unshowOp() {
        ...
        if ($result['state']) {
            showDialog(L('store_goods_index_goods_unshow_success'), getReferer() ? getReferer() : 'index.php?act=supplier_goods_online&op=goods_list', 'succ', '', 2);
        } else {
    ...
    public function edit_jingleOp() {
        ...
        Tpl::showpage('supplier_goods_list.edit_jingle', 'null_layout');
    }
    ...
    public function edit_plateOp() {
        ...
        Tpl::showpage('supplier_goods_list.edit_plate', 'null_layout');
    }
    ...
    public function add_giftOp() {
        ...
        Tpl::showpage('supplier_goods_edit.add_gift');
    }
   ...
   * 设置商品佣金
    ...
    public function edit_invite_priceOp() {
        ...
        Tpl::showpage('supplier_goods_list.edit_invite_price', 'null_layout');
    }
    ...
    public function search_goodsOp() {
        ...
        Tpl::output('goods_list', $goods_list);
        Tpl::showpage('supplier_goods_edit.search_goods', 'null_layout');
    }
    ...
    public function edit_iframe_ajaxOp() {
        ...
        Tpl::showpage('supplier_goods_list.edit_iframe', 'null_layout');
    }
    ...
    public function edit_body_ajaxOp() {
        ...
        Tpl::showpage('supplier_goods_list.edit_body', 'null_layout');
    }
    ...
    private function profile_menu($menu_type,$menu_key, $allow_promotion = array()) {
        ...
        switch ($menu_type) {
            case 'goods_list':
                $menu_array = array(
                   array('menu_key' => 'goods_list',    'menu_name' => '出售中的商品', 'menu_url' => urlShop('supplier_goods_online', 'index'))
                );
                break;
            case 'edit_detail':
                if ($allow_promotion['lock'] === false) {
                    $menu_array = array(
                        array('menu_key' => 'edit_detail',  'menu_name' => '编辑商品', 'menu_url' => urlShop('supplier_goods_online', 'edit_goods', array('commonid' => $_GET['commonid'], 'ref_url' => $_GET['ref_url']))),
                        array('menu_key' => 'edit_image',   'menu_name' => '编辑图片', 'menu_url' => urlShop('supplier_goods_online', 'edit_image', array('commonid' => $_GET['commonid'], 'ref_url' => ($_GET['ref_url'] ? $_GET['ref_url'] : getReferer())))),
                    );
                }
                if ($allow_promotion['gift'] == true) {
                    $menu_array[] = array('menu_key' => 'add_gift', 'menu_name' => '赠送赠品', 'menu_url' => urlShop('supplier_goods_online', 'add_gift', array('commonid' => $_GET['commonid'], 'ref_url' => ($_GET['ref_url'] ? $_GET['ref_url'] : getReferer()))));
                }
                break;
            case 'edit_class':
                $menu_array = array(
                    array('menu_key' => 'edit_class',   'menu_name' => '选择分类', 'menu_url' => urlShop('supplier_goods_online', 'edit_class', array('commonid' => $_GET['commonid'], 'ref_url' => $_GET['ref_url']))),
                    array('menu_key' => 'edit_detail',  'menu_name' => '编辑商品', 'menu_url' => urlShop('supplier_goods_online', 'edit_goods', array('commonid' => $_GET['commonid'], 'ref_url' => $_GET['ref_url']))),
                    array('menu_key' => 'edit_image',   'menu_name' => '编辑图片', 'menu_url' => urlShop('supplier_goods_online', 'edit_image', array('commonid' => $_GET['commonid'], 'ref_url' => ($_GET['ref_url'] ? $_GET['ref_url'] : getReferer())))),
                );
                break;
