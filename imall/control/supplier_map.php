...
class supplier_mapControl extends BaseSupplierControl{
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            case 'store_map':
                $menu_array = array(
                    array('menu_key'=>'index','menu_name'=>'地图显示 ',  'menu_url'=>'index.php?act=supplier_map&op=index'),
                    array('menu_key'=>'list','menu_name'=>'列表显示 ',  'menu_url'=>'index.php?act=supplier_map&op=list')
                );
                break;
        }
