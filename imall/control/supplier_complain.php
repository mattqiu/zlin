...
class supplier_complainControl extends BaseSupplierControl{
    //定义投诉状态常量
    const STATE_NEW = 10;
    ...
    public function appeal_saveOp() {
        ...
        showDialog(Language::get('appeal_submit_success'),'index.php?act=supplier_complain','succ');
    }
    ...
    public function apply_handleOp() {
        ...
        showMessage(Language::get('handle_submit_success'),'index.php?act=supplier_complain');
    }
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            array('menu_key'=>'complain_accused_list','menu_name'=>Language::get('complain_manage_title'),'menu_url'=>'index.php?act=supplier_complain')
        );
