...
class supplier_deliverControl extends BaseSupplierControl {
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            case 'deliver':
                $menu_array = array(
                array('menu_key'=>'deliverno',          'menu_name'=>Language::get('im_member_path_deliverno'), 'menu_url'=>'index.php?act=supplier_deliver&op=index&state=deliverno'),
                array('menu_key'=>'delivering',         'menu_name'=>Language::get('im_member_path_delivering'),    'menu_url'=>'index.php?act=supplier_deliver&op=index&state=delivering'),
                array('menu_key'=>'delivered',      'menu_name'=>Language::get('im_member_path_delivered'), 'menu_url'=>'index.php?act=supplier_deliver&op=index&state=delivered'),
                );
                break;
            case 'search':
                $menu_array = array(
                1=>array('menu_key'=>'nodeliver',           'menu_name'=>Language::get('im_member_path_deliverno'), 'menu_url'=>'index.php?act=supplier_deliver&op=index&state=nodeliver'),
                2=>array('menu_key'=>'delivering',          'menu_name'=>Language::get('im_member_path_delivering'),    'menu_url'=>'index.php?act=supplier_deliver&op=index&state=delivering'),
                3=>array('menu_key'=>'delivered',       'menu_name'=>Language::get('im_member_path_delivered'), 'menu_url'=>'index.php?act=supplier_deliver&op=index&state=delivered'),
                4=>array('menu_key'=>'search',      'menu_name'=>Language::get('im_member_path_deliver_info'),  'menu_url'=>'###'),
                );
                break;
        }
