...
class member_pointorderControl extends BaseMemberControl{
	...
	private function profile_menu($menu_type,$menu_key='') {
		...
		switch ($menu_type) {
			case 'pointorder':
				$menu_array	= array(
                    1=>array('menu_key'=>'points',	'menu_name'=>L('im_member_path_points'),	'menu_url'=>'index.php?act=member_points'),
			...
			case 'pointorderinfo':
				$menu_array	= array(
                    1=>array('menu_key'=>'points',	'menu_name'=>L('im_member_path_points'),	'menu_url'=>'index.php?act=member_points'),
                    2=>array('menu_key'=>'orderlist','menu_name'=>Language::get('im_member_path_pointorder_list'),	'menu_url'=>'index.php?act=member_pointorder&op=orderlist'),
                    3=>array('menu_key'=>'orderinfo','menu_name'=>Language::get('im_member_path_pointorder_info'),	'')
				);
				break;
		}
