...
class store_activityControl extends BaseSellerControl {
	...
	private function profile_menu($menu_key='') {
        ...
        $menu_array = array(
				1=>array('menu_key'=>'store_activity','menu_name'=>Language::get('im_member_path_activity_list'),'menu_url'=>'index.php?act=store_activity&op=store_activity'),
				2=>array('menu_key'=>'activity_apply','menu_name'=>Language::get('im_member_path_join_activity'),'menu_url'=>'')
        );
