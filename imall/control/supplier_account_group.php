...
class supplier_account_groupControl extends BaseSupplierControl {
    ...
    public function group_saveOp() {
        ...
        if (empty($_POST['group_id'])) {
            ...
            showDialog('添加成功', urlShop('supplier_account_group', 'group_list'),'succ');
        } else {
            $condition = array();
            ...
            showDialog('编辑成功', urlShop('supplier_account_group', 'group_list'),'succ');
        }
    }
    ...
    private function profile_menu($menu_key='') {
        ...
        $menu_array[] = array(
            'menu_key'=>'group_list',
            'menu_name' => '组列表',
            'menu_url' => urlShop('supplier_account_group', 'group_list')
        );
        if($menu_key === 'group_add') {
            $menu_array[] = array(
                'menu_key'=>'group_add',
                'menu_name' => '添加组',
                'menu_url' => urlShop('supplier_account_group', 'group_add')
            );
        }
        if($menu_key === 'group_edit') {
            $menu_array[] = array(
                'menu_key'=>'group_edit',
                'menu_name' => '编辑组',
                'menu_url' => urlShop('supplier_account_group', 'group_edit')
            );
        }
