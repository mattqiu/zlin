...
class sns_albumControl extends BaseSNSControl {
	...
	private function profile_menu($menu_type,$menu_key=''){
		$menu_array	= array();
		$album_menuname = ($this->relation==3?Language::get('sns_me'):'TA').Language::get('im_sns_path_my_album');
		switch ($menu_type) {
			case 'album':
				$menu_array	= array(
			...
			case 'album_pic':
				$menu_array	= array(
					1=>array('menu_key'=>'album','menu_name'=>$album_menuname,'menu_url'=>'index.php?act=sns_album&mid='.$this->master_id),
					2=>array('menu_key'=>'pic_list','menu_name'=>Language::get('im_sns_path_album_pic_list'),'menu_url'=>'index.php?act=sns_album&op=album_pic_list&id='.intval($_GET['id']).'&mid='.$this->master_id),
				);
				break;
			case 'album_pic_info':
				$menu_array	= array(
					1=>array('menu_key'=>'album','menu_name'=>$album_menuname,'menu_url'=>'index.php?act=sns_album&mid='.$this->master_id),
					2=>array('menu_key'=>'pic_info','menu_name'=>Language::get('im_sns_path_album_pic_info'),'menu_url'=>'index.php?act=sns_album&op=album_pic_info&id='.intval($_GET['id']).'&class_id='.intval($_GET['class_id']).'$mid='.$this->master_id),
				);
				break;
		}
