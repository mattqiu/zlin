...
class supplier_waybillControl extends BaseSupplierControl{
    ...
    public function waybill_bind_saveOp() {
        ...
        if($result) {
            showMessage('绑定成功', urlShop('supplier_waybill', 'waybill_manage'));
        } else {
    ...
    public function waybill_setting_saveOp() {
        ...
        if($result) {
            showDialog(L('nc_common_save_succ'), urlShop('supplier_waybill', 'waybill_manage'), 'succ');
        } else {
    ...
    public function waybill_saveOp() {
        ...
        if($result) {
            showDialog(L('nc_common_save_succ'), urlShop('supplier_waybill', 'waybill_list'), 'succ');
        } else {
            showDialog(L('nc_common_save_fail'), urlShop('supplier_waybill', 'waybill_list'));
        }
    }
    ...
    private function profile_menu($menu_key = '') {
        ...
        $menu_array[] = array(
            ...
            'menu_name' => '模板绑定',
            'menu_url' => urlShop('supplier_waybill', 'waybill_manage')
        );
        $menu_array[] = array(
            'menu_key' => 'waybill_list',
            'menu_name' => '自建模板',
            'menu_url' => urlShop('supplier_waybill', 'waybill_list')
        );
        if($menu_key == 'waybill_bind') {
            $menu_array[] = array(
                'menu_key' => 'waybill_bind',
                'menu_name' => '选择模板',
                'menu_url' => urlShop('supplier_waybill', 'waybill_bind')
            );
        }
        if($menu_key == 'waybill_setting') {
            $menu_array[] = array(
                ...
                'menu_name' => '模板设置',
                'menu_url' => urlShop('supplier_waybill', 'waybill_setting')
            );
        }
        if($menu_key == 'waybill_add') {
            $menu_array[] = array(
                ...
                'menu_name' => '添加模板',
                'menu_url' => urlShop('supplier_waybill', 'waybill_add')
            );
        }
        if($menu_key == 'waybill_edit') {
            $menu_array[] = array(
                ...
                'menu_name' => '编辑模板',
                'menu_url' => urlShop('supplier_waybill', 'waybill_edit')
            );
        }
        if($menu_key == 'waybill_design') {
            $menu_array[] = array(
                ...
                'menu_name' => '设计模板',
                'menu_url' => urlShop('supplier_waybill', 'waybill_design')
            );
        }
