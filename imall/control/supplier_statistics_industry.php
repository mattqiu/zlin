...
class supplier_statistics_industryControl extends BaseSupplierControl{
    ...
    private function profile_menu($menu_key=''){
        $menu_array = array(
            1=>array('menu_key'=>'hot','menu_name'=>'同行热卖','menu_url'=>'index.php?act=supplier_statistics_industry&op=hot'),
            2=>array('menu_key'=>'price','menu_name'=>'行业价格分布','menu_url'=>'index.php?act=supplier_statistics_industry&op=price')
        );
