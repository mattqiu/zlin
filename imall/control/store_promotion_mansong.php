...
class store_promotion_mansongControl extends BaseSellerControl {
    ...
    public function mansong_delOp() {
        ...
        if($result) {
            ...
            showDialog(L('im_common_op_succ'), urlShop('store_promotion_mansong', 'mansong_list'), 'succ');
        } else {
    ...
    public function mansong_quota_add_saveOp() {
        ...
        $this->recordSellerLog('购买'.$mansong_quota_quantity.'份满即送套餐，单价'.$current_price.$lang['im_yuan']);
