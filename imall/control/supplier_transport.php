...
class supplier_transportControl extends BaseSupplierControl {
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            ...
            case 'offpay_area':
                $menu_array = array(
                1=>array('menu_key'=>'transport',   'menu_name'=>Language::get('im_member_path_postage'),       'menu_url'=>'index.php?act=store_transport'),
                );
                if (checkPlatformStore()) {
                    $menu_array[] = array(
