...
class member_addressControl extends BaseMemberControl{
	...
	public function addressOp() {
		...
		if (chksubmit()){
			...
			showDialog($lang['im_common_op_succ'],'reload','js');
		}
	...
	private function profile_menu($menu_type,$menu_key='') {
		...
		switch ($menu_type) {
			case 'address':
				$menu_array = array(
				1=>array('menu_key'=>'address','menu_name'=>Language::get('im_member_path_address_list'),	'menu_url'=>'index.php?act=member_adderss&op=address'));
				break;
		}
