...
class store_order_printControl extends BaseSellerControl {
	...
	public function indexOp() {
		...
		if (!empty($store_info['store_label'])){
			if (file_exists(BASE_UPLOAD_PATH.DS.ATTACH_STORE.DS.'LOGO'.DS.$store_info['store_label'])){  
				$store_info['store_label'] = UPLOAD_SITE_URL.DS.ATTACH_STORE.DS.'LOGO'.DS.$store_info['store_label'];    
			}else {
