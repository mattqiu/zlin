...
class store_printsetupControl extends BaseSellerControl {
	...
	public function indexOp(){
		...
		if(chksubmit()){
			...
			if ($rs){
				showDialog(Language::get('im_common_save_succ'),'index.php?act=store_printsetup','succ');
			}else {
				showDialog(Language::get('im_common_save_fail'),'index.php?act=store_printsetup','error');
			}
		}else{
