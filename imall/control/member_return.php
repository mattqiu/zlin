...
class member_returnControl extends BaseMemberControl {
	...
	public function shipOp(){
		...
		if (chksubmit()) {
			...
			if ($state) {
				showDialog(Language::get('im_common_save_succ'),'index.php?act=member_return&op=index','succ');
			} else {
	...
	private function profile_menu($menu_type,$menu_key='') {
		...
		switch ($menu_type) {
			case 'member_order':
				$menu_array = array(
				array('menu_key'=>'buyer_refund','menu_name'=>Language::get('im_member_path_buyer_refund'),	'menu_url'=>'index.php?act=member_refund'),
				array('menu_key'=>'buyer_return','menu_name'=>Language::get('im_member_path_buyer_return'),	'menu_url'=>'index.php?act=member_return'),
