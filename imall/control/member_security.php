...
class member_securityControl extends BaseMemberControl {
    ...
    public function authOp() {
        ...
        if (chksubmit(false,true)) {
            ...
            if (($_GET['type'] == 'modify_email' && intval($member_info['member_email_bind']) == 0) ||
            ($_GET['type'] == 'modify_mobile' && intval($member_info['member_mobile_bind']) == 0)) {
            ...
            if (in_array($_GET['type'],array('modify_pwd','modify_paypwd')) && intval($member_info['member_email_bind']) == 0 &&
            intval($member_info['member_mobile_bind']) == 0) {
