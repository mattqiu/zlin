...
class store_groupbuyControl extends BaseSellerControl {
    ...
    public function groupbuy_quota_add_saveOp() {
        ...
        $this->recordSellerLog('购买'.$groupbuy_quota_quantity.'份抢购套餐，单价'.$current_price.L('im_yuan'));
    ...
    public function groupbuy_saveOp() {
        ...
        $param['groupbuy_rebate'] = imPriceFormat(floatval($_POST['groupbuy_price'])/floatval($goods_info['goods_price'])*10);
    ...
    private function profile_menu($menu_key='') {
        $menu_array	= array(
            1=>array('menu_key'=>'groupbuy_list','menu_name'=>L('im_member_path_group_list'),'menu_url'=>urlShop('store_groupbuy', 'groupbuy_list'))
        );
        switch ($menu_key){
        case 'groupbuy_add':
            $menu_array[] = array('menu_key'=>'groupbuy_add','menu_name'=>L('im_member_path_new_group'),'menu_url'=>'index.php?act=store_groupbuy&op=groupbuy_add');
            break;
        ...
        case 'groupbuy_quota_add':
            ...
            break;
        case 'groupbuy_edit':
            $menu_array[] = array('menu_key'=>'groupbuy_edit','menu_name'=>L('im_member_path_edit_group'),'menu_url'=>'index.php?act=store_groupbuy');
            break;
        case 'cancel':
            $menu_array[] = array('menu_key'=>'groupbuy_cancel','menu_name'=>L('im_member_path_cancel_group'));
            break;
        }
