...
class store_waybillControl extends BaseSellerControl{
    ...
    public function waybill_setting_saveOp() {
        ...
        if($result) {
            showDialog(L('im_common_save_succ'), urlShop('store_waybill', 'waybill_manage'), 'succ');
        } else {
            showDialog(L('im_common_save_fail'), '', 'error');
        }
    }
    ...
    public function waybill_set_defaultOp() {
        ...
        if($result) {
            ...
            showMessage(L('im_common_save_fail'), '', '', 'error');
        }
    }
    ...
    public function waybill_saveOp() {
        ...
        if(!isset($result['error'])) {
            showDialog(L('im_common_save_succ'), urlShop('store_waybill', 'waybill_list'), 'succ');
        } else {
            showDialog(L('im_common_save_fail'), urlShop('store_waybill', 'waybill_list'));
        }
    }
