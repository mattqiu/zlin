...
class member_favoritesControl extends BaseMemberControl{
	...
	private function profile_menu($menu_type,$menu_key='') {
		$menu_array = array(
			1=>array('menu_key'=>'fav_goods','menu_name'=>Language::get('im_member_path_collect_list'),	'menu_url'=>'index.php?act=member_favorites&op=fglist'),
			2=>array('menu_key'=>'fav_store','menu_name'=>Language::get('im_member_path_collect_store'), 'menu_url'=>'index.php?act=member_favorites&op=fslist')
		);
