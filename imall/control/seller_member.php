...
class seller_memberControl extends BaseExtensionControl {
    ...
    public function __construct() {
		...
		if ($this->store_info['member_count']<=0){
			$this->member_count = '';
		}else{
			$this->member_count = '('.$this->store_info['member_count'].')';
		}
    ...
    public function indexOp() {
    	$model_member = Model('extension');
    
    	$condition=array();
    	$member_list = $model_member->getMemberList($_SESSION['store_id'],20);
