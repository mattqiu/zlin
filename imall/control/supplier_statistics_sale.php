...
class supplier_statistics_saleControl extends BaseSupplierControl {
    ...
    public function saleOp(){
        ...
        $statcount_arr['orderamount'] = imPriceFormat(($t = floatval($statcount_arr['orderamount'])) > 0?$t:0);
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'sale','menu_name'=>'销售统计','menu_url'=>'index.php?act=supplier_statistics_sale&op=sale'),
            2=>array('menu_key'=>'area','menu_name'=>'区域分布','menu_url'=>'index.php?act=supplier_statistics_sale&op=area'),
            3=>array('menu_key'=>'buying','menu_name'=>'购买分析','menu_url'=>'index.php?act=supplier_statistics_sale&op=buying'),
        );
