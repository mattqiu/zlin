...
class searchControl extends BaseHomeControl {
    ...
    public function indexOp() {
        ...
        if (intval($_GET['cate_id']) > 0) {
            ...
            setIMCookie('his_sh', implode('~', $his_sh_list),2592000);
            //从TAG中查找分类
        ...
        if ($_GET['keyword'] == '') {
            ...
            Tpl::output('html_title', (empty($_GET['keyword']) ? '' : $_GET['keyword'] . ' - ') . C('site_name') . L('im_common_search'));
        }
