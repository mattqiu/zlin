...
//		Tpl::output('show_page',$page->show());
	...
	public function pic_listOp(){
        ...
        case 'goods':
            ...
            break;
		case 'advpic':
            Tpl::showpage('store_goods_add.step2_advpic','null_layout');
            break;
        case 'des':
	...
	private function profile_menu($menu_type,$menu_key=''){
		...
		switch ($menu_type) {
			case 'album':
				$menu_array	= array(
				1=>array('menu_key'=>'album','menu_name'=>Language::get('im_member_path_my_album'),'menu_url'=>'index.php?act=store_album'),
				2=>array('menu_key'=>'watermark','menu_name'=>Language::get('im_member_path_watermark'),'menu_url'=>'index.php?act=store_album&op=store_watermark')
				);
				break;
			case 'album_pic':
				$menu_array	= array(
				1=>array('menu_key'=>'album','menu_name'=>Language::get('im_member_path_my_album'),'menu_url'=>'index.php?act=store_album'),
				2=>array('menu_key'=>'pic_list','menu_name'=>Language::get('im_member_path_album_pic_list'),'menu_url'=>'index.php?act=store_album&op=album_pic_list&id='.intval($_GET['id'])),
				3=>array('menu_key'=>'watermark','menu_name'=>Language::get('im_member_path_watermark'),'menu_url'=>'index.php?act=store_album&op=store_watermark')
				);
				break;
			case 'album_pic_info':
				$menu_array	= array(
				1=>array('menu_key'=>'album','menu_name'=>Language::get('im_member_path_my_album'),'menu_url'=>'index.php?act=store_album'),
				2=>array('menu_key'=>'pic_info','menu_name'=>Language::get('im_member_path_album_pic_info'),'menu_url'=>'index.php?act=store_album&op=album_pic_info&id='.intval($_GET['id']).'&class_id='.intval($_GET['class_id'])),
				3=>array('menu_key'=>'watermark','menu_name'=>Language::get('im_member_path_watermark'),'menu_url'=>'index.php?act=store_album&op=store_watermark')
				);
				break;
		}
