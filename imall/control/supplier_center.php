...
class supplier_centerControl extends BaseSupplierControl {
...
//         Tpl::output('help_list',$help_list);
    ...
    function quicklink_addOp() {
        if(!empty($_POST['item'])) {
            $_SESSION['supplier_quicklink'][$_POST['item']] = $_POST['item'];
        }
    ...
    function quicklink_delOp() {
        if(!empty($_POST['item'])) {
            unset($_SESSION['supplier_quicklink'][$_POST['item']]);
        }
        $this->_update_quicklink();
        echo 'true';
    }
    ...
    private function _update_quicklink() {
        $quicklink = implode(',', $_SESSION['supplier_quicklink']);
        $update_array = array('supplier_quicklink' => $quicklink);
        $condition = array('supplier_id' => $_SESSION['supplier_id']);
