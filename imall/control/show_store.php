...
class show_storeControl extends BaseStoreControl {
	...
	public function indexOp(){
        ...
        if(!$this->store_decoration_only) {
			...
			$groupbuy_list = $model_groupbuy->getGroupbuyOnlineList($condition,10);
            ...
            //得到最新12个商品列表
            $new_goods_list = $model_goods->getGoodsListByCommonidDistinct($condition, $fieldstr, 'goods_id desc', 12);

            $condition['goods_commend'] = 1;
            //得到12个推荐商品列表
            $recommended_goods_list = $model_goods->getGoodsListByCommonidDistinct($condition, $fieldstr, 'goods_id desc', 12);
	...
	public function customOp(){
        ...
        Tpl::output('store_decoration_only', true);
        Tpl::showpage('index');
    }
	...
	public function goods_allOp(){
        ...
        $recommended_goods_list = $model_goods->getGoodsListByCommonidDistinct($condition, $fieldstr, $order, 24);
