      ...
      <div class="fill_filter">
        ...
        <div class="tips orange">  
			<span class="tips_c">
				...
				<a class="ico3" style="text-decoration:underline; cursor:pointer;" im_type="dialog" dialog_id="friend_add" dialog_title="<?php echo $lang['flea_oldnew_choose'];?>" uri="index.php?act=flea_class&op=quality_inner" dialog_width="400">
          ...
          <div class="seller fn-left">
            <div class="pic fn-left">
              <span class="thumb size50">
                <i></i>
                <a href="index.php?act=flea_class&seller_input=<?php echo $val['member_info']['member_id'];?>&pic_input=1"><img height="50" width="50" onload="javascript:DrawImage(this,50,50);" src="<?php echo UPLOAD_SITE_URL.DS.$val['member_info']['avatar'];?>" /></a>
              </span>
            </div>
            <p class="seller_name">
					...
					<li class="sell_one">
					  <div>
						<p class="pic1">
						  ...
						  <a href="index.php?act=flea_class&seller_input=<?php echo $val['member_id'];?>">
								<img width="20" height="20" onload="javascript:DrawImage(this,20,20);" src="<?php echo UPLOAD_SITE_URL;?>/<?php echo $val['member_avatar']?ATTACH_AVATAR.'/'.$val['member_avatar']:SKINS_PATH.'/images/default_user_portrait.gif';?>" />
							</a>              
						  </span>
						</p>
					  ...
					  <div class="items_info">
						<div class="pic2 fn-left">
						  <span class="thumb size50">
							<a href="index.php?act=flea_goods&goods_id=<?php echo $val['goods_id'];?>">
								<img height="48" width="48" onload="javascript:DrawImage(this,48,48);" title="<?php echo $val['goods_name'];?>" src="<?php echo $val['goods_image']?UPLOAD_SITE_URL.DS.ATTACH_MALBUM.'/'.$val['member_id'].'/'.$val['goods_image']:SHOP_SKINS_URL.'/images/member/default_image.png';?>" />
							</a>
						  </span>
						</div>
				...
				<li>
				  <div class="pic fn-left">
					<span class="thumb size60">
					  <i></i>
					  <a href="index.php?act=flea_goods&goods_id=<?php echo $val['goods_id'];?>">
						<img height="60" width="60" onload="javascript:DrawImage(this,60,60);" title="<?php echo $val['goods_name'];?>" src="<?php echo $val['goods_image']?UPLOAD_SITE_URL.DS.ATTACH_MALBUM.'/'.$val['member_id'].'/'.$val['goods_image']:SHOP_SKINS_URL.'/images/member/default_image.png';?>" />
					  </a>
					</span>
				  </div>
				  <h3 class="fn-right">
