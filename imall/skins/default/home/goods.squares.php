    ...
    <li class="item">
      <div class="goods-content" imtype_goods=" <?php echo $value['goods_id'];?>" imtype_store="<?php echo $value['store_id'];?>">
        ...
        <div class="goods-info">
          ...
          <div class="goods-price"> <em class="sale-price" title="<?php echo $lang['goods_class_index_store_goods_price'].$lang['im_colon'].$lang['currency'].$value['goods_promotion_price'];?>"><?php echo imPriceFormatForList($value['goods_promotion_price']);?></em> <em class="market-price" title="市场价：<?php echo $lang['currency'].$value['goods_marketprice'];?>"><?php echo imPriceFormatForList($value['goods_marketprice']);?></em> <span class="raty" data-score="<?php echo $value['evaluation_good_star'];?>"></span> </div>
          <div class="goods-sub">
            ...
            <?php }?>
            <span class="goods-compare" im_type="compare_<?php echo $value['goods_id'];?>" data-param='{"gid":"<?php echo $value['goods_id'];?>"}'><i></i>加入对比</span> </div>
          <div class="sell-stat">
            <ul>
              <li><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $value['goods_id']));?>#imGoodsRate" target="_blank" class="status"><?php echo $value['goods_salenum'];?></a>
                <p>商品销量</p>
              </li>
