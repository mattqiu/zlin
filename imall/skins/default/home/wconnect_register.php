    ...
    <div class="imcss-qq-mode">
      ...
      <div id="tabs_container" class="tabs-container">
        <div id="register" class="tabs-content">
          <form name="register_form" id="register_form" class="imcss-login-form" method="post" action="index.php?act=connect_wx&op=register">
        ...
        <div id="binding" class="tabs-content">
          <form id="binding_form" class="imcss-login-form" method="post" action="index.php?act=connect_wx&op=binding">
