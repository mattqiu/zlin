...
<div class="wrapper pr">
  ...
  <div class="imcr-main">
    ...
    <form method="post" id="porder_form" name="porder_form" action="index.php?act=pointcart&op=step2">
      ...
      <div class="imcr-receipt-info">
        ...
        <table class="imcr-table-style">
          ...
          <tbody>
            ...
            <tr class="shop-list ">
              <td></td>
              <td class="w60"><a href="<?php echo urlShop('pointprod', 'pinfo', array('id' => $val['pgoods_id']));?>" class="imcr-goods-thumb" target="_blank"><img src="<?php echo $val['pgoods_image_small']; ?>" alt="<?php echo $val['pgoods_name']; ?>"/></a></td>
            ...
            <tr>
            <td></td>
              <td colspan="20" class="tl"><label><?php echo $lang['pointcart_step1_message'].$lang['im_colon'];?>
          ...
          <tfoot>
            <tr>
              <td colspan="20"><div class="imcr-all-account"><?php echo $lang['pointcart_cart_allpoints'].$lang['im_colon'];?><em><?php echo $output['pointprod_arr']['pgoods_pointall']; ?></em><?php echo $lang['points_unit']; ?></div></td>
            </tr>
          </tfoot>
        </table>
        <!-- 已经选择礼品end -->
      ...
      <div class="imcr-bottom">
        <a href="index.php?act=pointcart" class="imcr-btn"><?php echo $lang['pointcart_step1_return_list'];?></a>
        <a id="submitpointorder" href="javascript:void(0);" class="imcr-btn imcr-btn-acidblue fr"><?php echo $lang['pointcart_step1_submit'];?></a>
       </div>
    </form>
  </div>
</div>
