  ...
  <div class="imcr-main">
    ...
    <table class="imcr-table-style">
      ...
      <tr id="pcart_item_<?php echo $v['pcart_id']; ?>">
        <td></td>
        <td class="w60"><a href="<?php echo urlShop('pointprod', 'pinfo', array('id' => $v['pgoods_id']));?>" target="_blank" class="imcr-goods-thumb"><img src="<?php echo $v['pgoods_image_small']; ?>" alt="<?php echo $v['pgoods_name']; ?>"/></a></td>
      ...
      <tfoot>
        <tr>
          <td colspan="20"><?php echo $lang['pointcart_cart_allpoints'].$lang['im_colon']; ?><span class="cart-point-b mr5" id="pcart_amount"><?php echo $output['pgoods_pointall']; ?></span><?php echo $lang['points_unit']; ?></td>
        </tr>
      </tfoot>
    </table>
    <div class="imcr-bottom"> <a href="index.php?act=pointcart&op=step1" class="imcr-btn imcr-btn-acidblue fr"><?php echo $lang['pointcart_cart_submit']; ?></a> </div>
  </div>
  <?php } else { ?>
  <div class="imcr-null-shopping"><i class="ico-gift"></i>
    <h4><?php echo $lang['pointcart_cart_null'];?></h4>
    <p><a href="index.php?act=pointprod" class="imcr-btn-mini mr10"><i class="fa fa-reply-all"></i><?php echo $lang['pointcart_cart_exchangenow'];?></a> <a href="index.php?act=member_pointorder" class="imcr-btn-mini"><i class="fa fa-file-text"></i><?php echo $lang['pointcart_cart_exchanged_list'];?></a></p>
  </div>
  <?php } ?>
</div>