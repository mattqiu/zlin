...
<div class="imcc-breadcrumb-layout" style="display: block;">
  <div class="imcc-breadcrumb wrapper"> <i class="fa fa-home"></i> <span> <a href="index.php">首页</a> </span> <span class="arrow">></span> <span><a href="index.php?act=show_live_groupbuy&op=live_groupbuy_list">线下团</a></span> <span class="arrow">></span> <span><?php echo $output['live_groupbuy']['groupbuy_name'];?></span> </div>
</div>
<div class="imcg-container wrapper">
  <div class="imcg-layout-l">
    <div class="imcg-main <?php if($output['groupbuy_state']!='2'){ echo 'not-start';}?>">
      <div class="imcg-group">
        ...
        <div class="imcg-item">
          ...
          <div class="button"> <span><?php echo $lang['currency'];?><em><?php echo $output['live_groupbuy']['groupbuy_price'];?></em></span> <a href="javascript:;" class="buynow">
            <?php if($output['groupbuy_state']=='1'){ echo '未开始';}elseif($output['groupbuy_state']=='2'){ echo '我要团';}else{ echo '已结束';}?>
            </a> </div>
          <div class="info" id="main-nav-holder">
            ...
            <div class="require">
              <h4>本团购已被团<em><?php echo $output['live_groupbuy']['buyer_num'];?></em>个</h4>
              <p>
            ...
            <div class="time"> 
              <!-- 倒计时 距离本期结束 --> 
              <i class="fa fa-clock-o"></i>剩余时间： <span class="process" endtime="<?php echo $output['live_groupbuy']['end_time'];?>"></span> </div>
            <?php }?>
          </div>
          <div class="clear"></div>
        </div>
    ...
    <div class="imcg-title-bar">
      <ul class="tabs-nav">
        <li class="tabs-selected"><a href="javascript:void(0);">团购介绍</a></li>
      </ul>
    </div>
    <div class="imcg-detail-content">
      <div class="imcg-instructions">
        ...
        <ul>
          ...
          <li>2. 单人每笔订单最多团购<strong><?php echo $output['live_groupbuy']['buyer_limit'];?></strong>个兑换码/券，如需更多请再次购买。</li>
          <li>3. 消费团购兑换码/券时，请向商家提供系统发送的”线下团购兑换码“，一码一销。</li>
        </ul>
      </div>
      <div class="imcg-intro"><?php echo $output['live_groupbuy']['groupbuy_intro'];?></div>
    </div>
  </div>
