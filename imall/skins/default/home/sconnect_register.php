...
<div class="imcss-login-layout">
  <div class="left-pic"><img src="<?php echo SHOP_SKINS_URL;?>/images/login_weibo.jpg" /><span><?php echo $output['sinauser_info']['name'];?> </span> </div>
  <div class="imcss-login" id="rotate">
    <ul>
      ...
      <form name="register_form" id="register_form" method="post" action="index.php?act=sconnect&op=register">
        ...
        <dl>
          ...
          <dd>
            ...
            <img src="index.php?act=seccode&op=makecode&imhash=<?php echo $output['imhash'];?>" title="<?php echo $lang['login_index_change_checkcode'];?>" name="codeimage" border="0" id="codeimage" onclick="this.src='index.php?act=seccode&op=makecode&imhash=<?php echo $output['imhash'];?>&t=' + Math.random()"  class="fl ml5"><a href="javascript:void(0)" class="fl ml5" onclick="javascript:document.getElementById('codeimage').src='index.php?act=seccode&op=makecode&imhash=<?php echo $output['imhash'];?>&t=' + Math.random();"><?php echo $lang['login_index_change_checkcode'];?></a>
      ...
      <form name="log_form" id="log_form" method="post" action="index.php?act=sconnect&op=login">
        ...
        <dl>
          ...
          <dd style="min-height:54px;">
            ...
            <img src="index.php?act=seccode&op=makecode&imhash=<?php echo $output['imhash'];?>" title="<?php echo $lang['login_index_change_checkcode'];?>" border="0" id="codeimage2" name="codeimage2" onclick="this.src='index.php?act=seccode&op=makecode&imhash=<?php echo $output['imhash'];?>&t=' + Math.random()" class="fl ml5"><a href="javascript:void(0)" class="fl ml5" onclick="javascript:document.getElementById('codeimage2').src='index.php?act=seccode&op=makecode&imhash=<?php echo $output['imhash'];?>&t=' + Math.random();"><?php echo $lang['login_index_change_checkcode'];?></a>
            <input name="imhash" type="hidden" value="<?php echo $output['imhash'];?>" />
            <label></label>
          </dd>
        </dl>
    ...
    <div class="imcss-login-bottom"></div>
  </div>
</div>
