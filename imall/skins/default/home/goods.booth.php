...
<div class="title">
<h3>推广商品</h3></div>
<div class="content" im_type="current_display_mode">
  <?php if(!empty($output['goods_list']) && is_array($output['goods_list'])){?>
  <ul class="imcc-booth-list squares">
    <?php foreach($output['goods_list'] as $value){?>
    <li imtype_goods="<?php echo $value['goods_id'];?>" imtype_store="<?php echo $value['store_id'];?>">
        ...
        <?php }?>
          ...
          <div class="goods-price" title="商品价格<?php echo $lang['im_colon'].$lang['currency'].$value['goods_promotion_price'];?>"><?php echo $lang['currency'];?><?php echo $value['goods_promotion_price'];?></div>
    </li>
    <?php }?>
  </ul>
  <?php }?>
