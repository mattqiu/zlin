...
.goods-promotion { font: 700 12px/15px "microsoft yahei"; color: #FFFFFF; background: url("<?php echo SHOP_SKINS_URL;?>/images/2014shop_background_img.png") no-repeat scroll 0 -100px rgba(0, 0, 0, 0); text-align: center; width: 30px; height: 30px; padding: 20px 9px 15px; position: absolute; top: 5px; right: 5px; z-index: 2;}
...
.jcarousel-next-horizontal { background: transparent url(<?php echo SHOP_SKINS_URL;?>/images/member/member_pics.png) no-repeat; width: 9px; height: 16px; padding: 10px 13px; position: absolute; z-index: 9; top: 40%; cursor: pointer;}
    ...
    <ul id="mycarousel" class="jcarousel-skin-tango">
      ...
      <li>
        ...
        <dl class="goods-info">
          ...
          <dd>
            <div>￥<em><?php echo imPriceFormat($v['goods_promotion_price']);?></em></div>
          </dd>
        </dl>
      </li>
      <?php } ?>
