...
<div class="imcp-voucher-exchange">
  ...
  <form method="post" action="index.php?act=pointvoucher&op=voucherexchange_save" id="exform" onsubmit="ajaxpost('exform', '', '', 'onerror');">
    ...
    <div class="button">
      ...
      <a href="javascript:DialogManager.close('vexchange');" class="imcp-btn">取消</a>
    </div>
  </form>
  <?php }else {?>
  <div class="errormsg" style="height:50px; text-align:center;"><?php echo $output['message'];?></div>
  <div style="text-align:center;"><a href="javascript:DialogManager.close('vexchange');" class="imcp-btn">取消</a></div>
  <?php }?>
</div>