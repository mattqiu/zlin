  ...
  <ul>
    ...
    <li>
      ...
      <dl>
        ...
        <dd class="goods-price"><strong><?php echo imPriceFormatForList($val['groupbuy_price']); ?></strong><span class="sell">已售<em><?php echo $val['buy_quantity']+$val['virtual_quantity'];?></em></span></dd>
      </dl>
  ...
  <ul>
    ...
    <li>
      ...
      <dl>
        ...
        <dd class="goods-price"><strong><?php echo imPriceFormatForList($val['xianshi_price']); ?></strong><span class="original"><?php echo imPriceFormatForList($val['goods_price']);?></span></dd>
