...
<link href="<?php echo SHOP_SKINS_URL;?>/css/flea_info.css" rel="stylesheet" type="text/css">
...
<div class="content">
        ...
        <?php if(!empty($output['goods_commend']) && is_array($output['goods_commend'])){?>
            ...
            <span class="thumb size76">
              ...
              <a href="index.php?act=flea_goods&type=goods&goods_id=<?php echo $comment_goods['goods_id'];?>">
              	<img height="76" width="76" onload="javascript:DrawImage(this,76,76);" src="<?php echo $comment_goods['goods_image'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$comment_goods['member_id'].DS.$comment_goods['goods_image'] : SHOP_SKINS_URL.'/images/member/default_image.png';?>" title="<?php echo $comment_goods['goods_name'] ?>" />
              </a>
			</span>
  ...
  <div class="flea_info_main">
    <div class="content_780 fn-left" style="position: relative;" im_type="jqzoom_relative">
      <h1 class="ware_title">
      ...
      <div class="ware_pic">
        <div class="big_pic"><i><a href="javascript:void(0)">
        	<span class="jqzoom">
        		...
        		<img height="300" width="300" src="<?php if (empty($output['desc_image'])){ echo SHOP_SKINS_URL.'/images/member/default_image.png'; }else{ echo $output['goods_image']['thumb_mid'];} ?>" onerror="this.src='<?php echo SHOP_SKINS_URL.'/images/member/default_image.png'; ?>'" onload="javascript:DrawImage(this,300,300);" jqimg="<?php echo $output['goods_image']['thumb_max'];?>" />
          ...
          <div class="ware_box">
            <ul>
              ...
              <li <?php if($key == 0) { ?>class="ware_pic_hover"<?php } ?> bigimg="<?php echo $val['thumb_max']; ?>">
              	<span class="thumb size40"><i></i><img height="40" width="40" src="<?php echo $val['thumb_small']; ?>" onerror="this.src='<?php echo SHOP_SKINS_URL.'/images/member/default_image.png';?>'" onload="javascript:DrawImage(this,40,40);" /></span>
              </li>
        <?php
			  	}
			  }
 ...
 <div class="share">
   ...
   <span><a href="#" class="blue" onclick="javascrit:collect_flea(<?php echo $output['goods']['goods_id'];?>);return false;"><?php echo $lang['flea_goods_collect_goods'];?></a></span>    </div>  
        ...
        <ul class="item_info">
          ...
          <li class="rank_new">
            ...
            <span class="tb-tips">
               ...
               <a class="ico3" style="text-decoration:none; cursor:pointer;" im_type="dialog" dialog_id="friend_add" dialog_title="<?php echo $lang['flea_oldnew_choose'];?>" uri="index.php?act=flea_class&op=quality_inner" dialog_width="400">
    ...
    <div id="seller_info" class="flea_gray mb10">
      ...
      <p><?php echo $lang['flea_store_owner'];?>:<?php echo $output['flea_member_info']['member_name'];?><a href="/index.php?act=member_message&op=sendmsg&member_id=<?php echo $output['flea_member_info']['member_id'];?>" target=_blank><img src="<?php echo SHOP_SKINS_URL;?>/images/web_mail.gif"></a></p>
    </div>
    <div id="seller_info" class="flea_gray mb10">
        ...
        <div class="flea_goods">
           <div class="pic">
             <span class="thumb size60">
               <i></i>
               <a title="<?php echo $val['goods_name']?>" href="index.php?act=flea_goods&type=goods&goods_id=<?php echo $val['goods_id']?>"><img height="60" width="60" src="<?php echo $val['goods_image'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$val['member_id'].DS.$val['goods_image'] : SHOP_SKINS_URL.'/images/member/default_image.png';?>" onload="javascript:DrawImage(this,60,60);"></a>
             </span>
           </div>
           <dl>
