...
<div id="category">
  <div class="content">
    <ul>
      <li>
        <div class="items_pic"><img src="<?php echo SHOP_SKINS_URL;?>/images/flea/cat.gif" /></div>
        <div class="cat_list">
      ...
      <li>
        <div class="items_pic"><img src="<?php echo SHOP_SKINS_URL;?>/images/flea/cat2.gif" /></div>
        <div class="cat_list">
      ...
      <li>
        <div class="items_pic"><img src="<?php echo SHOP_SKINS_URL;?>/images/flea/cat3.gif" /></div>
        <div class="cat_list">
      ...
      <li>
        <div class="items_pic"><img src="<?php echo SHOP_SKINS_URL;?>/images/flea/cat4.gif" /></div>
        <div class="cat_list">
      ...
      <li>
        <div class="items_pic"><img src="<?php echo SHOP_SKINS_URL;?>/images/flea/cat5.gif" /></div>
        <div class="cat_list">
      ...
      <div class="hotgoods">
        ...
        <div class="hotgoods_G">
          <dl>
            <dt class="fn-left">
              <div class="pic">
                <span class="thumb size100">
                  <i></i>
                  <a title="<?php echo $output['new_flea_goods']['goods_name'];?>" target="_blank" href="index.php?act=flea_goods&goods_id=<?php echo $output['new_flea_goods']['goods_id']?>"><img height="100" width="100" onload="javascript:DrawImage(this,100,100);" src="<?php echo $output['new_flea_goods']['goods_image'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$output['new_flea_goods']['member_id'].DS.$output['new_flea_goods']['goods_image'] : SHOP_SKINS_URL.'/images/member/default_image.png';?>" /></a>
                </span>
              </div>
            </dt>
            ...
            <dd class="fn-left"><img src="<?php echo SHOP_SKINS_URL;?>/images/flea/zr.png" /></dd>
      ...
      <li<?php if($i==7||$i==14){echo ' class="cn"';}?>>
        <div class="pic">
          <span class="thumb size120">
            <i></i>
            <a target="_blank" title="<?php echo $val['goods_name']; ?>" href="index.php?act=flea_goods&goods_id=<?php echo $val['goods_id']?>"><img height="120" width="120" onload="javascript:DrawImage(this,120,120);" src="<?php echo $val['goods_image'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$val['member_id'].DS.$val['goods_image'] : SHOP_SKINS_URL.'/images/member/default_image.png';?>" /></a>
          </span>
        </div>
        ...
        <li class="fn-left">
          <div class="pic">
            <span class="thumb size125">
              <i></i>
              <a target="_blank" title="<?php echo $val['goods_name']?>" href="index.php?act=flea_goods&goods_id=<?php echo $val['goods_id']?>"><img height="125" width="125" onload="javascript:DrawImage(this,125,125);" src="<?php echo $val['goods_image'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$val['member_id'].DS.$val['goods_image'] : SHOP_SKINS_URL.'/images/member/default_image.png';?>" /></a>
            </span>
          </div>
                  ...
                  <ul>
                    ...
                    <li>
                      <div class="pic">
                        <span class="thumb size120">
                          <i></i>
                          <a target="_blank" title="<?php echo $v['goods_name'];?>" href="index.php?act=flea_goods&goods_id=<?php echo $v['goods_id']?>"><img height="120" width="120" onload="javascript:DrawImage(this,120,120);" src="<?php echo $v['goods_image'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$v['member_id'].DS.$v['goods_image'] : SHOP_SKINS_URL.'/images/member/default_image.png';?>" /></a>                        </span>                      </div>
