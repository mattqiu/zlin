...
<div class="imcc-breadcrumb-layout" style="display: block;">
  <div class="imcc-breadcrumb wrapper"> <i class="fa fa-home"></i> <span> <a href="<?php echo urlShop(); ?>">首页</a> </span> <span class="arrow">></span>
...
<div class="imcg-container wrapper">
  <div class="imcg-layout-l">
    <div class="imcg-main <?php echo $output['groupbuy_info']['state_flag'];?>">
      <div class="imcg-group">
        ...
        <div class="imcg-item">
          ...
          <div class="info" id="main-nav-holder">
            ...
            <div class="time">
              ...
              <!-- 倒计时 距离本期结束 -->
              <i class="fa fa-clock-o"></i>剩余时间：<span id="d1">0</span><strong><?php echo $lang['text_tian'];?></strong><span id="h1">0</span><strong><?php echo $lang['text_hour'];?></strong><span id="m1">0</span><strong><?php echo $lang['text_minute'];?></strong><span id="s1">0</span><strong><?php echo $lang['text_second'];?></strong>
    ...
    <div class="imcg-detail-content">
<?php if ($output['groupbuy_info']['is_vr']) { ?>
      <div class="imcg-instructions">
        <h4>使用声明</h4>
        <ul>
          <li>
            1. 本次团购活动的最终有效期至
...
<?php } ?>
      <div class="imcg-intro"><?php echo $output['groupbuy_info']['groupbuy_intro'];?></div>
    </div>
    <div id="groupbuy_order" class="imcg-detail-content hide"></div>
    <div class="imcg-detail-content hide">
      <div class="imcg-evaluate">
        <div class="top">
          <div class="rate">
          ...
          <div class="btns"><span>您可对已购商品进行评价</span>
            <p><a href="<?php if ($output['groupbuy_info']['is_vr']) { echo urlShop('member_vr_order', 'index');} else { echo urlShop('member_order', 'index');}?>" class="imcg-btn imcg-btn-red" target="_blank"><i class="fa fa-comment-o"></i>评价商品</a></p>
          </div>
        </div>
        <!-- 商品评价内容部分 -->
        <div id="groupbuy_evaluate" class="imcg-evaluate-main"></div>
      </div>
    </div>
  </div>
  <div class="imcg-layout-r">

<?php if (!$output['store_info']['is_own_shop'] || $output['groupbuy_info']['is_vr']) { ?>
    <div class="imcg-store">
      <div class="title"><?php echo $lang['store_info'];?></div>
      <div class="content">
        <div class="imcg-store-info">
          <dl class="name">
            <dt>商&#12288;&#12288;家：</dt>
...
<?php } ?>
    ...
    <div class="imcg-module-sidebar">
      <div class="title"><?php echo $lang['current_hot'];?></div>
      <div class="content">
        <div class="imcg-group-command">
...
$(function(){
    ...
    $(".tabs-nav > li > a").live('mouseover', (function(e) {
    	if (e.target == this) {
    		...
    		var panels = $(this).parent().parent().parent().parent().children(".imcg-detail-content");
