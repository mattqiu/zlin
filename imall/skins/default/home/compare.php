...
<div class="imcc-container mt10 mb10">
  <div class="imcc-compare-title">基本信息对比</div>
  <?php if($output['compare_list']){ ?>
  <table class="imcc-compare-table">
    ...
    <tr id="comparetr_<?php echo $k; ?>" class="goods_tr">
      ...
      <td><dl class="goods-info">
          ...
          <?php if ($i>0){?>
          <dd class="del" onclick="javascript:delCompare(<?php echo $v[$i]['goods_id'];?>,'info');"><i class="fa fa-trash-o"></i>删除</dd>
          <?php }?>
        </dl></td>
  ...
  <div class="imcc-compare-bottom"> <a href="javascript:void(0);" im_type="comparediff" data-param='{"type":"light"}'><i class="fa fa-indent"></i>高亮显示不同项</a> <a href="javascript:void(0);" im_type="comparediff" data-param='{"type":"cancel"}' style="display: none;"><i class="fa fa-outdent"></i>取消高亮不同项</a> <a href="javascript:void(0);" im_type="comparesame" data-param='{"type":"hide"}'><i class="fa fa-compress"></i>隐藏相同项</a> <a href="javascript:void(0);" im_type="comparesame" data-param='{"type":"show"}' style="display: none;"><i class="fa fa-expand"></i>显示相同项</a> <a href="javascript:void(0);" class="delall" onclick="javascript:delCompare('all','info');"><i class="fa fa-times-circle"></i>清空对比栏</a></div>
  <?php } else {?>
  <table class="imcc-compare-table">
    <tbody>
      <tr>
        <td class="imcc-compare-null"><p> <i class="fa fa-search"></i>对比栏暂无对比商品，先添加对比商品再来进行详细比较吧！</p></td>
      </tr>
    </tbody>
  </table>
  <?php } ?>
...
<script type="text/javascript">
      ...
      $(document).ready(function(){
            $(".imcc-compare-table tr td").mouseover(function(){
      ...
      $(document).ready(function(){
            $(".imcc-compare-table tr td").mouseout(function(){
...
$(function(){
	//高亮显示和取消高亮不同项
	$("[im_type='comparediff']").click(function(){
		//处理参数
		var data_str = '';
		eval('data_str =' + $(this).attr('data-param'));
		var type = data_str.type;
		$("[im_type='comparediff']").show();
		$(this).hide();
	...
	//隐藏和显示相同项
	$("[im_type='comparesame']").click(function(){
		//处理参数
		var data_str = '';
		eval('data_str =' + $(this).attr('data-param'));
		var type = data_str.type;
		$("[im_type='comparesame']").show();
		$(this).hide();
		$("[name='isdiff[]']").each(function(){
			var itemval = $(this).val();
			if(itemval){
