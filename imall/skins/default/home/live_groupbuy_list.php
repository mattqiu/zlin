...
<div class="imcc-breadcrumb-layout" style="display: block;">
  <div class="imcc-breadcrumb wrapper"> <i class="fa fa-home"></i> <span> <a href="index.php">首页</a> </span> <span class="arrow">></span> <span>线下团</span></div>
</div>
<div class="imcg-container">
  <div id="imgCategory" class="imcg-category">
    <h3>团商品</h3>
    <ul>
