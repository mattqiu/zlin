...
<div id="apply_store_info" class="apply-store-info">
  ...
  <?php }?>
    ...
    <form id="form_paying_money_certificate" action="index.php?act=store_joinin&op=pay_save_p" method="post" enctype="multipart/form-data">
    ...
    <div class="bottom"><a id="btn_paying_money_certificate" href="javascript:;" class="btn">提交付款凭证</a></div>
  </div>
</div>
