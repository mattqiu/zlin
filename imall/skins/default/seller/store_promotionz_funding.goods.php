...
<ul class="goods-list" style="width:760px;">
  ...
  <li>
    ...
    <a imtype="btn_add_groupbuy_goods" data-goods-commonid="<?php echo $val['goods_commonid'];?>" href="javascript:void(0);" class="imsc-btn-mini imsc-btn-green"><i class="fa fa-check-circle-o "></i>选择为抢购商品</a> </li>
  <?php } ?>
</ul>
