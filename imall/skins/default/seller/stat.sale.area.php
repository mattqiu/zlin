...
<div id="stat_tabs" class="ui-tabs" style="min-height:500px;padding-top:10px;">
	<div class="tabmenu">
      	<ul class="tab pngFix">
      		<li><a href="#membernum_div" im_type="showdata" data-param='{"type":"membernum"}'>下单会员数</a></li>
      		<li><a href="#orderamount_div" im_type="showdata" data-param='{"type":"orderamount"}'>下单金额</a></li>
        	<li><a href="#ordernum_div" im_type="showdata" data-param='{"type":"ordernum"}'>下单量</a></li>
        </ul>
    </div>
    <!-- 下单会员数 -->
    <div id="membernum_div" im_type="datacontainer" class="tc">
        ...
        <?php } else {?>
        <div class="warning-option"><i class="fa fa-exclamation-triangle"></i><span>暂无符合条件的数据记录</span></div>
        <?php }?>
    </div>
    <!-- 下单金额 -->
    <div id="orderamount_div" im_type="datacontainer" class="tc" style="display:none;">
        <?php if($output['stat_json_map']){ ?>
    	<div class="stat-map-color">高&nbsp;&nbsp;<span style="background-color: #fd0b07;">&nbsp;</span><span style="background-color: #ff9191;">&nbsp;</span><span style="background-color: #f7ba17;">&nbsp;</span><span style="background-color: #fef406;">&nbsp;</span><span style="background-color: #25aae2;">&nbsp;</span>&nbsp;&nbsp;低
    		<p>备注：按照排名由高到低显示：排名第1、2、3名为第一阶梯；排名第4、5、6名为第二阶梯；排名第7、8、9为第三阶梯；排名第10、11、12为第四阶梯；其余为第五阶梯。</p>
    	</div>
    ...
    <!-- 下单量 -->
    <div id="ordernum_div" im_type="datacontainer" class="tc" style="display:none;">
    	<?php if($output['stat_json_map']){ ?>
    	<div class="stat-map-color">高&nbsp;&nbsp;<span style="background-color: #fd0b07;">&nbsp;</span><span style="background-color: #ff9191;">&nbsp;</span><span style="background-color: #f7ba17;">&nbsp;</span><span style="background-color: #fef406;">&nbsp;</span><span style="background-color: #25aae2;">&nbsp;</span>&nbsp;&nbsp;低
    		<p>备注：按照排名由高到低显示：排名第1、2、3名为第一阶梯；排名第4、5、6名为第二阶梯；排名第7、8、9为第三阶梯；排名第10、11、12为第四阶梯；其余为第五阶梯。</p>
    	</div>
