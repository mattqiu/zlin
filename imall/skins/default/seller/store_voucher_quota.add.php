<?php defined('InIMall') or exit('Access Invalid!');?>
  ...
  <div class="imsc-form-default">
    <form id="add_form" action="index.php?act=store_voucher&op=quotaadd" method="post">
      ...
      <dl>
        <dt><i class="required">*</i><?php echo $lang['voucher_apply_addnum'].$lang['im_colon'];?></dt>
        <dd><input id="quota_quantity" name="quota_quantity" type="text" class="text w50"/><em class="add-on"><?php echo $lang['im_month'];?></em><span></span>
...
$(document).ready(function(){
    ...
    $("#add_form").validate({
        ...
        messages : {
            quota_quantity : {
            	required : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['voucher_apply_num_error'];?>', 
            	digits : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['voucher_apply_num_error'];?>', 
            	min : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['voucher_apply_num_error'];?>',
            	max : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['voucher_apply_num_error'];?>'
            }
       	}
    });
});
