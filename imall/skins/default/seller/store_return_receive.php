<div class="eject_con">
  ...
  <form action="index.php?act=store_return&op=receive&return_id=<?php echo $output['return']['refund_id']; ?>" method="post" id="post_form">
    <input type="hidden" name="form_submit" value="ok" />
	  <dl>
	    <dt><?php echo '发货时间'.$lang['im_colon'];?></dt>
    ...
    <dl>
      <dt><i class="required">*</i><?php echo '收货情况'.$lang['im_colon'];?></dt>
    ...
    <div class="bottom">
        <label class="submit-border"><input type="submit" class="submit" id="confirm_yes" value="<?php echo $lang['im_ok'];?>" /></label>
    </div>
  </form>
</div>
...
$(function(){
    $('#post_form').validate({
        ...
        messages : {
            return_type  : {
                required  : '<i class="fa fa-exclamation-circle"></i><?php echo '请选择收货情况';?>'
            }
        }
	    });
});
