  ...
  <div class="imsc-flow-container">
    ...
    <div id="saleRefundReturn">
      ...
      <div class="imsc-form-default">
        ...
        <dl>
          <dt><?php echo $lang['return_buyer_message'].$lang['im_colon'];?></dt>
        ...
        <dl>
          <dt><?php echo $lang['return_order_return'].$lang['im_colon'];?></dt>
        ...
        <dl>
          ...
          <dd>
            ...
            <ul class="imsc-evidence-pic">
              <?php foreach ($output['pic_list'] as $key => $val) { ?>
              <?php if(!empty($val)){ ?>
              <li><a href="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_PATH.'/refund/'.$val;?>" imtype="nyroModal" rel="gal" target="_blank"> <img class="show_image" src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_PATH.'/refund/'.$val;?>"></a></li>
              <?php } ?>
              <?php } ?>
            </ul>
            <?php } ?>
        ...
        <?php } ?>
        <div class="bottom">
            <label class=""><a href="javascript:history.go(-1);" class="imsc-btn"><i class="fa fa-reply"></i>返回列表</a></label>
        </div>
      </div>
    </div>
  </div>
