...
<dl>
  <dt><em class="pngFix"></em><?php echo $lang['voucher_template_title'].$lang['im_colon']; ?></dt>
...
<dl>
  <dt ><em class="pngFix"></em><?php echo $lang['voucher_template_total'].$lang['im_colon']; ?></dt>
  <dd><?php echo $output['t_info']['voucher_t_total']; ?>&nbsp;<?php echo $lang['voucher_template_eachlimit_unit'];?></dd>
</dl>
<dl>
  <dt ><em class="pngFix"></em><?php echo $lang['voucher_template_eachlimit'].$lang['im_colon']; ?></dt>
  <dd><?php echo $output['t_info']['voucher_t_eachlimit'];?>&nbsp;<?php echo $lang['voucher_template_eachlimit_unit'];?></dd>
</dl>
<dl>
  <dt ><em class="pngFix"></em><?php echo $lang['voucher_template_orderpricelimit'].$lang['im_colon']; ?></dt>
  <dd><?php echo $output['t_info']['voucher_t_limit'];?>&nbsp;<?php echo $lang['currency_zh'];?></dd>
</dl>
<dl>
  <dt ><em class="pngFix"></em><?php echo $lang['voucher_template_describe'].$lang['im_colon']; ?></dt>
  <dd>
    <textarea  name="txt_template_describe" rows="3" class="w300" readonly><?php echo $output['t_info']['voucher_t_desc'];?></textarea>
  </dd>
</dl>
<dl>
  <dt ><em class="pngFix"></em><?php echo $lang['voucher_template_image'].$lang['im_colon']; ?></dt>
  <dd>
...
<dl>
  <dt><em class="pngFix"></em><?php echo $lang['voucher_template_giveoutnum'].$lang['im_colon']; ?></dt>
  <dd><?php echo $output['t_info']['voucher_t_giveout'];?>&nbsp;<?php echo $lang['voucher_template_eachlimit_unit'];?></dd>
</dl>
<dl>
  <dt><em class="pngFix"></em><?php echo $lang['voucher_template_usednum'].$lang['im_colon']; ?></dt>
