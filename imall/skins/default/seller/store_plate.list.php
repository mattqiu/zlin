...
<div class="tabmenu">
  ...
  <a href="<?php echo urlShop('store_plate', 'plate_add');?>" class="imsc-btn imsc-btn-green" title="添加关联版式">添加关联版式</a>
</div>
  ...
  <thead>
    ...
    <tr>
      ...
      <td colspan="10"><label for="all" ><?php echo $lang['im_select_all'];?></label>
        <a href="javascript:void(0);" im_type="batchbutton" uri="<?php echo urlShop('store_plate', 'drop_plate');?>" name="p_id" confirm="<?php echo $lang['im_ensure_del'];?>" class="imsc-btn-mini"><i class="fa fa-trash-o"></i><?php echo $lang['im_del'];?></a>
      </td>
    </tr>
    <?php } ?>
  </thead>
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle">
        <span><a href="<?php echo urlShop('store_plate', 'plate_edit', array('p_id' => $val['plate_id']));?>" class="btn-blue"><i class="fa fa-pencil-square-o"></i><p><?php echo $lang['im_edit'];?></p></a></span>
        <span><a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['im_ensure_del'];?>', '<?php echo urlShop('store_plate', 'drop_plate', array('p_id' => $val['plate_id']));?>');" class="btn-red"><i class="fa fa-trash-o"></i><p><?php echo $lang['im_del'];?></p></a></span>
      </td>
    </tr>
    <?php } ?>
    <?php } else { ?>
