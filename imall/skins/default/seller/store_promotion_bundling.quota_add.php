...
<div class="imsc-form-default">
  ...
  <?php }?>
    ...
    <dl>
      <dt><i class="required">*</i><?php echo $lang['bundling_quota_add_quantity'].$lang['im_colon'];?></dt>
      <dd>
        <input id="bundling_quota_quantity" name="bundling_quota_quantity" type="text" class="text w50"/><em class="add-on"><?php echo $lang['im_month'];?></em><span></span>
...
$(document).ready(function(){
	...
	$("#add_form").validate({
		...
		messages : {
			bundling_quota_quantity : {
				required : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['bundling_quota_quantity_error'];?>',
				digits : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['bundling_quota_quantity_error'];?>',
				min : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['bundling_quota_quantity_error'];?>',
				max : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['bundling_quota_quantity_error'];?>'
			}
		}
	});
});
