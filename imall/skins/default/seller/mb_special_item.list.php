...
<script type="text/javascript">
    ...
    var url_item_add = "<?php echo urlShop('mb_special', 'special_item_add');?>";
    var url_item_del = "<?php echo urlShop('mb_special', 'special_item_del');?>";
    var url_item_edit = "<?php echo urlShop('mb_special', 'special_item_edit');?>";
