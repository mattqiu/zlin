...
<table class="imsc-default-table">
  <thead>
    ...
    <tr>
      ...
      <td colspan="10"><label for="all"><?php echo $lang['im_select_all'];?></label>
        <a href="javascript:void(0);" class="imsc-btn-mini" im_type="batchbutton" uri="<?php echo urlShop('store_goods_online', 'drop_goods');?>" name="commonid" confirm="<?php echo $lang['im_ensure_del'];?>"><i class="fa fa-trash-o"></i><?php echo $lang['im_del'];?></a> <a href="javascript:void(0);" class="imsc-btn-mini" im_type="batchbutton" uri="<?php echo urlShop('store_goods_offline', 'goods_show');?>" name="commonid"><i class="fa fa-level-up"></i><?php echo $lang['store_goods_index_show'];?></a>
    </tr>
    <?php } ?>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td class="tl"><dl class="goods-name">
          ...
          <dd class="serve"> <span class="<?php if ($val['goods_commend'] == 1) { echo 'open';}?>" title="店铺推荐商品"><i class="commend">荐</i></span> <span class="<?php if ($val['mobile_body'] != '') { echo 'open';}?>" title="手机端商品详情"><i class="fa fa-mobile"></i></span> <span class="" title="商品页面二维码"><i class="fa fa-qrcode"></i>
            <div class="QRcode"><a target="_blank" href="<?php echo GetGoodsQRCode($_SESSION['store_id'],$output['storage_array'][$val['goods_commonid']]['goods_id']);?>">下载标签</a>
              <p><img src="<?php echo GetGoodsQRCode($_SESSION['store_id'],$output['storage_array'][$val['goods_commonid']]['goods_id']);?>"/></p>
            </div>
            </span> </dd>
        </dl></td>
      <td><a href="javascript:void(0)" onclick="ajax_get_confirm('','<?php echo urlShop('store_goods_offline', 'goods_show', array('commonid' => $val['goods_commonid']));?>')" class="imsc-btn"><?php echo $lang['store_goods_index_show'];?></a></td>
      ...
      <td class="nscs-table-handle"><span><a href="<?php echo urlShop('store_goods_online', 'edit_goods', array('commonid' => $val['goods_commonid']));?>" class="btn-blue"><i class="fa fa-pencil-square-o"></i><p><?php echo $lang['im_edit'];?></p></a></span>
        <span><a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['im_ensure_del'];?>', '<?php echo urlShop('store_goods_online', 'drop_goods', array('commonid' => $val['goods_commonid']));?>');" class="btn-red"><i class="fa fa-trash-o"></i><p><?php echo $lang['im_del'];?></p></a></span></td>
    </tr>
    <tr style="display:none;"><td colspan="20"><div class="imsc-goods-sku ps-container"></div></td></tr>
    <?php } ?>
    <?php } else { ?>
    <tr>
  ...
  <tfoot>
    <tr>
      ...
      <th colspan="10"><label for="all2"><?php echo $lang['im_select_all'];?></label>
        <a href="javascript:void(0);" class="imsc-btn-mini" im_type="batchbutton" uri="<?php echo urlShop('store_goods_online', 'drop_goods');?>" name="commonid" confirm="<?php echo $lang['im_ensure_del'];?>"><i class="fa fa-trash-o"></i><?php echo $lang['im_del'];?></a> <a href="javascript:void(0);" class="imsc-btn-mini" im_type="batchbutton" uri="<?php echo urlShop('store_goods_offline', 'goods_show');?>" name="commonid"><i class="fa fa-level-up"></i><?php echo $lang['store_goods_index_show'];?></a></th>
    </tr>
    <tr>
