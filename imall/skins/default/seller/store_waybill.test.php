...
.print-btn i { background: url(<?php echo SHOP_SKINS_URL?>/images/seller/ncsc_bg_img.png)scroll no-repeat 0 -460px; vertical-align: middle; display: inline-block; width: 32px; height: 32px;}
