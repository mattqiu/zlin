  ...
  <tbody>
    ...
    <tr class="bd-line" >
      ...
      <td class="nscs-table-handle"><?php if ($val['seller_state'] == 1) { ?>
    	<span><a href="index.php?act=store_refund&op=edit&refund_id=<?php echo $val['refund_id']; ?>" class="btn-blue"><i class="fa fa-pencil-square-o"></i><p>处理</p></a></span>
    	<?php } else { ?>
    	<span><a href="index.php?act=store_refund&op=view&refund_id=<?php echo $val['refund_id']; ?>" class="btn-orange"><i class="fa fa-eye"></i><p><?php echo $lang['im_view'];?></p></a></span><?php } ?>
       </td>
    </tr>
    <?php } ?>
    <?php } else { ?>
