  ...
  <form method="post" enctype="multipart/form-data" action="index.php?act=store_album&op=store_watermark" id="wm_form">
    ...
    <dl>
      ...
      <dd>
        ...
        <div class="imsc-upload-thumb watermark-pic"><p><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_WATERMARK.DS.$output['store_wm_info']['wm_image_name'];?>" id="imgView"/></p><a href="javascript:void(0);" id="del_image" title="<?php echo $lang['store_watermark_del_pic'];?>">X</a>
          <input type="hidden" id="is_del_image" name="is_del_image" value=""/>
        </div>
        <?php }else{?>
        <div class="imsc-upload-thumb watermark-pic"><p><i class="fa fa-picture-o"></i></p></div>
        <?php }?>
        <div class="imsc-upload-btn"> <a href="javascript:void(0);"><span>
          <input type="file" hidefocus="true" size="1" class="input-file" name="image" id="image" im_type="logo"/>
          </span>
    ...
    <dl>
      ...
      <dd>
        <ul class="imsc-watermark-pos" id="wm_image_pos">
          <li>
    ...
    <dl>
      ...
      <dd>
        <ul class="imsc-watermark-pos" id="wm_text_pos">
