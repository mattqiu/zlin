...
<div class="imsc-form-default">
    ...
    <?php } ?>
    <dl>
      <dt><i class="required">*</i><?php echo $lang['xianshi_name'];?><?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>活动标题<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>活动描述<?php echo $lang['im_colon'];?></dt>
      <dd>
...
<?php } ?>
    ...
    <?php } ?>
    <dl>
      <dt><i class="required">*</i>购买下限<?php echo $lang['im_colon'];?></dt>
      <dd>
...
<?php } ?>
        ...
        messages : {
            xianshi_name : {
                required : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['xianshi_name_error'];?>'
            },
            start_time : {
            required : '<i class="fa fa-exclamation-circle"></i><?php echo sprintf($lang['xianshi_add_start_time_explain'],date('Y-m-d H:i',$output['current_xianshi_quota']['start_time']));?>',
                greaterThanDate : '<i class="fa fa-exclamation-circle"></i><?php echo sprintf($lang['xianshi_add_start_time_explain'],date('Y-m-d H:i',$output['current_xianshi_quota']['start_time']));?>'
            },
            end_time : {
            required : '<i class="fa fa-exclamation-circle"></i><?php echo sprintf($lang['xianshi_add_end_time_explain'],date('Y-m-d H:i',$output['current_xianshi_quota']['end_time']));?>',
<?php if (!$output['isOwnShop']) { ?>
                lessThanDate : '<i class="fa fa-exclamation-circle"></i><?php echo sprintf($lang['xianshi_add_end_time_explain'],date('Y-m-d H:i',$output['current_xianshi_quota']['end_time']));?>',
<?php } ?>
            ...
            lower_limit: {
                ...
                digits: '<i class="fa fa-exclamation-circle"></i>购买下限必须为数字',
