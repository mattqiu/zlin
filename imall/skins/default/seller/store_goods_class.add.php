...
<div class="eject_con">
  ...
  <form id="category_form" method="post" target="_parent" action="index.php?act=store_goods_class&op=goods_class_save">
    ...
    <?php } ?>
    <dl>
      <dt><i class="required">*</i><?php echo $lang['store_goods_class_name'].$lang['im_colon'];?></dt>
      <dd>
    ...
    <?php if ($output['class_info']['stc_id']==0) { ?>
    <dl>
      <dt><?php echo $lang['store_goods_class_sup_class'].$lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><?php echo $lang['store_goods_class_display_state'].$lang['im_colon'];?></dt>
      <dd>
        <label>
...
$(function(){
    $('#category_form').validate({
        ...
        messages : {
            stc_name : {
                required : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['store_goods_class_name_null'];?>'

            },
            stc_sort  : {
                number   : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['store_goods_class_input_int'];?>'
            }
        }
    });
});
