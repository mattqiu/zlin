...
<table class="imsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <span><a href="javascript:void(0)" class="btn-red" onclick="ajax_get_confirm('<?php echo $lang['im_ensure_del'];?>', 'index.php?act=store_info&op=reopen_del&re_id=<?php echo $val['re_id']; ?>');"><i class="fa fa-trash-o"></i><p><?php echo $lang['im_del'];?></p></a></span>
     <?php } ?>
      </td>
    </tr>
    <?php } ?>
