...
<table class="imsc-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><?php echo imPriceFormat($code_info['pay_price'] * $code_info['commis_rate']/100);?></td>
        <td>
       	<a target="_blank" href="index.php?act=store_vr_order&op=show_order&order_id=<?php echo $code_info['order_id'];?>"><?php echo $lang['im_view'];?></a>
        </td>
      </tr>
      <?php } ?>
      <?php } else { ?>
