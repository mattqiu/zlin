...
<div class="imsc-form-default">
  <form method="post" id="tpl_form" name="tpl_form" action="index.php?act=store_transport&op=save">
    ...
    <dl>
      <dt>
        <label for="J_TemplateTitle" class="label-like"><?php echo $lang['transport_tpl_name'].$lang['im_colon'];?></label>
      </dt>
      <dd>
        <input type="text"  class="text"  id="title" autocomplete="off"  value="<?php echo $output['transport']['title'];?>" name="title">
        <p class="J_Message" style="display:none" error_type="title"><i class="fa fa-exclamation-circle"></i><?php echo $lang['transport_tpl_name_note'];?></p>
      </dd>
    </dl>
    <dl>
      <dt><?php echo $lang['transport_type'].$lang['im_colon'];?></dt>
  ...
  <div id="dialog_areas" class="dialog-areas" style="display:none">
    <div class="ks-contentbox">
      ...
      <form method="post">
        ...
        <div class="bottom"> <a href="javascript:void(0);" class="J_Submit imsc-btn imsc-btn-green"><?php echo $lang['transport_tpl_ok'];?></a> <a href="javascript:void(0);" class="J_Cancel imsc-btn"><?php echo $lang['transport_tpl_cancel'];?></a> </div>
      </form>
    </div>
  </div>
  <div id="dialog_batch" class="dialog-batch" style="z-index: 9999; display:none">
    <div class="ks-contentbox">
      ...
      <form method="post">
        <div class="batch"><?php echo $lang['transport_note_1'].$lang['im_colon'];?>
        ...
        <input class="w60 text" type="text" maxlength="6" autocomplete="off" value="0.00" name="express_postage" data-field="postage"><em class="add-on"> 元 </em><?php echo $lang['transport_note_3'];?>
        ...
        <input class="w60 text" type="text" maxlength="6" autocomplete="off" value="0.00" data-field="postageplus" name="express_postageplus"><em class="add-on"> 元 </em></div>
        <div class="J_DefaultMessage"></div>
        <div class="bottom"> <a href="javascript:void(0);" class="J_SubmitPL imsc-btn imsc-btn-green"><?php echo $lang['transport_tpl_ok'];?></a> <a href="javascript:void(0);" class="J_Cancel imsc-btn"><?php echo $lang['transport_tpl_cancel'];?></a> </div>
      </form>
    </div>
  </div>
</div>
