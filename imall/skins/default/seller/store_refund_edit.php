...
<div class="imsc-flow-layout">
  <div class="imsc-flow-container">
    ...
    <div class="imsc-form-default">
      ...
      <dl>
        <dt><?php echo $lang['refund_buyer_message'].$lang['im_colon'];?></dt>
        <dd> <?php echo $output['refund']['reason_info']; ?> </dd>
      </dl>
      <dl>
        <dt><?php echo $lang['refund_order_refund'].$lang['im_colon'];?></dt>
      ...
      <form id="post_form" method="post" action="index.php?act=store_refund&op=edit&refund_id=<?php echo $output['refund']['refund_id']; ?>">
        ...
        <h3>商家处理意见</h3>
        <dl>
          <dt><i class="required">*</i><?php echo $lang['refund_seller_confirm'].$lang['im_colon'];?></dt>
          <dd>
            <label class="mr20">
        ...
        <dl>
          <dt><i class="required">*</i><?php echo $lang['refund_message'].$lang['im_colon'];?></dt>
          <dd>
            <textarea name="seller_message" rows="2" class="textarea w300"></textarea>
            <span class="error"></span>
            <p class="hint">只能提交一次，请认真选择。<br>
              同意并经过平台确认后会将金额以积分的形式返还给买家。<br>
...
$(function(){
    ...
    $('#post_form').validate({
        ...
        messages : {
            seller_state  : {
                required  : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['refund_seller_confirm_null'];?>'
            },
            seller_message  : {
