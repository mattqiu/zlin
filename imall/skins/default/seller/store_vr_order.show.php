    ...
    <table class="imsc-default-table order">
      ...
      <tbody>
        ...
        <tr>
          ...
          <?php echo imPriceFormat($output['order_info']['order_amount']);?> * <?php echo $output['order_info']['commis_rate'];?>% = <?php echo imPriceFormat($output['order_info']['order_amount'] * $output['order_info']['commis_rate']/100);?>
          <?php } ?>
          </td>
      ...
      <tfoot>
        ...
        <tr>
          <th colspan="20"><dl class="imsc-store-sales">
              <?php if(!empty($output['order_info']['voucher_code'])){ ?>
