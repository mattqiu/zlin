    ...
    <dl>
			<dt>
				<input type="checkbox" class="checkbox mr5" name="message_forced"
					...
					checked="checked" <?php }?> /> <strong>商家消息提醒<?php echo $lang['im_colon'];?></strong>
			</dt>
    ...
    <dl>
			<dt>
				<input type="checkbox" class="checkbox mr5" name="short_forced" id="short_forced"
					...
					checked="checked" <?php }?> /> <strong>手机短信提醒<?php echo $lang['im_colon'];?></strong>
			</dt>
			<dd>
    ...
    <dl>
			<dt>
				<input type="checkbox" class="checkbox mr5" name="mail_forced" id="mail_forced"
					...
					checked="checked" <?php }?> /> <strong>邮件提醒<?php echo $lang['im_colon'];?></strong>
			</dt>
			<dd>
...
$(function(){
    $('#store_msg_setting').validate({
        ...
        messages : {
            short_number : {
                required : '<i class="fa fa-exclamation-circle"></i>请填写正确的手机号',
                digits : '<i class="fa fa-exclamation-circle"></i>请填写正确的手机号',
                rangelength : '<i class="fa fa-exclamation-circle"></i>请填写正确的手机号'
            },
            mail_number : {
                required : '<i class="fa fa-exclamation-circle"></i>请填写正确的邮箱',
