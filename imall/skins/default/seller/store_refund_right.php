...
<div class="imsc-flow-item">
  ...
  <div class="item-goods">
      ...
      <dl>
        <dt>
          <div class="imsc-goods-thumb-mini"><a target="_blank" href="<?php echo urlShop('goods','index',array('goods_id'=> $val['goods_id'])); ?>">
  ...
  <div class="item-order">
    ...
    <dl>
      <dt>订单总额：</dt>
      <dd><strong><?php echo $lang['currency'];?><?php echo imPriceFormat($output['order']['order_amount']); ?>
        <?php if ($output['order']['refund_amount'] > 0) { ?>
        (<?php echo $lang['refund_add'].$lang['im_colon'].$lang['currency'].$output['order']['refund_amount'];?>)
        <?php } ?>
        </strong> </dd>
    </dl>
    <dl class="line">
      <dt>订单编号：</dt>
      <dd><a target="_blank" href="index.php?act=store_order&op=show_order&order_id=<?php echo $output['order']['order_id']; ?>"><?php echo $output['order']['order_sn'];?></a> <a href="javascript:void(0);" class="a">更多<i class="fa fa-angle-down"></i>
