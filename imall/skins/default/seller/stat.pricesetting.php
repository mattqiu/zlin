...
<form id="pricerangeform" method="post" action="index.php" target="_self" onsubmit="return checksubmit();">
    ...
    <table id="pricerang_table" class="imsc-default-table">
      <thead>
        <tr>
        ...
        <tr>
          <td colspan="20">
            <a id="addrow" href="javascript:void(0);" class="imsc-btn-mini"><span>增加一行</span></a>
          </td>
        </tr>
      </thead>
      <tbody>
    	...
    	<tr id="row_<?php echo $k; ?>">
    		...
    		<td class="nscs-table-handle">
    			<span><a class="btn-red" href="JavaScript:void(0);" onclick="delrow(<?php echo $k;?>);"><i class="fa fa-trash-o"></i><p><?php echo $lang['im_del']; ?></p></a></span>
    		</td>
    	</tr>
    	<?php } } else { ?>
    	<tr id="row_0">
    		...
    		<td class="nscs-table-handle">
    			<span><a class="btn-red" href="JavaScript:void(0);" onclick="delrow(0);"><i class="fa fa-trash-o"></i><p><?php echo $lang['im_del']; ?></p></a></span>
    		</td>
    	</tr>
    	<?php } ?>
      </tbody>
...
$(function(){
	...
	$('#addrow').click(function(){
		...
		html += '<td class="nscs-table-handle"><span><a class="btn-red" href="JavaScript:void(0);" onclick="delrow('+i+');"><i class="fa fa-trash-o"></i><p><?php echo $lang['im_del']; ?></p></a></span></td>';
