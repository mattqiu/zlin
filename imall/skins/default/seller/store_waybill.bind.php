...
<table class="imsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="<?php echo urlShop('store_waybill', 'waybill_test', array('waybill_id' => $value['waybill_id']));?>" class="btn-acidblue" target="_blank"><i class="fa fa-print"></i>
        <p>测试</p>
        </a></span><span><a href="javascript:;" imtype="btn_bind" class="btn-green" data-waybill-id="<?php echo $value['waybill_id'];?>"><i class="fa fa-link"></i>
        <p>绑定</p>
        </a></span></td>
    </tr>
    <?php }?>
    <?php }else{?>
    <tr>
        <td colspan="20" class="norecord"><div class="warning-option"><i class="fa fa-exclamation-triangle"></i><span>还没有可用的运单模板，<a href="<?php echo urlShop('store_waybill', 'waybill_add');?>">去建立模板</a></span></div></td>
    </tr>
    <?php }?>
  </tbody>
  <tfoot>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('[imtype="btn_bind"]').on('click', function() {
