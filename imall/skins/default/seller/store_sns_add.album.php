...
<div class="groupbuy-gallery" imtype="store_sns_album"> <a class="sample_demo" id="select_s" href="index.php?act=store_album&op=pic_list&item=store_sns_normal" style="display:none;"><?php echo $lang['im_submit'];?></a>
...
$(document).ready(function(){
	/* 从图片空间选择图片 */
	$('div[imtype="store_sns_album"]').find('.demo').unbind().ajaxContent({
