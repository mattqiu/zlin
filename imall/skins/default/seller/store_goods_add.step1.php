...
<ul class="add-goods-step">
  <li class="current"><i class="icon fa fa-list-alt"></i>
    <h6>STEP.1</h6>
    <h2>选择商品分类</h2>
...
<div class="wrapper_search">
        ...
        <div class="text" id="commSelect">
            ...
            <div class="select_list" id="commListArea">
              <ul>
                ...
                <li  data-param="{stapleid:<?php echo $val['staple_id']?>}"><span imtype="staple_name"><?php echo $val['staple_name']?></span><a href="JavaScript:void(0);" imtype="del-comm-cate" title="<?php echo $lang['im_delete'];?>">X</a></li>
                <?php }?>
                <?php }?>
        ...
        <div class="wp_category_list">
          <div id="class_div_1" class="category_list">
            <ul>
              ...
              <li class="" imtype="selClass" data-param="{gcid:<?php echo $val['gc_id'];?>,deep:1,tid:<?php echo $val['type_id'];?>}"> <a class="" href="javascript:void(0)"><i class="fa fa-angle-double-right"></i><?php echo $val['gc_name'];?></a></li>
              <?php }?>
              <?php }?>
            </ul>
          </div>
  ...
  <div class="alert">
    <dl class="hover_tips_cont">
      ...
      <dt id="commoditydt" style="display: none;" class="current_sort"><?php echo $lang['store_goods_step1_current_choose_category'];?><?php echo $lang['im_colon'];?></dt>
  ...
  <div class="wp_confirm">
    <form method="get">
      ...
      <div class="bottom tc">
      <label class="submit-border"><input disabled="disabled" imtype="buttonNextStep" value="<?php echo $lang['store_goods_add_next'];?>，填写商品信息" type="submit" class="submit"style=" width: 200px;" /></label>
      </div>
    </form>
  </div>
</div>
