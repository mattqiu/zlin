  ...
  <form method="get" id="formSearch">
    <table class="search-form">
      ...
      <tr>
        ...
        <td class="tc w200">
        <label class="submit-border"><input type="button" id="imsubmit" class="submit" value="<?php echo $lang['im_search'];?>" /></label>
        <label class="submit-border"><input type="button" id="imexport" class="submit" value="导出" /></label>
        </td>
    </table>
  </form>
