...
<div class="imsc-form-default">
  <form id="add_form" action="<?php echo urlShop('store_waybill', 'waybill_setting_save');?>" method="post">
    ...
    <dl>
      <dt><i class="required">*</i>左偏移<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>上偏移<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>显示项目<?php echo $lang['im_colon'];?></dt>
      <dd>
        <?php if(!empty($output['store_waybill_data']) && is_array($output['store_waybill_data'])) {?>
        <ul class="imsc-form-checkbox-list">
...
$(document).ready(function(){
    $('#add_form').validate({
        ...
        messages: {
            store_waybill_left: {
                required: '<i class="fa fa-exclamation-circle"></i>上偏移不能为空',
                number: '<i class="fa fa-exclamation-circle"></i>上偏移必须为数字' 
            },
            store_waybill_top: {
                required: '<i class="fa fa-exclamation-circle"></i>上偏移不能为空',
                number: '<i class="fa fa-exclamation-circle"></i>上偏移必须为数字' 
