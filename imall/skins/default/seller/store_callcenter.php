...
<div class="imsc-form-default">
  <div class="alert"><strong><?php echo $lang['im_explain'].$lang['im_colon'];?></strong><?php echo $lang['store_callcenter_notes'];?>
    </li>
  </div>
  <form method="post" action="index.php?act=store_callcenter&op=save" id="callcenter_form" onsubmit="ajaxpost('callcenter_form','','','onerror')" class="imcs-message">
    <input type="hidden" name="form_submit" value="ok" />
    <dl imtype="pre">
      <dt><?php echo $lang['store_callcenter_presales_service'].$lang['im_colon']?></dt>
      <dd>
        <div class="imcs-message-title"><span class="name"><?php echo $lang['store_callcenter_service_name'];?></span><span class="tool"><?php echo $lang['store_callcenter_service_tool'];?></span><span class="number"><?php echo $lang['store_callcenter_service_number'];?></span></div>
        <?php if(empty($output['storeinfo']['store_presales'])){?>
        <div class="imcs-message-list"><span class="name tip" title="<?php echo $lang['store_callcenter_name_title'];?>">
          ...
          </span><span class="del"><a imtype="del" href="javascript:void(0);" class="imsc-btn"><i class="fa fa-trash-o"></i><?php echo $lang['im_delete'];?></a></span></div>
        <?php }else{?>
        ...
        <?php }?>
        <?php }?>
        <p><span><a href="javascript:void(0);" onclick="add_service('pre');" class="imsc-btn imsc-btn-acidblue mt10"><i class="fa fa-plus"></i><?php echo $lang['store_callcenter_add_service'];?></a></span></p>
      </dd>
    </dl>
    <dl imtype="after" >
      <dt><?php echo $lang['store_callcenter_aftersales_service'].$lang['im_colon'];?></dt>
      <dd>
        <div class="imcs-message-title"><span class="name"><?php echo $lang['store_callcenter_service_name'];?></span><span class="tool"><?php echo $lang['store_callcenter_service_tool'];?></span><span class="number"><?php echo $lang['store_callcenter_service_number'];?></span></div>
        ...
        <div class="imcs-message-list"><span class="name tip" title="<?php echo $lang['store_callcenter_name_title'];?>">
          ...
          </span><span><a imtype="del" href="javascript:void(0);" class="imsc-btn"><i class="fa fa-trash-o"></i><?php echo $lang['im_delete'];?></a></span> </div>
        <?php }else{?>
        ...
        <?php }?>
        <?php }?>
        <p><span><a href="javascript:void(0);" onclick="add_service('after');" class="imsc-btn imsc-btn-acidblue mt10"><i class="fa fa-plus"></i><?php echo $lang['store_callcenter_add_service'];?></a></span></p>
      </dd>
    </dl>
    <dl >
      <dt><em class="pngFix"><?php echo $lang['store_callcenter_working_time'].$lang['im_colon'];?></em></dt>
      <dd>
        <div class="imcs-message-title"><span><?php echo $lang['store_callcenter_working_time_title'];?></span></div>
        <div>
    ...
    <div class="bottom">
      <label class="submit-border"><input type="submit" class="submit" value="<?php echo $lang['im_common_button_submit'];?>" /></label>
    </div>
  </form>
</div>
...
$(function(){
	$('#callcenter_form').find('a[imtype="del"]').live('click', function(){
...
function add_service(param){
	...
	obj = $('dl[imtype="'+param+'"]').children('dd').find('p');
	len = $('dl[imtype="'+param+'"]').children('dd').find('div').length;
	key = 'k'+len+Math.floor(Math.random()*100);
	var add_html = '';
	add_html += '<div class="imcs-message-list">';
	...
	add_html += '<span class="del"><a imtype="del" href="javascript:void(0);" class="imsc-btn"><i class="fa fa-trash-o"></i><?php echo $lang['im_delete'];?></a></span>';
	add_html += '</div>';
	obj.before(add_html);
	titleTip();
}
