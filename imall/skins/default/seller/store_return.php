...
<table class="imsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line" >
        ...
        <dd><?php echo $lang['refund_order_ordersn'].$lang['im_colon'];?><a href="index.php?act=store_order&op=show_order&order_id=<?php echo $val['order_id']; ?>" target="_blank"><?php echo $val['order_sn'];?></a></dd>
      ...
      <td class="nscs-table-handle">
        ...
        <span><a href="index.php?act=store_return&op=edit&return_id=<?php echo $val['refund_id']; ?>" class="btn-blue"><i class="fa fa-pencil-square-o"></i><p>处理</p></a></span>
        <?php } else { ?>
       <span> <a href="index.php?act=store_return&op=view&return_id=<?php echo $val['refund_id']; ?>" class="btn-orange"><i class="fa fa-eye"></i><p><?php echo $lang['im_view'];?></p></a></span>
        <?php } ?>
        <?php if ($val['seller_state'] == 2 && $val['return_type'] == 2 && $val['goods_state'] == 2) { ?>
        <span><a href="javascript:void(0)" class="btn-green" im_type="dialog" dialog_title="<?php echo $lang['im_edit'];?>" dialog_id="return_order" dialog_width="480" uri="index.php?act=store_return&op=receive&return_id=<?php echo $val['refund_id']; ?>"><i class="fa fa-check-square"></i><p><?php echo '收货';?></p></a></span>
        <?php } ?>
        </td>
    </tr>
    <?php } ?>
