...
$(document).ready(function(){
	...
	$("#add_form").validate({
		...
		messages : {
			booth_quota_quantity : {
				required : '<i class="fa fa-exclamation-circle"></i>套餐购买数量不能为空，且必须为1~12之间的整数',
				digits : '<i class="fa fa-exclamation-circle"></i>套餐购买数量不能为空，且必须为1~12之间的整数',
				range : '<i class="fa fa-exclamation-circle"></i>套餐购买数量不能为空，且必须为1~12之间的整数'
			}
		}
	});
});
