...
<div class="imsc-form-default">
  <form id="add_form" action="index.php?act=store_livegroup&op=groupbuy_add" method="post" enctype="multipart/form-data">
    ...
    <dl>
      <dt>抢购副标题<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>抢购开始时间<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>抢购结束时间<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>活动有效期<?php echo $lang['im_colon'];?></dt>
      <dd>
        <input id="validity" name="validity" type="text" class="text w130"/><em class="add-on"><i class="fa fa-calendar"></i></em><span></span>
        <p class="hint">活动有效期为本次线下抢购活动所生成的兑换码有效使用日期，应大于抢购结束时间</p>
      </dd>
    </dl>
    <dl>
      <dt><i class="required">*</i>原价<?php echo $lang['im_colon'];?></dt>
      <dd>
        <input class="w70 text" id="original_price" name="original_price" type="text" value=""/><em class="add-on">元</em><span></span>
        <p class="hint">原价为所抢线下服务活动的正常销售价格，作为抢购价格参考及折扣率换算，必须是0.01~1000000之间的数字(单位：元)</p>
      </dd>
    </dl>
    <dl>
      <dt><i class="required">*</i>抢购价格<?php echo $lang['im_colon'];?></dt>
      <dd>
        <input class="w70 text" id="groupbuy_price" name="groupbuy_price" type="text" value=""/><em class="add-on">元</em><span></span>
        <p class="hint">抢购价格线下服务类活动的促销价格，必须是0.01~1000000之间的数字(单位：元)，并小于原价，线下抢购不产生任何物流运输费用</p>
      </dd>
    </dl>
    <dl>
      <dt><i class="required">*</i>抢购数量<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>单笔购买上限<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>抢购活动图片<?php echo $lang['im_colon'];?></dt>
      <dd>
        <div class="imsc-upload-thumb groupbuy-pic">
          <p><i class="fa fa-picture-o"></i> <img imtype="img_groupbuy_image" style="display:none;" src=""/></p>
        </div>
        <input imtype="groupbuy_image" name="groupbuy_image" type="hidden" value="">
        <div class="imsc-upload-btn"> <a href="javascript:void(0);"> <span>
          <input type="file" hidefocus="true" size="1" class="input-file" name="groupbuy_image" imtype="btn_upload_image"/>
          </span>
    ...
    <dl>
      <dt>抢购推荐位图片<?php echo $lang['im_colon'];?></dt>
      <dd>
        <div class="imsc-upload-thumb groupbuy-commend-pic">
          <p><i class="fa fa-picture-o"></i> <img imtype="img_groupbuy_image" style="display:none;" src=""/></p>
        </div>
        <input imtype="groupbuy_image" name="groupbuy_image1" type="hidden" value="">
        <div class="imsc-upload-btn"> <a href="javascript:void(0);"> <span>
          <input type="file" hidefocus="true" size="1" class="input-file" name="groupbuy_image" imtype="btn_upload_image"/>
          </span>
          <p><i class="fa fa-upload"></i>图片上传</p>
    ...
    <dl>
      <dt><i class="required">*</i>抢购分类<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>抢购区域<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>抢购介绍<?php echo $lang['im_colon'];?></dt>
      <dd>
        <?php showEditor('groupbuy_intro','','740px','360px','','false',false);?>
        <p class="hr8"><a class="des_demo imsc-btn" href="index.php?act=store_album&op=pic_list&item=groupbuy"><i class="fa fa-picture-o"></i>插入相册图片</a></p>
...
$(document).ready(function(){
    ...
    $('[imtype="btn_upload_image"]').fileupload({
        dataType: 'json',
            ...
            add: function(e, data) {
                ...
                $input = $parent.find('[imtype="groupbuy_image"]');
                $img = $parent.find('[imtype="img_groupbuy_image"]');
    ...
    $("#add_form").validate({
        ...
        messages : {
            groupbuy_name: {
                required : '<i class="fa fa-exclamation-circle"></i>抢购名称不能为空',
            },
            start_time : {
                required : '<i class="fa fa-exclamation-circle"></i>抢购开始时间不能为空',
                greaterThanDate:'<?php echo '抢购开始时间应大于'.date('Y-m-d H:i', time());?>'
            },
            end_time : {
                required : '<i class="fa fa-exclamation-circle"></i>抢购结束时间不能为空',
                greaterThanStartDate : '抢购结束时间应大于抢购开始时间'
            },
            validity : {
            	required : '<i class="fa fa-exclamation-circle"></i>有效期时间不能为空',
            	greaterThanEndDate : '活动有效期应大于抢购结束时间'
            },
            original_price:{
            	required : '<i class="fa fa-exclamation-circle"></i>原价不能为空',
                number : '<i class="fa fa-exclamation-circle"></i>原价必须是数字',
                min : '<i class="fa fa-exclamation-circle"></i>价格区间0.01~1000000',
                max : '<i class="fa fa-exclamation-circle"></i>价格区间0.01~1000000'
            },
            groupbuy_price: { 
            	required : '<i class="fa fa-exclamation-circle"></i>抢购价格不能为空',
                number : '<i class="fa fa-exclamation-circle"></i>抢购价格必须是数字',
                min : '<i class="fa fa-exclamation-circle"></i>价格区间0.01~1000000',
                max : '<i class="fa fa-exclamation-circle"></i>价格区间0.01~1000000',
                lessThanOriginalPrice:'抢购价格应小于原价'
            },
            buyer_count:{
                required : '<i class="fa fa-exclamation-circle"></i>抢购数量不能为空',
                number : '<i class="fa fa-exclamation-circle"></i>抢购数量必须是数字',
                min : '<i class="fa fa-exclamation-circle"></i>抢购数量数值区间0~1000000',
                max : '<i class="fa fa-exclamation-circle"></i>抢购数量数值区间0~1000000',
            },
            buyer_limit:{
                required : '<i class="fa fa-exclamation-circle"></i>购买上限不能为空',
                number : '<i class="fa fa-exclamation-circle"></i>购买上限必须是数字',
                min : '<i class="fa fa-exclamation-circle"></i>购买上限应大于等于1',
                lessThanBuyerCount : '<i class="fa fa-exclamation-circle"></i>购买上限应小于抢购数量'
            },
            groupbuy_image:{
            	required : '<i class="fa fa-exclamation-circle"></i>抢购图片不能为空',
            },
            s_class:{
            	required : '<i class="fa fa-exclamation-circle"></i>抢购分类不能为空',
            },
            mall:{
            	required : '<i class="fa fa-exclamation-circle"></i>抢购区域不能为空',
            }
        }
    });
