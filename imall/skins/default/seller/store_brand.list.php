...
<div class="tabmenu">
  ...
  <a href="javascript:void(0)" class="imsc-btn imsc-btn-green" im_type="dialog" dialog_title="<?php echo $lang['store_goods_brand_apply'];?>" dialog_id="my_goods_brand_apply" dialog_width="480" uri="index.php?act=store_brand&op=brand_add"><?php echo $lang['store_goods_brand_apply'];?></a></div>
...
<table class="imsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
     ...
     <span><a href="javascript:void(0)" class="btn-blue" im_type="dialog" dialog_title="<?php echo $lang['store_goods_brand_edit'];?>" dialog_id="my_goods_brand_edit" dialog_width="480" uri="index.php?act=store_brand&op=brand_add&brand_id=<?php echo $val['brand_id']; ?>"><i class="fa fa-pencil-square-o"></i><p><?php echo $lang['im_edit'];?></p></a></span>
        <span><a href="javascript:void(0)" class="btn-red" onclick="ajax_get_confirm('<?php echo $lang['im_ensure_del'];?>', 'index.php?act=store_brand&op=drop_brand&brand_id=<?php echo $val['brand_id']; ?>');"><i class="fa fa-trash-o"></i><p><?php echo $lang['im_del'];?></p></a></span><?php } ?></td>
    </tr>
    <?php } ?>
    <?php } else { ?>
    <tr>
