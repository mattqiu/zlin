...
<div class="tabmenu">
  ...
  <a uri="index.php?act=store_album&op=album_add" im_type="dialog" dialog_title="<?php echo $lang['album_class_add'];?>" class="imsc-btn imsc-btn-green" style="right: 100px;"><i class="fa fa-folder-open "></i><?php echo $lang['album_class_add'];?></a>
  ...
  <div class="upload-con" id="uploader" style="display: none;">
    <form method="post" action="" id="fileupload" enctype="multipart/form-data">
      <div class="upload-con-div"><?php echo $lang['album_class_list_sel_img_class'].$lang['im_colon'];?>
...
<div id="pictureIndex" class="imsc-picture-folder">
    ...
    <ul>
      ...
      <li class="hidden">
        <dl>
          ...
          <dd class="buttons"><span im_type="dialog" dialog_title="<?php echo $lang['album_class_deit'];?>" dialog_id='album_<?php echo $v['aclass_id'];?>' dialog_width="480" uri="index.php?act=store_album&op=album_edit&id=<?php echo $v['aclass_id'];?>"><a href="JavaScript:void(0);"><i class="fa fa-pencil"></i><?php echo $lang['album_class_edit'];?></a></span>
            <?php if($v['is_default'] != '1'){?>
            <a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['album_class_delete_confirm_message'];?>', 'index.php?act=store_album&op=album_del&id=<?php echo $v['aclass_id'];?>');"><i class="fa fa-times-circle"></i><?php echo $lang['album_class_delete'];?></a>
            <?php }?>
          </dd>
        </dl>
      </li>
...
$(function() {
    //鼠标触及区域li改变class
    $(".imsc-album ul li").hover(function() {
        $(this).addClass("hover");
    }, function() {
        $(this).removeClass("hover");
    });
    //凸显鼠标触及区域、其余区域半透明显示
    $(".imsc-album > ul > li").jfade({
        start_opacity:"1",
        high_opacity:"1",
        low_opacity:".5",
        timing:"200"
