    ...
    <?php if (is_array($output['address_list']) && !empty($output['address_list'])){?>
      <thead>
        <tr>
          ...
          <th class="w80"><?php echo $lang['im_common_button_operate'];?></th>
        </tr>
      </thead>
      ...
      <tbody>
        ...
        <tr class="bd-line">
          ...
          <td class="tc"><a href="javascript:void(0);" im_type="select" class="imsc-btn" address_id="<?php echo $value['address_id'];?>" address_value="<?php echo $value['seller_name'].'&nbsp;'.$value['telphone'].'&nbsp;'.$value['area_info'].'&nbsp;'.$value['address'];?>"><?php echo $lang['im_common_button_select'];?></a></td>
        </tr>
        <?php }?>
        <tr class="bd-line">
          <td colspan="20"></td>
...
$(document).ready(function(){
	$('a[im_type="select"]').on('click',function(){
