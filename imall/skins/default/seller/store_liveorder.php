...
<div class="tabmenu">
  ...
  <a href="javascript:void(0);" class="imsc-btn imsc-btn-orange" dialog_id="store_msg_info" dialog_title="兑换码验证" dialog_width="640" im_type="dialog" uri="<?php echo urlShop('store_liveorder', 'store_liveverify');?>"><i class="fa fa-pencil-square-o"></i>兑换码验证</a> </div>
...
<table class="imsc-table-style order">
  <thead>
    <tr>
      <th class="w10"></th>
  ...
  <tr>
    ...
    <td class="bdl bdr"><p>
      ...
      <p>
        <?php if($val['state']==1){?>
        <a href="javascript:void(0)" class="imsc-btn-mini imsc-btn-red mt5" im_type="dialog" dialog_width="480" dialog_title="取消订单" dialog_id="buyer_order_cancel_order" uri="index.php?act=store_liveorder&op=cancel&order_id=<?php echo $val['order_id'];?>"  id="order<?php echo $val['order_id'];?>_action_cancel"><i class="fa fa-ban"></i>取消订单</a>
        <?php }?>
      </p></td>
  </tr>
  <?php }?>
