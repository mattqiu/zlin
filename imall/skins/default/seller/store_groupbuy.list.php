...
<?php if ($output['isOwnShop']) { ?>
  <a href="<?php echo urlShop('store_groupbuy', 'groupbuy_add_vr'); ?>" style="right:100px" class="imsc-btn imsc-btn-green" title="新增虚拟商品抢购"><i class="fa fa-plus-circle"></i>新增虚拟抢购</a>
  <a href="<?php echo urlShop('store_groupbuy', 'groupbuy_add');?>" class="imsc-btn imsc-btn-green" title="<?php echo $lang['groupbuy_index_new_group'];?>"><i class="fa fa-plus-circle"></i><?php echo $lang['groupbuy_index_new_group'];?></a>
<?php } else { ?>

  <?php if(!empty($output['current_groupbuy_quota'])) { ?>
  <a href="<?php echo urlShop('store_groupbuy', 'groupbuy_add_vr'); ?>" style="right:200px" class="imsc-btn imsc-btn-green" title="新增虚拟商品抢购"><i class="fa fa-plus-circle"></i>新增虚拟抢购</a>
  <a href="<?php echo urlShop('store_groupbuy', 'groupbuy_add');?>" style="right:100px" class="imsc-btn imsc-btn-green" title="<?php echo $lang['groupbuy_index_new_group'];?>"><i class="fa fa-plus-circle"></i><?php echo $lang['groupbuy_index_new_group'];?></a>
  <a class="imsc-btn imsc-btn-acidblue" href="<?php echo urlShop('store_groupbuy', 'groupbuy_quota_add');?>" title="套餐续费"><i class="fa fa-money"></i>套餐续费</a>
  <?php } else { ?>
  <a class="imsc-btn imsc-btn-acidblue" href="<?php echo urlShop('store_groupbuy', 'groupbuy_quota_add');?>" title="购买套餐"><i class="fa fa-money"></i>购买套餐</a>
  <?php } ?>
<?php } ?>
