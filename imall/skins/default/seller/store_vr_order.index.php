...
<div class="tabmenu">
  ...
  <a href="<?php echo urlShop('store_vr_order', 'exchange');?>" class="imsc-btn imsc-btn-orange"><i class="fa fa-pencil-square-o"></i>兑换兑换码</a>
</div>
...
<table class="imsc-default-table order">
  ...
  <tbody>
    ...
    <tr>
      ...
      <?php if ($order['order_from'] == 2){?><i class="fa fa-mobile"></i><?php }?>
    ...
    <tr>
      <td class="bdl"></td>
      <td class="w70"><div class="imsc-goods-thumb"><a href="<?php echo urlShop('goods','index',array('goods_id'=>$order['goods_id']));?>" target="_blank"><img src="<?php echo thumb($order,60);?>" onMouseOver="toolTip('<img src=<?php echo thumb($order,240);?>>')" onMouseOut="toolTip()"/></a></div></td>
...
<?php } ?>
      ...
      <td class="bdl"><p class="imsc-order-amount"><?php echo $order['order_amount']; ?></p>
