...
<div class="tabmenu">
  ...
  <a href="javascript:void(0)" class="imsc-btn imsc-btn-green" im_type="dialog" dialog_title="添加导购员" dialog_id="my_saleman_add" dialog_width="480" uri="<?php echo urlShop('seller_saleman', 'saleman_edit');?>" title="添加导购员">添加会员</a>
</div>
<table class="imsc-table-style">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td>
        <a href="javascript:void(0)" im_type="dialog" dialog_title="查看会员信息" dialog_id="my_saleman_info" dialog_width="480" uri="<?php echo urlShop('seller_saleman', 'saleman_info',array('saleman_id'=>$v['member_id']));?>" title="查看会员信息">查看</a>|
        <a href="javascript:void(0)" im_type="dialog" dialog_title="修改会员信息" dialog_id="my_saleman_add" dialog_width="480" uri="<?php echo urlShop('seller_saleman', 'saleman_edit',array('saleman_id'=>$v['member_id']));?>" title="修改会员信息">修改</a>|
