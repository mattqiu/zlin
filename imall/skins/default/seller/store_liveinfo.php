...
<div class="imsc-form-default">
  <form id="add_form" action="index.php?act=store_live&op=store_live" method="post" >
    <dl>
      <dt>兑换码生成前缀<?php echo $lang['im_colon'];?></dt>
      <dd>
        <input class="w50 text" name="store_vrcode_prefix" type="text" value="<?php echo $output['store']['store_vrcode_prefix'];?>" maxlength="30"  />
        <span></span>
        <p class="hint">该设置将作为兑换码的一部分，用于区别不同店铺之间的兑换码，增加兑换码使用的安全性，只接受字母或数字，最多3个字符。</p>
      </dd>
    </dl>
    <dl>
      <dt>线下商铺名称<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>线下商铺面积<?php echo $lang['im_colon'];?></dt>
      <dd>
        <input class="w200 text" name="live_area_count" type="text" id="live_area_count" value="<?php echo $output['store']['live_area_count'];?>" maxlength="30"  />
        <span></span>
        <p class="hint">线下商铺面积将影响到统计经营概况中的坪效等数据。</p>
      </dd>
    </dl>
    <dl>
      <dt>线下商铺员工数<?php echo $lang['im_colon'];?></dt>
      <dd>
        <input class="w200 text" name="live_employee_count" type="text" id="live_employee_count" value="<?php echo $output['store']['live_employee_count'];?>" maxlength="30"  />
        <span></span>
        <p class="hint">线下商铺面积将影响到统计经营概况中的人效等数据。</p>
      </dd>
    </dl>
    <dl>
      <dt>线下商铺电话<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>线下商铺地址<?php echo $lang['im_colon'];?></dt>
      <dd>
