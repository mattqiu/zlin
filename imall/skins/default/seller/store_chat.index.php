...
<div class="alert mt10"> <strong><?php echo $lang['im_explain'].$lang['im_colon'];?></strong> 只能查询“<?php echo $output['minDate']; ?>”到“<?php echo $output['maxDate']; ?>”的聊天记录，切换不同的选项卡选择可查看与店铺客服最近对话的会员。 </div>
<div class="tabmenu">
...
<div class="imsc-chat-layout"><table class="search-form">
      <tr><td class="w10"></td>
