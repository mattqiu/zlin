...
<form method="post" id="goods_gift" action="<?php echo urlShop('store_goods_online', 'save_gift');?>">
  ...
  <div class="imsc-form-goods-gift" data-gid="<?php echo $value['goods_id'];?>">
    ...
    <div class="goods-summary">
      ...
      <dl>
        <dt>赠品捆绑：</dt>
        <dd>
          <ul class="goods-gift-list" imtype="choose_goods_list">
            ...
            <li>
              ...
              <a class="gift-del" imtype="del_choosed" href="javascript:void(0);" title="删除赠品">X</a></li>
            <?php }?>
            <?php }?>
          </ul>
          <a class="imsc-btn-mini" imtype="select_goods" href="javascript:void(0);"><i class="fa fa-gift"></i>选择赠品</a></dd>
      </dl>
    </div>
      ...
      <table class="search-form">
        <thead>
          <tr>
            ...
            <td class="tc w70"><a class="imsc-btn" href="javascript:void(0);" imtype="search_gift"><i class="fa fa-search"></i>搜索</a></td>
            <td class="w10"></td>
          </tr>
        </thead>
      </table>
      <div class="search-result" imtype="gift_goods_list"></div>
...
$(function(){
    ...
    $('a[imtype="select_goods"]').click(function(){
        $(this).parents('.goods-summary:first').nextAll('.div-goods-select').show()
            ...
            .find('a[imtype="search_gift"]').click();
    });
    ...
    // 所搜商品
    $('a[imtype="search_gift"]').click(function(){
    ...
    // 分页
    $('div[imtype="gift_goods_list"]').on('click', 'a[class="demo"]', function(){
        $(this).parents('div[imtype="gift_goods_list"]').load($(this).attr('href'));
        return false;
    });

    // 删除
    $('ul[imtype="choose_goods_list"]').on('click', 'a[imtype="del_choosed"]', function(){
        $(this).parents('li:first').remove();
    });

    // 选择商品
    $('div[imtype="gift_goods_list"]').on('click', 'a[imtype="a_choose_goods"]', function(){
        _owner_gid = $(this).parents('.imsc-form-goods-gift:first').attr('data-gid');
        ...
        _li = $('<li></li>')
            ...
            .append('<a class="gift-del" imtype="del_choosed" href="javascript:void(0);" title="删除赠品">X</a>');
        $(this).parents('.div-goods-select:first').prev().find('ul[imtype="choose_goods_list"]').append(_li);
    });
