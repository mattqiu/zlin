...
<div class="imsc-form-default">
  <form id="form_setting" method="post" action="<?php echo urlShop('store_decoration', 'decoration_setting_save');?>">
    <dl>
      <dt>启用店铺装修<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>仅显示装修内容<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>店铺装修<?php echo $lang['im_colon'];?></dt>
      <dd> <a href="<?php echo urlShop('store_decoration', 'decoration_edit', array('decoration_id' => $output['decoration_id']));?>" class="imsc-btn imsc-btn-acidblue mr5" target="_blank"><i class="fa fa-puzzle-piece"></i>装修页面</a> <a id="btn_build" href="<?php echo urlShop('store_decoration', 'decoration_build', array('decoration_id' => $output['decoration_id']));?>" class="imsc-btn imsc-btn-orange" target="_blank"><i class="fa fa-magic"></i>生成页面</a>
