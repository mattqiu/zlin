...
<form method="get" action="index.php">
  <table class="search-form">
    <input type="hidden" name="act" value="seller_promotion" />
...
$(function(){
	...
	$('#today_flow').click(function(){
	    window.location.href = 'index.php?act=seller_promotion&op=promotion_detail&type=today&promotion_id=<?php echo $output['promotion_id'];?>';
	})
	$('#week_flow').click(function(){
	    window.location.href = 'index.php?act=seller_promotion&op=promotion_detail&type=week&promotion_id=<?php echo $output['promotion_id'];?>';
	})
	$('#month_flow').click(function(){
	    window.location.href = 'index.php?act=seller_promotion&op=promotion_detail&type=month&promotion_id=<?php echo $output['promotion_id'];?>';
	})
	$('#year_flow').click(function(){
	    window.location.href = 'index.php?act=seller_promotion&op=promotion_detail&type=year&promotion_id=<?php echo $output['promotion_id'];?>';
	})
});
</script>