...
<div class="imsc-form-default">
  <form id="form_item" action="<?php echo urlShop('mb_special', 'special_item_save');?>" method="post">
      ...
      <tfoot>
        <tr class="tfoot">
          <td colspan="2"><a id="btn_save" class="btn" href="javascript:;"><span>保存编辑</span></a>
            ...
            <a id="btn_back" href="<?php echo urlShop('mb_special', 'special_edit', array('special_id' => $output['item_info']['special_id']));?>" class="btn"><span>返回上一级</span></a>
            <?php } else { ?>
            <a id="btn_back" href="<?php echo urlShop('mb_special', 'special_list');?>" class="btn"><span>返回上一级</span></a>
            <?php } ?></td>
        </tr>
      </tfoot>
    </table>
...
<script type="text/javascript">
    var url_upload_image = '<?php echo urlShop('mb_special', 'special_image_upload');?>';
