...
<div class="tr p10">
	...
	<a class="imsc-btn-mini" id="export_btn" href="javascript:void(0);" title="导出Excel">导出Excel</a>
</div>
...
<table class="imsc-default-table">
  <thead>
    ...
    <th class="align-center">
    	...
    	<a im_type="orderitem" href="<?php echo $output['actionurl'];?>&orderby=<?php echo $v['key'].' asc';?>" class="selected desc"><?php echo $v['text'];?><i></i></a></th>
    	<?php } elseif ($output['orderby'] == $v['key'].' asc'){?>
    	<a im_type="orderitem" href="<?php echo $output['actionurl'];?>&orderby=<?php echo $v['key'].' desc';?>" class="selected asc"><?php echo $v['text'];?><i></i></a></th>
    	<?php } else {?>
    	<a im_type="orderitem" href="<?php echo $output['actionurl'];?>&orderby=<?php echo $v['key'].' desc';?>"><?php echo $v['text'];?><i></i></a></th>
    	<?php }?>
    <?php } else {?>
