...
<div class="tabmenu">
  ...
  <a class="imsc-btn imsc-btn-red" im_type="dialog" dialog_title="添加地址" dialog_id="add_map" dialog_width="480" uri="<?php echo urlShop('store_map', 'add_map');?>"><i class="icon-plus-sign"></i>添加地址</a>
  <?php } ?>
</div>
