...
<ul class="add-goods-step">
  ...
  <li><i class="icon fa fa-camera-retro "></i>
    ...
    <h2>上传商品图片</h2>
    <i class="arrow fa fa-angle-right"></i> </li>
  <li class="current"><i class="icon fa fa-check-circle-o"></i>
    <h6>STEP.4</h6>
    <h2>商品发布成功</h2>
  </li>
</ul>
<div class="alert alert-block hr32">
  <h2><i class="fa fa-check-circle-o mr10"></i><?php echo $lang['store_goods_step3_goods_release_success'];?>&nbsp;&nbsp;<?php if (C('goods_verify')) {?>等待管理员审核商品！<?php }?></h2>
  <div class="hr16"></div>
  <div>
    <?php if ($output['allow_gift']) {?>
    <a class="imsc-btn imsc-btn-green ml30" href="<?php echo urlShop('store_goods_online', 'add_gift', array('commonid' => $_GET['commonid'], 'ref_url' => urlShop('store_goods_online', 'index')));?>"><i class="fa fa-gift"></i>为该商品添加赠品捆绑</a>
    <?php }?>
    <?php if ($output['allow_combo']) {?>
    <a class="imsc-btn imsc-btn-orange ml10" href="<?php echo urlShop('store_goods_online', 'add_combo', array('commonid' => $_GET['commonid'], 'ref_url' => urlShop('store_goods_online', 'index')));?>"><i class="fa fa-thumbs-up "></i>为该商品添加推荐组合</a></div>  
    <?php }?>
  <div class="hr16"></div>
  <strong>
  ...
  <ul class="ml30">
    ...
    <li>2. <?php echo $lang['store_goods_step3_access'];?> &quot; <?php echo $lang['im_seller'];?>&quot; <?php echo $lang['store_goods_step3_manage'];?> &quot;<a href="<?php echo urlShop('store_goods_online', 'index');?>"><?php echo $lang['im_member_path_goods_list'];?></a>&quot;</li>
