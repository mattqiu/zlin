...
<div class="goods-gallery" imtype="gallery-<?php echo $output['color_id'];?>"> <a class="sample_demo" href="index.php?act=store_album&op=pic_list&item=goods_image&color_id=<?php echo $output['color_id'];?>" style="display:none;"><?php echo $lang['im_submit'];?></a>
...
$(document).ready(function(){
	$('div[imtype="gallery-<?php echo $output['color_id'];?>"]').find('.demo').unbind().ajaxContent({
		event:'click', //mouseover
		loaderType:'img',
		loadingMsg:'<?php echo SHOP_SKINS_URL;?>/images/loading.gif',
		target:'div[imtype="album-<?php echo $output['color_id'];?>"]'
	});
	$('div[imtype="gallery-<?php echo $output['color_id'];?>"]').find('select[name="jumpMenu"]').unbind().change(function(){
		var $_select_submit = $('div[imtype="gallery-<?php echo $output['color_id'];?>"]').find('.sample_demo');
