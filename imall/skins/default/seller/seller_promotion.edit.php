<div class="eject_con">
  <form id="promotion_form" method="post" target="_parent" action="<?php echo urlShop('seller_promotion', 'promotion_save');?>">
    ...
    <input type="hidden" name="parent_id" value="<?php echo $output['promotion_info']['parent_id']; ?>" />
    <dl>
      <dt>用户名：</dt>
      <dd>
        <input class="text w200" type="text" name="member_name" id="member_name" value="<?php echo $output['promotion_info']['member_name']; ?>" />
      </dd>
    </dl>
    <dl>
      <dt>设置密码：</dt>
    ...
    <dl>
      <dt>真实姓名：</dt>
      <dd>
        <input class="text w200" type="text" name="member_truename" id="member_truename" value="<?php echo $output['promotion_info']['member_truename']; ?>" />
      </dd>
    </dl>
    <dl>
      <dt>性别：</dt>
    ...
    <dl>
      <dt>手机：</dt>
      <dd>
        <input class="text w200" type="text" name="member_mobile" id="member_mobile" value="<?php echo $output['promotion_info']['member_mobile']; ?>" />
      </dd>
    </dl>
    <dl>
      <dt>QQ：</dt>
      <dd>
        <input class="text w200" type="text" name="member_qq" id="member_qq" value="<?php echo $output['promotion_info']['member_qq']; ?>" />
      </dd>
    </dl>
    <dl>
      <dt>邮箱：</dt>
      <dd>
        <input class="text w200" type="text" name="member_email" id="member_email" value="<?php echo $output['promotion_info']['member_email']; ?>" />
      </dd>
    </dl>
    <div class="bottom">
