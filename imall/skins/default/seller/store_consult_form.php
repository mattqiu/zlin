...
<div class="eject_con">
  ...
  <form id="message" target="_parent" method="post" action="index.php?act=store_consult&op=reply_save&consult_id=<?php echo $output['consult']['consult_id'];?>">
    ...
    <dl>
      <dt><?php echo $lang['store_consult_list_consult_content'].$lang['im_colon'];?></dt>
      <dd><p style="line-height: 18px;"><?php echo nl2br($output['consult']['consult_content']);?></p></dd>
    </dl>
    <dl>
      <dt><i class="required">*</i><?php echo $lang['store_consult_list_reply_consult'].$lang['im_colon'];?></dt>
      <dd>
    ...
    <div class="bottom">
        <label class="submit-border"><input type="submit" class="submit" value="<?php echo $lang['im_ok'];?>" /></label>
    </div>
  </form>
</div>
<script>
$(function(){
     $('#message').validate({
        ...
        messages : {
                     content : {
                         required : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['store_consult_reply_input_content'];?>',
                         maxlength: '<i class="fa fa-exclamation-circle"></i><?php echo $lang['store_consult_reply_input_content_tip'];?>'
                        }
                     }
         });
});
