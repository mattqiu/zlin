...
<div class="imsc-flow-item">
  ...
  <div class="item-goods">
    ...
    <dl>
      <dt>
        <div class="imsc-goods-thumb-mini"><a href="<?php echo urlShop('goods','index',array('goods_id'=> $val['goods_id'])); ?>" target="_blank"> <img src="<?php echo thumb($val,60); ?>" onMouseOver="toolTip('<img src=<?php echo thumb($val,240); ?>>')" onMouseOut="toolTip()" /> </a></div>
      </dt>
  ...
  <div class="item-order">
    <dl>
      <dt>运&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;费：</dt>
      <dd><?php echo $output['order']['shipping_fee']>0 ? imPriceFormat($output['order']['shipping_fee']):$lang['im_common_shipping_free']; ?></dd>
    </dl>
    <dl>
      <dt><?php echo $lang['order_price'].$lang['im_colon'];?></dt>
      <dd><strong><?php echo $lang['currency'].$output['order']['order_amount'];?></strong></dd>
    </dl>
    <dl class="line">
      <dt><?php echo $lang['order_sn'].$lang['im_colon'];?></dt>
      <dd><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=store_order&op=show_order&order_id=<?php echo $output['order']['order_id'];?>" target="_blank"> <?php echo $output['order']['order_sn'];?> </a><a href="javascript:void(0);" class="a">更多<i class="fa fa-angle-down"></i>
        <div class="more"> <span class="arrow"></span>
          <ul>
            ...
            <li><?php echo '付款单号'.$lang['im_colon'];?><span><?php echo $output['order']['pay_sn']; ?></span></li>
            <?php } ?>
            <li><?php echo $lang['store_order_pay_method'].$lang['im_colon'];?><span><?php echo $output['order']['payment_name']; ?></span></li>
            <li><?php echo $lang['store_order_add_time'].$lang['im_colon'];?><span><?php echo date("Y-m-d H:i:s",$output['order']['add_time']); ?></span></li>
            <?php if ($output['order']['payment_time'] > 0) { ?>
            <li><?php echo $lang['store_show_order_pay_time'].$lang['im_colon'];?><span><?php echo date("Y-m-d H:i:s",$output['order']['payment_time']); ?></span></li>
            <?php } ?>
            <?php if ($output['order_common']['shipping_time'] > 0) { ?>
            <li><?php echo $lang['store_show_order_send_time'].$lang['im_colon'];?><span><?php echo date("Y-m-d H:i:s",$output['order_common']['shipping_time']); ?></span></li>
            <?php } ?>
            <?php if ($output['order']['finnshed_time'] > 0) { ?>
            <li><?php echo $lang['store_show_order_finish_time'].$lang['im_colon'];?><span><?php echo date("Y-m-d H:i:s",$output['order']['finnshed_time']); ?></span></li>
            <?php } ?>
          </ul>
        </div>
        </a></dd>
    ...
    <dl class="line">
      <dt>收&nbsp;&nbsp;货&nbsp;&nbsp;人：</dt>
      <dd><?php echo $output['order_common']['reciver_name'];?><a href="javascript:void(0);" class="a">更多<i class="fa fa-angle-down"></i>
        <div class="more"><span class="arrow"></span>
          <ul>
            <li><?php echo $lang['store_order_address'].$lang['im_colon'];?><span><?php echo $output['order_common']['reciver_info']['address'];?></span></li>
