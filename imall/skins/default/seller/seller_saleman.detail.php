...
<form method="get" action="index.php">
  <table class="search-form">
    <input type="hidden" name="act" value="seller_saleman" />
    <input type="hidden" name="op" value="saleman_detail" />
    <input type="hidden" name="saleman_id" value="<?php echo $output['saleman_id'];?>" />
    <tr>
      <td>
...
$(function(){
	...
	$('#today_flow').click(function(){
	    window.location.href = 'index.php?act=seller_saleman&op=saleman_detail&type=today&saleman_id=<?php echo $output['saleman_id'];?>';
	})
	$('#week_flow').click(function(){
	    window.location.href = 'index.php?act=seller_saleman&op=saleman_detail&type=week&saleman_id=<?php echo $output['saleman_id'];?>';
	})
	$('#month_flow').click(function(){
	    window.location.href = 'index.php?act=seller_saleman&op=saleman_detail&type=month&saleman_id=<?php echo $output['saleman_id'];?>';
	})
	$('#year_flow').click(function(){
	    window.location.href = 'index.php?act=seller_saleman&op=saleman_detail&type=year&saleman_id=<?php echo $output['saleman_id'];?>';
	})
});
</script>