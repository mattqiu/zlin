...
<div class="tabmenu">
  ...
  <a title="建立模板" class="imsc-btn imsc-btn-green" href="<?php echo urlShop('store_waybill', 'waybill_add');?>">添加模板</a> </div>
...
<table class="imsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="<?php echo urlShop('store_waybill', 'waybill_design', array('waybill_id' => $value['waybill_id']));?>" class="btn-orange"><i class="fa fa-pencil-square-o"></i>
        <p>设计</p>
        </a></span><span><a href="<?php echo urlShop('store_waybill', 'waybill_test', array('waybill_id' => $value['waybill_id']));?>" class="btn-acidblue" target="_blank"><i class="fa fa-print"></i>
        <p>测试</p>
        </a></span><span><a href="<?php echo urlShop('store_waybill', 'waybill_edit', array('waybill_id' => $value['waybill_id']));?>" class="btn-blue"><i class="fa fa-pencil-square-o"></i>
        <p>编辑</p>
        </a></span><span><a href="javascript:;" imtype="btn_del" data-waybill-id="<?php echo $value['waybill_id'];?>" class="btn-red"><i class="fa fa-trash-o"></i>
        <p>删除</p>
        </a></span></td>
    </tr>
    <?php }?>
