...
<div class="imsc-vr-order-exchange">
    <dl>
      <dt><h3>电子兑换码</h3></dt>
      <dd>
...
$(document).ready(function(){
    ...
    Tpl += "<td>IM_CODE</td>\n";
    Tpl += "<td class=\"w70\"><div class=\"imsc-goods-thumb\"><a target=\"_blank\" href=\"IM_GOODS_URL\"><img onmouseout=\"toolTip()\" onmouseover=\"toolTip('<img src=IM_IMG240>')\" src=\"IM_IMG60\"></a></div></td>\n";
    Tpl += "<td class=\"tl\"><a href=\"IM_GOODS_URL\" target=\"_blank\">IM_GOODS_NAME</a></td>\n";
    Tpl += "<td><a target=\"_blank\" href=\"IM_ORDER_URL\">IM_ORDER_SN</a></td>\n";
    Tpl += "<td class=\"bdr\">IM_ORDER_MSG</td></tr>\n";
    function exPost() {
		$('#vr_code_waring').html('');
	    $.getJSON('index.php?act=store_vr_order&op=exchange&form_submit=ok&vr_code='+$("#vr_code").val(),null, function(data){
	        ...
	        content = content.replace(/IM_CODE/g,$("#vr_code").val());
	        content = content.replace(/IM_GOODS_URL/g,data.data.goods_url);
	        content = content.replace(/IM_IMG240/g,data.data.img_240);
	        content = content.replace(/IM_IMG60/g,data.data.img_60);
	        content = content.replace(/IM_GOODS_NAME/g,data.data.goods_name);
	        content = content.replace(/IM_ORDER_URL/g,data.data.order_url);
	        content = content.replace(/IM_ORDER_SN/g,data.data.order_sn);
	        content = content.replace(/IM_ORDER_MSG/g,data.data.buyer_msg);
