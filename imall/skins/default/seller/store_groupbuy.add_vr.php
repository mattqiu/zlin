...
<?php } ?>
    ...
    <dl imtype="groupbuy_goods_info" style="display:none;">
      ...
      <dd> <?php echo $lang['currency'];?><span imtype="groupbuy_goods_price"></span></dd>
    </dl>
    <dl>
    ...
    <dl>
      <dt>抢购分类<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>抢购区域<?php echo $lang['im_colon'];?></dt>
      <dd>
...
<?php } ?>
                lessThanVrExpireTime : '<i class="fa fa-exclamation-circle"></i>结束时间必须小于虚拟商品过期时间',
