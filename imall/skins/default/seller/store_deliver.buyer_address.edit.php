...
$(document).ready(function(){
    $('#address_form').validate({
        ...
        messages : {
            new_reciver_name: {
                required : '<i class="fa fa-exclamation-circle"></i>收货人不能为空'
            },
            new_area: {
                required : '<i class="fa fa-exclamation-circle"></i>地区不能为空'
            },
            new_mob_phone: {
                required : '<i class="fa fa-exclamation-circle"></i>手机不能为空'
            }
        }
    });
