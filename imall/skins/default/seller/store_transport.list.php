...
<div class="tabmenu">
  ...
  <a class="imsc-btn imsc-btn-green" href="index.php?act=store_transport&op=add&type=<?php echo $_GET['type'];?>"><?php echo $lang['transport_tpl_add'];?> </a> </div>
<!-----------------list begin------------------------>
  ...
  <tbody>
    ...
    <tr>
      <th colspan="20"><?php if ($_GET['type'] == "select"){?>
        <a class="ml5 imsc-btn-mini imsc-btn-orange" data-param="{name:'<?php echo $v['title'];?>',id:'<?php echo $v['id'];?>',price:'<?php echo intval($output['extend'][$v['id']]['price']);?>'}" href="javascript:void(0)"><i class="fa fa-truck"></i><?php echo $lang['transport_applay'];?></span></a>
        <?php }?><h3><?php echo $v['title'];?></h3>
        
        <span class="fr mr5">
        <time title="<?php echo $lang['transport_tpl_edit_time'];?>"><i class="fa fa-clock-o"></i><?php echo date('Y-m-d H:i:s',$v['update_time']);?></time>
        <a class="J_Clone imsc-btn-mini" href="javascript:void(0)" data-id="<?php echo $v['id'];?>"><i class="fa fa-files-o"></i><?php echo $lang['transport_tpl_copy'];?></a> <a class="J_Modify imsc-btn-mini" href="javascript:void(0)" data-id="<?php echo $v['id'];?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['transport_tpl_edit'];?></a> <a class="J_Delete imsc-btn-mini" href="javascript:void(0)" data-id="<?php echo $v['id'];?>"><i class="fa fa-trash-o"></i><?php echo $lang['transport_tpl_del'];?></a></span></th>
    </tr>
...
<script>
$(function(){	
	$('a[class="J_Delete imsc-btn-mini"]').click(function(){
...
//		return true;
	...
	$('a[class="J_Modify imsc-btn-mini"]').click(function(){
		var id = $(this).attr('data-id');
		if(typeof(id) == 'undefined') return false;
