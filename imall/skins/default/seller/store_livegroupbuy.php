<?php defined('InIMall') or exit('Access Invalid!');?>
  <div class="tabmenu">
    ...
    <a class="imsc-btn imsc-btn-green" href="index.php?act=store_livegroup&op=groupbuy_add" title=""><i class="fa fa-plus-circle"></i>新增线下抢</a>
  </div>
  ...
  <table class="imsc-table-style">
    ...
    <tbody>
      ...
      <?php } else { ?>
      <tr>
        <td colspan="17" class="norecord"><div class="warning-option"><i class="fa fa-exclamation-triangle"></i><span><?php echo $lang['no_record'];?></span></div></td>
      </tr>
      <?php } ?>
    </tbody>
    <tfoot>
