    ...
    <div id="saleRefundReturn">
      ...
      <div class="imsc-form-default">
        ...
        <form id="post_form" method="post" action="index.php?act=store_return&op=edit&return_id=<?php echo $output['return']['refund_id']; ?>">
          ...
          <h3>商家处理意见</h3>
          <dl>
            <dt><i class="required">*</i><?php echo $lang['return_seller_confirm'].$lang['im_colon'];?></dt>
            <dd>
              <div>
                <label class="mr20">
          ...
          <dl>
            <dt><i class="required">*</i><?php echo $lang['return_message'].$lang['im_colon'];?></dt>
            <dd>
          ...
          <div class="bottom">
              <label class="submit-border">
                <a class="submit" id="confirm_button"><?php echo $lang['im_ok'];?></a>
              </label>
              <label class="submit-border">
...
$(function(){
    ...
    $('#post_form').validate({
        ...
        messages : {
            seller_state  : {
                required  : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['return_seller_confirm_null'];?>'
            },
            seller_message  : {
                required   : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['return_message_null'];?>'
            }
        }
	    });
});
