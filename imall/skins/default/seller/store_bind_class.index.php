...
<?php if ($notOwnShop = !checkPlatformStore()) { ?>
  <a href="javascript:void(0)" class="imsc-btn imsc-btn-green" im_type="dialog" dialog_title="申请新的经营类目" dialog_id="my_goods_brand_apply" dialog_width="480" uri="index.php?act=store_info&op=bind_class_add">申请新的经营类目</a>
<?php } ?>
  </div>
...
<?php } ?>
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <?php if ($val['state'] == '0') {?>
      <span><a href="javascript:void(0)" class="btn-red" onclick="ajax_get_confirm('<?php echo $lang['im_ensure_del'];?>', 'index.php?act=store_info&op=bind_class_del&bid=<?php echo $val['bid']; ?>');"><i class="fa fa-trash-o"></i><p><?php echo $lang['im_del'];?></p></a></span>
      <?php } ?>
      </td>
      <?php } ?>      
    </tr>
