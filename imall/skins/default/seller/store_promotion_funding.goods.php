...
<ul class="goods-list">
  ...
  <li>
    ...
    <a imtype="btn_add_funding_goods" data-goods-id="<?php echo $val['goods_id'];?>" data-goods-name="<?php echo $val['goods_name'];?>" data-goods-img="<?php echo thumb($val, 240);?>" data-goods-price="<?php echo $val['goods_price'];?>" href="javascript:void(0);" class="imsc-btn-mini">选择商品/修改折扣价</a> </li>
  <?php } ?>
</ul>
...
<?php } ?>
<div id="dialog_add_funding_goods" style="display:none;">
  ...
  <div class="selected-goods-info">
    ...
    <dl class="goods-info">
      ...
      <dd>折扣价格：<input id="dialog_funding_price" type="text" class="text w70"><em class="add-on">元</em>
      <p id="dialog_add_funding_goods_error">
          <label for="dialog_funding_price" class="error" ><i class='fa fa-exclamation-circle'></i>折扣价格不能为空，且必须小于商品价格</label></p></dd>
