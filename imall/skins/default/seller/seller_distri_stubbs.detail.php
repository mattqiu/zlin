...
<table class="imsc-table-style">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <div class="pic-thumb">
          <a href="<?php echo urlShop('goods', 'index', array('goods_id' => $val['b_goods_id']));?>" target="_blank"><img src="<?php echo $val['b_image_60_url'];?>"/></a>
        </div>
      </td>
      <td class="tl">
        <dl class="goods-name">
          <dt><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $val['b_goods_id']));?>" target="_blank"><?php echo $val['b_goods_name']; ?></a></dt>
        </dl>
      </td>
      <td><span><?php echo $lang['currency'].$val['b_goods_price']; ?></span></td>
      ...
      <td class="nscs-table-handle">
        <span>
          <a href="javascript:void(0);" onclick="ajax_get_confirm('<?php echo $lang['im_ensure_del'];?>', '<?php echo urlShop('seller_distri_replenish', 'drop_goods', array('bs_id' => $val['bs_id']));?>');" class="btn-red"><i class="fa fa-trash-o"></i><p><?php echo $lang['im_del'];?></p></a>
        </span>
      </td>
    </tr>
    <?php } ?>
