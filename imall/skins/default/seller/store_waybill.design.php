...
<div class="imsc-form-default">
  <dl>
    ...
    <dd>
      <form id="design_form" action="<?php echo urlShop('store_waybill', 'waybill_design_save');?>" method="post">
        ...
        <ul id="waybill_item_list" class="imsc-form-checkbox-list">
          ...
          <li>
            ...
            <i imtype="btn_item_edit" data-item-name="<?php echo $key;?>" title="微调" class="fa fa-pencil-square-o"></i>
  ...
  <div class="bottom"><label class="submit-border"><input id="submit"  type="submit" class="submit" value="<?php echo $lang['im_submit'];?>"></label></div>
</div>
<div id="dialog_item_edit" class="eject_con" style="display:none;">
  ...
  <div class="bottom pt10 pb10"><a id="btn_dialog_submit" class="imsc-btn imsc-btn-green" href="javascript:;">确认</a> <a id="btn_dialog_cancel" class="imsc-btn" href="javascript:;">取消</a></div> </div>
...
$(document).ready(function() {
    ...
    //微调弹出窗口
    $('[imtype="btn_item_edit"]').on('click', function() {
        ...
        $('#dialog_item_edit').im_show_dialog({title:'微调'});
    });
