...
<div class="imsc-index">
  <div class="top-container">
    <div class="basic-info">
      <dl class="imsc-seller-info">
        ...
        <dd class="store-logo">
          ...
          <a href="<?php echo urlShop('store_setting', 'store_setting');?>"><i class="fa fa-pencil-square-o"></i>编辑店铺设置</a> </dd>
        ...
        <dd class="store-name"><?php echo $lang['store_name'].$lang['im_colon'];?><a href="<?php echo urlShop('show_store', 'index', array('store_id' => $_SESSION['store_id']), $output['store_info']['store_domain']);?>" ><?php echo $output['store_info']['store_name'];?></a></dd>
        <dd class="store-grade"><?php echo $lang['store_store_grade'].$lang['im_colon'];?><strong><?php echo $output['store_info']['grade_name']; ?></strong></dd>
...
<?php if (!checkPlatformStore()) { ?>
      <div class="detail-rate">
        <h5> <strong><?php echo $lang['store_dynamic_evaluation'].$lang['im_colon'];?></strong> 与行业相比 </h5>
        <ul>
  ...
  <div class="seller-cont">
    <div class="container type-a">
      ...
      <div class="content">
        <dl class="focus">
          <dt>店铺商品发布情况：</dt>
          <dd title="已发布/<?php echo $lang['store_publish_goods'];?>"><em id="im_goodscount">0</em>&nbsp;/&nbsp;
          ...
          <dd><em id="im_imagecount">0</em>&nbsp;/&nbsp;<?php echo $output['store_info']['grade_albumlimit'] > 0 ? $output['store_info']['grade_albumlimit'] : '不限'; ?></dd>
        </dl>
        <ul>
          <li><a href="index.php?act=store_goods_online&op=index"><?php echo $lang['store_goods_selling'];?> <strong id="im_online"></strong></a></li>
          <?php if (C('goods_verify')) {?>
          <li><a href="index.php?act=store_goods_offline&op=index&type=wait_verify&verify=10" title="<?php echo $lang['store_inform30'];?>">发布待平台审核 <strong id="im_waitverify"></strong></a></li>
          <li><a href="index.php?act=store_goods_offline&op=index&type=wait_verify&verify=0" title="<?php echo $lang['store_inform30'];?>">平台审核失败 <strong id="im_verifyfail"></strong></a></li>
          <?php }?>
          <li><a href="index.php?act=store_goods_offline&op=index"><?php echo $lang['store_goods_storage'];?> <strong id="im_offline"></strong></a></li>
          <li><a href="index.php?act=store_goods_offline&op=index&type=lock_up"><?php echo $lang['store_goods_show0'];?> <strong id="im_lockup"></strong></a></li>
          <li><a href="index.php?act=store_consult&op=consult_list&type=to_reply"><?php echo $lang['store_to_consult'];?> <strong id="im_consult"></strong></a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="container type-a">
      ...
      <div class="content">
        <dl class="focus">
          ...
          <dd><a href="index.php?act=store_order"><?php echo $lang['store_order_progressing'];?> <strong id="im_progressing"></strong></a></dd>
          <dt><?php echo $lang['store_complain_info'].$lang['im_colon'];?></dt>
          <dd><a href="index.php?act=store_complain&select_complain_state=1"><?php echo $lang['store_complain'];?> <strong id="im_complain"></strong></a></dd>
        </dl>
        <ul>
          <li><a href="index.php?act=store_order&op=index&state_type=state_new"><?php echo $lang['store_order_pay'];?> <strong id="im_payment"></strong></a></li>
          <li><a href="index.php?act=store_order&op=index&state_type=state_pay"><?php echo $lang['store_shipped'];?> <strong id="im_delivery"></strong></a></li>
          <li><a href="index.php?act=store_refund&lock=2"> <?php echo '售前退款';?> <strong id="im_refund_lock"></strong></a></li>
          <li><a href="index.php?act=store_refund&lock=1"> <?php echo '售后退款';?> <strong id="im_refund"></strong></a></li>
          <li><a href="index.php?act=store_return&lock=2"> <?php echo '售前退货';?> <strong id="im_return_lock"></strong></a></li>
          <li><a href="index.php?act=store_return&lock=1"> <?php echo '售后退货';?> <strong id="im_return"></strong></a></li>
          <li><a href="index.php?act=store_bill&op=index&bill_state=1"> <?php echo '待确认账单';?> <strong id="im_bill_confirm"></strong></a></li>
        </ul>
      </div>
    </div>
