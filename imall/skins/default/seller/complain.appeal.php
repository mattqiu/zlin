...
<div class="imsc-flow-layout" id="imscComplainFlow">
  <div class="imsc-flow-container">
    ...
    <div class="imsc-form-default">
      ...
      <dl>
        <dt><?php echo $lang['complain_state'].$lang['im_colon'];?></dt>
      ...
      <form action="index.php?act=store_complain&op=appeal_save" method="post" id="add_form" enctype="multipart/form-data">
        ...
        <dl>
          <dt><?php echo $lang['complain_appeal_evidence_upload'].$lang['im_colon'];?></dt>
          <dd>
            <p>
        ...
        <div class="bottom">
          <label class="submit-border">
            <input id="submit_button" type="submit" class="submit" value="<?php echo $lang['im_submit'];?>">
          </label>
          <label class=""><a href="javascript:history.go(-1);" class="imsc-btn ml10"><i class="fa fa-reply"></i>返回列表</a></label>
        </div>
      </form>
    </div>
  </div>
