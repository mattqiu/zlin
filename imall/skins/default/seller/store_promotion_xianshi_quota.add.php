...
<div class="imsc-form-default">
  <form id="add_form" action="index.php?act=store_promotion_xianshi&op=xianshi_quota_add_save" method="post">
    <dl>
      <dt><i class="required">*</i><?php echo $lang['xianshi_quota_add_quantity'].$lang['im_colon'];?></dt>
      <dd>
        ...
        <p class="hint"><?php echo $lang['xianshi_price_explain2'].$output['setting_config']['promotion_xianshi_price'].$lang['im_yuan'];?> ; </p>
...
$(document).ready(function(){
    ...
    $("#add_form").validate({
    	...
    	submitHandler:function(form){
            ...
            showDialog('<?php echo $lang['xianshi_quota_add_confirm'];?>'+price+'<?php echo $lang['im_yuan'];?>', 'confirm', '', function(){
            ...
            rules : {
                ...
                messages : {
                    xianshi_quota_quantity : {
                        required : "<i class='fa fa-exclamation-circle'></i><?php echo $lang['xianshi_quota_quantity_error'];?>",
                        digits : "<i class='fa fa-exclamation-circle'></i><?php echo $lang['xianshi_quota_quantity_error'];?>",
                        min : "<i class='fa fa-exclamation-circle'></i><?php echo $lang['xianshi_quota_quantity_error'];?>",
                        max : "<i class='fa fa-exclamation-circle'></i><?php echo $lang['xianshi_quota_quantity_error'];?>"
                    }
                }
    });
});
