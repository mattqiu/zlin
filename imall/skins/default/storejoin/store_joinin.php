...
<div class="banner">
  <div class="user-box">
    ...
    <div class="user-joinin">
      ...
      <dl>
        <dt><?php echo $lang['welcome_to_site'].C('site_name');?></dt>
        <dd> 若您还没有填写入驻申请资料
        　　<br/>请点击“<a href="<?php echo urlShop('store_joinin','pstep0');?>" target="_blank">个人入驻</a>”或“<a href="<?php echo urlShop('store_joinin','step0');?>" target="_blank">企业入驻</a>”进行入驻资料填写，并完成入驻相关流程。
        </dd>
        <dd>若您的店铺还未开通<br/>
          请通过“<a href="<?php echo urlShop('store_joinin','index');?>" target="_blank">查看入驻进度</a>”了解店铺开通的最新状况 
        </dd>
      </dl>
      <div class="bottom">
        <a href="<?php echo urlShop('store_joinin','step0_p');?>" target="_blank">个人入驻</a>
      　　<a href="<?php echo urlShop('store_joinin','step0');?>" target="_blank">企业入驻</a>
    　　</div>
    </div>
     <?php }else { ?>
      ...
      <form id="login_form" action="index.php?act=login" method="post">
        ...
        <dl>
          ...
          <dd>
            ...
            <a href="JavaScript:void(0);" onclick="javascript:document.getElementById('codeimage').src='index.php?act=seccode&op=makecode&imhash=<?php echo getIMhash();?>&t=' + Math.random();" class="change" title="<?php echo $lang['login_index_change_checkcode'];?>">
            <img src="index.php?act=seccode&op=makecode&imhash=<?php echo getIMhash();?>" class="fl ml5" name="codeimage" id="codeimage" border="0"/></a>
            <label></label>
          </dd>
        </dl>
        <?php } ?>
