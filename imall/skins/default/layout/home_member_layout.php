  ...
  <div class="left-layout">
    ...
    <ul id="extensionMenu" class="imm-sidebar">
      <li class="side-menu">
        ...
        <ul>          
          <li <?php if ($output['menu_highlight'] == 'my_achievement') {?>class="selected"<?php }?>><a href="<?php echo urlShop('member_extension', 'my_achievement');?>">我的业绩</a></li>
          <li <?php if ($output['menu_highlight'] == 'my_income') {?>class="selected"<?php }?>><a href="<?php echo urlShop('member_extension', 'my_income');?>">我的收益</a></li>
          ...
          <?php }?>
          <?php if ($output['member_info']['store_id']>0){?>
    ...
    <?php }?>
    <?php if (OPEN_CONSUMER_CARD_STATE ==1 && $_SESSION['is_cc_bind']==1){?>
    <ul id="extensionMenu" class="imm-sidebar">
      <li class="side-menu">
        <a href="javascript:void(0)" key="<?php echo $key;?>" <?php if (cookie('Mmenu_'.$key) == 1) echo 'class="shrink"';?>>
        <h3>集分宝-消费养老</h3>
        ...
        <ul>          
          <li <?php if ($output['menu_highlight'] == 'my_premium') {?>class="selected"<?php }?>><a href="<?php echo urlShop('member_consumercard', 'my_premium');?>">我的保金收益</a></li>
          <li <?php if ($output['menu_highlight'] == 'my_rebate') {?>class="selected"<?php }?>><a href="<?php echo urlShop('member_consumercard', 'my_rebate');?>">我的返利收益</a></li>
          <?php if ($_SESSION['ccard_member_type']==2 || $_SESSION['ccard_member_type']==3){?>
          <li <?php if ($output['menu_highlight'] == 'my_subccard') {?>class="selected"<?php }?>><a href="<?php echo urlShop('member_consumercard', 'my_ccard');?>">我的卡团</a></li>          
          <?php }?>
        </ul>
      </li>      
    </ul>
