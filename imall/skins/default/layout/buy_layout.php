...
.imcss-appbar-tabs a.compare { display: none !important;}
</style>
...
<header class="imcr-head-layout">
  <div class="site-logo">
    <a href="<?php echo SHOP_SITE_URL;?>"><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$GLOBALS['setting_config']['site_logo']; ?>" class="pngFix"></a>
  </div>
