...
<title><?php echo ($lang['im_member_path_'.$output['menu_sign']]==''?'':$lang['im_member_path_'.$output['menu_sign']].'_').$output['html_title'];?></title>
...
<link href="<?php echo SHOP_SKINS_URL;?>/css/sns.css" rel="stylesheet" type="text/css">
<link href="<?php echo RESOURCE_SITE_URL;?>/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />

<link id="skin_link" href="<?php echo SHOP_SKINS_URL;?>/sns/style/<?php echo $output['skin_style'];?>.css" rel="stylesheet" type="text/css">
...
var COOKIE_PRE = '<?php echo COOKIE_PRE;?>';var _CHARSET = '<?php echo strtolower(CHARSET);?>';var SITEURL = '<?php echo SHOP_SITE_URL;?>';var SHOP_SITE_URL = '<?php echo SHOP_SITE_URL;?>';var MAX_RECORDNUM = <?php echo $output['max_recordnum'];?>;var RESOURCE_SITE_URL = '<?php echo RESOURCE_SITE_URL;?>';var SHOP_RESOURCE_SITE_URL = '<?php echo SHOP_RESOURCE_SITE_URL;?>';var SHOP_SKINS_URL = '<?php echo SHOP_SKINS_URL;?>';
</script>
...
<header id="header" class="pngFix">
  <div class="wrapper">
    ...
    <h2><?php echo $lang['im_mysns']?></h2>
    <div class="search">
      <form id="formSearch" name="formSearch" action="index.php" method="get">
        <input id="search_act" type="hidden" value="search" name="act">
        <input id="keyword" class="imcs-search-input-text" type="text" lang="zh-CN" x-webkit-grammar="builtin:search" onwebkitspeechchange="foo()" x-webkit-speech="" name="keyword" style="color: rgb(153, 153, 153);">
        <a class="imcs-search-btn-mall" imtype="search_in_shop" href="javascript:void(0)" onClick="$('#formSearch').submit();"> <span><?php echo $lang['im_common_search'];?></span> </a>
      </form>
    </div>
...
<div id="container" class="wrapper mt20">
  <div class="user-info">
    <div class="user-face">
      <div class="hover-layout"><span class="thumb size120"><i></i><img src="<?php if ($output['master_info']['member_avatar']!='') { echo UPLOAD_SITE_URL.'/'.ATTACH_AVATAR.DS.$output['master_info']['member_avatar']; } else { echo UPLOAD_SITE_URL.'/'.ATTACH_COMMON.DS.C('default_user_portrait'); } ?>" />
        ...
        <a href="index.php?act=member_information&op=avatar" title="<?php echo $lang['im_updateavatar'];?>"><?php echo $lang['sns_change_avatar'];?></a>
        <?php }?>
        </span></div>
    </div>
    <dl class="user-data">
      <dt>
        ...
        <span class="add-friend ml10"><span style="<?php if($output['relation'] != 2){?>display:none;<?php }?>" im_type="mutualsign"><?php echo $lang['sns_mutual_attention'];?></span><span style="<?php if($output['relation'] != 4){?>display:none;<?php }?>" im_type="followsign"><?php echo $lang['sns_already_attention'];?></span>
        <?php if($output['relation'] == 1){?>
        <a data-param='{"mid":"<?php echo $output['master_info']['member_id'];?>"}' im_type="followbtn" href="javascript:void(0)"><?php echo $lang['sns_add_attention'];?></a>
        <?php }?>
        </span> </dt>
      <dd>
        ...
        <span class="tag"><?php echo $lang['sns_interest_label'].$lang['im_colon'];?>
  ...
  <div class="sns-nav">
    <ul>
      <li><a <?php if($output['menu_sign'] == 'snshome'){?>class="current"<?php }?> href="index.php?act=member_snshome<?php if(!empty($output['master_id'])){ echo '&mid='.$output['master_id']; }?>"><i class="home pngFix"></i><?php echo $lang['im_index'];?></a></li>
    ...
    <?php if($output['relation'] == '3'){?>
    <div class="skin"><a href="javascript:void(0)" title="<?php echo $lang['sns_change_skin'];?>" class="pngFix" imtype="change_skin"><?php echo $lang['sns_change_skin'];?></a></div>
    <?php }?>
  </div>
  <div class="sns-main">
    <?php
...
<?php
require_once template('layout/layout_footer');
?>
...
$(function(){
  ...
  $(".my-friend").click(function(){
	...
	//存在多规格时的价格修改
	$('a[imtype="change_skin"]').click(function(){
