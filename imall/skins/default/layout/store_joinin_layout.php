...
<link href="<?php echo SHOP_SKINS_URL;?>/css/store_joinin.css" rel="stylesheet" type="text/css">
<style type="text/css">
body { _behavior: url(<?php echo SHOP_SKINS_URL;?>/css/csshover.htc);}</style>
...
<div class="header">
  <h2 class="header_logo"><a href="<?php echo SHOP_SITE_URL;?>"><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$GLOBALS['setting_config']['site_logo']; ?>" class="pngFix"></a></h2>
...
<div class="header_line"><div><span></span></div></div>
