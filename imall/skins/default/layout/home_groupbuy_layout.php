...
<div class="imcg-topbar">
  <div id="headRelative" class="imcg-topbar-wrapper">
    ...
    <ul class="nav-menu">
      <li><a href="<?php echo urlShop('show_groupbuy', 'index'); ?>"<?php if (!isset($output['groupbuyMenuIsVr'])) echo ' class="current"'; ?>>团购首页</a></li>
      <li><a href="<?php echo urlShop('show_groupbuy', 'groupbuy_list'); ?>"<?php if (isset($output['groupbuyMenuIsVr']) && !$output['groupbuyMenuIsVr']) echo ' class="current"'; ?>>线上团</a></li>
      <li><a href="<?php echo urlShop('show_groupbuy', 'vr_groupbuy_list'); ?>"<?php if (isset($output['groupbuyMenuIsVr']) && $output['groupbuyMenuIsVr']) echo ' class="current"'; ?>>虚拟团</a></li>
    </ul>
  </div>
</div>
...
<script language="JavaScript">
 //浮动导航  waypoints.js
$("#imgCategory").waypoint(function(event, direction) {
