 ...
 <div class="imcr-title">
  ...
  <input type="hidden" name="goods_id" value="<?php echo $output['goods_info']['goods_id'];?>">
    <table class="imcr-table-style" im_type="table_cart">
      ...
      <tbody>
        <tr>
          <th colspan="20"><i class="fa fa-home"></i><a href="<?php echo urlShop('show_store','index',array('store_id'=>$output['store_info']['store_id']));?>"><?php echo $output['store_info']['store_name'];?></a> <span member_id="<?php echo $output['store_info']['member_id'];?>"></span>
          </th>
        </tr>
      ...
      <tfoot>
        <tr>
          <td colspan="20"><div class="imcr-all-account">商品总价￥<em id="cartTotal"><?php echo $output['goods_info']['goods_total']; ?></em>元</div></td>
        </tr>
      </tfoot>
    </table>
  </form>
  <div class="imcr-bottom"><a id="next_submit" href="javascript:void(0)" class="imcr-btn imcr-btn-acidblue fr">下一步</a></div>
