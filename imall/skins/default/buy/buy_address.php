...
<div class="imcr-receipt-info">
  <div class="imcr-receipt-info-title">
    <h3>收货人信息</h3>
    <a href="javascript:void(0)" im_type="buy_edit" id="edit_reciver">[修改]</a>
  </div>
  <div id="addr_list" class="imcr-candidate-items">
    <ul>
      <li>
        <span class="true-name"><?php echo $output['address_info']['true_name'];?></span>
        <span class="address"><?php echo intval($output['address_info']['dlyp_id']) ? '[自提服务站] ' : '';?><?php echo $output['address_info']['area_info'],$output['address_info']['address'];?></span>
        <span class="phone"><i class="fa fa-mobile"></i><?php echo $output['address_info']['mob_phone'] ? $output['address_info']['mob_phone'] : $output['address_info']['tel_phone'];?></span>
      </li>
    </ul>
  </div>
</div>
...
function hideAddrList(addr_id,true_name,address,phone) {
	...
	$("#addr_list").html('<ul><li><span class="true-name">'+true_name+'</span><span class="address">'+address+'</span><span class="phone"><i class="fa fa-mobile"></i>'+phone+'</span></li></ul>');
