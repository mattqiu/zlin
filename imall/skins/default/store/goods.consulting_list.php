      ...
      <div class="ncs-sidebar-container">
        ...
        <div class="content">
          <dl class="ncs-comment-goods">
            ...
            <dd class="goods-price"><?php echo $lang['goods_index_goods_price'].$lang['nc_colon'];?><em class="saleP"><?php echo $lang['currency'].imPriceFormat($output['goods']['goods_promotion_price']);?></em></dd>
