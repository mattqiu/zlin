...
<div class="public-standard-layout">
  <?php 
    //加载店铺装修静态页
  ...
  <div class="wrapper mt10">
    <div class="imcs-main">
      ...
      <div class="imcs-main-container">
        <div class="title"> <span><a href="<?php echo urlShop('store_search', 'index', array('store_id' => $_GET['store_id']));?>" class="more"><?php echo $lang['im_more'];?></a></span>
          <h4><?php echo $lang['show_store_index_recommend'];?></h4>
        </div>
        <div class="content imcs-goods-list">
          ...
          <ul>
            ...
            <li>
              <dl>
                ...
                <dd class="goods-name">
                  <a href="<?php echo urlShop('goods', 'index', array('goods_id'=>$value['goods_id']));?>" title="<?php echo $value['goods_name'];?>" target="_blank"><?php echo $value['goods_name']?></a>
                </dd>
                <dd class="goods-info">
                  <span class="price"><i><?php echo $lang['currency'];?></i> <?php echo $value['goods_promotion_price']?> </span> 
                  <span class="goods-sold"><?php echo $lang['show_store_index_be_sold'];?><strong><?php echo $value['goods_salenum'];?></strong> <?php echo $lang['im_jian'];?></span>
                </dd>
