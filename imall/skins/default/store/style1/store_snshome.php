...
<div class="cms-sns">
  <div class="cms-sns-left">
    <div class="cms-sns-tabmene">
      <ul>
        <li><a href="<?php echo urlShop('store_snshome', 'index', array('store_id' => $output['store_info']['store_id']));?>" <?php if($_GET['type'] == ''){?>class="selected"<?php }?>><?php echo $lang['store_sns_all_trends'];?><i></i></a></li>
        <li><a href="<?php echo urlShop('store_snshome', 'index', array('store_id' => $output['store_info']['store_id'], 'type' => 'promotion'));?>" <?php if($_GET['type'] == 'promotion'){?>class="selected"<?php }?>><?php echo $lang['store_sns_sales_promotion'];?><i></i></a></li>
        <li><a href="<?php echo urlShop('store_snshome', 'index', array('store_id' => $output['store_info']['store_id'], 'type' => 'new'));?>" <?php if($_GET['type'] == 'new'){?>class="selected"<?php }?>><?php echo $lang['store_sns_new_goods'];?><i></i></a></li>
        <li><a href="<?php echo urlShop('store_snshome', 'index', array('store_id' => $output['store_info']['store_id'], 'type' => 'hotsell'));?>" <?php if($_GET['type'] == 'hotsell'){?>class="selected"<?php }?>><?php echo $lang['store_sns_hot_sale'];?><i></i></a></li>
        <li><a href="<?php echo urlShop('store_snshome', 'index', array('store_id' => $output['store_info']['store_id'], 'type' => 'recommend'));?>" <?php if($_GET['type'] == 'recommend'){?>class="selected"<?php }?>><?php echo $lang['store_sns_recommended'];?><i></i></a></li>
      </ul>
    </div>
                      ...
                      <div class="forward-add">
                        ...
                        <div class="act"> 
                          <span class="skin-blue">
                            <span class="btn"><a href="javascript:void(0);" im_type="s_forwardbtn" data-param='{"txtid":"<?php echo $val['strace_id'];?>"}'><?php echo $lang['sns_forward'];?></a></span>
                          </span> 
                          <span id="forwardcharcount<?php echo $val['strace_id'];?>" style="float:right;"></span> 
                          <a class="face" im_type="smiliesbtn" data-param='{"txtid":"forward<?php echo $val['strace_id'];?>"}' href="javascript:void(0);" ><?php echo $lang['sns_smiles'];?></a> 
                        </div>
                      </div>
                    </form>
                  </div>
