...
<div class="ncs-sidebar-container ncs-class-bar">
  ...
  <div class="content">
    <p><span><a href="<?php echo urlShop('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id'], 'key' => '1', 'order' => '2'));?>"><?php echo $lang['im_by_new'];?></a></span><span><a href="<?php echo urlShop('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id'], 'key' => '2', 'order' => '2'));?>"><?php echo $lang['im_by_price'];?></a></span><span><a href="<?php echo urlShop('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id'], 'key' => '3', 'order' => '2'));?>"><?php echo $lang['im_by_sale'];?></a></span><span><a href="<?php echo urlShop('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id'], 'key' => '5', 'order' => '2'));?>"><?php echo $lang['im_by_click'];?></a></span></p>
    <div class="ncs-search">
      <form id="" name="searchShop" method="get" action="index.php" >
        ...
        <a href="javascript:document.searchShop.submit();" class="ncbtn"><?php echo $lang['im_search'];?></a>
      </form>
    </div>
    <ul class="ncs-submenu">
      <li><span class="ico-none"><em>-</em></span><a href="<?php echo urlShop('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id']));?>"><?php echo $lang['im_whole_goods'];?></a></li>
...
<?php foreach ((array) $output['goods_rand_list'] as $g) { ?>
          <li>
            <dl>
              ...
              <dd class="goods-price"><?php echo $lang['currency'];?><?php echo imPriceFormat($g['goods_promotion_price']); ?></dd>
            </dl>
          </li>
          <?php }?>
        </ul>
...
<div class="ncs-sidebar-container ncs-top-bar">
  ...
  <div class="content">
    <ul class="ncs-top-tab pngFix">
      <li id="hot_sales_tab" class="current"><a href="<?php echo urlShop('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id'], 'key' => '3', 'order' => '2'));?>"><?php echo $lang['im_hot_goods_rankings'];?></a></li>
      <li id="hot_collect_tab"><a href="<?php echo urlShop('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id'], 'key' => '4', 'order' => '2'));?>"><?php echo $lang['im_hot_collect_rankings'];?></a></li>
    </ul>
      ...
      <ol>
        ...
        <li>
          <dl>
            ...
            <dd class="price pngFix"><?php echo imPriceFormat($val['goods_promotion_price']);?></dd>
    ...
    <p><a href="<?php echo urlShop('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id']));?>"><?php echo $lang['im_look_more_store_goods'];?></a></p>
  </div>
</div>
