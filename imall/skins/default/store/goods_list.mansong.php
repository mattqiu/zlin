...
<div class="wrapper mt10">
  ...
  <div class="left"></div>
    ...
    <ul class="mjs-info">
      ...
      <li> <span class="sale-rule">单笔订单消费满<em><?php echo $lang['currency'].imPriceFormat($value['price']);?></em>
        <?php if(!empty($value['discount'])) { ?>
        ， 立减现金<em><?php echo $lang['currency'].imPriceFormat($value['discount']);?></em>
        <?php } ?>
      ...
      <ul>
        ...
        <li>
          <dl>
            ...
            <dd class="goods-info"><span class="price"><?php echo $lang['currency'];?> <?php echo imPriceFormat($value['goods_promotion_price']);?> </span><span class="goods-sold"><?php echo $lang['nc_sell_out'];?><strong><?php echo $value['goods_salenum'];?></strong> <?php echo $lang['nc_jian'];?></span></dd>
