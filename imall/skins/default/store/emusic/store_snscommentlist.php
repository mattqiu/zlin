...
<div class="comment-widget">
  <div class="comment-edit">
    <form id="commentform_<?php echo $output['stid'];?>" method="post" action="index.php?act=store_snshome&op=addcomment">
      ...
      <div class="comment-add">
        ...
        <!-- 防止点击Enter键提交 -->
        <div class="act"> <span class="skin-blue"><span class="btn"><a href="javascript:void(0);" im_type="scommentbtn" data-param='{"txtid":"<?php echo $output['stid'];?>"}'><?php echo $lang['sns_comment'];?></a></span></span> <span id="commentcharcount<?php echo $output['stid'];?>" style="float:right;"></span> <a class="face" im_type="smiliesbtn" data-param='{"txtid":"comment<?php echo $output['stid'];?>"}' href="javascript:void(0);" ><?php echo $lang['sns_smiles'];?></a> </div>
      </div>
    </form>
  </div>
  <div class="clear"></div>
  ...
  <ul class="comment-list">
    ...
    <li im_type="commentrow_<?php echo $v['scomm_id']; ?>"> <a target="_blank" href="index.php?act=member_snshome&mid=<?php echo $v['scomm_memberid'];?>"><img width="30" height="30" class="clogo" src="<?php if ($v['scomm_memberavatar']!='') { echo UPLOAD_SITE_URL.'/'.ATTACH_AVATAR.DS.$v['scomm_memberavatar']; } else {  echo UPLOAD_SITE_URL.'/'.ATTACH_COMMON.DS.C('default_user_portrait'); } ?>" onload="javascript:DrawImage(this,30,30);"></a>
      <div class="detail">
        <p class="words"><a target="_blank" href="index.php?act=member_snshome&mid=<?php echo $v['scomm_memberid'];?>" class="name"><?php echo $v['scomm_membername'];?></a><?php echo $lang['im_colon']; ?><?php echo parsesmiles($v['scomm_content']);?></p>
        <p class="other">
          <?php if ($_SESSION['member_id'] == $v['scomm_memberid']){?>
          <span class="opt"><a href="javascript:void(0);" im_type="scomment_del" data-param='{"scid":"<?php echo $v['scomm_id'];?>","stid":"<?php echo $v['strace_id'];?>"}'><?php echo $lang['im_delete'];?></a></span>
          <?php }?>
