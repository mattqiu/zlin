...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mt10">
  ...
  <tbody>
    ...
    <tr>
      <td><a href="index.php?act=member_snshome&mid=<?php echo $sale['buyer_id'];?>" target="_blank" data-param="{'id':<?php echo $sale['buyer_id'];?>}" imtype="mcard"><?php echo $sale['buyer_name'];?></a></td>
  ...
  <tbody>
    <tr>
      <td colspan="10" class="imcs-norecord"><?php echo $lang['no_record'];?></td>
    </tr>
  </tbody>
  <?php }?>
</table>
