      ...
      <div <?php if ($i != 0) {?>style="display: none;"<?php }?> data-id="<?php echo $val['id'];?>">
        <ul class="ncs-bundling-list">
          ...
          <li>
            ...
            <dl>
              ...
              <dd>原&nbsp;&nbsp;&nbsp;&nbsp;价：<em class="o-price"><?php echo $lang['currency'].imPriceFormat($v['shop_price']);?></em></dd>
              <dd>优惠价：<em class="b-price"><?php echo $lang['currency'].imPriceFormat($v['price']);?></em></dd>
            </dl>
        ...
        <ul>
          <li>已选套装：<strong><?php echo $val['name'];?></strong></li>
            <li>套装原价：<em><?php echo $lang['currency'].imPriceFormat($val['cost_price']);?></em></li>
            <li>优惠价格：<em class="bundling-price"><?php echo $lang['currency'].imPriceFormat($val['price']);?></em></li>
            <li>立刻节省：<em class="bundling-save" ><?php echo $lang['currency'].imPriceFormat(floatval($val['cost_price'])-floatval($val['price']));?></em></li>
  ...
  <div <?php if ($current) {?>style="display:none;"<?php }?> class="ncs-combo-box">
    <div class="default-goods">
      ...
      <dl>
        ...
        <dd class="goods-price"><?php echo $lang['currency'].imPriceFormat($output['goods_info']['goods_promotion_price']);?></dd>
      </dl>
        ...
        <ul class="F-center">
          ...
          <li <?php if ($j == 0) {?>class="combo-goods-first"<?php $j++;}?> data-id="<?php echo $key;?>">
            ...
            <dl>
              ...
              <dd class="goods-price"><?php echo $lang['currency'].imPriceFormat($combo['goods_promotion_price']);?></dd>
              <dd class="rp">参考价<?php echo $lang['currency'].imPriceFormat($combo['goods_marketprice']);?></dd>
            </dl>
            <input type="checkbox" class="checkbox" nctype="comb"  name="<?php echo $combo['goods_id'];?>" data-param="{price:<?php echo imPriceFormat($combo['goods_promotion_price']);?>,marketprice:<?php echo imPriceFormat($combo['goods_marketprice']);?>}">
            <span class="plus"></span>
          </li>
          <?php }?>
          <?php }?>
    ...
    <div class="combo-price">
      <ul>
        ...
        <li>组&nbsp;&nbsp;合&nbsp;&nbsp;价：<?php echo $lang['currency'];?><em nctype="gbcc_p" class="price"><?php echo imPriceFormat($output['goods_info']['goods_promotion_price']);?></em></li>        
