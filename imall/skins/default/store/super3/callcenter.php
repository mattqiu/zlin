...
<div class="imcs-message-bar">
  ...
  <div class="service-list" store_id="<?php echo $output['store_info']['store_id'];?>" store_name="<?php echo $output['store_info']['store_name'];?>">
    ...
    <dl>
      <dt><?php echo $lang['im_message_presales'];?></dt>
      ...
      <dd><span><?php echo $val['name']?></span><span>
        ...
        <a target="_blank" href="http://amos.im.alisoft.com/msg.aw?v=2&amp;uid=<?php echo $val['num'];?>&site=cntaobao&s=1&charset=<?php echo CHARSET;?>" ><img border="0" src="http://amos.im.alisoft.com/online.aw?v=2&uid=<?php echo $val['num'];?>&site=cntaobao&s=2&charset=<?php echo CHARSET;?>" alt="<?php echo $lang['im_message_me'];?>"/></a>
    ...
    <dl>
      <dt><?php echo $lang['im_message_service'];?></dt>
      <?php foreach($output['store_info']['store_aftersales'] as $val){?>
      <dd><span><?php echo $val['name']?></span><span>
        <?php if($val['type'] == 1){?>
        <a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $val['num'];?>&site=qq&menu=yes" title="QQ: <?php echo $val['num'];?>" target="_blank"><img border="0" src="http://wpa.qq.com/pa?p=2:<?php echo $val['num'];?>:52" alt="<?php echo $lang['im_message_me'];?>" style=" vertical-align: middle;"></a>
        <?php }elseif($val['type'] == 2){?>
        <a target="_blank" href="http://amos.im.alisoft.com/msg.aw?v=2&amp;uid=<?php echo $val['num'];?>&site=cntaobao&s=1&charset=<?php echo CHARSET;?>" ><img border="0" src="http://amos.im.alisoft.com/online.aw?v=2&uid=<?php echo $val['num'];?>&site=cntaobao&s=2&charset=<?php echo CHARSET;?>" alt="<?php echo $lang['im_message_me'];?>"/></a>
        <?php }elseif($val['type'] == 3){?>
        <span c_name="<?php echo $val['name'];?>" member_id="<?php echo $val['num'];?>"></span>
    ...
    <dl class="workingtime">
      <dt><?php echo $lang['im_message_working'];?></dt>
      <dd>
