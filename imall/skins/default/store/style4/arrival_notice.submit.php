...
<div class="eject_con">
  ...
  <form method="post" target="_parent" action="<?php echo urlShop('goods', 'arrival_notice_submit')?>" id="arrival_form">
    ...
    <dl>
      <dt><i class="required">*</i>手机号码<?php echo $lang['im_colon'];?></dt>
      <dd>
        <input type="text" class="text" name="mobile" id="mobile" value="<?php echo $output['member_info']['member_mobile']; ?>" />
      </dd>
    </dl>
    <dl>
      <dt><i class="required">*</i>邮箱号码<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    $('#arrival_form').validate({
        ...
        messages : {
            mobile : {
                ...
                rangelength : '<i class="fa fa-exclamation-circle"></i>请填写正确的手机号码',
                digits      : '<i class="fa fa-exclamation-circle"></i>请填写正确的手机号码'
            },
            email : {
                required    : '<i class="fa fa-exclamation-circle"></i>请填写邮箱号码',
                email       : '<i class="fa fa-exclamation-circle"></i>请填写正确的邮箱号码'
            }
        }
    });
});
