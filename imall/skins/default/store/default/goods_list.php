...
<div class="wrapper mt10">
  <div class="imcs-main-container">
    <div class="title">
      <h4>
        <?php if(!empty($_GET['stc_id'])){echo $output['stc_name'];}elseif(!empty($_GET['inkeyword'])){echo $lang['show_store_index_include'].$_GET['inkeyword'].$lang['show_store_index_goods'];}else{ echo $lang['im_whole_goods']; }?>
      </h4>
    </div>
    <div class="imcs-goodslist-bar">
      <ul class="imcs-array">
      ...
      <div class="imcs-list-search">
      <form id="" name="searchShop" method="get" action="index.php" >
        <input type="hidden" name="act" value="store_search" />
        <input type="hidden" name="op" value="index" />
        <input type="hidden" name="store_id" value="<?php echo $output['store_info']['store_id'];?>" />
        <input type="text" class="text w120" name="keyword" value="<?php echo $_GET['keyword'];?>" placeholder="搜索店内商品">
    ...
    <div class="content imcs-all-goods-list mb15">
      <ul>
        ...
        <li>
          <dl>
            ...
            <dd class="goods-info"><span class="price"><?php echo $lang['currency'];?>
              ...
              </span><span class="goods-sold"><?php echo $lang['im_sell_out'];?><strong><?php echo $value['goods_salenum'];?></strong> <?php echo $lang['im_jian'];?></span></dd>
    ...
    <?php }else{?>
    <div class="content imcs-all-goods-list">
    <div class="nothing">
