...
$(function(){
    ...
    <?php if (!empty($_SESSION['store_name'])) {?>
 	// 选入店铺
    $('a[imtype="addstore_submit"]').click(function(){
        addstore("<?php echo $output['goods']['goods_id'];?>");
    });
    <?php }?>
    // 到货通知
...
//选入店铺js
function addstore(goods_id){
	window.location.href = "index.php?act=goods&op=goodsadd&goods_id="+goods_id;
