...
<div class="sidebar">
  <div class="ad-image-date">
    ...
    <dd>
      <p id="upload_time"><b><?php echo $lang['album_pinfo_upload_time'].$lang['im_colon'];?></b><?php echo date('Y-m-d',$output['pic_info']['upload_time']);?></p>
      <p><b><?php echo $lang['album_pinfo_class_name'].$lang['im_colon'];?></b><?php echo $output['class_info']['ac_name'];?></p>
      
      <p id="default_spec"><b><?php echo $lang['album_pinfo_original_spec'].$lang['im_colon'];?></b><?php echo $output['pic_info']['ap_spec'];?></p>
      ...
      <div class="ad-nav">
        <div class="ad-thumbs">
          <ul class="ad-thumb-list">
            ...
            <li> <a href="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$output['master_id'].DS.$v['ap_cover'];?>" value="<?php echo $v['ap_id'] ?>"> <span class="thumb"><i></i> <img imtype="thumb" title="<?php echo $v['ap_name']?>" src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$output['master_id'].DS.str_ireplace('.', '_240.', $v['ap_cover']);?>" />
...
<script type="text/javascript">
  $(function() {
    ...
    var galleries = $('.ad-gallery').adGallery({loader_image:'<?php echo SHOP_SKINS_URL;?>/images/loading.gif', start_at_index:<?php echo intval($_GET['start_index'])?>, slideshow:{enable: false,start_label: '<?php echo $lang['album_pinfo_autoplay'];?>', stop_label: '<?php echo $lang['album_pinfo_suspend'];?>'}});
	...
	$('img[imtype="thumb"]').click(function(){
...
function ajax_change_imgmessage(url){
	...
	$.getJSON("<?php echo SHOP_SITE_URL; ?>/index.php?act=sns_album&op=ajax_change_imgmessage&mid=<?php echo $output['master_id'];?>", {'url':url}, function(data){
		...
		$("#upload_time").html('<b><?php echo $lang['album_pinfo_upload_time'].$lang['im_colon'];?></b>'+data.upload_time);
		$("#default_spec").html('<b><?php echo $lang['album_pinfo_original_spec'].$lang['im_colon'];?></b>'+data.default_spec);
	});
}
</script>