...
<link href="<?php echo SHOP_SKINS_URL;?>/css/member_store.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="<?php echo RESOURCE_SITE_URL;?>/js/jquery.js"></script>
<style type="text/css">
body { background-color: #F5F5F5; margin: 0; padding: 0; position:relative; z-index:0;}
.upload_wrap { padding: 0; border: 0;}
.pic-change-a { font-size:12px; line-height: 20px; color: #999; background: #F5F5F5 url(<?php echo SHOP_SKINS_URL;?>/images/member/album_bg.gif) no-repeat 0px -330px ; display: block; width: 60px; height: 20px; float: left; padding-left: 24px; white-space: nowrap;}
.pic-change-b {font-size:12px; text-decoration: underline; color: #36C; line-height: 20px; background: #F5F5F5 url(<?php echo SHOP_SKINS_URL;?>/images/member/album_bg.gif) no-repeat -152px -330px; display: block; width: 60px; height: 20px; float: left; padding-left: 24px; white-space: nowrap; }
</style>
