...
<div class="sns-main-all">
  ...
  <div id="pictureFolder" class="album">
    <div class="intro">
      <div class="covers"><span class="thumb size60"><i></i>
        ...
        <img id="aclass_cover" src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$output['master_id'].DS.$output['class_info']['ac_cover'];?>"  onerror="this.src='<?php echo SHOP_SKINS_URL.'/images/member/default_image.png';?>'" onload="javascript:DrawImage(this,60,60);">
        <?php }else{?>
        <img id="aclass_cover" src="<?php echo SHOP_SKINS_URL.'/images/member/default_image.png';?>" onload="javascript:DrawImage(this,60,60);">
        <?php }?>
        </span></div>
      <dl>
      ...
      <?php if($output['relation'] == 3){?>
          <div class="button"><a id="open_uploader" href="JavaScript:void(0);" class="imsc-btn imsc-btn-acidblue "><i class="fa fa-cloud-upload"></i><?php echo $lang['sns_upload_more_pic'];?></a></div>
  ...
  <?php if(is_array($output['pic_list']) && !empty($output['pic_list'])){?>
    <ul class="imcss-sns-pinterest masoned mt20"  id="snsPinterest">
      	<?php $ii=0;?>
      ...
      <li class="item">
        ...
        <ul class="handle">
          ...
          <li class="delete"><a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['album_plist_delete_confirm_message'];?>','index.php?act=sns_album&op=album_pic_del&id=<?php echo $v['ap_id'];?>');"><i></i><?php echo $lang['im_delete'];?></a></li>
        </ul>
        <?php }?>
        <dl>
          ...
          <dd> <span class="pinterest-addtime"><?php echo $lang['album_plist_upload_time'].$lang['im_colon'].date("Y-m-d",$v['upload_time'])?></span><!--<span class="ops-comment"><a href="index.php?act=member_snshome&op=goodsinfo&type=like&mid=<?php echo $v['share_memberid'];?>&id=<?php echo $v['share_id'];?>" title="<?php echo $lang['sns_comment'];?>"><i></i></a><em><?php echo $v['share_commentcount'];?></em> </span>-->
          </dd>
        </dl>
      </li>
      <?php }?>
