  ...
  <div id="pictureIndex" class="picture-index">
    ...
    <div class="album-info">
      <div class="build-album">
        <div class="button"><a uri="index.php?act=sns_album&op=album_add" im_type="dialog" dialog_title="<?php echo $lang['album_new_class_add'];?>" class="btn" ><i></i><?php echo $lang['album_new_class_add'];?></a></div>
      </div>
      <div class="upload-photo">
          ...
          <div class="upload-con" id="uploader" style="display: none;">
            <form method="post" action="" id="fileupload" enctype="multipart/form-data">
              <div class="upload-con-div"><?php echo $lang['album_plist_move_album_change'].$lang['im_colon'];?>
              ...
              <div class="upload-con-div mt10">
                <div class="imsc-upload-btn"><span>
    ...
    <div class="album-cover">
      <div class="cover"> <span class="thumb size190"><i></i><a href="index.php?act=sns_album&op=album_pic_list&id=<?php echo $v['ac_id']?>&mid=<?php echo $output['master_id'];?>">
        <?php if($v['ac_cover'] != ''){ ?>
        <img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$output['master_id'].DS.$v['ac_cover'];?>" onerror="this.src='<?php echo SHOP_SKINS_URL.'/images/member/default_image.png';?>'" >
        <?php }else{?>
        <img src="<?php echo SHOP_SKINS_URL.'/images/member/default_image.png';?>" onload=>
        <?php }?>
        </a></span></div>
      <div class="title">
      ...
      <?php if($output['relation'] == '3'){?>
      <div class="handle"><a href="JavaScript:void(0);" class="edit" im_type="dialog" dialog_title="<?php echo $lang['album_class_deit'];?>" dialog_id='album_<?php echo $v['ac_id'];?>' dialog_width="480" uri="index.php?act=sns_album&op=album_edit&id=<?php echo $v['ac_id'];?>"><i></i><?php echo $lang['album_class_edit'];?></a>
