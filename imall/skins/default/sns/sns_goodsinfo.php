  ...
  <div class="snsgoods-info">
    ...
    <div class="gcontainer">
      ...
      <?php if($output['sharegoods_info']['snsgoods_isfirst'] == false){?>
          <div class="prev <?php echo $output['sharegoods_info']['snsgoods_islast']==true?'whole':'';?>" im_type="imgflipover" data-param='{"id":"<?php echo $output['sharegoods_info']['snsgoods_previd'];?>"}'></div>
          <?php }?>
          <?php if($output['sharegoods_info']['snsgoods_islast'] == false){?>
          <div class="next <?php echo $output['sharegoods_info']['snsgoods_isfirst']==true?'whole':'';?>" im_type="imgflipover" data-param='{"id":"<?php echo $output['sharegoods_info']['snsgoods_nextid'];?>"}'></div>
          <?php }?>
      ...
      <div class="handle-module">
        <div class="operate" id="likestat_<?php echo $output['sharegoods_info']['share_goodsid'];?>"><span><i></i>
          ...
          <a href="javascript:void(0);" im_type="likebtn" data-param='{"gid":"<?php echo $output['sharegoods_info']['share_goodsid'];?>"}' class="<?php echo $output['sharegoods_info']['snsgoods_havelike']==1?'noaction':''; ?>"><?php echo $lang['sns_like'];?></a>
          <?php }?>
          </span> <em im_type="likecount_<?php echo $output['sharegoods_info']['share_goodsid'];?>"><?php echo $output['sharegoods_info']['snsgoods_likenum'];?></em></div>
        <?php if ($output['relation'] == 3){//  主人自己?>
        <div class="btn set" im_type="privacydiv" id="recordone_<?php echo $output['sharegoods_info']['share_id'];?>"> <a href="javascript:void(0)" im_type="privacybtn"><i></i><?php echo $lang['sns_setting'];?></a>
          <ul im_type="privacytab" style="display:none;" >
            <li im_type="privacyoption" data-param='{"sid":"<?php echo $output['sharegoods_info']['share_id'];?>","v":"0"}'><span class="<?php echo $output['sharegoods_info']['share_privacy']==0?'selected':'';?>"><?php echo $lang['sns_open'];?></span></li>
            <li im_type="privacyoption" data-param='{"sid":"<?php echo $output['sharegoods_info']['share_id'];?>","v":"1"}'><span class="<?php echo $output['sharegoods_info']['share_privacy']==1?'selected':'';?>"><?php echo $lang['sns_friend'];?></span></li>
            <li im_type="privacyoption" data-param='{"sid":"<?php echo $output['sharegoods_info']['share_id'];?>","v":"2"}'><span class="<?php echo $output['sharegoods_info']['share_privacy']==2?'selected':'';?>"><?php echo $lang['sns_privacy'];?></span></li>
          </ul>
        </div>
        <?php if($_GET['type'] != 'like'){?>
        <div class="btn buyer-show"><a href="javascript:void(0)" imtype="add_share" data-param="{'sid':'<?php echo $output['sharegoods_info']['share_id'];?>', 'gid':'<?php echo $output['sharegoods_info']['share_goodsid'];?>'}"><i></i><?php echo $lang['sns_buyershow'];?></a></div>
        <?php }?>
        <?php } ?>
    ...
    <div class="interact-module"><span class="add-time"><?php if ($_GET['type'] == 'like'){echo @date('Y-m-d H:i',$output['sharegoods_info']['share_likeaddtime']); }else {echo @date('Y-m-d H:i',$output['sharegoods_info']['share_addtime']);}?></span>
      <ul>
        <li><a data-param='{"gid":"<?php echo $output['sharegoods_info']['share_goodsid'];?>"}' im_type="sharegoods" href="javascript:void(0);"><?php echo $lang['im_snsshare'];?><em>(<?php echo $output['sharegoods_info']['snsgoods_sharenum'];?>)</em></a></li>
...
$(function(){
	//图片翻页
	$("[im_type='imgflipover']").bind('click',function(){
	...
	// 追加
	$('a[imtype="add_share"]').click(function(){
