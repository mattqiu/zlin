...
<ul class="handle">
  <?php if ($output['relation'] == 3){//主人自己?><li class="delete" style=" margin-left: 150px;" im_type="delbtn" data-param='{"sid":"<?php echo $v['share_id'];?>","tabtype":"like"}'><a href="javascript:void(0)"><i></i><?php echo $lang['im_delete'];?></a></li>
    <?php } ?></ul>
  <dl>
    ...
    <dd class="pinterest-ops"> <span class="ops-like" id="likestat_<?php echo $v['share_goodsid'];?>"> <a href="javascript:void(0);" im_type="likebtn" data-param='{"gid":"<?php echo $v['share_goodsid'];?>"}' class="<?php echo $v['snsgoods_havelike']==1?'noaction':''; ?>"><i class="<?php echo $v['snsgoods_havelike']==1?'noaction':''; ?>"></i><?php echo $lang['sns_like'];?></a><em im_type='likecount_<?php echo $v['share_goodsid'];?>'><?php echo $v['snsgoods_likenum'];?></em> </span> <span class="ops-comment"><a href="index.php?act=member_snshome&op=goodsinfo&type=like&mid=<?php echo $v['share_memberid'];?>&id=<?php echo $v['share_id'];?>" title="<?php echo $lang['sns_comment'];?>"><i></i></a><em><?php echo $v['share_commentcount'];?></em> </span> </dd>
    <div class="clear"></div>
  </dl>
  </li>
  <?php }?>
