...
<div class="sns-main-all">
  ...
  <div class="sharelist-g mt30">
    ...
    <ul class="imcss-sns-pinterest" id="snsPinterest">
      <?php foreach ($output['goodslist'] as $k=>$v){ ?>
      <li id="recordone_<?php echo $v['share_id'];?>" class="item">
        <ul class="handle">
          <?php if ($output['relation'] == 3){//主人自己?>
          <li class="buyer-show"><a href="javascript:void(0)" imtype="add_share" data-param="{'sid':'<?php echo $v['share_id'];?>', 'gid':'<?php echo $v['share_goodsid'];?>'}"><i></i><?php echo $lang['sns_buyershow'];?></a></li>
          <li class="set" im_type="privacydiv"><a href="javascript:void(0)" im_type="formprivacybtn"><i></i><?php echo $lang['sns_setting'];?></a>
            <ul class="set-menu" im_type="privacytab" style="display:none;">
              <li im_type="privacyoption" data-param='{"sid":"<?php echo $v['share_id'];?>","v":"0"}'><span class="<?php echo $v['share_privacy']==0?'selected':'';?>"><?php echo $lang['sns_open'];?></span></li>
              <li im_type="privacyoption" data-param='{"sid":"<?php echo $v['share_id'];?>","v":"1"}'><span class="<?php echo $v['share_privacy']==1?'selected':'';?>"><?php echo $lang['sns_friend'];?></span></li>
              <li im_type="privacyoption" data-param='{"sid":"<?php echo $v['share_id'];?>","v":"2"}'><span class="<?php echo $v['share_privacy']==2?'selected':'';?>"><?php echo $lang['sns_privacy'];?></span></li>
              <li im_type="delbtn" data-param='{"sid":"<?php echo $v['share_id'];?>","tabtype":"share"}'><span class="del"><a href="javascript:void(0);"><?php echo $lang['im_delete'];?></a></span></li>
            </ul>
          </li>
          <?php }?>
        </ul>
        <dl>
          ...
          <dd class="pinterest-addtime goods-time"><?php echo $lang['sns_at'];?>&nbsp;<?php echo @date('Y-m-d H:i',$v['share_addtime']);?>&nbsp;<?php echo $lang['im_snsshare'];?></dd>
          <dd class="pinterest-ops"> <span class="ops-like" id="likestat_<?php echo $v['share_goodsid'];?>"> <a href="javascript:void(0);" im_type="likebtn" data-param='{"gid":"<?php echo $v['share_goodsid'];?>"}' class="<?php echo $v['snsgoods_havelike']==1?'noaction':''; ?>"><i class="<?php echo $v['snsgoods_havelike']==1?'noaction':''; ?> pngFix"></i><?php echo $lang['sns_like'];?></a> <em im_type="likecount_<?php echo $v['share_goodsid'];?>"><?php echo $v['snsgoods_likenum'];?></em> </span> <span class="ops-comment"><a href="index.php?act=member_snshome&op=goodsinfo&mid=<?php echo $v['share_memberid'];?>&id=<?php echo $v['share_id'];?>" title="<?php echo $lang['sns_comment'];?>"><i class="pngFix"></i></a><em><?php echo $v['share_commentcount'];?></em> </span> </dd>
          <div class="clear"></div>
        </dl>
      </li>
      <?php }?>
...
$(function(){
	...
	// 买家秀
	$('a[imtype="add_pic"]').click(function(){
