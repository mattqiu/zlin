      ...
      <li class="shop-item" id="recordone_<?php echo $v['share_id']; ?>">
        <dl>
          <dt>
            ...
            <?php if ($output['relation'] == 3){?>
            <div class="set-btn fr" im_type="privacydiv"><a href="javascript:void(0)" im_type="formprivacybtn"><i></i><?php echo $lang['sns_setting'];?></a>
            <ul class="set-menu" im_type="privacytab" style="display: none;">
              <li im_type="privacyoption" data-param='{"sid":"<?php echo $v['share_id'];?>","v":"0","op":"store"}'><span class="<?php echo $v['share_privacy']==0?'selected':'';?>"><?php echo $lang['sns_open'];?></span></li>
              <li im_type="privacyoption" data-param='{"sid":"<?php echo $v['share_id'];?>","v":"1","op":"store"}'><span class="<?php echo $v['share_privacy']==1?'selected':'';?>"><?php echo $lang['sns_friend'];?></span></li>
              <li im_type="privacyoption" data-param='{"sid":"<?php echo $v['share_id'];?>","v":"2","op":"store"}'><span class="<?php echo $v['share_privacy']==2?'selected':'';?>"><?php echo $lang['sns_privacy'];?></span></li>
              <li im_type="storedelbtn" data-param='{"sid":"<?php echo $v['share_id'];?>"}'><span class="del"><a href="javascript:void(0);"><?php echo $lang['im_delete'];?></a></span></li>
            </ul></div>
            <?php }?>
          </dt>
          <dd><i class="pngFix"></i>
