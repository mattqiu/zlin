...
<div class="title">
  <h4>
    <?php if ($output['relation'] == 3){echo $lang['sns_me']; }else {?>TA<?php } echo $lang['sns_of_other']; if($_GET['type'] == 'like'){echo $lang['sns_like']; }else{echo $lang['im_snsshare']; }?>
  </h4>
  <span><a href="index.php?act=member_snshome&op=shareglist&type=<?php if ($_GET['type'] == 'like'){?>like<?php }else { ?>share<?php } ?>&mid=<?php echo $output['sharegoods_info']['share_memberid'];?>"><?php echo $lang['im_more'];?></a></span></div>
