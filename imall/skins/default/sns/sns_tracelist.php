...
<div id="lazymodule">
  ...
  <ul class="fd-list">
    ...
    <li im_type="tracerow_<?php echo $v['trace_id']; ?>">
      <dl class="fd-wrap">
        <dt>
          <img src="<?php echo getMemberAvatarForID($v['trace_memberid']);?>" data-param="{'id':<?php echo $v['trace_memberid'];?>}" imtype="mcard">
          ...
          <div class="del-btn fr"><a href="javascript:void(0);" im_type="fd_del" data-param='{"txtid":"<?php echo $v['trace_id'];?>"}'><i></i>&nbsp;</a></div>
          <?php }?>
        </dt>
        <dd>
