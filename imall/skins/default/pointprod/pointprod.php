...
<div class="imcp-container">
  <div class="imcp-base-layout">
    <div class="imcp-member-left">
      <?php if($_SESSION['is_login'] == '1'){?>
      <?php include_once BASE_TPL_PATH.'/pointprod/pointshop.minfo.php'; ?>
      <?php } else { ?>
      <div class="imcp-not-login">
        ...
        <div class="button"> <a href="javascript:login_dialog();" class="imcp-btn" style="width:120px;"><?php echo $lang['pointprod_list_hello_login']; ?></a> </div>
      </div>
      <?php }?>
    </div>
    <div class="imcp-banner-right"><?php echo loadadv(35,'html');?></div>
  </div>
    ...
    <ul class="imcp-voucher-list">
      ...
      <li>
        <div class="imcp-voucher">
          ...
          <div class="button"><a target="_blank" href="javascript:void(0);" im_type="exchangebtn" data-param='{"vid":"<?php echo $v['voucher_t_id'];?>"}' class="imcp-btn imcp-btn-red">立即兑换</a></div>
        </div>
      </li>
      <?php }?>
    </ul>
  ...
  <div class="imcp-main-layout mb30">
    <div class="title">
