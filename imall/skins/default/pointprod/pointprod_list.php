      ...
      <dl class="searchbox">
        ...
        <dd><!-- 高级搜索start -->
          <ul>
            ...
            <?php } else { ?>
            <li im_type="search_orderby" data-param='{"orderval":"default"}' style="cursor: pointer;">默认排序</li>
            <?php }?>
            <!-- 默认排序e --> 
            ...
            <li class="selected" im_type="search_orderby" data-param='{"orderval":"stimeasc"}'>上架时间<em class="desc"></em></li>
            <?php } elseif ($_GET['orderby'] == 'stimeasc') {//升序选中 ?>
            <li class="selected" im_type="search_orderby" data-param='{"orderval":"stimedesc"}'>上架时间<em class="asc"></em></li>
            <?php } else {//未选中?>
            <li im_type="search_orderby" data-param='{"orderval":"stimedesc"}'>上架时间<em class="desc"></em></li>
            <?php } ?>
            <!-- 上架时间e --> 
            <li>&nbsp;</li>
            <!-- 会员等级s -->
            ...
            <li>所需积分：
              ...
              <a href="javascript:searchpointprod();" class="imcp-btn">搜索</a> </li>
            <!-- 所需积分e -->
            <li>&nbsp;</li>
            <?php if($_SESSION['is_login'] == '1'){ ?>
            <li>
    ...
    <ul class="imcp-exchange-list">
      ...
      <li>
        ...
        <div class="exchange-rule">
          ...
          <?php } ?>
          <span class="pgoods-price"><?php echo $lang['pointprod_goodsprice'].$lang['im_colon']; ?><em><?php echo $lang['currency'].$v['pgoods_price']; ?></em></span> <span class="pgoods-points"><?php echo $lang['pointprod_pointsname'].$lang['im_colon'];?><strong><?php echo $v['pgoods_points']; ?></strong><?php echo $lang['points_unit']; ?></span> </div>
      </li>
      <?php } ?>
    </ul>
