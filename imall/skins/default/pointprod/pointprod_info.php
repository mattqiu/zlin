...
<div class="imcp-container">
  <div class="imcp-detail">
    <div class="imcp-gift-picture"><a href="<?php echo $output['prodinfo']['pgoods_image_max']; ?>"><img src="<?php echo $output['prodinfo']['pgoods_image_max']; ?>"></a></div>
    <div class="imcp-share">
    ...
    <div class="imcp-gift-summary">
      ...
      <div class="imcp-meta">
        ...
        <dl>
          <dt><?php echo $lang['pointprod_info_goods_limittime'].$lang['im_colon']; ?></dt>
          <dd>
      ...
      <div class="imcp-key">
        <dl>
          <dt><?php echo $lang['pointprod_info_goods_exchangenum'].$lang['im_colon']; ?></dt>
          <dd class="imcp-figure-input">
            <input name="exnum" type="text" class="text w30" id="exnum" value='1' size="4"/>
            <span>（<?php echo $lang['pointprod_info_goods_lastnum'].$lang['im_colon']; ?><?php echo $output['prodinfo']['pgoods_storage']; ?>
    ...
    <div style=" position: absolute; z-index: 1; top: -1px; right: -1px;">
      <div class="imcp-info">
        ...
        <div class="content">
          <dl>
            <dt><?php echo $lang['pointprod_info_goods_serial'].$lang['im_colon']; ?></dt>
  ...
  <div class="imcp-goods-layout">
    <div class="imcp-sidebar">
      <div class="imcp-sidebar-container">
    ...
    <div class="imcp-goods-main">
      <div class="tabbar">
        <div class="imcp-goods-title-nav">
          <ul id="categorymenu">
            <li class="current"> <a id="tabGoodsIntro" href="#content"><?php echo $lang['pointprod_info_goods_description']; ?></a> </li>
          </ul>
        </div>
      </div>
      <div class="imcp-goods-info-content"><?php echo $output['prodinfo']['pgoods_body']; ?></div>
    </div>
  </div>
</div>
