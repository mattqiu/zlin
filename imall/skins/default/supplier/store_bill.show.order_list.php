  ...
  <form method="get" id="formSearch">
    <table class="search-form">
      ...
      <tr>
        ...
        <td class="tc w200">
        <label class="submit-border"><input type="button" id="ncsubmit" class="submit" value="<?php echo $lang['im_search'];?>" /></label>
...
<table class="ncsc-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><?php echo imPriceFormat($order_info['order_amount']);?></td>
        <td><?php echo imPriceFormat($order_info['shipping_fee']);?></td>
        <td><?php echo imPriceFormat($output['commis_list'][$order_info['order_id']]['commis_amount']);?></td>
        <td><?php echo imPriceFormat($order_info['rpt_amount']);?></td>
        <td>
       	<a target="_blank" href="index.php?act=store_order&op=show_order&order_id=<?php echo $order_info['order_id'];?>"><?php echo $lang['im_view'];?></a>
        </td>
      </tr>
      <?php } ?>
      <?php } else { ?>
