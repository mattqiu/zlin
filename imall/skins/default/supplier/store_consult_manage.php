...
<form method="get" action="index.php">
  <input type="hidden" name="act" value="supplier_consult" />
  ...
  <thead>
    ...
    <tr>
      ...
      <td colspan="20"><label for="all"><?php echo $lang['im_select_all'];?></label>
        <a href="javascript:void(0);" class="ncbtn-mini" im_type="batchbutton" uri="index.php?act=supplier_consult&op=drop_consult" name="id" confirm="<?php echo $lang['im_ensure_del'];?>"><i class="icon-trash"></i><?php echo $lang['im_del'];?></a></td>
    </tr>
    <?php }?>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td rowspan="2" class="nscs-table-handle vt"><?php if($consult['consult_reply'] == ''){?>
        <span><a href="javascript:void(0);" class="btn-aqua" im_type="dialog" dialog_id="my_qa_reply" dialog_title="<?php echo $lang['store_consult_list_reply_consult'];?>" dialog_width="460" uri="index.php?act=supplier_consult&op=reply_consult&id=<?php echo $consult['consult_id'];?>"><i class="icon-comments-alt "></i><p><?php echo $lang['store_consult_list_reply'];?></p></a></span>
        <?php }else{?>
        <span><a href="javascript:void(0);" im_type="dialog" dialog_id="my_qa_edit_reply" dialog_title="<?php echo $lang['store_consult_list_reply_consult'];?>" dialog_width="480" uri="index.php?act=supplier_consult&op=reply_consult&id=<?php echo $consult['consult_id'];?>" class="btn-bluejeans"><i class="icon-edit"></i><p><?php echo $lang['im_edit'];?></p></a></span>
        <?php }?>
        <span><a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['im_ensure_del'];?>', 'index.php?act=supplier_consult&op=drop_consult&id=<?php echo $consult['consult_id'];?>');" class="btn-grapefruit"><i class="icon-trash"></i><p><?php echo $lang['im_del'];?></p></a> </span></td>
    </tr>
  ...
  <tfoot>
    ...
    <tr>
      ...
      <th colspan="20"><label for="all2"><?php echo $lang['im_select_all'];?></label>
        <a href="javascript:void(0);" class="ncbtn-mini" im_type="batchbutton" uri="index.php?act=supplier_consult&op=drop_consult" name="id" confirm="<?php echo $lang['im_ensure_del'];?>"><i class="icon-trash"></i><?php echo $lang['im_del'];?></a></th>
    </tr>
    <tr>
