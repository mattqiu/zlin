...
<div id="div_goods_select" class="div-goods-select" style="display: none;">
    <table class="search-form">
      <tr><th class="w150"><strong>第一步：搜索店内商品</strong></th><td class="w160"><input id="search_goods_name" type="text w150" class="text" name="goods_name" value=""/></td>
        <td class="w70 tc"><a href="javascript:void(0);" id="btn_search_goods" class="ncbtn"/><i class="icon-search"></i><?php echo $lang['im_search'];?></a></td><td class="w10"></td><td><p class="hint">不输入名称直接搜索将显示店内所有普通商品，特殊商品不能参加。</p></td>
      </tr>
    </table>
...
<table class="ncsc-default-table">
  ...
  <tbody id="xianshi_goods_list">
    ...
    <tr class="bd-line">
        ...
        <?php if($output['xianshi_info']['editable']) { ?>
        <span><a nctype="btn_edit_xianshi_goods" class="btn-bluejeans" data-xianshi-goods-id="<?php echo $val['xianshi_goods_id']?>" data-goods-price="<?php echo $val['goods_price'];?>" href="javascript:void(0);"><i class="icon-edit"></i><p><?php echo $lang['im_edit'];?></p></a></span>
            <span><a nctype="btn_del_xianshi_goods" class="btn-grapefruit" data-xianshi-goods-id="<?php echo $val['xianshi_goods_id']?>" href="javascript:void(0);"><i class="icon-trash"></i><p><?php echo $lang['im_del'];?></p></a></span>
        <?php } ?>
        </td>
    </tr>
    <?php }?>
...
<tr class="bd-line">
    ...
    <td class="nscs-table-handle">
    <?php if($output['xianshi_info']['editable']) { ?>
    <span><a nctype="btn_edit_xianshi_goods" class="btn-bluejeans" data-xianshi-goods-id="<%=xianshi_goods_id%>" data-goods-price="<%=goods_price%>" href="javascript:void(0);"><i class="icon-edit"></i><p><?php echo $lang['im_edit'];?></p></a></span>
        <span><a nctype="btn_del_xianshi_goods" class="btn-grapefruit" data-xianshi-goods-id="<%=xianshi_goods_id%>" href="javascript:void(0);"><i class="icon-trash"></i><p><?php echo $lang['im_del'];?></p></a></span>
    <?php } ?>
    </td>
</tr>
</script> 
