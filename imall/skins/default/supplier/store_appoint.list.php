  ...
  <thead>
    ...
    <tr>
      ...
      <td colspan="20"><label for="all" ><?php echo $lang['im_select_all'];?></label>
        <a href="javascript:void(0);" class="ncbtn-mini" im_type="batchbutton" uri="<?php echo urlShop('supplier_goods_online', 'drop_goods');?>" name="commonid" confirm="<?php echo $lang['im_ensure_del'];?>"><i class="icon-trash"></i><?php echo $lang['im_del'];?></a> <a href="javascript:void(0);" class="ncbtn-mini" im_type="batchbutton" uri="<?php echo urlShop('supplier_goods_online', 'goods_unshow');?>" name="commonid"><i class="icon-level-down"></i><?php echo $lang['store_goods_index_unshow'];?></a> <a href="javascript:void(0);" class="ncbtn-mini" nctype="batch" data-param="{url:'<?php echo urlShop('supplier_goods_online', 'edit_jingle');?>', sign:'jingle'}"><i></i>设置广告词</a> <a href="javascript:void(0);" class="ncbtn-mini" nctype="batch" data-param="{url:'<?php echo urlShop('supplier_goods_online', 'edit_plate');?>', sign:'plate'}"><i></i>设置关联版式</a></td>
    </tr>
    <?php } ?>
  </thead>
  <tbody>
