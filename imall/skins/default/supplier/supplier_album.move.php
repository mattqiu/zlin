<div class="eject_con">
  ...
  <form id="category_form" method="post" target="_parent" onsubmit="ajaxpost('category_form','','','onerror')" action="index.php?act=supplier_album&op=album_pic_move">
    <input type="hidden" name="form_submit" value="ok" />
    <input type="hidden" name="id" value="<?php echo $output['id']?>" />
    <dl>
      <dt><?php echo $lang['album_plist_move_album_change'].$lang['im_colon'];?></dt>
      <dd>
