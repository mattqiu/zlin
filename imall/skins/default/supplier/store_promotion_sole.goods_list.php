...
<?php } else {?>
  <strong>套餐过期时间<?php echo $lang['im_colon'];?></strong> <strong style=" color:#F00;"><?php echo date('Y-m-d H:i:s',$output['sole_quota']['sole_quota_endtime']);?></strong>
<?php }?>
  <ul>
...
<table class="ncsc-default-table">
  ...
  <tbody nctype="choose_goods_list">
    ...
    <tr class="bd-line" data-gid="<?php echo $val['goods_id'];?>">
      ...
      <td class="goods-price"><?php echo $lang['currency'].imPriceFormat($val['goods_price']);?></td>
      <td class="goods-price"><?php echo $lang['currency'].imPriceFormat($val['sole_price']);?></td>
      <td class="nscs-table-handle">
        ...
        <span><a class="btn-grapefruit" href='javascript:void(0);' nctype="del_choosed" data-param="{gid:<?php echo $val['goods_id'];?>}"><i class="icon-trash"></i><p><?php echo $lang['im_del'];?></p></a></span></td>
    </tr>
    <?php }?>
    <?php } ?>
  </tbody>
