...
<div class="ncsc-form-default">
  <form method="post" action="<?php if (empty($output['plate_info'])) { echo urlShop('supplier_plate', 'plate_add');} else { echo urlShop('supplier_plate', 'plate_edit');}?>" id="plate_form">
