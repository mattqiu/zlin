  ...
  <form method="post" action="index.php?act=store_sns&op=store_sns_save" id="normal_form">
    ...
    <dl>
      ...
      <dd>
        <div class="ncsc-upload-thumb store-sns-pic">
          <p><img nctype="normal_img" src="<?php echo SHOP_SKINS_URL?>/images/member/default_image.png"/></p>
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="w450"><a href="javascript:void(0)" im_type="smiliesbtn" data-param='{"txtid":"normal"}' class="ncbtn-mini ncbtn-bittersweet"><i class="icon-smile"></i><?php echo $lang['store_sns_face'];?></a> <span id="weibocharcount_normal" class="weibocharcount"></span></p>
      </dd>
    </dl>
    <div class="bottom">
  ...
  <form method="post" action="index.php?act=store_sns&op=store_sns_save" id="recommend_form">
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="w450"><span class="smile"><a href="javascript:void(0)" im_type="smiliesbtn" data-param='{"txtid":"recommend"}' class="ncbtn-mini ncbtn-bittersweet"><i class="icon-smile"></i><?php echo $lang['store_sns_face'];?></a> </span> <span id="weibocharcount_recommend" class="weibocharcount"></span></p>
      </dd>
    </dl>
    <div class="bottom">
      <label class="submit-border"><input type="submit" class="submit" value="<?php echo $lang['store_sns_release'];?>" /></label>
  ...
  <form method="post" action="index.php?act=store_sns&op=store_sns_save" id="hotsell_form">
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="w450"><span class="smile"> <a href="javascript:void(0)" im_type="smiliesbtn" data-param='{"txtid":"hotsell"}' class="ncbtn-mini ncbtn-bittersweet"><i class="icon-smile"></i><?php echo $lang['store_sns_face'];?></a> </span> <span id="weibocharcount_hotsell" class="weibocharcount"></span></p>
      </dd>
    </dl>
    <div class="bottom">
      <label class="submit-border"><input type="submit" class="submit" value="<?php echo $lang['store_sns_release'];?>" /></label>
  ...
  <form method="post" action="index.php?act=store_sns&op=store_sns_save" id="new_form">
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="w450"><span class="smile"> <a href="javascript:void(0)" im_type="smiliesbtn" data-param='{"txtid":"new"}' class="ncbtn-mini ncbtn-bittersweet"><i class="icon-smile"></i><?php echo $lang['store_sns_face'];?></a> </span> <span id="weibocharcount_new" class="weibocharcount"></span></p>
      </dd>
    </dl>
    <div class="bottom">
      <label class="submit-border"><input type="submit" class="submit" value="<?php echo $lang['store_sns_release'];?>" /></label>
...
$(function(){
	...
	$('#normal_file').unbind().live('change', function(){
		$('img[nctype="normal_img"]').attr('src',SHOP_SKINS_URL+"/images/loading.gif");
