...
<?php foreach ($areas['children'][$provinceId] as $cityId) { ?>
            <div class="area-list">
              ...
              <a city_id="<?php echo $cityId; ?>" nc_title="<?php echo $areas['name'][$cityId]; ?>" province_id="<?php echo $provinceId; ?>" im_type="edit" href="javascript:void(0);" title="选择下级地区"><i class="icon-pencil"></i></a>
            </div>
<?php } ?>
<?php } ?>
          </td>
