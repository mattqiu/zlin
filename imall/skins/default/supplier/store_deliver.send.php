...
<div class="wrap">
  ...
  <form name="deliver_form" method="POST" id="deliver_form" action="index.php?act=store_deliver&op=send&order_id=<?php echo $_GET['order_id'];?>" onsubmit="ajaxpost('deliver_form', '', '', 'onerror');return false;">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="tl"><dl class="goods-name">
              ...
              <dd><strong>￥<?php echo imPriceFormat($goods_info['goods_price']); ?></strong>&nbsp;x&nbsp;<em><?php echo $goods_info['goods_num'];?></em>件</dd>
            </dl></td>
    ...
    <div class="deliver-sell-info"><strong class="fl"><?php echo $lang['store_deliver_my_daddress'].$lang['im_colon'];?></strong>
      <a href="javascript:void(0);" onclick="ajax_form('modfiy_daddress', '<?php echo $lang['store_deliver_select_daddress'];?>', 'index.php?act=store_deliver&op=send_address_select&order_id=<?php echo $output['order_info']['order_id'];?>', 640,0);" class="ncbtn-mini fr"><i class="icon-edit"></i><?php echo $lang['im_edit'];?></a> <span id="seller_address_span">
    ...
    <table class="ncsc-default-table order" id="texpress1">
      <tbody>
        ...
        <tr>
          ...
          <td class="bdl"><input name="shipping_code" type="text" class="text w200 tip-r" title="<?php echo $lang['store_deliver_shipping_code_tips'];?>" maxlength="20" im_type='eb' nc_value="<?php echo $v;?>" /></td>
          <td class="bdl gray" nc_value="<?php echo $v;?>"></td>
          <td class="bdl bdr tc"><a im_type='eb' nc_value="<?php echo $v;?>" href="javascript:void(0);" class="ncbtn"><?php echo $lang['im_common_button_confirm'];?></a></td>
        </tr>
        <?php }?>
        <?php }?>
      </tbody>
    ...
    <table class="ncsc-default-table order" id="texpress2" style="display:none">
      <tbody>
        ...
        <tr>
          ...
          <td class="bdr tl w400">&emsp;<a im_type='eb' nc_value="e1000" href="javascript:void(0);" class="ncbtn"><?php echo $lang['im_common_button_confirm'];?></a></td>
        </tr>
        <tr>
          <td colspan="2"></td>
        </tr>
