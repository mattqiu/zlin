  ...
  <table class="search-form">
    <tbody>
      <tr>
        ...
        <td class="tc w70"><a href="index.php?act=store_promotion_cou&op=cou_level_sku&level=<?php echo $output['level']; ?>" nctype="search_a" class="ncs-btn"><i class="icon-search"></i><?php echo $lang['im_search'];?></a></td>
        <td class="w10"></td>
      </tr>
    </tbody>
  </table>
...
?>
      <li nctype="<?php echo $val['goods_id'];?>">
        ...
        <dl class="goods-info">
          ...
          <dd><?php echo $lang['bundling_goods_price'];?>¥<?php echo imPriceFormat($val['goods_price']);?></dd>
