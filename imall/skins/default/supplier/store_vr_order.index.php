  ...
  <tbody>
    ...
    <tr>
      <th colspan="20"><span class="ml10"><?php echo $lang['store_order_order_sn'].$lang['im_colon'];?><em><?php echo $order['order_sn']; ?></em>
        ...
        <?php }?>
        </span> <span><?php echo $lang['store_order_add_time'].$lang['im_colon'];?><em class="goods-time"><?php echo date("Y-m-d H:i:s",$order['add_time']); ?></em></span> </th>
    </tr>
    <tr>
      <td class="bdl"></td>
      ...
      <td><p><?php echo imPriceFormat($order['goods_price']); ?></p>
