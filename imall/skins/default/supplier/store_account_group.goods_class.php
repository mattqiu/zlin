...
<div class="ncsc-account-container">
  ...
  <ul class="ncsc-account-container-list">
    ...
    <li>
      ...
      )</span> <a cate_id="<?php echo $key2; ?>" nc_title="<?php echo $value2['gc_name']; ?>" parent_id="<?php echo $key; ?>" im_type="edit" href="javascript:void(0);" title="选择下级分类"><i class="icon-pencil"></i></a> 
      <!-- 三级分类循环到隐藏域 -->
