<div class="eject_con">
  ...
  <form id="post_form" method="post" action="index.php?act=supplier_map&op=add_map">
    ...
    <dl>
      <dt>当前地图所在城市<?php echo $lang['im_colon'];?></dt>
      <dd><div id="baidu_city"></div></dd>
    </dl>
    <dl>
      <dt><i class="required">*</i>实体店铺名称<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>公交信息<?php echo $lang['im_colon'];?></dt>
      <dd>
