    ...
    <div id="printarea">
      ...
      <div class="orderprint">
        ...
        <table class="buyer-info">
          <tr>
            <td class="w200"><?php echo $lang['member_printorder_truename'].$lang['im_colon']; ?><?php echo $output['order_info']['extend_order_common']['reciver_name'];?></td>
            <td><?php echo '电话'.$lang['im_colon']; ?><?php echo @$output['order_info']['extend_order_common']['reciver_info']['phone'];?></td>
            <td></td>
          </tr>
          <tr>
            <td colspan="3"><?php echo $lang['member_printorder_address'].$lang['im_colon']; ?><?php echo @$output['order_info']['extend_order_common']['reciver_info']['address'];?></td>
          </tr>
          <tr>
            <td><?php echo $lang['member_printorder_orderno'].$lang['im_colon'];?><?php echo $output['order_info']['order_sn'];?></td>
            <td><?php echo $lang['member_printorder_orderadddate'].$lang['im_colon'];?><?php echo @date('Y-m-d',$output['order_info']['add_time']);?></td>
            <td><?php if ($output['order_info']['shippin_code']){?>
              <span><?php echo $lang['member_printorder_shippingcode'].$lang['im_colon']; ?><?php echo $output['order_info']['shipping_code'];?></span>
              <?php }?></td>
          </tr>
        </table>
        <table class="order-info">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="tl"><?php echo $lang['currency'].imPriceFormat($v['goods_price']);?></td>
          ...
          <tfoot>
            <tr>
              <th colspan="10"><span><?php echo $lang['member_printorder_totle'].$lang['im_colon'];?><?php echo $lang['currency'].$output['goods_total_price'];?></span><span><?php echo $lang['member_printorder_freight'].$lang['im_colon'];?><?php echo $lang['currency'].$output['order_info']['shipping_fee'];?></span><span><?php echo $lang['member_printorder_privilege'].$lang['im_colon'];?><?php echo $lang['currency'].$output['promotion_amount'];?></span><span><?php echo $lang['member_printorder_orderamount'].$lang['im_colon'];?><?php echo $lang['currency'].$output['order_info']['order_amount'];?></span><span><?php echo $lang['member_printorder_shop'].$lang['im_colon'];?><?php echo $output['store_info']['store_name'];?></span>
                ...
                <span><?php echo $lang['member_printorder_shopww'].$lang['im_colon'];?><?php echo $output['store_info']['store_ww'];?></span>
                <?php }?></th>
            </tr>
          </tfoot>
        </table>
