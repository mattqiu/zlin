...
<form method="post" id="goods_gift" action="<?php echo urlShop('supplier_goods_online', 'save_gift');?>">
  ...
  <div class="ncsc-form-goods-gift" data-gid="<?php echo $value['goods_id'];?>">
    ...
    <div class="goods-summary">
      ...
      <dl>
        <dt>商品价格：</dt>
        <dd>￥<?php echo imPriceFormat($value['goods_price']);?></dd>
      </dl>
      <dl>
        <dt>库&nbsp;&nbsp;存&nbsp;&nbsp;量：</dt>
...
$(function(){
    ...
    $('a[nctype="search_gift"]').click(function(){
        _url = "<?php echo urlShop('supplier_goods_online', 'search_goods');?>";
