...
<div class="ncsc-form-default">
  <form id="add_form" action="<?php echo urlShop('supplier_account_group', 'group_save');?>" method="post">
    ...
    <dl id="function_list">
      <dt><i class="required">*</i>基本权限<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl id="goods_class_panel">
      <dt><i class="required"></i>商品分类权限<?php echo $lang['im_colon'];?></dt>
      <dd>
        <div class="ncsc-account-all">
    ...
    <div class="bottom">
      <label class="submit-border">
        <input type="button" id="group_submit" class="submit" value="<?php echo $lang['im_submit'];?>设置">
      </label>
    </div>
  </form>
</div>
