  ...
  <thead>
    ...
    <tr>
      ...
      <td colspan="20"><label for="all" ><?php echo $lang['im_select_all'];?></label>
        <a href="javascript:void(0);" class="ncbtn-mini" im_type="batchbutton" uri="index.php?act=store_promotion_bundling&op=drop_bundling" name="bundling_id" confirm="<?php echo $lang['im_ensure_del'];?>"><i class="icon-trash"></i><?php echo $lang['im_del'];?></a></td>
    </tr>
  </thead>
  ...
  <tbody>
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="index.php?act=store_promotion_bundling&op=bundling_add&bundling_id=<?php echo $val['bl_id'];?>" class="btn-bluejeans"><i class="icon-cog"></i>
        ...
        </a></span> <span><a class="btn-grapefruit" href='javascript:void(0);' onclick="ajax_get_confirm('<?php echo $lang['im_ensure_del'];?>', '<?php echo urlShop('store_promotion_bundling', 'drop_bundling', array('bundling_id' => $val['bl_id']));?>');"><i class="icon-trash"></i>
  ...
  <tfoot>
    <tr>
      ...
      <th colspan="20"><label for="all" ><?php echo $lang['im_select_all'];?></label>
        <a href="javascript:void(0);" class="ncbtn-mini" im_type="batchbutton" uri="index.php?act=store_promotion_bundling&op=drop_bundling" name="bundling_id" confirm="<?php echo $lang['im_ensure_del'];?>"><i class="icon-trash"></i><?php echo $lang['im_del'];?></a></th>
    </tr>
    <tr>
