...
<div class="tabmenu">
  ...
  <a class="ncbtn ncbtn-mint" im_type="dialog" dialog_title="添加地址" dialog_id="add_map" dialog_width="480" uri="<?php echo urlShop('supplier_map', 'add_map');?>"><i class="icon-plus-sign"></i>添加地址</a>
  <?php } ?>
</div>
...
<script type="text/javascript">
	...
	function getMarkerPoint(e){//拖拽结束时通过点找到地区
	    ...
	    getPointArea(point,function(pointArea){
    		...
    		$.ajax({
    			type: "POST",
    			url: 'index.php?act=supplier_map&op=update_map',
    			data: obj,
    			async: false,
    		    success: function(rs){
    		    }
