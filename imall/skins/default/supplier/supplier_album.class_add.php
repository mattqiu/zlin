...
<div class="eject_con">
  ...
  <form id="category_form" method="post" target="_parent" action="index.php?act=supplier_album&op=album_add_save">
    ...
    $('#category_form').validate({
        ...
        rules : {
        	name : {
                ...
                maxlength	: 20,
                remote   : {
                    url :'index.php?act=supplier_album&op=ajax_check_class_name&column=ok',
                    type:'get',
                    data:{
                        ac_name : function(){
                            return $('#name').val();
