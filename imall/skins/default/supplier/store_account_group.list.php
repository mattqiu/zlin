...
<div class="tabmenu">
  ...
  <a href="javascript:void(0)" class="ncbtn ncbtn-mint" onclick="go('index.php?act=supplier_account_group&op=group_add');" title="添加账号"><i class="icon-group"></i>添加组</a> </div>
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="<?php echo urlShop('supplier_account_group', 'group_edit', array('group_id' => $value['group_id']));?>" class="btn-bluejeans"><i class="icon-edit"></i>
...
<form id="del_form" method="post" action="<?php echo urlShop('supplier_account_group', 'group_del');?>">
