...
<div class="goods-gallery" nctype="gallery-<?php echo $output['color_id'];?>"> <a class="sample_demo" href="index.php?act=store_album&op=pic_list&item=goods_image&color_id=<?php echo $output['color_id'];?>" style="display:none;"><?php echo $lang['im_submit'];?></a>
