...
<head>
<script>
var SITEURL = '<?php echo SHOP_SITE_URL;?>'; var SHOP_SKINS_URL = '<?php echo SHOP_SKINS_URL?>';
</script>
...
<div class="eject_con">
  ...
  <form method="post" action="<?php echo urlShop('supplier_goods_online', 'edit_body_ajax');?>" onsubmit="ajaxpost('body_form', '', '', 'onerror')" id="body_form">
