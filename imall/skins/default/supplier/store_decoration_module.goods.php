...
<ul class="goods-list">
  ...
  <li nctype="goods_item" data-goods-id="<?php echo $val['goods_id'];?>" data-goods-name="<?php echo $val['goods_name'];?>" data-goods-price="<?php echo imPriceFormat($val['goods_price']);?>"  data-goods-image="<?php echo $val['goods_image'];?>">
    ...
    <dl class="goods-info">
      ...
      <dd><?php echo $lang['currency'].imPriceFormat($val['goods_price']);?></dd>
    </dl>
