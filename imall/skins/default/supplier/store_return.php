...
<form method="get" action="index.php">
  <input type="hidden" name="act" value="supplier_return" />
...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line" >
        ...
        <dd><?php echo $lang['refund_order_ordersn'].$lang['im_colon'];?><a href="index.php?act=supplier_order&op=show_order&order_id=<?php echo $val['order_id']; ?>" target="_blank"><?php echo $val['order_sn'];?></a></dd>
        <dd><?php echo $lang['return_order_returnsn'].$lang['im_colon'];?><?php echo $val['refund_sn']; ?></dd></dl></td>
      ...
      <td class="nscs-table-handle">
        ...
        <span><a href="index.php?act=supplier_return&op=edit&return_id=<?php echo $val['refund_id']; ?>" class="btn-bluejeans"><i class="icon-edit"></i><p>处理</p></a></span>
        <?php } else { ?>
       <span> <a href="index.php?act=supplier_return&op=view&return_id=<?php echo $val['refund_id']; ?>" class="btn-bittersweet"><i class="icon-eye-open"></i><p><?php echo $lang['im_view'];?></p></a></span>
        <?php } ?>
        <?php if ($val['seller_state'] == 2 && $val['return_type'] == 2 && $val['goods_state'] == 2) { ?>
        <span><a href="javascript:void(0)" class="btn-mint" im_type="dialog" dialog_title="<?php echo $lang['im_edit'];?>" dialog_id="return_order" dialog_width="480" uri="index.php?act=supplier_return&op=receive&return_id=<?php echo $val['refund_id']; ?>"><i class="icon-check-sign"></i><p><?php echo '收货';?></p></a></span>
        <?php } ?>
        </td>
    </tr>
    <?php } ?>
