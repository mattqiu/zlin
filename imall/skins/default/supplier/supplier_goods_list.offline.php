...
<form method="get" action="index.php">
  <table class="search-form">
    <input type="hidden" name="act" value="supplier_goods_offline" />
  ...
  <thead>
    ...
    <tr>
      ...
      <td colspan="10"><label for="all"><?php echo $lang['im_select_all'];?></label>
        <a href="javascript:void(0);" class="ncbtn-mini" im_type="batchbutton" uri="<?php echo urlShop('supplier_goods_online', 'drop_goods');?>" name="commonid" confirm="<?php echo $lang['im_ensure_del'];?>"><i class="icon-trash"></i><?php echo $lang['im_del'];?></a> <a href="javascript:void(0);" class="ncbtn-mini" im_type="batchbutton" uri="<?php echo urlShop('supplier_goods_offline', 'goods_show');?>" name="commonid"><i class="icon-level-up"></i><?php echo $lang['supplier_goods_index_show'];?></a>
    </tr>
    <?php } ?>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td><a href="javascript:void(0)" onclick="ajax_get_confirm('','<?php echo urlShop('supplier_goods_offline', 'goods_show', array('commonid' => $val['goods_commonid']));?>')" class="ncbtn"><?php echo $lang['store_goods_index_show'];?></a></td>
  ...
  <tfoot>
    <tr>
      ...
      <th colspan="10"><label for="all2"><?php echo $lang['im_select_all'];?></label>
        <a href="javascript:void(0);" class="ncbtn-mini" im_type="batchbutton" uri="<?php echo urlShop('supplier_goods_online', 'drop_goods');?>" name="commonid" confirm="<?php echo $lang['im_ensure_del'];?>"><i class="icon-trash"></i><?php echo $lang['im_del'];?></a> <a href="javascript:void(0);" class="ncbtn-mini" im_type="batchbutton" uri="<?php echo urlShop('supplier_goods_offline', 'goods_show');?>" name="commonid"><i class="icon-level-up"></i><?php echo $lang['store_goods_index_show'];?></a></th>
    </tr>
    <tr>
