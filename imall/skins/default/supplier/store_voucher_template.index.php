	...
	<table class="search-form">
		...
		<tr>
			...
			<td class="w120"><select class="w80" name="select_state">
					<option value="0"
						<?php if (!$_GET['select_state'] == '0'){ echo 'selected=true';}?>><?php echo $lang['im_please_choose'];?></option>
			...
			<td class="w120"><select class="w80" name="gettype_sel">
					<option value=""
						<?php if (!$_GET['gettype_sel']){ echo 'selected=true';}?>><?php echo $lang['im_please_choose'];?></option>
			...
			<td class="tc w70"><label class="submit-border"><input type="submit"
					class="submit" value="<?php echo $lang['im_search'];?>" /></label></td>
...
<table class="ncsc-default-table">
	...
	<tbody>
      ...
      <tr class="bd-line">
        	...
        	<span> <a class="btn-grapefruit" href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['im_ensure_del'];?>','index.php?act=store_voucher&op=templatedel&tid=<?php echo $val['voucher_t_id'];?>');"><i class="icon-trash"></i><p>删除</p></a></span>
        	<?php }?>
        </td>
		</tr>
      <?php }?>
