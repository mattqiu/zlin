...
<![endif]-->
<script src="<?php echo SHOP_RESOURCE_SITE_URL;?>/js/supplier_goods_add.step2.js"></script>
...
<div class="alert alert-block mt10">
  <ul class="mt5">
    <li>1、商品基本信息中*号标注的字样为必填项</li>
    <li>2、商品详细信息描述，商品运费设置，发票信息，其他信息不填则为默认配置</li>
    <li>3、如果点击下一步无响应，请确认是否填入信息有误</li>
  </ul>
</div>
<?php }?>
<div class="item-publish">
  <form method="post" id="goods_form" action="<?php if ($output['edit_goods_sign']) { echo urlShop('supplier_goods_online', 'edit_save_goods');} else { echo urlShop('supplier_goods_add', 'save_goods');}?>">
    ...
    <input type="hidden" name="is_market" value="1" />
    <div class="ncsc-form-goods">
      <!-- <h3 id="demo1"><?php echo $lang['store_goods_index_goods_base_info']?></h3> -->
      <div class="tabmenu">
        <ul id="biaoqian" class="tab pngFix">
          <li class="active">
            <a href="javascript:void(0);" msg="basic"><?php echo $lang['store_goods_index_goods_base_info']?></a>
          </li>
          <li class="normal">
            <a href="javascript:void(0);" msg="detail">商品详细描述</a>
          </li>
          <li class="normal">
            <a href="javascript:void(0);" msg="logistics">商品运费设置</a>
          </li>
          <li class="normal">
            <a href="javascript:void(0);" msg="invoice">发票信息</a>
          </li>
          <li class="normal">
            <a href="javascript:void(0);" msg="other">其他信息</a>
          </li>
        </ul>
       </div>
       <div id="basic">
	      <dl>
	        ...
	        <dd id="gcategory"> <?php echo $output['goods_class']['gc_tag_name'];?> <a class="ncbtn" href="<?php if ($output['edit_goods_sign']) { echo urlShop('store_goods_online', 'edit_class', array('commonid' => $output['goods']['goods_commonid'], 'ref_url' => getReferer())); } else { echo urlShop('store_goods_add', 'add_step_one'); }?>"><?php echo $lang['im_edit'];?></a>
	      ...
	      <dl>
	        ...
	        <dd im_type="no_spec">
	          <input name="g_price" value="<?php echo imPriceFormat($output['goods']['goods_price']); ?>" type="text"  class="text w60" /><em class="add-on"><i class="icon-renminbi"></i></em> <span></span>
	      ...
	      <dl>
	        ...
	        <dd>
	          <input name="g_marketprice" value="<?php echo imPriceFormat($output['goods']['goods_marketprice']); ?>" type="text" class="text w60" /><em class="add-on"><i class="icon-renminbi"></i></em> <span></span>
	          <p class="hint"><?php echo $lang['store_goods_index_store_price_help'];?>，此价格仅为市场参考售价，请根据该实际情况认真填写。</p>
	        </dd>
	      </dl>
	      <dl>
	        <dt>供货价<?php echo $lang['im_colon'];?></dt>
	        <dd>
	          <input name="g_costprice" value="<?php echo imPriceFormat($output['goods']['goods_costprice']); ?>" type="text" class="text w60" /><em class="add-on"><i class="icon-renminbi"></i></em> <span></span>
	          <p class="hint">价格必须是0.00~9999999之间的数字，此价格为商户对所销售的商品实际供货价格进行备注记录，非必填选项，不会在前台销售页面中显示。</p>
	        </dd>
	      </dl>
	      <dl>
	      ...
	      <dl im_type="spec_group_dl_<?php echo $i;?>" nctype="spec_group_dl" class="spec-bg" <?php if($k == '1'){?>spec_img="t"<?php }?>>
	        <dt>
	      ...
	      <?php }?>
	      <?php }?>
	      <dl im_type="spec_dl" class="spec-bg" style="display:none; overflow: visible;">
	          ...
	          <div class="ncsc-goods-default-pic">
	            <div class="goodspic-uplaod">
	              ...
	              <div class="handle">
	                ...
	                <a class="ncbtn mt5" nctype="show_image" href="<?php echo urlShop('supplier_album', 'pic_list', array('item'=>'goods'));?>"><i class="icon-picture"></i>从图片空间选择</a> <a href="javascript:void(0);" nctype="del_goods_demo" class="ncbtn mt5" style="display: none;"><i class="icon-circle-arrow-up"></i>关闭相册</a></div>
	            </div>
	          </div>
	          <div id="demo"></div>
	        </dd>
	     ...
	     <div id="detail" style="display:none">
	      ...
	      <dl>
	        ...
	        <dd>
	          ...
	          <select name="" attr="attr[<?php echo $k;?>][__NC__]" im_type="attr_select">
	          ...
	          <div class="tabs">
	            ...
	            <div id="panel-1" class="ui-tabs-panel">
	              ...
	              <div class="hr8">
	                ...
	                <a class="ncbtn mt5" nctype="show_desc" href="index.php?act=supplier_album&op=pic_list&item=des"><i class="icon-picture"></i><?php echo $lang['store_goods_album_insert_users_photo'];?></a> <a href="javascript:void(0);" nctype="del_desc" class="ncbtn mt5" style="display: none;"><i class=" icon-circle-arrow-up"></i>关闭相册</a> </div>
	              <p id="des_demo"></p>
	            </div>
	          ...
	          <ul class="ncsc-form-radio-list">
	            <li>
	              ...
	              <div nctype="div_freight" <?php if (intval($output['goods']['transport_id']) != 0) {?>style="display: none;"<?php }?>>
	                <input id="g_freight" class="w50 text" im_type='transport' type="text" value="<?php printf('%.2f', floatval($output['goods']['goods_freight']));?>" name="g_freight"><em class="add-on"><i class="icon-renminbi"></i></em> </div>
	            </li>
	            <li>
...
$(function(){
	$("#biaoqian > li").click(function(){
       if($(this).attr('class') == 'normal'){
         var id = $(this).children("a").attr('msg');
    ...
    $('#goods_form').validate({
        ...
        messages : {
            ...
            g_price : {
                ...
                checkPrice  : '<i class="icon-exclamation-sign"></i>商品价格不能高于吊牌价格'
            },
            g_marketprice : {
                required    : '<i class="icon-exclamation-sign"></i>请填写吊牌价',
                ...
                checkPrice  : '<i class="icon-exclamation-sign"></i>吊牌价格不能低于商品价格'
            },
            g_costprice : {
                number      : '<i class="icon-exclamation-sign"></i>请填写正确的价格',
...
function recursionSpec($len,$sign) {
    if($len < $sign){
        ...
        echo "str +='<td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][marketprice]\" data_type=\"marketprice\" im_type=\"'+spec_bunch+'|marketprice\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em></td>' +
                    '<td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][price]\" data_type=\"price\" im_type=\"'+spec_bunch+'|price\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em></td>' +
                    '<td><input class=\"text stock\" type=\"text\" name=\"spec['+spec_bunch+'][stock]\" data_type=\"stock\" im_type=\"'+spec_bunch+'|stock\" value=\"\" /></td>' +
                    '<td><input class=\"text stock\" type=\"text\" name=\"spec['+spec_bunch+'][alarm]\" data_type=\"alarm\" im_type=\"'+spec_bunch+'|alarm\" value=\"\" /></td>' +
                    '<td><input class=\"text sku\" type=\"text\" name=\"spec['+spec_bunch+'][sku]\" im_type=\"'+spec_bunch+'|sku\" value=\"\" /></td>' +
                    '<td><input class=\"text sku\" type=\"text\" name=\"spec['+spec_bunch+'][barcode]\" im_type=\"'+spec_bunch+'|barcode\" value=\"\" /></td>' +
                    '</tr>';\n";
        for($i=0; $i< $len; $i++){
            echo "}\n";
        }
