...
<table class="ncsc-default-table" >
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="javascript:void(0);" dialog_id="my_address_edit" dialog_width="640" dialog_title="<?php echo $lang['store_daddress_edit_address'];?>" im_type="dialog" uri="index.php?act=store_deliver_set&op=daddress_add&address_id=<?php echo $address['address_id'];?>" class="btn-bluejeans"><i class="icon-edit"></i>
        <p><?php echo $lang['im_edit'];?></p>
        </a></span><span> <a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['im_ensure_del'];?>', 'index.php?act=store_deliver_set&op=daddress_del&address_id=<?php echo $address['address_id'];?>');" class="btn-grapefruit"><i class="icon-trash"></i>
