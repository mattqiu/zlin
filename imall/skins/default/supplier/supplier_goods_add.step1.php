...
<div class="wrapper_search">
        ...
        <div class="text" id="commSelect">
            ...
            <div class="select_list" id="commListArea">
              <ul>
                ...
                <li  data-param="{stapleid:<?php echo $val['staple_id']?>}"><span nctype="staple_name"><?php echo $val['staple_name']?></span><a href="JavaScript:void(0);" nctype="del-comm-cate" title="<?php echo $lang['im_delete'];?>">X</a></li>
                <?php }?>
                <?php }?>
  ...
  <div class="wp_confirm">
    <form method="get">
      ...
      <?php } else {?>
      <input type="hidden" name="act" value="supplier_goods_add" />
...
<script src="<?php echo SHOP_RESOURCE_SITE_URL;?>/js/supplier_goods_add.step1.js"></script> 
<script>
