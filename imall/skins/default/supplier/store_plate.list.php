...
<div class="tabmenu">
  ...
  <a href="<?php echo urlShop('supplier_plate', 'plate_add');?>" class="ncbtn ncbtn-mint" title="添加关联版式">添加关联版式</a>
</div>
  ...
  <thead>
    ...
    <tr>
      ...
      <td colspan="10"><label for="all" ><?php echo $lang['im_select_all'];?></label>
        <a href="javascript:void(0);" im_type="batchbutton" uri="<?php echo urlShop('supplier_plate', 'drop_plate');?>" name="p_id" confirm="<?php echo $lang['im_ensure_del'];?>" class="ncbtn-mini"><i class="icon-trash"></i><?php echo $lang['im_del'];?></a>
      </td>
    </tr>
    <?php } ?>
  </thead>
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle">
        <span><a href="<?php echo urlShop('supplier_plate', 'plate_edit', array('p_id' => $val['plate_id']));?>" class="btn-bluejeans"><i class="icon-edit"></i><p><?php echo $lang['im_edit'];?></p></a></span>
        <span><a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['im_ensure_del'];?>', '<?php echo urlShop('supplier_plate', 'drop_plate', array('p_id' => $val['plate_id']));?>');" class="btn-grapefruit"><i class="icon-trash"></i><p><?php echo $lang['im_del'];?></p></a></span>
      </td>
    </tr>
    <?php } ?>
    <?php } else { ?>
