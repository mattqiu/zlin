...
.bill_alert {
  ...
  <div class="bill_alert bill-alert-block mt10">
    ...
    <ul>
      ...
      <li>本期应收：<?php echo imPriceFormat($output['bill_info']['ob_result_totals']);?> = <?php echo imPriceFormat($output['bill_info']['ob_order_totals']);?> (消费金额) - <?php echo imPriceFormat($output['bill_info']['ob_commis_totals']);?> (佣金金额)</li>
