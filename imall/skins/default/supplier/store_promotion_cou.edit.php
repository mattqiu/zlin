...
<div class="ncsc-form-default">
  <form id="add_form" action="index.php?act=store_promotion_cou&op=cou_edit_save" method="post">
    ...
    <dl>
      <dt><i class="required">*</i>活动名称<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>开始时间<?php echo $lang['im_colon'];?></dt>
      <dd><?php echo date('Y-m-d H:i', $info['tstart']); ?></dd>
    </dl>
    <dl>
      <dt>结束时间<?php echo $lang['im_colon'];?></dt>
...
if (empty($g)) continue; ?>
            <tr class="off-shelf" data-product-id="<?php echo $g['goods_id']; ?>">
              ...
              <td class="goods-price w90"><?php echo imPriceFormat($g['goods_price']); ?></td>
...
if (empty($g)) continue; ?>
              <tr class="off-shelf" data-cou-level-selected-sku="<?php echo (string) $k2; ?>" data-level="<?php echo (string) $k; ?>">
                ...
                <td class="tl"><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $g['goods_id'], )); ?>"> <?php echo $g['goods_name']; ?> </a></td>
                <td class="goods-price w90" nctype="bundling_data_price"><s> <?php echo imPriceFormat($g['goods_price']); ?> </s></td>
                <td class="w90"><input type="text" class="w50" name="cou_level[<?php echo (string) $k; ?>][skus][<?php echo (string) $k2; ?>]" value="<?php echo $v2['price']; ?>" data-max-price="<?php echo imPriceFormat($g['goods_price']); ?>" /></td>
