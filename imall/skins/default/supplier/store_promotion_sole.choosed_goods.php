  ...
  <form id="choosed_goods_form" action="<?php echo urlShop('store_promotion_sole', 'choosed_goods_save');?>" method="post" >
    ...
    <div class="selected-goods-info">
      ...
      <dl class="goods-info">
        ...
        <dd>实际售价：<strong class="red"><?php echo $lang['currency']; ?><?php echo imPriceFormat($output['goods_info']['goods_promotion_price']);?></strong></dd>
    ...
    <dl>
      <dt>专享价格：</dt>
      <dd>
        <input name="sole_price" type="text" class="text w70" value="<?php echo imPriceFormat($output['solegoods_info']['sole_price']);?>">
        <em class="add-on"><i class="icon-renminbi"></i></em>
        <p class="hint">移动端的专享价格，销售价格要小于商品的实际销售价格。当前商品实际售价为(<?php echo $lang['currency']; ?><?php echo imPriceFormat($output['goods_info']['goods_promotion_price']);?>)</p>
      </dd>
    </dl>
    <div class="eject_con">
      <div class="bottom">
