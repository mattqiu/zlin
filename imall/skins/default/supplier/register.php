...
<head>
<meta charset="utf-8" />
<title><?php echo $output['setting_config']['site_name']; ?>-供货商注册</title>
...
<link href="<?php echo SHOP_SKINS_URL?>/css/supplier_login.css" rel="stylesheet" type="text/css">
<link href="<?php echo SHOP_SKINS_URL?>/css/supplier_header.css" rel="stylesheet" type="text/css">
    ...
    <header class="public-head-layout wrapper">
        ...
        <div class="nc-regist-now">
      		<span class="avatar"><img src="<?php echo UPLOAD_SITE_URL;?>/shop/common/default_user_portrait.gif"></span>
   			<span>您好，欢迎来到<?php echo $output['setting_config']['site_name']; ?><br>未注册的供货商请注册，或立即 
        		<a title="" href="<?php echo urlShop('supplier_login','index');?>" class="register">登录</a>
     		</span>
 		</div>
    </header>
</div>
<div style="width:1000px; margin:0px auto">
	...
	<div class="ncsc-login-container" style="background: #fff;height:auto; padding-bottom:30px; float:right; margin-top:60px;border-bottom:#F39800 1px solid; border-top:#F39800 solid 6px;">
	  <div class="ncsc-login-title">
	    <h2 style="text-align:right; color:#F39800; width:320px">供货商注册</h2>
	    
	  </div>
	  <form id="form_login" action="index.php?act=supplier_register&op=register" method="post" >
	    ...
	    <div class="input">
            <label>确认密码</label>
            <span class="repuired"></span>
            <input name="confirm_pwd" type="password" autocomplete="off" class="text">
            <span class="ico"><i class="icon-key"></i></span> </div>
        <div class="input">
            <label>邮箱</label>
            <span class="repuired"></span>
            <input name="supplier_email" type="text" autocomplete="off" class="text">
            <span class="ico"><i class="icon-key"></i></span> </div>
	    <div class="input">
	      <label>验证码</label>
	      <span class="repuired"></span>
	    ...
	    <div class="input" style="width:320px;height:auto">
        	<input type="submit" class="login-submit" value="确认注册">
        </div>
	  </form>
	</div>
	<div style="clear:both"></div>
