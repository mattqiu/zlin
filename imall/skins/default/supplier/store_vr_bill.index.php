  ...
  <table class="search-form">
    ...
    <tr>
      ...
      <td class="w70 tc"><label class="submit-border">
          <input type="submit" class="submit" value="<?php echo $lang['im_common_search'];?>" />
        </label></td>
    </tr>
  </table>
</form>
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td><?php echo imPriceFormat($bill_info['ob_result_totals']);?></td>
      ...
      <td><a href="index.php?act=store_vr_bill&op=show_bill&ob_id=<?php echo $bill_info['ob_id'];?>"><?php echo $lang['im_view'];?></a></td>
    </tr>
    <?php }?>
    <?php } else { ?>
    <tr>
