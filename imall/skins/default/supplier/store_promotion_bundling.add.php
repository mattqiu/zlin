          ...
          <table class="ncsc-default-table mb15">
            ...
            <tbody nctype="bundling_data"  class="bd-line tip" title="<?php echo $lang['bundling_add_goods_explain'];?>">
              ...
              <tr id="bundling_tr_<?php echo $val['goods_id']?>" class="off-shelf">
                ...
                <td class="goods-price w90" nctype="bundling_data_price"><?php echo imPriceFormat($output['goods_list'][$val['goods_id']]['goods_price']);?></td>
                <td class="w90"><?php echo $val['goods_store_price'];?>
                  <input nctype="price" type="text" value="<?php echo imPriceFormat($val['bl_goods_price']);?>" name="goods[<?php echo $val['goods_id'];?>][price]" class="text w70"></td>
