      ...
      <div class="orderprint">
        ...
        <table class="buyer-info">
          <tr>
            ...
            <td><?php echo '电话'.$lang['im_colon']; ?><?php echo @$item_v['extend_order_common']['reciver_info']['phone'];?></td>
            <td></td>
          </tr>
          <tr>
            <td colspan="3">地址<?php echo $lang['im_colon']; ?><?php echo @$item_v['extend_order_common']['reciver_info']['address'];?></td>
          </tr>
          <tr>
            <td>订单号<?php echo $lang['im_colon'];?><?php echo $item_v['order_sn'];?></td>
            <td>下单时间<?php echo $lang['im_colon'];?><?php echo @date('Y-m-d',$item_v['add_time']);?></td>
			
            <td><?php if ($item_v['shippin_code']){?>
              <span><?php echo $lang['member_printorder_shippingcode'].$lang['im_colon']; ?><?php echo $item_v['shipping_code'];?></span>
              <?php }?></td>
          </tr>
        </table>
        ...
        <table class="order-info">
          ...
          <tfoot>
            <tr>
              <th colspan="10"><span><?php echo $lang['member_printorder_totle'].$lang['im_colon'];?><?php echo $lang['currency'].$item_v['goods_total_price'];?></span><span><?php echo $lang['member_printorder_freight'].$lang['im_colon'];?><?php echo $lang['currency'].$item_v['shipping_fee'];?></span><span><?php echo $lang['member_printorder_privilege'].$lang['im_colon'];?><?php echo $lang['currency'].$item_v['promotion_amount'];?></span><span><?php echo $lang['member_printorder_orderamount'].$lang['im_colon'];?><?php echo $lang['currency'].$item_v['order_amount'];?></span><span><?php echo $lang['member_printorder_shop'].$lang['im_colon'];?><?php echo $item_v['store_info']['store_name'];?></span>
                ...
                <span><?php echo $lang['member_printorder_shopww'].$lang['im_colon'];?><?php echo $item_v['store_info']['store_ww'];?></span>
                <?php }?></th>
            </tr>
          </tfoot>
        </table>
