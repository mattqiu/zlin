    ...
    <dl nctype="pre">
      ...
      <dd>
        ...
        <div class="ncs-message-list"><span class="name tip" title="<?php echo $lang['store_callcenter_name_title'];?>">
          ...
          </span><span class="del"><a nctype="del" href="javascript:void(0);" class="ncbtn"><i class="icon-trash"></i><?php echo $lang['im_delete'];?></a></span></div>
        <?php }else{?>
    ...
    <dl nctype="after" >
      ...
      <dd>
        ...
        <div class="ncs-message-list"><span class="name tip" title="<?php echo $lang['store_callcenter_name_title'];?>">
          ...
          </span><span><a nctype="del" href="javascript:void(0);" class="ncbtn"><i class="icon-trash"></i><?php echo $lang['im_delete'];?></a></span> </div>
        <?php }else{?>
...
function add_service(param){
	...
	add_html += '<span class="del"><a nctype="del" href="javascript:void(0);" class="ncbtn"><i class="icon-trash"></i><?php echo $lang['im_delete'];?></a></span>';
	add_html += '</div>';
	obj.before(add_html);
	titleTip();
}
