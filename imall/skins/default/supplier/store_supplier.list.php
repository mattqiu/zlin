...
<div class="tabmenu">
    ...
    <a href="javascript:void(0)" class="ncbtn ncbtn-mint" im_type="dialog" dialog_title="新增供货商" dialog_id="my_goods_brand_apply" dialog_width="480" uri="index.php?act=store_supplier&op=sup_add">新增供货商</a>
</div>
...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
     ...
     <span><a href="javascript:void(0)" class="btn-bluejeans" im_type="dialog" dialog_title="编辑供货商" dialog_id="sup_edit" dialog_width="480" uri="index.php?act=store_supplier&op=sup_add&sup_id=<?php echo $value['sup_id']; ?>"><i class="icon-edit"></i><p><?php echo $lang['im_edit'];?></p></a></span>
        <span><a href="javascript:void(0)" class="btn-grapefruit" onclick="ajax_get_confirm('<?php echo $lang['im_ensure_del'];?>', 'index.php?act=store_supplier&op=sup_del&sup_id=<?php echo $value['sup_id']; ?>');"><i class="icon-trash"></i><p><?php echo $lang['im_del'];?></p></a></span></td>
    </tr>
    <?php }?>
    <?php }else{?>
    <tr>
