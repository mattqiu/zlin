...
<form id="pay_form" method="post" enctype="multipart/form-data" action="index.php?act=store_contract&op=applypay">
		...
		<dd>
			...
			<div class="ncsc-upload-btn">
				<a href="javascript:void(0);">
					<span><input type="file" hidefocus="true" size="1" class="input-file" name="costimg" id="costimg" im_type="costimg"/></span>
	...
	<div class="bottom">
		<label class="submit-border">
			<a id='submitbtn' class="submit" href="javascript:void(0);"><?php echo $lang['im_submit'];?></a>
		</label>
	</div>
</form>
</div>
