...
<div class="ncsc-form-default">
  <form id="add_form" action="index.php?act=store_groupbuy&op=groupbuy_save&vr=1" method="post" enctype="multipart/form-data">
    ...
    <dl>
      <dt>团购副标题<?php echo $lang['im_colon'];?></dt>
      <dd>
...
<?php } ?>
      ...
      <div id="div_search_goods" class="div-goods-select mt10" style="display: none;">
          <table class="search-form">
              <tr>
                  ...
                  <td class="w70 tc">
                      <a href="javascript:void(0);" id="btn_search_goods" class="ncbtn"/><i class="icon-search"></i><?php echo $lang['im_search'];?></a></td>
                    <td class="w10"></td>
                    <td>
    ...
    <dl>
      <dt><i class="required">*</i>团购活动图片<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>团购推荐位图片<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>团购分类<?php echo $lang['im_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>团购区域<?php echo $lang['im_colon'];?></dt>
      <dd>
