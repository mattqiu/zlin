...
<?php }?>
<form method="post" id="goods_image" action="<?php if ($output['edit_goods_sign']) { echo urlShop('supplier_goods_online', 'edit_save_image'); } else { echo urlShop('supplier_goods_add', 'save_image');}?>">
...
<script type="text/javascript" src="<?php echo SHOP_RESOURCE_SITE_URL;?>/js/supplier_goods_add.step3.js" charset="utf-8"></script>
<script>
