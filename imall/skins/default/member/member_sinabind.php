  ...
  <div class="imm-bind">
    ...
    <div class="revise imm-default-form ">
      <form method="post" id="editpw_form" name="editpw_form" action="index.php?act=member_connect&op=sinaunbind">
        ...
        <dl>
          <dt><?php echo $lang['member_sconnect_modpw_newpw'].$lang['im_colon']; ?></dt>
          <dd>
        ...
        <dl>
          <dt><?php echo $lang['member_sconnect_modpw_two_password'].$lang['im_colon']; ?></dt>
          <dd>
    ...
    <div class="relieve pt50">
      <p class="ico"><a href="<?php echo SHOP_SITE_URL;?>/api.php?act=tosina"><img src="<?php echo SHOP_SKINS_URL;?>/images/sina_bind_small.gif"></a></p>
...
$(function(){
    ...
    $('#editpw_form').validate({
        ...
        messages : {
            new_password  : {
                required   : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['member_sconnect_new_password_null'];?>',
                minlength  : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['member_sconnect_password_range'];?>'
            },
            confirm_password : {
                required   : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['member_sconnect_ensure_password_null'];?>',
                equalTo    : '<i class="fa fa-exclamation-circle"></i><?php echo $lang['member_sconnect_input_two_password_again'];?>'
            }
        }
    });
});
