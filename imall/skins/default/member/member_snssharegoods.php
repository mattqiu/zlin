...
<div class="dialog-share">
  <form method="post" action="index.php?act=member_snsindex&op=sharegoods<?php if($_GET['irefresh'] == 1){?>&irefresh=1<?php }?>" id="sharegoods_form">
    ...
    <div id="sg_seccode" class="seccode">
      ...
      <img src="" title="<?php echo $lang['wrong_checkcode_change'];?>" name="codeimage" border="0" onclick="this.src='index.php?act=seccode&op=makecode&imhash=<?php echo $output['imhash'];?>&t=' + Math.random()"/> <span><?php echo $lang['wrong_seccode'];?></span>
