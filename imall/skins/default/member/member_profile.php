  ...
  <div class="imm-user-profile">
    ...
    <div class="imm-default-form fr">
      <form method="post" id="profile_form" action="index.php?act=member_information&op=member">
        ...
        <dl>
          <dt><?php echo $lang['home_member_username'].$lang['im_colon'];?></dt>
          <dd>
        ...
        <dl>
          <dt><?php echo $lang['home_member_email'].$lang['im_colon'];?></dt>
        ...
        <dl>
          <dt><?php echo $lang['home_member_truename'].$lang['im_colon'];?></dt>
          <dd><span class="w400">
        ...
        <dl>
          <dt><?php echo $lang['home_member_sex'].$lang['im_colon'];?></dt>
          <dd><span class="w400">
            <label>
        ...
        <dl>
          <dt><?php echo $lang['home_member_birthday'].$lang['im_colon'];?></dt>
          <dd><span class="w400">
        ...
        <dl>
          <dt><?php echo $lang['home_member_areainfo'].$lang['im_colon'];?></dt>
          <dd><span id="region" class="w400">
            ...
            <input type="button" value="<?php echo $lang['im_edit'];?>" style="background-color: #F5F5F5; width: 60px; height: 32px; border: solid 1px #E7E7E7; cursor: pointer" class="edit_region" />
        ...
        <dl>
          <dt><?php echo $lang['home_member_wangwang'].$lang['im_colon'];?></dt>
          <dd><span class="w400">
