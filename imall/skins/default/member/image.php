...
<?php } ?>
<input id="submit_button" <?php if ($output['act']=='uploadedfile') { ?>style="display:none"<?php } ?> type="button" value="<?php if ($output['act']=='uploadedfile') { ?><?php echo $lang['store_goods_upload_upload'];?><?php } ?><?php if ($output['act']=='remote_image') { ?><?php echo $lang['im_submit'];?><?php } ?>" onclick="submit_form($(this))">
</form>
</body>
</html>