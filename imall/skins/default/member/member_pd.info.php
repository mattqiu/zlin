...
<div class="wrap">
  ...
  <div class="imm-default-form">
    <dl>
      <dt><?php echo $lang['predeposit_rechargesn'].$lang['im_colon'];?></dt>
      <dd><?php echo $output['info']['pdr_sn']; ?></dd>
    </dl>
    <dl>
      <dt><?php echo $lang['predeposit_payment'].$lang['im_colon'];?></dt>
      <dd><?php echo $output['info']['pdr_payment_name']; ?></dd>
    </dl>
    <dl>
      <dt><?php echo $lang['predeposit_recharge_price'].$lang['im_colon'];?></dt>
    ...
    <dl>
      <dt><?php echo $output['info']['pdr_payment_name'].$lang['predeposit_trade_no'].$lang['im_colon'];?></dt>
