...
<div class="wrap">
  ...
  <table class="imm-default-table order">
    ...
    <tbody>
      ...
      <tr>
        <th colspan="20"> <span class="ml10"><?php echo $lang['refund_order_refundsn'].$lang['im_colon'];?><?php echo $val['refund_sn']; ?></span><span><?php echo $lang['refund_buyer_add_time'].$lang['im_colon'];?><?php echo date("Y-m-d H:i:s",$val['add_time']);?></span>
      ...
      <tr class="bd-line" >
        ...
        <td class="tl"><dl class="goods-name">
            ...
            <dd><?php echo $lang['refund_order_ordersn'].$lang['im_colon'];?><a href="index.php?act=member_vr_order&op=show_order&order_id=<?php echo $val['order_id']; ?>" target="_blank"><?php echo $val['order_sn'];?></a></dd>
          </dl></td>
        <td><?php echo $val['refund_amount'];?></td>
        <td><?php echo $output['admin_array'][$val['admin_state']]; ?></td>
        <td class="bdr"><a href="index.php?act=member_vr_refund&op=view&refund_id=<?php echo $val['refund_id']; ?>" class="imm-btn"><?php echo $lang['im_view'];?> </a></td>
      </tr>
      <?php } ?>
    </tbody>
    <tfoot>
