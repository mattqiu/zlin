...
<div class="wrap">
  ...
  <table class="imm-default-table order">
    ...
    <tbody>
      ...
      <tr>
        <th colspan="20"> <span class="fl ml10"><?php echo $lang['return_order_returnsn'].$lang['im_colon'];?><?php echo $val['refund_sn']; ?></span><span><?php echo $lang['refund_buyer_add_time'].$lang['im_colon'];?><?php echo date("Y-m-d H:i:s",$val['add_time']);?></span>
          <!-- store_name -->
      ...
      <tr>
        ...
        <td class="tl"><dl class="goods-name">
            ...
            <dd><?php echo $lang['refund_order_ordersn'].$lang['im_colon'];?><a href="index.php?act=member_order&op=show_order&order_id=<?php echo $val['order_id']; ?>" target="_blank"><?php echo $val['order_sn'];?></a></dd>
          </dl></td>
        ...
        <td class="bdr"><?php if($val['seller_state'] == 2 && $val['return_type'] == 2 && $val['goods_state'] == 1) { ?>
          <p><a href="index.php?act=member_return&op=ship&return_id=<?php echo $val['refund_id']; ?>" class="imm-btn">退货</a></p>
          <?php } else { ?>
          <a href="index.php?act=member_return&op=view&return_id=<?php echo $val['refund_id']; ?>" class="imm-btn">查看</a>
          <?php } ?>
          <?php if($val['seller_state'] == 2 && $val['return_type'] == 2 && $val['goods_state'] == 3) { ?>
          <p><a href="javascript:void(0)" class="imm-btn imm-btn-orange" im_type="dialog" dialog_title="延迟时间" dialog_id="return_delay" dialog_width="480"
