  ...
  <table class="imm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="imm-table-handle"><span><a href="index.php?act=member_inform&op=inform_info&inform_id=<?php echo $val['inform_id']; ?>" class="btn-blue"><i class="fa fa-eye"></i>
          <p><?php echo $lang['im_view'];?></p>
          </a></span>
          <?php if($val['inform_state']==='1') { ?>
          <span><a class="btn-orange" href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['inform_cancel_confirm'];?>', 'index.php?act=member_inform&op=inform_cancel&inform_id=<?php echo $val['inform_id']; ?>');"><i class="fa fa-ban"></i>
          <p><?php echo $lang['im_cancel']; ?></p>
          </a></span>
          <?php } ?></td>
      </tr>
      <?php }?>
