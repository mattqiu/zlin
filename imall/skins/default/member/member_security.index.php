...
<div class="wrap">
  ...
  <div class="imm-security-container">
    ...
    <dl id="password" class="yes">
      ...
      <dd><span class="explain">安全性高的密码可以使账号更安全。建议您定期更换密码，且设置一个包含数字和字母，并长度超过6位以上的密码，为保证您的账户安全，只有在您绑定邮箱或手机后才可以修改密码。</span><span class="handle"><a href="index.php?act=member_security&op=auth&type=modify_pwd" class="imm-btn  imm-btn-orange">修改密码</a></span></dd>
    </dl>
    <dl id="email" class="<?php echo $output['member_info']['member_email_bind'] == 1 ? 'yes' : 'no';?>">
      ...
      <dd><span class="explain">进行邮箱验证后，可用于接收敏感操作的身份验证信息，以及订阅更优惠商品的促销邮件。</span><span class="handle"><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_security&op=auth&type=modify_email" class="imm-btn imm-btn-acidblue bd">绑定邮箱</a><a href="index.php?act=member_security&op=auth&type=modify_email" class="imm-btn imm-btn-orange jc">修改邮箱</a></span></dd>
    </dl>
    <dl id="mobile" class="<?php echo $output['member_info']['member_mobile_bind'] == 1 ? 'yes' : 'no';?>">
      ...
      <dd><span class="explain">进行手机验证后，可用于接收敏感操作的身份验证信息，以及进行积分消费的验证确认，非常有助于保护您的账号和账户财产安全。</span><span class="handle"><a href="index.php?act=member_security&op=auth&type=modify_mobile" class="imm-btn imm-btn-acidblue bd">绑定手机</a><a href="index.php?act=member_security&op=auth&type=modify_mobile" class="imm-btn imm-btn-orange jc">修改手机</a></span></dd>
    </dl>
    <dl id="paypwd" class="<?php echo $output['member_info']['member_paypwd'] != ''  ? 'yes' : 'no';?>">
      ...
      <dd><span class="explain">设置支付密码后，在使用账户中余额时，需输入支付密码。</span><span class="handle"><a href="index.php?act=member_security&op=auth&type=modify_paypwd" class="imm-btn imm-btn-acidblue bd">设置密码</a><a href="index.php?act=member_security&op=auth&type=modify_paypwd" class="imm-btn imm-btn-orange jc">修改密码</a></span></dd>
    </dl>
  </div>
</div>
