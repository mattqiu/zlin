...
<div class="wrap">
  ...
  <div class="imm-default-form">
    <form method="post" id="recharge_form" action="index.php">
      ...
      <dl>
        <dt><i class="required">*</i><?php echo $lang['predeposit_recharge_price'].$lang['im_colon']; ?></dt>
        <dd>
...
$(function(){
	$('#recharge_form').validate({
        ...
        messages : {
        	pdr_amount		: {
            	required  :'<i class="fa fa-exclamation-circle"></i><?php echo $lang['predeposit_recharge_add_pricenull_error']; ?>',
            	number    :'<i class="fa fa-exclamation-circle"></i><?php echo $lang['predeposit_recharge_add_pricemin_error']; ?>',
                min    	  :'<i class="fa fa-exclamation-circle"></i><?php echo $lang['predeposit_recharge_add_pricemin_error']; ?>'
            }
        }
    });
});
