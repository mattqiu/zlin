...
<div class="imm-flow-layout">
  <div class="imm-flow-container">
    ...
    <div id="saleRefund" show_id="1">
      ...
      <h3>我的退款申请</h3>
        <dl>
          <dt><?php echo $lang['refund_order_refundsn'].$lang['im_colon'];?></dt>
        ...
        <dl>
          ...
          <dd>
            ...
            <ul class="imm-evidence-pic">
              ...
              <?php if(!empty($val)){ ?>
              <li><a href="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_PATH.'/refund/'.$val;?>" imtype="nyroModal" rel="gal"> <img class="show_image" src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_PATH.'/refund/'.$val;?>"></a></li>
              <?php } ?>
              <?php } ?>
            </ul>
            <?php } ?>
        ...
        <?php } ?><div class="bottom"><a href="javascript:history.go(-1);" class="imm-btn"><i class="fa fa-reply"></i>返回列表</a></div>
      </div>
    </div>
  </div>
