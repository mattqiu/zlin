...
<div class="imm-oredr-show">
  <div class="imm-order-info">
      ...
      <div class="content">
        <dl>
          ...
          <dd><?php echo $output['order_info']['buyer_phone'];?>
            ...
            <a href="javascript:void(0);" class="imm-btn-mini imm-btn-orange" dialog_id="vr_code_resend" dialog_title="发送电子兑换码" dialog_width="480" im_type="dialog" uri="<?php echo urlShop('member_vr_order', 'resend',array('buyer_phone'=>$output['order_info']['buyer_phone'],'order_id'=>$output['order_info']['order_id']));?>"><i class="fa fa-mobile"></i>重新发送</a>
            <?php } ?>
          </dd>
        </dl>
        <dl class="line">
        ...
        <dl class="line">
          <dt>商&#12288;&#12288;家：</dt>
          <dd><?php echo $output['order_info']['store_name'];?><a href="javascript:void(0);" id="mapmore">更多<i class="fa fa-angle-down"></i>
            <div class="more"><span class="arrow"></span>
              <ul>
    ...
    <div class="imm-order-condition">
      ...
      <ul>
        <li>1. 您尚未对该订单进行支付，请<a href="index.php?act=buy_virtual&op=pay&order_id=<?php echo $output['order_info']['order_id']; ?>" class="imm-btn-mini imm-btn-orange"><i></i>支付订单</a>以确保及时获取电子兑换码。</li>
        <li>2. 如果您不想购买此订单，请点击 <a href="#order-list" class="imm-btn-mini" >取消订单</a>。 </li>
        <li>3. 系统将于
    ...
    <div class="imm-order-condition">
      ...
      <ul>
        ...
        <li>2. 去商城看看有没有新的<a href="<?php echo urlShop('search','index');?>" class="imm-btn-mini imm-btn-green" target="_blank">虚拟商品</a>。</li>
      </ul>
    </div>
    <?php }?>
  ...
  <?php }?>
  <div class="imm-order-contnet" id="order-list">
      ...
      <tbody>
        ...
        <tr>
          ...
          <?php if ($output['order_info']['if_cancel']){ ?>
            <a href="javascript:void(0)" class="imm-btn imm-btn-red" im_type="dialog" dialog_width="480" dialog_title="取消订单" dialog_id="buyer_order_cancel_order" uri="index.php?act=member_vr_order&op=change_state&state_type=order_cancel&order_id=<?php echo $output['order_info']['order_id'];?>"  id="order_action_cancel"><i class="fa fa-ban"></i>取消</a>
            <?php }?>

            <!-- 评价 -->
            <?php if ($output['order_info']['if_evaluation']) { ?>
            <p><a class="imm-btn imm-btn-acidblue" href="index.php?act=member_evaluate&op=add_vr&order_id=<?php echo $output['order_info']['order_id']; ?>"><?php echo $lang['member_order_want_evaluate'];?></a></p>
            <?php } ?>
            ...
            <p><a href="javascript:void(0)" im_type="sharegoods" data-param='{"gid":"<?php echo $output['order_info']['goods_id'];?>"}'>分享商品</a></p>
            <?php } ?>
          </td>
        </tr>
      </tbody>
