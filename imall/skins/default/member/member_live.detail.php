  ...
  <div class="imm-order-info">
    <div class="imm-order-details">
      ...
      <div class="content">
        ...
        <dl class="line">
          <dt>抢购单号：</dt>
          <dd><?php echo $output['order']['order_sn'];?><a href="javascript:void(0);">更多<i class="fa fa-angle-down"></i>
        ...
        <dl class="line">
          <dt>商&#12288;&#12288;家：</dt>
          <dd><?php echo $output['order']['store_name'];?><a href="javascript:void(0);" id="mapmore">更多<i class="fa fa-angle-down"></i>
            <div class="more"><span class="arrow"></span>
              <ul>
                <li>联系电话：
                  <?php 
    ...
    <div class="imm-order-condition">
      ...
      <ul>
        <li>1. 您尚未对该订单进行支付，请<a href="index.php?act=show_live_groupbuy&op=pay&order_sn=<?php echo $output['order']['order_sn']; ?>" class="imm-btn-mini imm-btn-orange"><i></i>支付订单</a>以确保抢购兑换码及时发放。</li>
        <li>2. 如果您不想购买此订单抢购，请选择					
		<a href="javascript:void(0)" class="imm-btn-mini" im_type="dialog" dialog_width="480" dialog_title="取消抢购" dialog_id="buyer_order_cancel_order" uri="index.php?act=member_live&op=cancel&order_id=<?php echo $output['order']['order_id'];?>"  id="order<?php echo $output['order']['order_id'];?>_action_cancel">取消抢购</a>操作。
		</li>
    ...
    <div class="imm-order-condition">
      ...
      <ul>
        ...
        <li>2. 去商城看看新的<a href="<?php echo urlShop('show_live_groupbuy','index');?>" class="imm-btn-mini imm-btn-green" target="_blank">抢购</a>活动。</li>
      </ul>
    </div>
    <!-- E 全部兑换完成订单 -->
    <?php }?>
    ...
    <table class="imm-default-table order">
      ...
      <td class="bdl"></td>
		...
		<?php if($output['order']['state'] == 1){?>
			<a href="javascript:void(0)" class="imm-btn imm-btn-red" im_type="dialog" dialog_width="480" dialog_title="取消抢购" dialog_id="buyer_order_cancel_order" uri="index.php?act=member_live&op=cancel&order_id=<?php echo $output['order']['order_id'];?>"  id="order<?php echo $output['order']['order_id'];?>_action_cancel"><i class="fa fa-ban"></i>取消抢购</a>
		<?php }?>
		</td>
      </tbody>
      <tfoot>
