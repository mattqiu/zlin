...
<div class="imm-flow-layout" id="immComplainFlow">
  <div class="imm-flow-container">
    ...
    <div class="imm-default-form">
        ...
        <dl>
          <dt><?php echo $lang['complain_accused'].$lang['im_colon'];?></dt>
          <dd><?php echo $output['complain_info']['accused_name'];?></dd>
          <dt><?php echo $lang['complain_subject_content'].$lang['im_colon'];?></dt>
          <dd><?php echo $output['complain_info']['complain_subject_content'];?></dd>
          <dt><?php echo $lang['complain_datetime'].$lang['im_colon'];?></dt>
          <dd><?php echo date('Y-m-d H:i:s',$output['complain_info']['complain_datetime']);?></dd>
          <dt><?php echo $lang['complain_content'].$lang['im_colon'];?></dt>
          <dd><?php echo $output['complain_info']['complain_content'];?></dd>
          <dt><?php echo $lang['complain_evidence'].$lang['im_colon'];?></dt>
          <dd>
            ...
            <ul class="imm-evidence-pic">
              ...
              <?php if(!empty($val)){ ?>
              <li><a href="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_PATH.'/complain/'.$val;?>" imtype="nyroModal" rel="gal">
            ...
            <?php echo $lang['complain_pic_none'];?>
                <?php if((intval($output['complain_info']['complain_state']) < 99)) { ?>
                    <a class="imm-btn-mini imm-btn-orange" href="javascript:void(0);" onclick="$('#post_add_pic_form').toggle();" title="<?php echo $lang['complain_add_pic'];?>"><i class="fa fa-cloud-upload "></i><?php echo $lang['complain_add_pic'];?></a>
        ...
        <?php if ($output['complain_info']['appeal_datetime'] > 0) { ?>
            ...
            <dl>
              <dt><?php echo $lang['complain_appeal_datetime'].$lang['im_colon'];?></dt>
              <dd><?php echo date('Y-m-d H:i:s',$output['complain_info']['appeal_datetime']);?></dd>
              <dt><?php echo $lang['complain_appeal_content'].$lang['im_colon'];?></dt>
              <dd><?php echo $output['complain_info']['appeal_message'];?></dd>
              <dt><?php echo $lang['complain_appeal_evidence'].$lang['im_colon'];?></dt>
              <dd>
        ...
        <dl>
          <dt><?php echo '处理意见'.$lang['im_colon'];?></dt>
          <dd><?php echo $output['complain_info']['final_handle_message'];?></dd>
          <dt><?php echo $lang['final_handle_datetime'].$lang['im_colon'];?></dt>
