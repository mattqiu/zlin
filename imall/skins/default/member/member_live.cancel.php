...
<div class="eject_con">
  ...
  <form method="post" action="index.php?act=member_live&op=cancel&order_id=<?php echo $output['order']['order_id']; ?>" id="order_cancel_form" onsubmit="ajaxpost('order_cancel_form','','','onerror')">
    ...
    <dl>
      <dt><?php echo $lang['member_order_sn'].$lang['im_colon'];?></dt>
      <dd><span class="num"><?php echo $output['order']['order_sn']; ?></span></dd>
    </dl>
    <dl>
      <dt><?php echo $lang['member_change_cancel_reason'].$lang['im_colon'];?></dt>
      <dd>
    ...
    <div class="bottom">
      <label class="submit-border"><input type="submit" id="confirm_button" class="submit" value="<?php echo $lang['im_ok'];?>提交" /></label>
      <a class="imm-btn ml5" href="javascript:DialogManager.close('buyer_order_cancel_order');">取消</a>
    </div>
  </form>
</div>
