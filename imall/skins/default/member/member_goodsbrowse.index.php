...
<div class="wrap">
  <div class="tabmenu">
    ...
    <a class="imm-btn imm-btn-red" href="javascript:void(0);" im_type="delbtn" data-param='{"goods_id":"all"}'><i class="fa fa-trash-o"></i>清空全部足迹</a>
  </div>
  
  <div class="imm-browse">
    <div class="imm-browse-left">
      <?php if (is_array($output['browselist']) && !empty($output['browselist'])) { ?>
      <ul class="imm-browse-list">
        ...
        <li id="browserow_<?php echo $v['goods_id']; ?>">
          ...
          <div class="browse-goods">
            ...
            <a class="imm-btn imm-btn-orange" href="javascript:addcart(<?php echo $v['goods_id'];?>,1,'');"><i class="fa fa-shopping-cart"></i>加入购物车</a>
            <br/><br/>
            <a class="imm-btn" href="javascript:void(0);" im_type="delbtn" data-param='{"goods_id":<?php echo $v['goods_id'];?>}'><i class="fa fa-trash-o"></i>删除该记录</a>
         </div>
        </li>
        <?php }?>
      </ul>
...
$(document).ready(function(){
   ...
   //清除单条浏览记录
   $("[im_type='delbtn']").bind('click',function(){
	   if(confirm("确实要删除吗？")){
   ...
   //立即购买
   $('a[imtype="buy_now"]').click(function(){
