...
<div class="wrap">
  ...
  <table class="imm-default-table order">
    ...
    <tbody>
      ...
      <tr>
        <th colspan="20"><span class="ml10"><?php echo $lang['member_pointorder_ordersn'].$lang['im_colon'];?><?php echo $val['point_ordersn']; ?></span><span><?php echo $lang['member_pointorder_addtime'].$lang['im_colon'];?><?php echo @date("Y-m-d H:i:s",$val['point_addtime']); ?></span></th>
      </tr>
      ...
      <tr>
        ...
        <td class="bdl bdr w100" rowspan="<?php echo count($val['prodlist']);?>"><p></p>
          ...
          <p><a href="javascript:void(0)" class="imm-btn" onclick="ajax_confirm('<?php echo $lang['member_pointorder_confirmreceivingtip']; ?>','index.php?act=member_pointorder&op=receiving_order&order_id=<?php echo $val['point_orderid']; ?>');"><?php echo $lang['member_pointorder_confirmreceiving']; ?></a></p>
          <?php } ?>
          <?php if ($val['point_orderallowcancel']) { ?>
          <p><a href="javascript:void(0)" class="imm-btn imm-btn-orange" onclick="ajax_confirm('<?php echo $lang['member_pointorder_cancel_confirmtip']; ?>','index.php?act=member_pointorder&op=cancel_order&order_id=<?php echo $val['point_orderid']; ?>');"><?php echo $lang['member_pointorder_cancel_title']; ?></a></p>
          <?php } ?></td>
        <?php } ?>
      </tr>
      <?php } ?>
