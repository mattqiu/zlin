...
<div class="wrap">
  ...
  <form id="goodsevalform" method="get" class="tc">
    ...
    <div class="imm-evaluation-list">
      <?php foreach ((array)$output['goodsevallist'] as $k=>$v){?>
      <div class="imm-evaluation-timeline">
        ...
        <dl class="detail">
          ...
          <dd>
            ...
            <a href="<?php echo urlShop('member_evaluate', 'add_image', array('geval_id' => $v['geval_id']));?>" class="imm-btn imm-btn-orange">我要晒单</a>
            <?php } ?>
            <?php if (!empty($v['geval_image'])){?>
            晒图图片：
