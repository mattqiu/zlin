    ...
    <thead>
      ...
      <tr>
        <td colspan="20"><input type="checkbox" id="all" class="checkall"/>
          ...
          <a href="javascript:void(0);" class="imm-btn-mini" uri="index.php?act=member_favorites&op=delfavorites&type=store" name="fav_id" confirm="<?php echo $lang['im_ensure_del'];?>" im_type="batchbutton"><i class="fa fa-trash-o"></i><?php echo $lang['im_del'];?></a></td>
      </tr>
      <?php }?>
    </thead>
    <?php if(!empty($output['favorites_list']) && is_array($output['favorites_list'])){?>
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="tl"><dl class="goods-name">
            ...
            <dd><?php echo $lang['favorite_message'].$lang['im_colon'];?><span member_id="<?php echo $favorites['store']['member_id'];?>"></span>
        ...
        <td class="imm-table-handle"><span><a href="javascript:void(0);" class="btn-acidblue" im_type="sharestore" data-param='{"sid":"<?php echo $favorites['store']['store_id'];?>"}'><i class="fa fa-share-square-o"></i>
          <p><?php echo $lang['im_snsshare'];?></p>
          </a></span> <span><a href="javascript:void(0)" class="btn-red" onclick="ajax_get_confirm('<?php echo $lang['im_ensure_del'];?>', 'index.php?act=member_favorites&op=delfavorites&type=store&fav_id=<?php echo $favorites['fav_id'];?>');"><i class="fa fa-trash-o"></i>
    ...
    <tfoot>
      <tr>
        <th colspan="20"><input type="checkbox" id="all2" class="checkall"/>
          ...
          <a href="javascript:void(0);" class="imm-btn-mini" uri="index.php?act=member_favorites&op=delfavorites&type=store" name="fav_id" confirm="<?php echo $lang['im_ensure_del'];?>" im_type="batchbutton"><i class="fa fa-trash-o"></i><?php echo $lang['im_del'];?></a> </th>
      </tr>
      <tr>
