  ...
  <div class="imm-flow-container">
    ...
    <div id="saleRefundReturn" show_id="1">
      ...
      <div class="imm-default-form">
        ...
        <dl>
          ...
          <dd>
            ...
            <ul class="imm-evidence-pic">
              ...
              <?php if(!empty($val)){ ?>
              <li><a href="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_PATH.'/refund/'.$val;?>"  imtype="nyroModal"> <img class="show_image" src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_PATH.'/refund/'.$val;?>"></a></li>
              <?php } ?>
              <?php } ?>
            </ul>
            <?php } ?>
        ...
        <h3>商家退货退款处理</h3>
        <dl>
          <dt><?php echo $lang['refund_state'].$lang['im_colon'];?></dt>
