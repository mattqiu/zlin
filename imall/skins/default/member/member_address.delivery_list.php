...
<ul>
  ...
  <li>
    <label>
      <input type="radio" <?php echo $_GET['dlyp_id'] == $v['dlyp_id'] ? 'checked' : null; ?> imtype="dlyp_radio" data_area="<?php echo $v['dlyp_area_info'].$v['dlyp_address'];?>" value="<?php echo $v['dlyp_id'];?>" name="dlyp_id">
...
$(document).ready(function(){
	$('input[imtype="dlyp_radio"]').on('click',function(){
