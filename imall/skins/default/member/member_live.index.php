...
<div class="wrap">
  ...
  <table class="imm-default-table order">
    ...
    <tbody>
      ...
      <tr>
        <td class="bdl"></td>
        <td class="w70"><div class="imm-goods-thumb"><a href="<?php echo urlShop('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$val['groupbuy_id']));?>" target="_blank" onMouseOver="toolTip('<img src=<?php echo lgthumb($val['groupbuy_pic'], 'small');?>>')" onMouseOut="toolTip()"/><img src="<?php echo lgthumb($val['groupbuy_pic'], 'small');?>"/></a></div></td>
        ...
        <td class="bdl bdr">
		  <?php if($val['state']==1){?>
          <p><a class="imm-btn imm-btn-orange" href="index.php?act=show_live_groupbuy&op=pay&order_sn=<?php echo $val['order_sn']; ?>"><i class="fa fa-shield"></i>订单支付</a></p> 		  
		  <!--取消订单-->
          <p class="mt5"><a href="javascript:void(0)" class="imm-btn imm-btn-red" im_type="dialog" dialog_width="480" dialog_title="取消抢购" dialog_id="buyer_order_cancel_order" uri="index.php?act=member_live&op=cancel&order_id=<?php echo $val['order_id'];?>"  id="order<?php echo $val['order_id'];?>_action_cancel"><i class="fa fa-ban"></i>取消抢购</a></p>
		  <?php }?>
		  </td>
      </tr>
      <?php }?>
