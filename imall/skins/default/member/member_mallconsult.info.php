...
<div class="imm-flow-layout">
  <div id="immInformFlow" class="imm-flow-container">
    ...
    <div class="imm-default-form">
      ...
      <dl>
        <dt>回复内容<?php echo $lang['im_colon'];?></dt>
        <dd>
          <?php echo $output['consult_info']['mc_reply'];?>
        </dd>
      </dl>
      <?php }?>
      <div class="bottom"><a href="javascript:history.go(-1);" class="imm-btn ml10">返回列表</a></div>
    </div>
  </div>
