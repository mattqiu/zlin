...
<div class="wrap">
  <div class="tabmenu">
	...
	<!--
    <a class="imm-btn imm-btn-orange" title="在线充值" href="index.php?act=predeposit&op=recharge_add" style="right: 207px;"><i class="fa fa-shield"></i>在线充值</a> <a class="imm-btn imm-btn-green" href="index.php?act=member_security&op=auth&type=pd_cash" style="right: 107px;"><i class="fa fa-money"></i>申请提现</a> <a class="imm-btn imm-btn-blue" href="index.php?act=predeposit&op=rechargecard_add"><i class="fa fa-shield"></i>充值卡充值</a>
	-->
	</div>
