...
<div class="wrap">
  <div class="tabmenu">
	...
	<!--
    <a class="imm-btn imm-btn-green" href="index.php?act=member_security&op=auth&type=pd_cash"><i class="fa fa-money"></i>申请提现</a>
	-->
  </div>
  ...
  <form method="get" action="index.php">
    <table class="imm-search-table">
      ...
      <tr>
      <th></th><td></td>
        <th><?php echo $lang['predeposit_paystate'].$lang['im_colon']; ?></th>
  ...
  <table class="imm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><p><a href="index.php?act=predeposit&op=pd_cash_info&id=<?php echo $val['pdc_id']; ?>"><?php echo $lang['im_view']; ?></a></p></td>
      </tr>
      <?php } ?>
      <?php } else {?>
      <tr>
