  ...
  <form method="get" action="index.php">
    <table class="imm-search-table">
      ...
      <tr><td class="w10">&nbsp;</td>
        ...
        <td class="w240"><input type="text" id="stime" name="stime" class="text w70" value="<?php echo $_GET['stime'];?>"><label class="add-on"><i class="fa fa-calendar"></i></label>&nbsp;&#8211;&nbsp;<input type="text" id="etime" name="etime" class="text w70" value="<?php echo $_GET['etime'];?>"><label class="add-on"><i class="fa fa-calendar"></i></label></td>
        <th><?php echo $lang['points_stage']; ?></th>
        <td class="w100"><select name="stage">
            <option value="" <?php if (!$_GET['stage']){echo 'selected=selected';}?>><?php echo $lang['im_please_choose'];?></option>
