...
.box_arr .table_btn a.disable_spec {background: url(<?php echo SHOP_SKINS_URL;?>/images/member/btn.gif) repeat 0 -1018px;float: right;}
...
.flea_pic_list .content .standard .small_pic .cut_in {background: url(<?php echo SHOP_SKINS_URL;?>/images/member/picedit.png) 0px -64px;width: 16px;height: 16px;float: left;margin-left: 7px;display: inline;}.flea_pic_list .content .standard .small_pic .delete {background: url(<?php echo SHOP_SKINS_URL;?>/images/member/picedit.png) 0 0;display: inline;width: 16px;height: 16px;float: right;margin-right: 7px;}.flea_pic_list .content .standard .small_pic .upload-btn {width: 74px;height: 32px;padding: 0px;position: absolute;*z-index: -1;z-index: 1;left: 1px;bottom: 0px;}.flea_pic_list .content .standard .small_pic .titles {width: 66px;height: 16px;line-height: 15px;text-align: center;color: #3d3f3e;background: #fdf04c;border: 1px solid #ffba2f;position: absolute;top: 1px;left: 1px;z-index: 9999;}.flea_pic_list .content .standard .small_pic .line {width: 66px;height: 2px;overflow: hidden;background: #d8deda;position: absolute;bottom: -3px;left: -1px;}.flea_pic_list .content .standard .small_pic .help {line-height: 18px;background-color: #FFFAE3;width: 420px;height: 57px;clear: both;padding: 4px;border: 1px solid #F1E38B;}.flea_pic_list .standard .small_pic .help p {padding-left: 24px;width: 398px;}.flea_pic_list .content .standard .help .ico {background: url(<?php echo SHOP_SKINS_URL;?>/images/member/ico.gif) no-repeat 3px -2867px;color: #F60;}.flea_goods-attribute {width: 792px;margin-top: 0;border: none;}.flea_goods-attribute dl dd p {float: none;}.goods-gallery {width: 650px;}.goods-gallery .list li{display: inline;float: left;margin: 5px; width:90px; height:90px;position: relative;z-index: 99;cursor: pointer; border:1px solid #ddd;}
.imcu-form-style {  padding-top: 15px;}
.imcu-form-style h3 { font-weight: 600; line-height: 22px; color: #555; clear: both; background-color: #F5F5F5; padding: 5px 0 5px 12px; border-bottom: solid 1px #E7E7E7;}
.imcu-form-style dl { line-height: 20px; color: #777; width: 96%; clear: both; padding: 0; margin: 4px auto; border-bottom: dashed 1px #F5F5F5; overflow: hidden;}
.imcu-form-style dl.bottom { border-bottom-width: 0px;}
.imcu-form-style dl dt { color: #404040; line-height: 32px; text-align: right; width: 130px; float: left; padding: 6px 6px 0 0; margin: 0;}
.imcu-form-style dl dt.required em { line-height: 22px; background: url(../images/member/ncus_public.png) no-repeat scroll -276px -231px; display: inline-block; height: 16px; width: 16px; margin-right: 5px;}
.imcu-form-style dl dd { float: left; padding: 8px; width: 600px;}
.imcu-form-style dl dd p { clear: both;}
.imcu-form-style textarea { width: 198px; height: 64px;}
.imcu-form-style .upload-appeal-pic { border: dotted 1px #D8D8D8; padding: 5px; width: 250px; margin-left: 32px;}
.imcu-form-style .upload-appeal-pic p { padding: 5px;}
.imcu-form-style .info-album a { font-weight: bold; color: #999; line-height: 20px; background: url(<?php echo SHOP_SKINS_URL;?>/images/member/album_bg.gif) no-repeat 5px -492px; display: inline-block; height: 20px; padding: 0px 4px 0px 28px; margin: 8px 0px; border: 1px solid #E7E7E7; }	
a.imcu-btn3 {  font-weight: 700;   line-height: 24px;   color: #FFF;   background: #ff4545;   display: block;   height: 25px;   padding: 3px 12px;   border: solid 1px #FF4545;   border-radius: 0px;   position: absolute;   z-index: 1;   top: -2px;   right: 0px;   box-shadow: 1px 1px 1px rgba(0,0,0,0.1);}
a:hover.imcu-btn3 { color: #FFF; background-position: 0 -30px;  box-shadow: none;}

.imcu-table-style { line-height:20px; width: 100%; border-collapse: collapse; clear: both;}
.imcu-table-style thead th { padding: 5px 0 6px 0; border-bottom: solid 1px #E7E7E7; }
.imcu-table-style thead td { color: #5F718B; background-color: #F7F7F7; padding-top: 5px; border-top: solid 1px #EEEEEE;}
.imcu-table-style thead td label, .imcu-table-style tfoot td label { color: #555; display:inline; float:left; margin-right:10px; cursor:pointer; }
.imcu-table-style tbody th { background-color: #EDF5FF; border-top: solid 1px #AED2FF; padding: 4px 0;}
.imcu-table-style tbody th a { color:#0579C6;}
.imcu-table-style tbody td { background-color: #FFF; text-align: center; padding: 12px 0;}
.imcu-table-style tfoot td { color: #5F718B;border-top: solid 1px #C4D5E0; background-color: #FFF; padding: 5px 0 6px 0;}
/* 内容部分通用搜索样式 */
...
.search-form input.text { font-family: 微软雅黑; width: 148px; height: 24px; line-height: 16px; background-color:#FFF; padding: 1px 2px 3px 4px !important; padding: 3px 2px 1px 4px; border: solid 1px; border-color: #CCC #DDD #DDD #CCC;}
...
.search-form input[type="text"]:focus { background-color:#FFF; border-color: #CCC; box-shadow: 1px 1px 1px 0 #E7E7E7; -moz-box-shadow: 1px 1px 1px 0 #E7E7E7/* if FF*/; -webkit--box-shadow: 1px 1px 1px 0 #E7E7E7/* if Webkie*/;}</style>

<div class="wrap">
  <div class="tabmenu">
    <?php include template('member/member_submenu');?>
  </div>
  <div class="imcu-form-style">
    <form method="post" id="goods_form" action="index.php?act=member_flea&op=<?php if ($output['goods']['goods_id']!='') echo 'edit_save_goods'; else echo 'save_goods'; ?>">
      ...
      <dl>
        <dt class="required"><em class="pngFix"></em><?php echo $lang['store_goods_index_flea_goods_class'].$lang['im_colon'];?></dt>
        <dd id="gcategory">
          <?php if (!empty($output['goods']['gc_id'])) { ?>
          <span class="f_l"><?php echo $output['goods']['gc_name'];?></span> <a class="edit_gcategory btn" href="javascript:void(0)"><?php echo $lang['im_edit'];?></a>
      ...
      <dl>
        <dt class="required"><em class="pngFix"></em><?php echo $lang['store_goods_index_flea_goods_name'].$lang['im_colon'];?></dt>
        <dd>
          <p>
            <input type="text" style=" width:400px" class="text" name="goods_name" value="<?php echo $output['goods']['goods_name']; ?>"  />
          </p>
          <p class="hint"><?php echo $lang['store_goods_index_flea_title'];?></p>
        </dd>
      </dl>
      <dl>
        <dt><?php echo $lang['store_goods_index_flea_goods_tag'].$lang['im_colon'];?></dt>
        <dd>
          <p>
      ...
      <dl>
        <dt><?php echo $lang['store_goods_album_flea_goods_pic'].$lang['im_colon'];?></dt>
        <dd>
              ...
              <div class="standard">
                <div id="goodsCoverPicture" class="big_pic">
                  <div class="picture"> <span class="thumb size182"><i></i>
                    ...
                    <?php } else { ?>
                    <img id="big_goods_image" src="<?php echo SHOP_SKINS_URL.'/images/member/default_image.png';?>" onload="javascript:DrawImage(this,182,182);" alt="" />
                    <?php } ?>
                    </span> 
                  </div>
                </div>
                <div class="small_pic" >
                  <ul id="goods_images">
                    <?php for($i=0;$i<5;$i++){?>
                    <li im_type="handle_pic" file_id="<?php echo $output['goods_image'][$i]['upload_id']; ?>" thumbnail="<?php echo $output['goods_image'][$i]['file_thumb']; ?>" id="thumbnail_<?php echo $i;?>">
                      <input type="hidden" name="goods_file_id[]" value="<?php echo $output['goods_image'][$i]['upload_id']; ?>">
                      <div class="picture">
                        <span class="thumb size60"><i></i>
                          <img id="img_<?php echo $i;?>" src="<?php echo $output['goods_image'][$i]['file_thumb'] !=''?$output['goods_image'][$i]['file_thumb']:SHOP_SKINS_URL.'/images/member/default_image.png';?>" onerror="this.src='<?php echo SHOP_SKINS_URL.'/images/member/default_image.png';?>'" onload="javascript:DrawImage(this,60,60);"/>
                        </span>
                      </div>
                      <div im_type="handler" class="bg" id="<?php echo $i;?>">
                        <?php if($output['goods_image'][$i]['file_thumb'] !=''){?>
                        <p class="operation"><span class="cut_in" im_type="set_cover" ecm_title="<?php echo $lang['store_goods_index_face'];?>"></span><span class="delete" im_type="drop_image" ecm_title="<?php echo $lang['im_del'];?>"></span></p>
                        <?php }?>
                      </div>
      ...
      <dl>
        ...
        <dd>
          <select name="sh_quality" class="w100">
            <option value="0"<?php if($output['goods']['flea_quality']=='0'){echo ' selected="selected"';}?>><?php echo $lang['im_please_choose'];?></option>
      ...
      <dl>
        ...
        <dd>
          <div class="select_add" id="region" style="width:500px;border:1px solide red;">
            ...
            <input type="button" value="<?php echo $lang['im_edit'];?>" class="edit_region" />
            <select style="display:none;">
              <option><?php echo $lang['im_please_choose'];?></option>
      ...
      <dl>
        <dt class="required"><em class="pngFix"></em><?php echo $lang['store_goods_index_flea_goods_price'].$lang['im_colon'];?></dt>
        <dd>
          <input name="goods_price" class="text" value="<?php echo $output['goods']['goods_price']; ?>" type="text" />
        </dd>
      </dl>
      <dl>
        <dt im_type="no_spec" class="required"><em></em><?php echo $lang['store_goods_index_store_flea_price'].$lang['im_colon'];?></dt>
        <dd im_type="no_spec">
          <input name="goods_store_price" class="text" value="<?php echo $output['goods']['goods_store_price']; ?>" type="text" />
        </dd>
      </dl>
      <dl>
        <dt class="required"><em class="pngFix"></em><?php echo $lang['flea_contact_person'].$lang['im_colon'];?></dt>
        <dd>
          <input name="flea_pname" value="<?php echo $output['goods']['flea_pname']; ?>" type="text" class="text" />
        </dd>
      </dl>
      <dl>
        <dt class="required"><em class="pngFix"></em><?php echo $lang['flea_contact_tel'].$lang['im_colon'];?></dt>
        <dd>
          <input name="flea_pphone" value="<?php echo $output['goods']['flea_pphone']; ?>" type="text" class="text" />
        </dd>
      </dl>
      <dl>
        <dt><?php echo $lang['store_goods_index_flea_goods_seo_keywords'].$lang['im_colon'];?></dt>
        <dd >
          <p>
      ...
      <dl>
        <dt><?php echo $lang['store_goods_index_goods_seo_description'].$lang['im_colon'];?></dt>
        <dd>
          <p>
            <textarea name="seo_description" rows="3" style=" width:400px" id="remark_input" ><?php echo $output['goods']['goods_description']; ?></textarea>
          </p>
          <p class="hint"> <?php echo $lang['store_goods_index_goods_seo_description_help']; ?></p>
        </dd>
      </dl>
      <dl>
        <dt><?php echo $lang['store_goods_index_flea_goods_desc'].$lang['im_colon'];?></dt>
        <dd>
          <p>
...
$(document).ready(function(){
	    ...
	    $('*[im_type="handle_pic"]').find('img:first').hover(function(){
	        $('*[im_type="explain_layer"]').remove();
	        handle_pic = $(this).parents('*[im_type="handle_pic"]');
	        handler = handle_pic.find('*[im_type="handler"]');
	        ...
	        cover = handler.find('*[im_type="set_cover"]');
	        cover.unbind('click');
	        cover.click(function(){
	            set_cover(handle_pic.attr("file_id"));
	        });

	        drop = handler.find('*[im_type="drop_image"]');
	        drop.unbind('click');
	        drop.click(function(){
	            drop_image(handler.attr("id"));
	        });

	        insert = handler.find('*[im_type="insert_editor"]');
	        insert.unbind('click');
...
function add_uploadedfile(file_data)
{
    ...
    if(file_data.instance == 'goods_image'){
        ...
        $('#'+id).html('<p class="operation"><span class="cut_in" im_type="set_cover" ecm_title="<?php echo $lang['store_goods_index_face'];?>"></span><span class="delete" im_type="drop_image" ecm_title="<?php echo $lang['im_del'];?>"></span></p>');
        $('#iframe_'+id).attr('src','index.php?act=member_flea&op=image_upload&id='+id+'&item_id='+item_id+'&file_id='+file_data.file_id);
        if($('#big_goods_image').attr('src') == '<?php echo SHOP_SKINS_URL.'/images/member/default_image.png';?>'){
    ...
    if (confirm('<?php echo $lang['store_goods_index_goods_del_confirm']; ?>')){
            ...
            $.getJSON(url, {'id':goods_file_id}, function(data){
                if (data.done)
                {
                	...
                	$('#img_'+id).attr('src','<?php echo SHOP_SKINS_URL.'/images/member/default_image.png';?>');
                	$('#'+id).html('');
                }
                else
                {
            ...
            if($('#big_goods_image').attr('src') == $('#img_'+id).attr('src')){
				$('#big_goods_image').attr('src','<?php echo SHOP_SKINS_URL.'/images/member/default_image.png';?>');
            }
        }
}
	...
	if(j==5){
		...
		$.getJSON(url, {'id':id,'item_id':item_id}, function(data){
        	if (data.done){
        		...
        		$('#'+y).html('<p class="operation"><span class="cut_in" im_type="set_cover" ecm_title="<?php echo $lang['store_goods_index_face'];?>"></span><span class="delete" im_type="drop_image" ecm_title="<?php echo $lang['im_del'];?>"></span></p>');
        		if($('#big_goods_image').attr('src') == '<?php echo SHOP_SKINS_URL.'/images/member/default_image.png';?>'){
