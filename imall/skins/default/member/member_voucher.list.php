    ...
    <table class="imm-search-table">
      ...
      <tr>
        ...
        <td class="w70 tc"><label class="submit-border">
            <input type="submit" class="submit" onclick="submit_search_form()" value="<?php echo $lang['im_search'];?>" />
          </label></td>
      </tr>
    </table>
  </form>
  <table class="imm-default-table">
    <thead>
      <tr>
        ...
        <th class="w70"><?php echo $lang['im_handle'];?></th>
      </tr>
    </thead>
    <tbody>
      ...
      <tr class="bd-line">
        <td></td>
        <td><div class="imm-goods-thumb"><a href="javascript:void(0);"><img src="<?php echo $val['voucher_t_customimg'];?>" onMouseOver="toolTip('<img src=<?php echo $val['voucher_t_customimg'];?>>')" onMouseOut="toolTip()" /></a></div></td>
        ...
        <td class="imm-table-handle"><?php if ($val['voucher_state'] == '1'){?>
          <span><a href="<?php echo urlShop('show_store', 'index', array('store_id'=>$val['store_id']));?>" class="btn-green" ><i class="fa fa-shopping-cart"></i><p>使用</p></a></span>
