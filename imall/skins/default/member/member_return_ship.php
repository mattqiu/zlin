...
<form id="post_form" method="post" action="index.php?act=member_return&op=ship&return_id=<?php echo $output['return']['refund_id']; ?>">
  ...
  <h3>请填写退货发货信息</h3>
  <dl>
    <dt><?php echo '物流公司'.$lang['im_colon'];?></dt>
    <dd>
  ...
  <dl>
    <dt><i class="required">*</i><?php echo '物流单号'.$lang['im_colon'];?></dt>
    <dd>
  ...
  <div class="bottom">
    <label class="submit-border">
      <input type="submit" class="submit" id="confirm_button" value="<?php echo $lang['im_ok'];?>" />
    </label>
      <a href="javascript:history.go(-1);" class="imm-btn ml10"><i class="fa fa-reply"></i>返回列表</a>
  </div>
</form>
