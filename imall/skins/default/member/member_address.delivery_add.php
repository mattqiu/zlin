...
<div class="eject_con">
  <div class="adds">
    ...
    <form method="post" action="index.php?act=member_address&op=delivery_add" id="address_form" target="_parent">
      ...
      <div class="imde-delivery" id="zt_address"></div>
      <dl>
        <dt><i class="required">*</i>收货人姓名<?php echo $lang['im_colon'];?></dt>
        <dd>
      ...
      <dl>
        <dt><i class="required">*</i>电话号码<?php echo $lang['im_colon'];?></dt>
        <dd>
      ...
      <dl>
        <dt><i class="required">*</i>手机<?php echo $lang['im_colon'];?></dt>
        <dd>
      ...
      <div class="bottom">
        ...
        <a class="imm-btn ml5" href="javascript:DialogManager.close('daisou');">取消</a> </div>
    </form>
  </div>
</div>
