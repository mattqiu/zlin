...
<div class="wrap">
  ...
  <div class="imm-default-form">
    <form method="post" id="rechargecard_form" action="index.php">
      ...
      <dl>
        <dt><i class="required">*</i>平台充值卡号<?php echo $lang['im_colon']; ?></dt>
        <dd>
...
$('#rechargecard_form').validate({
    ...
    messages : {
        rc_sn : {
            required :'<i class="fa fa-exclamation-circle"></i>请输入平台充值卡号',
            maxlength :'<i class="fa fa-exclamation-circle"></i>平台充值卡号长度小于50'
        }
    }
});
});
