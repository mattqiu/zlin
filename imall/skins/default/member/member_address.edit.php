...
<div class="eject_con">
  <div class="adds">
    ...
    <form method="post" action="index.php?act=member_address&op=address" id="address_form" target="_parent">
      ...
      <dl>
        <dt><i class="required">*</i><?php echo $lang['member_address_receiver_name'].$lang['im_colon'];?></dt>
        <dd>
      ...
      <dl>
        <dt><i class="required">*</i><?php echo $lang['member_address_location'].$lang['im_colon'];?></dt>
        <dd>
          <div id="region">
      ...
      <dl>
        <dt><i class="required">*</i><?php echo $lang['member_address_address'].$lang['im_colon'];?></dt>
        <dd>
      ...
      <dl>
        <dt><i class="required">*</i><?php echo $lang['member_address_phone_num'].$lang['im_colon'];?></dt>
        <dd>
      ...
      <dl>
        <dt><i class="required">*</i><?php echo $lang['member_address_mobile_num'].$lang['im_colon'];?></dt>
        <dd>
      ...
      <dl>
        <dt><em class="pngFix"></em>设为默认地址<?php echo $lang['im_colon'];?></dt>
        <dd>
      ...
      <dl>
        <dt>&nbsp;</dt>
        <dd> <a href="javascript:void(0);" class="imm-btn-mini imm-btn-orange" id="zt"><i class="fa fa-flag"></i>使用自提服务站</a>
      ...
      <div class="bottom">
        ...
        <a class="imm-btn ml5" href="javascript:DialogManager.close('my_address_edit');">取消</a> </div>
    </form>
  </div>
</div>
