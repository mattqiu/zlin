...
<div class="wrap">
  ...
  <div class="imm-message-send">
    <div class="imm-message-send-form">
      <div class="imm-default-form">
        <form method="post" id="send_form" action="index.php?act=member_message&op=savemsg">
          <input type="hidden" name="form_submit" value="ok" />
          <dl>
            <dt><i class="required">*</i><?php echo $lang['home_message_reveiver'].$lang['im_colon'];?></dt>
            <dd>
          ...
          <dl>
            <dt><i class="required">*</i><?php echo $lang['home_message_content'].$lang['im_colon'];?></dt>
            <dd>
    ...
    <div class="imm-message-send-friend">
      <h3><?php echo $lang['home_message_friend'];?></h3>
       <?php if ($output['friend_list'] != '') { ?><ul>
       
        <?php foreach ($output['friend_list'] as $val) { ?>
        <li><a href="javascript:void(0);" id="<?php echo $val['friend_tomname']; ?>" im_type="to_member_name">
        ...
        <a href="index.php?act=member_snsfriend&op=find" class="imm-btn-mini" target="_blank">添加好友</a>
        </div>
        <?php } ?>
    </div>
  </div>
...
$(function(){
    $('a[im_type="to_member_name"]').click(function (){
