...
<div class="wrap">
  <div class="tabmenu">
    ...
    <a href="index.php?act=member_message&op=sendmsg" title="<?php echo $lang['home_message_send_message'];?>" class="imm-btn imm-btn-orange"><i class="fa fa-envelope-o"></i><?php echo $lang['home_message_send_message'];?></a>
    <?php }?>
  </div>
    ...
    <thead>
      ...
      <tr>
        <td colspan="20"><input type="checkbox" id="all" class="checkall"/>
          ...
          <a href="javascript:void(0)" class="imm-btn-mini" uri="index.php?act=member_message&op=dropcommonmsg&drop_type=<?php echo $output['drop_type']; ?>" name="message_id" confirm="<?php echo $lang['home_message_delete_confirm'];?>?" im_type="batchbutton"><i class="fa fa-trash-o"></i><?php echo $lang['home_message_delete'];?></a></td>
      </tr>
      <?php } ?>
    </thead>
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="imm-table-handle"><span><a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['home_message_delete_confirm'];?>?', 'index.php?act=member_message&op=dropcommonmsg&drop_type=<?php echo $output['drop_type']; ?>&message_id=<?php echo $v['message_id']; ?>');" class="btn-red"><i class="fa fa-trash-o"></i>
