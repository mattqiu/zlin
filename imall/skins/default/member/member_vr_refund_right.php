<?php defined('InIMall') or exit('Access Invalid!');?>
  ...
  <div class="imm-flow-item">
    ...
    <div class="item-goods">
      ...
      <dl>
        <dt>
          <div class="imm-goods-thumb-mini"><a target="_blank" href="<?php echo urlShop('goods','index',array('goods_id'=> $output['order']['goods_id'])); ?>">
    ...
    <div class="item-order">
      ...
      <dl class="line">
        <dt>商&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;家：</dt>
        <dd><?php echo $output['order']['store_name'];?><a href="javascript:void(0);" class="a" id="store_more">更多<i class="fa fa-angle-down"></i>
          <div class="more"><span class="arrow"></span>
              <ul>
