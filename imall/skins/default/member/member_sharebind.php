...
<div class="wrap">
  ...
  <ul class="bind-account-list">
    ...
    <li>
      <div class="account-item"><span class="website-icon"><img src="<?php echo SHOP_SKINS_URL;?>/images/member/shareicon/shareicon_<?php echo $k;?>.png"></span>
        <dl>
          <dt><?php echo $v['name'];?></dt>
          <dd><?php echo $v['url'];?></dd>
          <dd class="operate">
            <?php if ($v['isbind']){?>
            <em><?php echo $lang['sharebind_list_bindtime'].$lang['im_colon']; ?><?php echo @date('Y-m-d',$v['snsbind_updatetime']);?></em> <a href="javascript:void(0);" im_type="unbindbtn" data-param='{"apikey":"<?php echo $k;?>","apiname":"<?php echo $v['name'];?>"}'><?php echo $lang['sharebind_list_unbind'];?></a>
            <?php }else {?>
            <a class="imm-btn imm-btn-green" im_type="bindbtn" data-param='{"apikey":"<?php echo $k;?>","apiname":"<?php echo $v['name'];?>"}' href="javascript:void(0);"><?php echo $lang['sharebind_list_immediatelybind'];?></a>
            <?php }?>
          </dd>
        </dl>
      </div>
...
<textarea id="bindtooltip_module" style="display:none;">
  <div class="bindtooltip">
    <dl>
      ...
      <dd>
        <p><?php echo $lang['sharebind_list_popup_tip1'];?><strong>@apiname</strong><?php echo $lang['sharebind_list_popup_tip2'];?></p>
        <p class="hint"><?php echo $lang['sharebind_list_popup_tip3'];?>@apiname<?php echo $lang['sharebind_list_popup_tip4'];?></p>
      </dd>
    </dl>
    <div class="bottom">
      <a href="javascript:void(0);" im_type="finishbtn" data-param='{"apikey":"@apikey"}' class="mini-btn"><?php echo $lang['sharebind_list_finishbind'];?></a>
      <span><?php echo $lang['sharebind_list_unfinishedbind'];?><a target="_blank" href="<?php echo SHOP_SITE_URL;?>/api.php?act=sharebind&type=@apikey"><?php echo $lang['sharebind_list_againbind'];?></a></span>
    </div>
  </div>
</textarea>
...
$(function(){
	...
	$("[im_type='unbindbtn']").bind('click',function(){
		var data_str = $(this).attr('data-param');
	    eval( "data_str = "+data_str);
