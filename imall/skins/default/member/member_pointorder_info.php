...
<div class="imm-oredr-show">
  <div class="imm-order-info">
    <div class="imm-order-details">
      ...
      <div class="content">
        <dl>
          <dt><?php echo $lang['member_pointorder_info_shipinfo'].$lang['im_colon'];?></dt>
          <dd>
        ...
        <dl>
          <dt><?php echo $lang['member_pointorder_info_ordermessage'].$lang['im_colon'];?></dt>
          <dd>
        ...
        <dl class="line">
          <dt><?php echo $lang['member_pointorder_ordersn'].$lang['im_colon'];?></dt>
          <dd><?php echo $output['order_info']['point_ordersn']; ?><a href="javascript:void(0);">更多<i class="fa fa-angle-down"></i>
            <div class="more"><span class="arrow"></span>
              <ul>
                <li><?php echo $lang['member_pointorder_addtime'].$lang['im_colon'];?> <span><?php echo @date('Y-m-d H:i:s',$output['order_info']['point_addtime']);?></span></li>
                <?php if ($output['order_info']['point_shippingtime'] != ''){?>
                <li><?php echo $lang['member_pointorder_shipping_time'].$lang['im_colon'];?> <span> <?php echo @date('Y-m-d H:i:s',$output['order_info']['point_shippingtime']);?> </span></li>
                <?php }?>
              </ul>
            </div>
            </a></dd>
    ...
    <?php if ($output['order_info']['point_orderstate'] == $output['pointorderstate_arr']['canceled'][0]){ ?>
      <dl>
        <dt><i class="fa fa-power-off orange"></i>兑换订单状态：</dt>
  ...
  <div class="imm-order-contnet">
    <table class="imm-default-table order">
      ...
      <tbody>
        ...
        <tr>
          <th colspan="20">
          <div class="order-deliver"><span>物流公司： <a target="_blank" href="<?php echo $output['express_info']['e_url'];?>"><?php echo $output['express_info']['e_name'];?></a></span><span> <?php echo $lang['member_pointorder_shipping_code'].$lang['im_colon'];?> <?php echo $output['order_info']['point_shippingcode'];?> </span><span><a href="javascript:void(0);" id="show_shipping">物流跟踪<i class="fa fa-angle-down"></i>
              <div class="more"><span class="arrow"></span>
        ...
        <tr>
          ...
          <p><a href="javascript:void(0)" class="imm-btn imm-btn-orange" onclick="ajax_confirm('<?php echo $lang['member_pointorder_cancel_confirmtip']; ?>','index.php?act=member_pointorder&op=cancel_order&order_id=<?php echo $output['order_info']['point_orderid']; ?>');"><?php echo $lang['member_pointorder_cancel_title']; ?></a></p>
          <?php } ?>
            <?php if ($output['order_info']['point_orderallowreceiving']) { ?>
          <p><a href="javascript:void(0)" class="imm-btn" onclick="ajax_confirm('<?php echo $lang['member_pointorder_confirmreceivingtip']; ?>','index.php?act=member_pointorder&op=receiving_order&order_id=<?php echo $output['order_info']['point_orderid']; ?>');" class="" ><?php echo $lang['member_pointorder_confirmreceiving']; ?></a></p>
          <?php } ?>
          </td>
          <?php } ?>
        </tr>
