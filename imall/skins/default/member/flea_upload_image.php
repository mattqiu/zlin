...
.upload-button  { line-height: 32px; text-decoration: none; color: #555; text-align:center; background: url(<?php echo SHOP_SKINS_URL;?>/images/member/goods_pictures.gif) no-repeat 0 -70px; display: block; width:74px; height: 32px; padding: 0px; position: absolute; z-index:1; left: 0px; top: -15px;}
