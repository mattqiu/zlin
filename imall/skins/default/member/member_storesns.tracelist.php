...
<div id="lazymodule">
  ...
  <ul class="fd-list">
    ...
    <div class="fd-aside"> <span class="thumb size60"><i></i> <a href="index.php?act=store_snshome&store_id=<?php echo $val['strace_storeid'];?>" target="_blank"> <img onload="javascript:DrawImage(this,60,60);" src="<?php echo getStoreLogo($val['strace_storelogo']);?>"> </a> </span> </div>
      <dl class="fd-wrap">
        <dt>
          <h3><a href="index.php?act=store_snshome&store_id=<?php echo $val['strace_storeid'];?>" target="_blank"><?php echo $val['strace_storename'];?></a><?php echo $lang['im_colon'];?></h3>
          <h5><?php echo parsesmiles($val['strace_title']);?></h5>
          <?php if ($_SESSION['store_id'] == $val['strace_storeid']){?>
          <span class="fd-handle">
          <p class="hover-arrow"><i></i><a href="javascript:void(0);" class="down-sub" im_type="sd_del" data-param='{"txtid":"<?php echo $val['strace_id'];?>"}'><?php echo $lang['im_delete'];?></a> </p>
          </span>
          <?php }?>
        </dt>
              ...
              <div class="forward-edit">
                <form id="forwardform_<?php echo $val['strace_id'];?>" method="post" action="index.php?act=store_snshome&op=addforward">
                  ...
                  <div class="forward-add">
                    ...
                    <!-- 防止点击Enter键提交 -->
                    <div class="act"> <span class="skin-blue"><span class="btn"><a href="javascript:void(0);" im_type="s_forwardbtn" data-param='{"txtid":"<?php echo $val['strace_id'];?>"}'><?php echo $lang['sns_forward'];?></a></span></span> <span id="forwardcharcount<?php echo $val['strace_id'];?>" style="float:right;"></span> <a class="face" im_type="smiliesbtn" data-param='{"txtid":"forward<?php echo $val['strace_id'];?>"}' href="javascript:void(0);" ><?php echo $lang['sns_smiles'];?></a> </div>
                  </div>
                </form>
              </div>
