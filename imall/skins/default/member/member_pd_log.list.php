...
<div class="wrap">
  <div class="tabmenu">
	...
	<!--
    <a class="imm-btn imm-btn-green" href="index.php?act=member_security&op=auth&type=pd_cash" style="right: 107px;"><i class="fa fa-money"></i>申请提现</a> <a class="imm-btn imm-btn-blue" href="index.php?act=predeposit&op=rechargecard_add"><i class="fa fa-shield"></i>充值卡充值</a> 
	-->
	</div>
  <div class="alert"><span class="mr30"><?php echo $lang['predeposit_pricetype_available'].$lang['im_colon']; ?><strong class="mr5 red" style="font-size: 18px;"><?php echo $output['member_info']['available_predeposit']; ?></strong><?php echo $lang['currency_zh'];?></span><span><?php echo $lang['predeposit_pricetype_freeze'].$lang['im_colon']; ?><strong class="mr5 blue" style="font-size: 18px;"><?php echo $output['member_info']['freeze_predeposit']; ?></strong><?php echo $lang['currency_zh'];?></span></div>
