<?php defined('InIMall') or exit('Access Invalid!');?>
  ...
  <div class="imm-flow-item">
    ...
    <div class="item-goods">
      ...
      <dl>
        <dt>
          <div class="imm-goods-thumb-mini"><a target="_blank" href="<?php echo urlShop('goods','index',array('goods_id'=> $val['goods_id'])); ?>">
    ...
    <div class="item-order">
      ...
      <dl class="line">
        ...
        <dd><a target="_blank" href="index.php?act=member_order&op=show_order&order_id=<?php echo $output['order']['order_id']; ?>"><?php echo $output['order']['order_sn'];?></a>
            <a href="javascript:void(0);" class="a">更多<i class="fa fa-angle-down"></i>
          <div class="more"> <span class="arrow"></span>
            <ul>
              ...
              <?php } ?>
              <li><?php echo $lang['member_order_pay_method'].$lang['im_colon'];?><span><?php echo $output['order']['payment_name']; ?></span></li>
              <li><?php echo $lang['member_order_time'].$lang['im_colon'];?><span><?php echo date("Y-m-d H:i:s",$output['order']['add_time']); ?></span></li>
              <?php if ($output['order']['payment_time'] > 0) { ?>
              <li><?php echo $lang['member_show_order_pay_time'].$lang['im_colon'];?><span><?php echo date("Y-m-d H:i:s",$output['order']['payment_time']); ?></span></li>
              <?php } ?>
              <?php if ($output['order_common']['shipping_time'] > 0) { ?>
              <li><?php echo $lang['member_show_order_send_time'].$lang['im_colon'];?><span><?php echo date("Y-m-d H:i:s",$output['order_common']['shipping_time']); ?></span></li>
              <?php } ?>
              <?php if ($output['order']['finnshed_time'] > 0) { ?>
              <li><?php echo $lang['member_show_order_finish_time'].$lang['im_colon'];?><span><?php echo date("Y-m-d H:i:s",$output['order']['finnshed_time']); ?></span></li>
              <?php } ?>
            </ul>
          </div>
          </a> </dd>
      ...
      <dl class="line">
        <dt>商&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;家：</dt>
        <dd><?php echo $output['order']['store_name'];?><a href="javascript:void(0);" class="a">更多<i class="fa fa-angle-down"></i>
          <div class="more"><span class="arrow"></span>
            <ul>
              <li><?php echo $lang['member_address_location'].$lang['im_colon'];?><span><?php echo $output['store']['area_info'].'&nbsp;'.$output['store']['store_address'];?></span></li>
