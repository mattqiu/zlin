      ...
      <dl>
        ...
        <dd>
          <p>
            ...
            <a href="javascript:void(0);" id="send_auth_code" class="imm-btn ml5">
              <span id="sending" style="display:none">正在</span><span class="send_success_tips"><strong id="show_times" class="red mr5"></strong>秒后再次</span>获取短信验证码
            </a>
          </p>
