  ...
  <table class="imcu-table-style">
    <thead>
      ...
      <tr>
        ...
        <td colspan="20"><label for="all"><?php echo $lang['im_select_all'];?></label>
          <a href="javascript:void(0);" class="imcu-btn1" uri="index.php?act=member_flea&op=favorites&drop=ok" name="fav_id" confirm="<?php echo $lang['im_ensure_del'];?>" im_type="batchbutton"><span><?php echo $lang['im_del'];?></span></a></td>
      </tr>
      <?php }?>
    </thead>
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><?php echo $favorites['flea']['member_name'];?><a target="_blank" href="index.php?act=home&op=sendmsg&member_id=<?php echo $favorites['flea']['member_id'];?>" class="email" title="<?php echo $lang['im_message'];?>"></a></td>
        <td><?php echo imPriceFormat($favorites['flea']['goods_store_price']);?></td>
        <td><a href="javascript:drop_confirm('<?php echo $lang['im_ensure_del'];?>', 'index.php?act=member_flea&op=favorites&drop=ok&type=flea&fav_id=<?php echo $favorites['fav_id'];?>');" class="imcu-btn2"><?php echo $lang['im_del_&nbsp'];?></a></td>
      </tr>
      <?php }?>
      <?php }else{?>
      <tr>
    ...
    <tfoot>
      <tr>
        ...
        <td colspan="20"><label for="all2"><?php echo $lang['im_select_all'];?></label>
          <a href="javascript:void(0);" class="imcu-btn1" uri="index.php?act=member_flea&op=favorites&drop=ok" name="fav_id" confirm="<?php echo $lang['im_ensure_del'];?>" im_type="batchbutton"><span><?php echo $lang['im_del'];?></span></a>
