...
<div class="wrap">
  ...
  <div class="imm-message-setting">
    <form method="post" action="<?php echo urlShop('member_message', 'setting');?>" id="setting_form" onsubmit="ajaxpost('setting_form', '', '', 'onerror');">
      ...
      <dl>
        <dt><span><i class="fa fa-shopping-cart"></i></span>订单交易通知</dt>
        <dd>
          <ul>
            <li>
      ...
      <dl>
        <dt><span><i class="fa fa-money"></i></span>余额卡券提醒</dt>
        <dd>
          <ul>
            <li>
              ...
              <label for="predeposit_change">余额变动提醒</label>
            </li>
            <li>
              ...
              <label for="recharge_card_balance_change">充值卡余额变动提醒</label>
            </li>
            <li>
            ...
            <li>
              ...
              <label for="voucher_will_expire">代金券即将到期提醒</label>
            </li>
          </ul>
        </dd>
      </dl>
      <dl>
        <dt><span><i class="fa fa-coffee"></i></span>售后服务消息</dt>
        <dd>
          <ul>
            <li>
