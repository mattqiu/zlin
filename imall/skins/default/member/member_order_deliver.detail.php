...
<div class="imm-flow-layout">
  <div class="imm-flow-container">
    <div class="title">
      <h3><?php echo $lang['member_show_express_detail'];?></h3>
    </div>
    <div class="alert alert-block alert-info">
    
     <ul><li><strong><?php echo $lang['member_show_receive_info'].$lang['im_colon'];?></strong><?php echo $output['order_info']['extend_order_common']['reciver_name']?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $output['order_info']['extend_order_common']['reciver_info']['phone'];?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $output['order_info']['extend_order_common']['reciver_info']['address'];?></li>
      <li><strong><?php echo $lang['member_show_expre_my_fdback'].$lang['im_colon'];?></strong><?php echo $output['order_info']['extend_order_common']['order_message']; ?></li>
      <li><strong><?php echo $lang['member_show_deliver_info'].$lang['im_colon'];?></strong><?php echo $output['daddress_info']['seller_name']; ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $output['daddress_info']['telphone'];?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $output['daddress_info']['area_info'];?>&nbsp;&nbsp;<?php echo $output['daddress_info']['address'];?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $output['daddress_info']['company'];?></li></ul>
    </div>
    <div class="tabmenu">
      <ul class="tab pngFix">
    ...
    <ul class="express-log" id="express_list">
      ...
      <li class="loading"><?php echo $lang['im_common_loading'];?></li>
      <?php } ?>
    </ul>
    <div class="alert"><?php echo $lang['member_show_express_ship_tips'];?></div>
  </div>
  <div class="imm-flow-item">
    ...
    <div class="item-goods">
      ...
      <dl>
        <dt>
          <div class="imm-goods-thumb-mini"><a href="index.php?act=goods&goods_id=<?php echo $val['goods_id']; ?>" target="_blank"><img src="<?php echo thumb($val,'60'); ?>" onMouseOver="toolTip('<img src=<?php echo thumb($val,'240'); ?>>')" onMouseOut="toolTip()"/></a></div>
        </dt>
    ...
    <div class="item-order">
      ...
      <dl>
        ...
        <dd><a href="javascript:void(0);"><?php echo $output['order_info']['order_sn']; ?></a><a href="javascript:void(0);" class="a">更多<i class="fa fa-angle-down"></i>
      ...
      <dl>
        <dt><?php echo $lang['member_show_express_ship_code'].$lang['im_colon'];?></dt>
      ...
      <dl class="line">
        <dt>商&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;家：</dt>
        <dd><?php echo $output['store_info']['store_name'];?><a href="javascript:void(0);" class="a">更多<i class="fa fa-angle-down"></i>
          <div class="more"><span class="arrow"></span>
            <ul>
              <li><?php echo $lang['member_address_location'].$lang['im_colon'];?><span><?php echo $output['store_info']['area_info'].'&nbsp;'.$output['store_info']['store_address'];?></span></li>
