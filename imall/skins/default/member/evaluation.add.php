...
<div class="imm-flow-layout">
  <div class="imm-flow-container">
    <div class="title"><a href="javascript:history.go(-1);" class="imm-btn-mini fr"><i class="fa fa-reply"></i>返&nbsp;回</a>
    ...
    <form id="evalform" method="post" action="index.php?act=member_evaluate&op=<?php echo $_GET['op'];?>&order_id=<?php echo $_GET['order_id'];?>">
      ...
      <table class="imm-default-table deliver mb30">
        <thead>
          <tr>
        ...
        <tbody>
          ...
          <tr class="bd-line">
            ...
            <td valign="top" class="w100"><div class="ncgeval mb10">
                <div class="raty">
                  <input imtype="score" name="goods[<?php echo $goods['goods_id'];?>][score]" type="hidden">
                </div>
              </div></td>
      ...
      <?php if (!$output['store_info']['is_own_shop'] && $_GET['op'] != 'add_vr') { ?>
        <dl>
          <dt><?php echo $lang['member_evaluation_evalstore_type_1'].$lang['im_colon'];?></dt>
          <dd>
            <div class="raty-x2">
              <input imtype="score" name="store_desccredit" type="hidden">
            </div>
          </dd>
        </dl>
        <dl>
          <dt><?php echo $lang['member_evaluation_evalstore_type_2'].$lang['im_colon'];?></dt>
          <dd>
            <div class="raty-x2">
              <input imtype="score" name="store_servicecredit" type="hidden">
            </div>
          </dd>
        </dl>
        <dl>
          <dt><?php echo $lang['member_evaluation_evalstore_type_3'].$lang['im_colon'];?></dt>
          <dd>
            <div class="raty-x2">
              <input imtype="score" name="store_deliverycredit" type="hidden">
            </div>
          </dd>
        </dl>
        <?php } ?>
    ...
    $(document).ready(function(){
        $('.raty').raty({
            ...
            click: function(score) {
                $(this).find('[imtype="score"]').val(score);
            }
        });
