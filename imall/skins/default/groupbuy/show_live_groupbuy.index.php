...
<link href="<?php echo SHOP_SKINS_URL;?>/css/groupbuy.css" rel="stylesheet" type="text/css">
<style type="text/css">
...
<div class="imcc-breadcrumb-layout" style="display: block;">
  <div class="imcc-breadcrumb wrapper"> <i class="fa fa-home"></i> <span> <a href="index.php">首页</a> </span> <span class="arrow">></span> <span>商城抢购</span></div>
</div>
