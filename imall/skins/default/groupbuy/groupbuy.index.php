...
<style type="text/css">
.imcc-breadcrumb-layout {display: none; }
</style>
<div class="imcc-breadcrumb-layout" style="display: block;">
  <div class="imcc-breadcrumb wrapper"> <i class="fa fa-home"></i> <span> <a href="<?php echo urlShop(); ?>">首页</a> </span> <span class="arrow">></span> <span>商城抢购</span></div>
</div>
