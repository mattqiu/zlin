...
$lang['store_show_order_price']			= '价格（元）';
...
$lang['store_setting_label_tip']			= '此处为店铺页logo；<br/><span style="color:orange;">建议使用宽260像素-高80像素内的GIF或PNG透明图片；点击下方"提交"按钮后生效。</span>';
$lang['store_setting_change_banner']		= '店铺条幅';
$lang['store_setting_banner_tip']			= '此处为店铺页banner导航；<br/><span style="color:orange;">建议使用宽1200像素*高250像素的图片；点击下方"提交"按钮后生效。</span>';
$lang['store_setting_change_avatar']		= '店铺头像';
$lang['store_setting_avatar_tip']			= '此处为店铺方形头像；<br/><span style="color:orange;">建议使用宽100像素*高100像素内的方型图片；点击下方"提交"按钮后生效。</span>';
$lang['store_setting_change_weixin']		= '微信二维码';
$lang['store_setting_weixin_tip']			= '此处为店铺微信公众号二维码；<br/><span style="color:orange;">建议使用宽258像素*高258像素内的方型图片；点击下方"提交"按钮后生效。</span>';
