...
<link href="<?php echo ADMIN_SKINS_URL;?>/css/login.css" rel="stylesheet" type="text/css">
...
$(function(){
    $.supersized({
        ...
        slide_links        : 'blank',    
        slides             : [    
                                 {image : '<?php echo ADMIN_SKINS_URL;?>/images/login/1.jpg'},
                                 {image : '<?php echo ADMIN_SKINS_URL;?>/images/login/2.jpg'},
                                 {image : '<?php echo ADMIN_SKINS_URL;?>/images/login/3.jpg'},
								 {image : '<?php echo ADMIN_SKINS_URL;?>/images/login/4.jpg'},
								 {image : '<?php echo ADMIN_SKINS_URL;?>/images/login/5.jpg'}
                             ]
    ...
    if ($.browser.msie && ($.browser.version=="6.0" || $.browser.version=="7.0")){
        window.location.href='<?php echo ADMIN_SKINS_URL;?>/ie6update.html';
    }
