...
<div class="msgpage">
  <div class="msgbox">
    ...
    <div class="scon"><?php echo $lang['im_auto_redirect'];?></div>
    <div class="button">
      <?php if (is_array($output['url'])){ foreach($output['url'] as $k => $v){ ?>
      <a href="<?php echo $v['url'];?>" class="imap-btn"><?php echo $v['msg'];?></a>
      <?php } ?>
      ...
      <a href="<?php echo $output['url'];?>" class="imap-btn"><?php echo $lang['im_back_to_pre_page'];?></a> 
      <script type="text/javascript"> window.setTimeout("javascript:location.href='<?php echo $output['url'];?>'", <?php echo $time;?>); </script>
      <?php }else { ?>
      <a href="javascript:history.back()" class="imap-btn"><?php echo $lang['im_back_to_pre_page'];?></a> 
      <script type="text/javascript"> window.setTimeout("javascript:history.back()", <?php echo $time;?>); </script>
      <?php } } ?>
    </div>
    <?php } ?>
    <div class="powerby"><?php echo $lang['im_shopim_message'];?></div>
  </div>
</div>
</body>
</html>