...
<ul class="cp-toast-list">
  ...
  <li>
    <span>[商城-会员]</span>
    <a target="workspace" href="<?php echo urlAdminShop('predeposit','pd_cash_list');?>" onclick="openItem('shop|predeposit')"><i class="fa fa-bell-o"></i>有<strong><?php echo $output['statistics']['cashlist'];?></strong>条积分提现申请需要处理。</a>
  </li>
  <?php }?>
  ...
  <li>
    <span>[商城-交易]</span>
    <a target="workspace" href="<?php echo urlAdminShop('pointprod', 'pointorder_list');?>" onclick="openItem('shop|pointprod')"><i class="fa fa-bell-o"></i>有<strong><?php echo $output['statistics']['points_order'];?></strong>个云币订单需要发货。</a>
  </li>
  <?php }?>
