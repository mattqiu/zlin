...
<form action="index.php?act=common&op=pic_cut" id="form_cut" method="post">
  ...
  <div class="pic-cut-<?php echo $_GET['x'].$_GET['type'];?>">
    ...
    <div class="cut-btn"> <a href="JavaScript:void(0);" class="imap-btn-big imap-btn-green" id="pic_submit"><i class="fa fa-scissors"></i><?php echo $lang['im_submit'];?></span></a> </div>
  </div>
</form>
