...
<div class="login-layout">
  ...
  <form method="post" id="form_login">
    ...
    <div class="avatar">
      ...
      <img src="<?php if (cookie('admin_avatar') == '') {echo ADMIN_SKINS_URL. '/images/login/admin.png';} else { echo UPLOAD_SITE_URL . '/' . ATTACH_ADMIN_AVATAR . '/' . cookie('admin_avatar');}?>" alt="">
    ...
    <div class="submit"> 
      ...
      <span>
        ...
        <div class="code">
          ...
          <div class="code-img"><img src="../imall/index.php?act=seccode&op=makecode&admin=1&imhash=<?php echo getIMhash();?>" name="codeimage" id="codeimage" border="0"/></div>

          <a href="JavaScript:void(0);" id="hide" class="close" title="<?php echo $lang['login_index_close_checkcode'];?>"><i></i></a>

          <a href="JavaScript:void(0);" onclick="javascript:document.getElementById('codeimage').src='index.php?act=seccode&op=makecode&admin=1&imhash=<?php echo getIMhash();?>&t=' + Math.random();" class="change" title="<?php echo $lang['login_index_change_checkcode'];?>"><i></i></a> 
  ...
  <div class="bottom">
    ...
    <h6>© 2013-2015 <a href="<?php echo C('main_site_url');?>" target="_blank">Powered by <?php echo C('site_name'); ?>.</a></h6>
