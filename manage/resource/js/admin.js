$(function() {
    ...
    /* BACK TO TOP */
		...
		$('#searchBarOpen').click(function() {
            $('.imap-search-ban-s').animate({'right': '-40px'},200,
            function() {
                $('.imap-search-bar').animate({'right': '0'},300);
            });
        });
        $('#searchBarClose').click(function() {
            $('.imap-search-bar').animate({'right': '-240px'}, 300,
            function() {
                $('.imap-search-ban-s').animate({'right': '0'},  200);
            });            
        });
		// 搜索项目过多时出现滚动条
