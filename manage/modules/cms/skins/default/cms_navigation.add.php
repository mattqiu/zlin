...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=cms_navigation&op=cms_navigation_list" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['im_cms_navigation_manage'];?> - <?php echo $lang['im_new'];?></h3>
  ...
  <form id="add_form" method="post" action="index.php?act=cms_navigation&op=cms_navigation_save">
    <div class="imap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="navigation_sort"><em>*</em><?php echo $lang['im_sort'];?></label>
        </dt>
        <dd class="opt">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="isuse_1" class="cb-enable selected" title="<?php echo $lang['im_yes'];?>"><?php echo $lang['im_yes'];?></label>
            <label for="isuse_0" class="cb-disable" title="<?php echo $lang['im_no'];?>"><?php echo $lang['im_no'];?></label>
