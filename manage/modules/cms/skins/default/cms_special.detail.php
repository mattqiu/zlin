...
<meta name="copyright" content="iMall Inc. All Rights Reserved">
<style type="text/css">
...
.special-goods-list li { float: left; width: 210px; padding: 15px 30px; margin: 15px 13px 15px 12px; border: solid 1px #D8D8D8;}
.special-goods-list dl { border: none; width: 210px; height: 60px; padding: 210px 0 0 0; position: relative; z-index: 1;}
.special-goods-list dt.name { font-size: 12px; line-height: 18px; height: 36px; margin: 5px; overflow: hidden;}
.special-goods-list dd.image { width: 210px; height: 210px; position: absolute; z-index: 1; top: 0; left: 0;}
.special-goods-list dd.image a { text-align: center; vertical-align: middle; display: table-cell; width:210px; height: 210px; overflow: hidden;}
.special-goods-list dd.image img { max-width: 210px; max-height: 210px; margin-top:expression(100-this.height/2);}
