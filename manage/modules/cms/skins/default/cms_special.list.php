    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="handle"><a href="index.php?act=cms_special&op=cms_special_drop&special_id=<?php echo $val['special_id'];?>" class="btn red confirm-del"><i class="fa fa-trash-o"></i><?php echo $lang['im_del'];?></a> <span class="btn"><em><i class="fa fa-cog"></i><?php echo $lang['im_set'];?><i class="arrow"></i></em>
            <ul>
              <li>
          ...
          <td>
            <a href="javascript:;" class="pic-thumb-tip" onmouseout="toolTip()" onmouseover="toolTip('<img src=\'<?php echo $val['special_image'] ? getCMSSpecialImageUrl($val['special_image']) : ADMIN_SKINS_URL . '/images/preview.png'; ?>\'>')">
