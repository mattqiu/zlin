...
<link href="<?php echo CMS_SITE_URL.DS;?>skins/cms_special.css" rel="stylesheet" type="text/css"/>
...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=cms_index&op=cms_index" title="返回模板"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['im_cms_index_manage'];?> - <?php echo $lang['cms_index_module_edit'];?></h3>
        <h5>资讯首页模板可视化编辑生成</h5>
      </div>
  ...
  <form id="add_form" method="post" action="index.php?act=cms_index&op=save_page_module">
    ...
    <div class="imap-form-all">
      ...
      <div class="bot"><a href="Javascript: void(0)" class="imap-btn-big imap-btn-green" id="btn_module_save"><?php echo $lang['cms_text_save'];?></a></div>
    </div>
  </form>
</div>
<!--编辑标题-->
<div id="dialog_module_title_edit" style="display:none;">
  <div class="imap-form-default">
    ...
    <div class="bot"><a class="imap-btn-big imap-btn-green" id="btn_module_title_save" href="JavaScript:void(0);"><?php echo $lang['cms_text_save'];?></a></div>
  </div>
</div>
<!-- 关键字标题 -->
    ...
    <dl class="row">
      ...
      <dd class="opt">
        <ul class="article-tag-list">
          ...
          <li imtype="btn_tag_select" data-tag-id="<?php echo $value['tag_id'];?>"><a href="<?php echo CMS_SITE_URL;?>/index.php?act=article&op=article_tag_search&tag_id=<?php echo $value['tag_id'];?>" ><?php echo $value['tag_name'];?></a><i></i></li>
          <?php } ?>
          <?php } ?>
        </ul>
      </dd>
    </dl>
    <div class="bot"><a class="imap-btn-big imap-btn-green" id="btn_module_tag_save" href="JavaScript:void(0);"><?php echo $lang['cms_text_save'];?></a></div>
  </div>
</div>
<!--编辑图片-->
<div id="dialog_module_image_edit" style="display:none;">
  ...
  <form action="index.php?act=cms_index&op=image_upload" method="post">
    <div class="imap-form-default">
      ...
      <div class="bot"><a class="imap-btn-big imap-btn-green" id="btn_module_image_save" href="JavaScript:void(0);"><?php echo $lang['cms_text_save'];?></a></div>
    </div>
  </form>
</div>
<!--编辑文章-->
      ...
      <dd class="opt">
        <div class="dialog-show-box">
          <div class="search-bar">
            ...
            <a href="JavaScript:void(0);" id="btn_article_search" class="imap-btn"><?php echo $lang['cms_text_search'];?></a></div>
          <div id="div_article_select_list" class="show-recommend-goods-list"> </div>
        </div>
      </dd>
    </dl>
    <div class="bot"><a class="imap-btn-big imap-btn-green" id="btn_module_article_save" href="JavaScript:void(0);"><?php echo $lang['cms_text_save'];?></a></div>
  </div>
</div>
<!--编辑商品-->
<div id="dialog_module_goods_edit" class="dialog-special-insert-goods upload_adv_dialog" style="display:none;">
  ...
  <div id="upload_adv_type" class="imap-form-default">
    <dl class="row">
      <dt class="tit"><?php echo $lang['cms_index_module_goods_input_url'];?></dt>
      <dd class="opt">
        <input id="input_goods_link" type="text" class="input-txt" />
        <a class="imap-btn" id="btn_goods_search" href="javascript:void(0);"><?php echo $lang['cms_text_add'];?></a>
  ...
  <div class="bot"><a class="imap-btn-big imap-btn-green" id="btn_module_goods_save" href="JavaScript:void(0);"><?php echo $lang['cms_text_save'];?></a></div>
</div>
<!-- 品牌选择弹出窗口 -->
<div id="dialog_module_brand_edit" class="brand_list_dialog" style="display:none;">
  ...
  <div class="imap-form-all" id="upload_adv_type">
    <dl class="row">
      <dt class="tit"><?php echo $lang['cms_index_module_brand_selected'];?><?php echo $lang['im_colon'];?></dt>
      <dd class="opt">
    ...
    <dl class="row">
      <dt class="tit"><?php echo $lang['cms_index_module_brand_list'];?><?php echo $lang['im_colon'];?></dt>
      <dd class="opt">
        <div id="div_brand_select_list" class="dialog-show-box"></div>
      </dd>
    </dl>
    <div class="bot"><a class="imap-btn-big imap-btn-green" id="btn_module_brand_save" href="JavaScript:void(0);"><?php echo $lang['cms_text_save'];?></a></div>
  </div>
</div>
<!-- 商品分类选择弹出窗口 -->
<div id="dialog_module_goods_class_edit" class="goods_class_list_dialog" style="display:none;">
  ...
  <div class="bot"><a class="imap-btn-big imap-btn-green" id="btn_module_goods_class_save" href="JavaScript:void(0);"><?php echo $lang['cms_text_save'];?></a></div>
</div>
<!--编辑店铺-->
    ...
    <dl class="row">
      ...
      <dd class="opt">
        <div class="search-bar">
          ...
          <a href="JavaScript:void(0);" id="btn_store_search" class="imap-btn"><?php echo $lang['cms_text_search'];?></a></div>
        <div class="dialog-show-box">
          <div id="div_store_select_list" class="show-store-list"> </div>
        </div>
      </dd>
    </dl>
    <div class="bot"><a class="imap-btn-big imap-btn-green" id="btn_module_store_save" href="JavaScript:void(0);"><?php echo $lang['cms_text_save'];?></a></div>
  </div>
</div>
<!--编辑会员-->
    ...
    <dl class="row">
      ...
      <dd class="opt">
        <div class="search-bar">
          ...
          <a href="JavaScript:void(0);" id="btn_member_search" class="imap-btn"><?php echo $lang['cms_text_search'];?></a></div>
        <div class="dialog-show-box">
          <div id="div_member_select_list" class="show-member-list"> </div>
        </div>
      </dd>
    </dl>
    <div class="bot"><a class="imap-btn-big imap-btn-green" id="btn_module_member_save" href="JavaScript:void(0);"><?php echo $lang['cms_text_save'];?></a></div>
  </div>
</div>
<!--编辑FLASH-->
<div id="dialog_module_flash_edit" style="display:none;">
  ...
  <div class="imap-form-default">
    ...
    <div class="bot"><a id="btn_module_flash_save" href="JavaScript:void(0);" class="imap-btn-big imap-btn-green" ><?php echo $lang['cms_text_save'];?></a></div>
  </div>
</div>
<!-- FLASH组件模板 --> 
...
<div id="dialog_module_html_edit" style="display:none;">
  <div class="imap-form-all">
    ...
    <div class="bot"><a class="imap-btn-big imap-btn-green"id="btn_module_html_save" href="JavaScript:void(0);"><?php echo $lang['cms_text_save'];?></a></div>
  </div>
</div>
