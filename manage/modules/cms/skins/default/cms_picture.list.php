...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['im_cms_picture_manage'];?></h3>
        <h5><?php echo $lang['im_cms_picture_manage_subhead'];?></h5>
      </div>
...
<div id="dialog_verify" style="display:none;">
  <form id="verify_form" method='post' action="index.php?act=cms_picture&op=cms_picture_verify">
    ...
    <div class="imap-form-default">
      ...
      <dl class="row" style="display: none;" imtype="reason">
        <dt class="tit">
      ...
      <div class="bot"><a id="btn_verify_submit" class="imap-btn-big imap-btn-green" href="javascript:void(0);"><?php echo $lang['im_submit'];?></a></div>
    </div>
  </form>
</div>
<script>
$(function(){
    ...
    $('input[name="verify_state"]').click(function() {
        if ($(this).val() == 1) {
            $('tr[imtype="reason"]').hide();
        } else {
            $('tr[imtype="reason"]').show();
        }
    });
...
$("a[data-j='audit']").live('click', function() {
    ...
    $('#dialog_verify').im_show_dialog({title:'审核'});
});
