...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=cms_special&op=cms_special_list" title="返回专题列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['im_cms_special_manage'];?> -  新增专题页</h3>
        <h5><?php echo $lang['im_cms_special_manage_subhead'];?></h5>
      </div>
    </div>
  </div>
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?act=cms_special&op=cms_special_save">
    ...
    <div class="imap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <div class="imap-upload-btn">
            ...
            <a href="javascript:void(0);" class="imap-btn"><i class="fa fa-upload"></i><?php echo $lang['cms_text_image_upload'];?></a> </div>
          <div class="imap-upload-btn">
            <input class="input-button" id="btn_show_special_insert_goods" type="button" value="" />
            <a href="javascript:void(0);" class="imap-btn"><i class="fa fa-cubes"></i><?php echo $lang['cms_text_goods_add'];?></a></div>
      ...
      <div class="bot"><a href="JavaScript:void(0);" class="imap-btn-big imap-btn-blue" id="btn_draft"><?php echo $lang['cms_special_draft'];?></a> <a href="JavaScript:void(0);" class="imap-btn-big imap-btn-green" id="btn_publish"><?php echo $lang['cms_special_publish'];?></a></div>
    </div>
  </form>
  <!-- 插入图片链接对话框 -->
