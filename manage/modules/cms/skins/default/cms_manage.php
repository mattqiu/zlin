...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['im_cms_manage'];?></h3>
        <h5><?php echo $lang['im_cms_manage_subhead'];?></h5>
      </div>
    </div>
  </div>
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?act=cms_manage&op=cms_manage_save">
    <div class="imap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="cms_isuse_1" class="cb-enable <?php if($output['setting']['cms_isuse'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['im_open'];?>"><?php echo $lang['im_open'];?></label>
            <label for="cms_isuse_0" class="cb-disable <?php if($output['setting']['cms_isuse'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['im_close'];?>"><?php echo $lang['im_close'];?></label>
      ...
      <dl class="row">
        <dt class="tit">
          <label for="class_image"><?php echo $lang['im_cms'].'LOGO';?></label>
        </dt>
        <dd class="opt">
          <div class="input-file-show"><span class="show">
            ...
            <input class="type-file-file" id="cms_logo" name="cms_logo" type="file" size="30" hidefocus="true" im_type="cms_image" title="点击前方预览图可查看大图，点击按钮选择文件并提交表单后上传生效">
            </span></div>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="cms_submit_verify_flag_1" class="cb-enable <?php if($output['setting']['cms_submit_verify_flag'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['im_open'];?>"><?php echo $lang['im_open'];?></label>
            <label for="cms_submit_verify_flag_0" class="cb-disable <?php if($output['setting']['cms_submit_verify_flag'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['im_close'];?>"><?php echo $lang['im_close'];?></label>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="cms_comment_flag_1" class="cb-enable <?php if($output['setting']['cms_comment_flag'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['im_open'];?>"><?php echo $lang['im_open'];?></label>
            <label for="cms_comment_flag_0" class="cb-disable <?php if($output['setting']['cms_comment_flag'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['im_close'];?>"><?php echo $lang['im_close'];?></label>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="cms_attitude_flag_1" class="cb-enable <?php if($output['setting']['cms_attitude_flag'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['im_open'];?>"><?php echo $lang['im_open'];?></label>
            <label for="cms_attitude_flag_0" class="cb-disable <?php if($output['setting']['cms_attitude_flag'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['im_close'];?>"><?php echo $lang['im_close'];?></label>
...
$(document).ready(function(){
    ...
    $("input[im_type='cms_image']").live("change", function(){
