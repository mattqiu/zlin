...
$(document).ready(function() {
    ...
    var control_html = '<div id="indexPersonalControl" imtype="cms_index_not_save">';
    ...
    //店铺
    $("[im_type='index_store']").each(function() {
...
<div class="cms-index-module-micro">
  <div id="micro_content" imtype="object_module_edit"> <?php echo html_entity_decode($module_content['micro_content']);?>
  </div>
