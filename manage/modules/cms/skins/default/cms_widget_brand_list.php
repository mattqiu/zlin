...
<div class="brand-select-box">
  ...
  <ul id="brand_search_list" class="brand-search-list">
    ...
    <li>
      <div class="cms-thumb"><a imtype="brand_item" href="<?php echo SHOP_SITE_URL;?>/index.php?act=brand&op=list&brand=<?php echo $value['brand_id'];?>" data-brand-id="<?php echo $value['brand_id'];?>" title="<?php echo $value['brand_name'];?>" target="_blank"><img style="width:78px;" src="<?php echo brandImage($value['brand_pic']);?>" alt="<?php echo $value['brand_name'];?>" /></a></div>
      ...
      <div imtype="btn_brand_select" class="add-brand"><i></i></div>
    </li>
    <?php } ?>
