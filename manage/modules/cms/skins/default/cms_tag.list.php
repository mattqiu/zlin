...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['im_cms_tag_manage'];?></h3>
        <h5><?php echo $lang['im_cms_tag_manage_subhead'];?></h5>
      </div>
    </div>
  </div>
  <!-- 操作说明 -->
    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr data-id="<?php echo $val['tag_id'];?>">
          ...
          <td class="handle-s"><a href="javascript:submit_delete(<?php echo $val['tag_id'];?>)" class="btn red"><i class="fa fa-trash-o"></i><?php echo $lang['im_del'];?></a></td>
          <td class="sort"><span im_type="tag_sort" column_id="<?php echo $val['tag_id'];?>" title="<?php echo $lang['im_editable'];?>" class="editable "><?php echo $val['tag_sort'];?></span></td>
          <td class="name"><span im_type="tag_name" column_id="<?php echo $val['tag_id'];?>" title="<?php echo $lang['im_editable'];?>" class="editable "><?php echo $val['tag_name'];?></span></td>
...
$(document).ready(function(){
    ...
    //行内ajax编辑
    $('span[im_type="tag_sort"]').inline_edit({act: 'cms_tag',op: 'update_tag_sort'});
    $('span[im_type="tag_name"]').inline_edit({act: 'cms_tag',op: 'update_tag_name'});
});
