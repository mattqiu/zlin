...
Tpl::showpage('cms_navigation.add');
    ...
    private function update_navigation($column, $new_value) {
        ...
        if($result) {
            ...
            echo json_encode(array('result'=>FALSE, 'message'=>Language::get('im_common_save_fail')));
            die;
        }
    }
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'list'=>array('menu_type'=>'link','menu_name'=>Language::get('im_list'),'menu_url'=>'index.php?act=cms_navigation&op=cms_navigation_list'),
            'add'=>array('menu_type'=>'link','menu_name'=>Language::get('im_new'),'menu_url'=>'index.php?act=cms_navigation&op=cms_navigation_add'),
        );
