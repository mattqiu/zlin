...
Tpl::showpage('cms_article_class.add');
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'list'=>array('menu_type'=>'link','menu_name'=>Language::get('im_list'),'menu_url'=>'index.php?act=cms_article_class&op=cms_article_class_list'),
            'add'=>array('menu_type'=>'link','menu_name'=>Language::get('im_new'),'menu_url'=>'index.php?act=cms_article_class&op=cms_article_class_add'),
        );
