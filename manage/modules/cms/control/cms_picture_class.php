...
Tpl::showpage('cms_picture_class.add');
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'list'=>array('menu_type'=>'link','menu_name'=>Language::get('im_list'),'menu_url'=>'index.php?act=cms_picture_class&op=cms_picture_class_list'),
            'add'=>array('menu_type'=>'link','menu_name'=>Language::get('im_new'),'menu_url'=>'index.php?act=cms_picture_class&op=cms_picture_class_add'),
        );
