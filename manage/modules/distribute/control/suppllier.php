...
class suppllierControl extends SystemControl {
	private $links = array(
        array('url'=>'act=extension_config&op=config','lang'=>'extension_config'),
        array('url'=>'act=extension_config&op=manage','lang'=>'extension_manage'),
        array('url'=>'act=extension_config&op=perfor','lang'=>'extension_perfor'),
		array('url'=>'act=extension_config&op=commislevel','lang'=>'extension_commislevel'),
		array('url'=>'act=extension_config&op=commisclass','lang'=>'extension_commisclass'),
		//array('url'=>'act=extension_config&op=priceclass','lang'=>"extension_priceclass"),
    );
