...
class returnControl extends SystemControl{
    ...
    public function get_manage_xmlOp() {
        ...
        foreach ($return_list as $k => $return_info) {
            ...
            $list['refund_amount'] = imPriceFormat($return_info['refund_amount']);
    ...
    public function editOp() {
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                ...
                showMessage(Language::get('im_common_save_succ'),'index.php?act=return&op=return_manage');
            } else {
                showMessage(Language::get('im_common_save_fail'));
            }
        }
    ...
    private function createCsv($return_list) {
        ...
        //output('return' .$_GET['curpage'] . '-'.date('Y-m-d'), $data, $header);
    }
}
