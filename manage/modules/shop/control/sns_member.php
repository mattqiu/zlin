...
class sns_memberControl extends SystemControl{
        ...
        if(chksubmit()){
            ...
            if($error != ''){
                ...
                if ($result){
                    ...
                    $this->log(L('im_add,sns_member_tag').'['.$_POST['membertag_name'].']',1);
                    showMessage(Language::get('im_common_op_succ'),$url);
                }else {
                    showMessage(Language::get('im_common_op_fail'));
                }
            }
    ...
    public function tag_editOp(){
        ...
        if(chksubmit()){
            ...
            if($error != ''){
                ...
                if ($result){
                    $this->log(L('im_edit,sns_member_tag').'['.$_POST['membertag_name'].']',1);
                    showMessage(Language::get('im_common_op_succ'),'index.php?act=sns_member&op=member_tag');
                }else {
                    showMessage(Language::get('im_common_op_fail'));
                }
            }
    ...
    public function tag_delOp(){
        ...
        if ($result){
            $this->log(L('im_del,sns_member_tag').'[ID:'.$mtag_id.']',1);
