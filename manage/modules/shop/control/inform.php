...
class informControl extends SystemControl{
    ...
    public function inform_subject_type_saveOp(){
        ...
        if ($error != ''){
            ...
            $this->log(L('im_add,inform_type').'['.$_POST['inform_type_name'].']',1);
            showMessage(Language::get('im_common_save_succ'),'index.php?act=inform&op=inform_subject_type_list');
        }
    }
    ...
    public function inform_subject_type_dropOp(){
        ...
        $this->log(L('im_del,inform_type').'[ID:'.$_POST['inform_type_id'].']',1);
        showMessage(Language::get('im_common_del_succ'),'index.php?act=inform&op=inform_subject_type_list');
    ...
    public function inform_subject_saveOp(){
        ...
        if ($error != ''){
            ...
            $this->log(L('im_add,inform_subject').'['.$input['inform_subject_type_name'].']',1);
            showMessage(Language::get('im_common_save_succ'),'index.php?act=inform&op=inform_subject_list');
        }
    }
    ...
    public function inform_subject_dropOp(){
        ...
        $this->log(L('im_del,inform_subject').'['.$_POST['inform_subject_id'].']',1);
        showMessage(Language::get('im_common_del_succ'),'index.php?act=inform&op=inform_subject_list');
    }
    ...
    public function inform_handleOp(){
        ...
        if($model_inform->updateInform($update_array,$where_array)) {
            ...
            showMessage(Language::get('im_common_op_succ'),'index.php?act=inform&op=inform_list');
        }
        else {
