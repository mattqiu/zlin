...
class paymentControl extends SystemControl{
    ...
    public function indexOp(){
		...
		if (empty($payment_list) || !is_array($payment_list)){
			$model_payment->InitPayment(0,'root');
			$payment_list = $model_payment->getPaymentList(array());
		}
    ...
    public function editOp(){
        ...
        if (chksubmit()){
            ...
            showMessage(Language::get('im_common_save_succ'),'index.php?act=payment&op=index');
        }
