    ...
    public function general_listOp(){
        ...
        if (!empty($gc_childarr) && is_array($gc_childarr)){
            ...
            foreach ($gc_childarr as $k => $v){
                ...
                $tmp['priceavg'] = imPriceFormat(($t = $goods_list[$v['gc_id']]['priceavg'])?$t:0);
    ...
    public function get_general_xmlOp(){
        ...
        if ($gc_childarr){
            ...
            foreach ($gc_childarr as $k => $v){
                ...
                $out_array['priceavg'] = imPriceFormat(($t = $goods_list[$v['gc_id']]['priceavg'])?$t:0);
                ...
                $out_array['orderamount'] = imPriceFormat(($t = $ordergoods_list[$v['gc_id']]['orderamount'])?$t:0);
