...
class sns_straceControl extends SystemControl{
    ...
    public function strace_delOp(){
        ...
        if($rs){
            ...
            $this->log(L('im_del,admin_snstrace_comment'),1);
    ...
    public function strace_editOp(){
        ...
        if($rs){
            $this->log(L('im_edit,admin_snstrace_comment'),1);
            showDialog(L('im_common_op_succ'), '', 'succ', '$("#flexigrid").flexReload();');
        }else{
            showDialog(L('im_common_op_fail'));
        }
    }
    ...
    public function scomm_delOp(){
        ...
        if($rs){
            $this->log(L('im_del,admin_snstrace_pl'),1);
            exit(json_encode(array('state'=>true,'msg'=>'删除成功')));
        }else{
            exit(json_encode(array('state'=>false,'msg'=>'删除失败')));
        }
    ...
    public function scomm_editOp(){
        ...
        if($rs){
            $this->log(L('im_edit,admin_snstrace_pl'),1);
            showDialog(L('im_common_op_succ'), '', 'succ', '$("#flexigrid").flexReload();');
        }else{
            showDialog(L('im_common_op_fail'));
        }
