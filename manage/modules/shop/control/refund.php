...
class refundControl extends SystemControl{
    ...
    public function editOp() {
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                ...
                showMessage(Language::get('im_common_save_succ'),'index.php?act=refund&op=index');
            } else {
                showMessage(Language::get('im_common_save_fail'));
            }
        }
    ...
    public function add_reasonOp() {
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                ...
                showMessage(Language::get('im_common_save_succ'),'index.php?act=refund&op=reason');
            } else {
                showMessage(Language::get('im_common_save_fail'));
            }
        }
    ...
    public function del_reasonOp() {
        ...
        if ($state) {
            ...
            showMessage(Language::get('im_common_del_succ'),'index.php?act=refund&op=reason');
        } else {
    ...
    private function createCsv($refund_list) {
        ...
        foreach ($refund_list as $k => $refund_info) {
            ...
            $list[$k]['refund_amount'] = imPriceFormat($refund_info['refund_amount']);
            if(!empty($refund_info['pic_info'])) {
                $info = unserialize($refund_info['pic_info']);
                if (is_array($info) && !empty($info['buyer'])) {
                    foreach($info['buyer'] as $pic_name) {
        ...
        //output('refund' .$_GET['curpage'] . '-'.date('Y-m-d'), $list, $header);
    }
}
