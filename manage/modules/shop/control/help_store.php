    ...
    public function add_helpOp() {
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                ...
                showMessage(Language::get('im_common_save_succ'),'index.php?act=help_store&op=help_store');
            } else {
    ...
    public function add_typeOp() {
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                ...
                showMessage(Language::get('im_common_save_succ'),'index.php?act=help_store&op=help_type');
            } else {
                showMessage(Language::get('im_common_save_fail'));
            }
        }
