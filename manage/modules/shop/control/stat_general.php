...
class stat_generalControl extends SystemControl{
    ...
    public function generalOp(){
        ...
        $statnew_arr['orderavg'] = imPriceFormat(($t = $stat_order['orderavg'])?$t:0);
        unset($stat_order);
        ...
        $statnew_arr['priceavg'] = imPriceFormat(($t = $stat_ordergoods['priceavg'])?$t:0);
    ...
    public function settingOp(){
        ...
        if (chksubmit()){
            ...
            if ($result === true){
                $this->log(L('im_edit,stat_setting'),1);
                showMessage(L('im_common_save_succ'));
            }else {
                $this->log(L('im_edit,stat_setting'),0);
