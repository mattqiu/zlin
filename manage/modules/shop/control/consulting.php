...
class consultingControl extends SystemControl{
    ...
    public function deleteOp(){
        ...
        if (preg_match('/^[\d,]+$/', $_GET['consult_id'])) {
            ...
            if ($del) {
                $this->log(L('im_delete,consulting').'[ID:'.implode(',',$_GET['consult_id']).']',null);
    ...
    public function type_addOp() {
        if (chksubmit()) {
            ...
            if ($result){
                $this->log('新增咨询类型',1);
                showMessage(L('im_common_save_succ'), urlAdminShop('consulting', 'type_list'));
            }else {
                $this->log('新增咨询类型',0);
                showMessage(L('im_common_save_fail'));
            }
    ...
    public function type_editOp() {
        ...
        if (chksubmit()) {
            ...
            if ($result){
                ...
                showMessage(L('im_common_op_succ'), urlAdminShop('consulting', 'type_list'));
            }else {
