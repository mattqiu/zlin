...
class store_joininControl extends SystemControl{
    ...
    public function edit_infoOp() {
        ...
        if (chksubmit()) {
            ...
            showMessage(Language::get('im_common_save_succ'),'index.php?act=store_joinin&op=edit_info');
        }
    ...
    public function edit_helpOp() {
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                ...
                showMessage(Language::get('im_common_save_succ'),'index.php?act=store_joinin&op=help_list');
            } else {
