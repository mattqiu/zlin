...
class sns_malbumControl extends SystemControl{
    ...
    public function get_xmlOp() {
        ...
        foreach ($ac_list as $value) {
            ...
            $param['ac_cover'] = "<a href='javascript:void(0);' class='pic-thumb-tip' onMouseOut='toolTip()' onMouseOver='toolTip(\"<img src=".($value['ac_cover'] != '' ? UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$value['member_id'].DS.$value['ac_cover'] : ADMIN_SITE_URL.'/skins/'.TPL_NAME.'/images/member/default_image.png').">\")'><i class='fa fa-picture-o'></i></a>";
    ...
    public function pic_listOp(){
        ...
        if(chksubmit()){
            ...
            $this->log(L('im_del,im_member_album_manage').'[ID:'.implode(',',$_POST['id']).']',1);
