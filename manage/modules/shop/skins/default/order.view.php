...
<div class="page">
  ...
  <div class="imap-order-style">
    <div class="titile">
      <h3></h3>
    </div>
    <div class="imap-order-flow">
      <ol class="num5">
        <li class="current">
          <h5>生成订单</h5>
    ...
    <div class="imap-order-details">
      ...
      <div class="tabs-panels">
        <div class="misc-info">
          <h4>下单/支付</h4>
          <dl>
            <dt><?php echo $lang['order_number'];?><?php echo $lang['im_colon'];?></dt>
            <dd><?php echo $output['order_info']['order_sn'];?><?php if ($output['order_info']['order_type'] == 2) echo '[预定]';?></dd>
            <dt>订单来源<?php echo $lang['im_colon'];?></dt>
            <dd><?php echo str_replace(array(1,2,3), array('PC端','移动端', '导购开单'), $output['order_info']['order_from']);?></dd>
            <dt><?php echo $lang['order_time'];?><?php echo $lang['im_colon'];?></dt>
            <dd><?php echo date('Y-m-d H:i:s',$output['order_info']['add_time']);?></dd>
          </dl>
          <?php if(intval($output['order_info']['payment_time'])){?>
          <dl>
            <dt>支付单号<?php echo $lang['im_colon'];?></dt>
            <dd><?php echo $output['order_info']['pay_sn'];?></dd>
            <dt><?php echo $lang['payment'];?><?php echo $lang['im_colon'];?></dt>
            <dd><?php echo orderPaymentName($output['order_info']['payment_code']);?></dd>
            <dt><?php echo $lang['payment_time'];?><?php echo $lang['im_colon'];?></dt>
        ...
        <div class="addr-note">
          <h4>购买/收货方信息</h4>
          <dl>
            <dt><?php echo $lang['buyer_name'];?><?php echo $lang['im_colon'];?></dt>
            <dd><?php echo $output['order_info']['buyer_name'];?></dd>
            <dt>联系方式<?php echo $lang['im_colon'];?></dt>
            <dd><?php echo @$output['order_info']['extend_order_common']['reciver_info']['phone'];?></dd>
          </dl>
          <dl>
            <dt>收货地址<?php echo $lang['im_colon'];?></dt>
          ...
          <dl>
            <dt>发票信息<?php echo $lang['im_colon'];?></dt>
            <dd>
              ...
              <ul>
                ...
                <li><strong><?php echo $key.$lang['im_colon'];?></strong><?php echo $value;?></li>
                <?php } ?>
              </ul>
              <?php } ?>
            </dd>
          ...
          <dl>
            <dt>买家留言<?php echo $lang['im_colon'];?></dt>
        ...
        <div class="contact-info">
          <h4>销售/发货方信息</h4>
          <dl>
            <dt><?php echo $lang['store_name'];?><?php echo $lang['im_colon'];?></dt>
            <dd><?php echo $output['order_info']['store_name'];?></dd><dt>店主名称<?php echo $lang['im_colon'];?></dt>
            <dd><?php echo $output['store_info']['seller_name'];?></dd>
            <dt>联系电话<?php echo $lang['im_colon'];?></dt>
            <dd><?php echo $output['store_info']['store_phone'];?></dd>
          </dl>
          <dl>
            <dt>发货地址<?php echo $lang['im_colon'];?></dt>
          ...
          <dl>
            ...
            <dt>快递公司<?php echo $lang['im_colon'];?></dt>
            <dd><?php echo $output['order_info']['express_info']['e_name'];?></dd>
            <dt>物流单号<?php echo $lang['im_colon'];?></dt>
            <dd>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="text-align: left;"><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=goods&goods_id=<?php echo $goods['goods_id'];?>" target="_blank"><?php echo $goods['goods_name'];?></a></td>
                <td class="w80"><?php echo $lang['currency'].imPriceFormat($goods['goods_price']);?></td>
                ...
                <td class="w80"><?php echo $goods['commis_rate'] == 200 ? '' : imPriceFormat($goods['goods_pay_price']*$goods['commis_rate']/100);?></td>
              </tr>
                <!-- S 赠品列表 -->
            ...
            <tfoot>
              ...
              <tr>
                <td colspan="10"><?php if(!empty($output['order_info']['extend_order_common']['promotion_info'])){ ?>
                  ...
                  使用了面额为 <?php echo $lang['im_colon'];?> <?php echo $output['order_info']['extend_order_common']['voucher_price'];?> 元的代金券，
        ...
        <div class="total-amount">
          <h3><?php echo $lang['order_total_price'];?><?php echo $lang['im_colon'];?><strong class="red_common"><?php echo $lang['currency'].imPriceFormat($output['order_info']['order_amount']);?></strong></h3>
          <h4>(<?php echo $lang['order_total_transport'];?><?php echo $lang['im_colon'];?><?php echo $lang['currency'].imPriceFormat($output['order_info']['shipping_fee']);?>)</h4>
          <?php if($output['order_info']['refund_amount'] > 0) { ?>
          (<?php echo $lang['order_refund'];?><?php echo $lang['im_colon'];?><?php echo $lang['currency'].imPriceFormat($output['order_info']['refund_amount']);?>)
          <?php } ?>
        </div>
      </div>
      <?php if(is_array($output['refund_list']) and !empty($output['refund_list'])) { ?>
      <div class="tabs-panels tabs-hide">
        <div>
          ...
          <dl>
            <dt>退款单号<?php echo $lang['im_colon'];?></dt>
            <dd><?php echo $val['refund_sn'];?></dd>
            <dt>退款金额<?php echo $lang['im_colon'];?></dt>
            <dd><?php echo $lang['currency'];?><?php echo imPriceFormat($val['refund_amount']); ?></dd>
            <dt>发生时间<?php echo $lang['im_colon'];?></dt>
            <dd><?php echo date("Y-m-d H:i:s",$val['admin_time']); ?></dd>
            <dt>备注<?php echo $lang['im_colon'];?></dt>
      ...
      <div class="tabs-panels tabs-hide">
        <div>
          ...
          <dl>
            <dt>退货单号<?php echo $lang['im_colon'];?></dt>
            <dd><?php echo $val['refund_sn'];?></dd>
            <dt>退款金额<?php echo $lang['im_colon'];?></dt>
            <dd><?php echo $lang['currency'];?><?php echo imPriceFormat($val['refund_amount']); ?></dd>
            <dt>发生时间<?php echo $lang['im_colon'];?></dt>
    ...
    $(function() {
        $(".tabs-nav > li > a").mousemove(function(e) {
            if (e.target == this) {
                ...
                var panels = $(this).parents('.imap-order-details:first').children(".tabs-panels");
