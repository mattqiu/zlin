...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li>焦点区位于品牌首页，大图区可设置背景颜色。</li>
      <li>所有相关设置完成，使用底部的“更新板块内容”前台展示页面才会变化。</li>
    </ul>
  </div>
  <div class="homepage-focus" id="homepageFocusTab">
    <form id="upload_screen_form" class="tab-content" name="upload_screen_form" enctype="multipart/form-data" method="post" action="index.php?act=brand&op=screen_pic" target="upload_pic">
      ...
      <div class="imap-form-default">
        <div class="bot">
          ...
          <a href="index.php?act=brand&op=html_update&web_id=<?php echo $output['code_screen_list']['web_id'];?>" class="imap-btn-big imap-btn-green"><?php echo $lang['web_config_web_html'];?></a> 
