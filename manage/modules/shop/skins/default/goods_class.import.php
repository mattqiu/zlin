      ...
      <dl class="row">
        ...
        <dd class="opt">
          <table border="1" cellpadding="3" cellspacing="3" bordercolor="#CCC">
            <tbody>
              <tr>
                <td bgcolor="#EFF8F8"><?php echo $lang['im_sort'];?></td>
          ...
          <p class="notic"><a href="<?php echo RESOURCE_SITE_URL;?>/examples/goods_class.csv" class="imap-btn"><?php echo $lang['goods_class_import_example_tip'];?></a></p>
        </dd>
      </dl>
      <div class="bot"><a href="JavaScript:document.form1.submit();" class="imap-btn-big imap-btn-green"><?php echo $lang['goods_class_import_import'];?></a></div>
    </div>
  </form>
</div>
