...
<div class="page">
  ...
  <div class="imap-stat-chart">
    <div class="title">
      <h3>行业价格分布图</h3>
      <h5><a href="index.php?act=stat_general&op=setting" class="imap-btn">设置价格区间</a></h5>
    </div>
    ...
    <?php } else {?>
    <div class="no-date"><i class="fa fa-exclamation-triangle"></i>查看行业价格分布情况前，请先设置价格区间。<a href="index.php?act=stat_general&op=setting" class="imap-btn imap-btn-orange">马上设置</a></div>
    <?php } ?>
  </div>
