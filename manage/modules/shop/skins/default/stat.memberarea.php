...
<div class="page">
  ...
  <div id="stat_tabs" class="  ui-tabs" style="min-height:500px">
    <ul class="tab-base im-row">
      <li><a href="#membernum_div" im_type="showmap" data-param='{"type":"membernum"}'>下单会员数</a></li>
      <li><a href="#ordernum_div" im_type="showmap" data-param='{"type":"ordernum"}'>下单量</a></li>
      <li><a href="#orderamount_div" im_type="showmap" data-param='{"type":"orderamount"}'>下单金额</a></li>
    </ul>
...
$(function () {
    ...
    $("[im_type='showmap']").click(function(){
