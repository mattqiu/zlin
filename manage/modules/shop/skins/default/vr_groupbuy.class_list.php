    ...
    <table class="flex-table">
      <thead>
        <tr>
          ...
          <th width="60" align="left"><?php echo $lang['im_sort']; ?></th>
      ...
      <tbody>
        ...
        <tr class="hover edit" data-id="<?php echo $val['class_id']; ?>">
          ...
          <td class="sort"><span im_type="class_sort" column_id="<?php echo $val['class_id']; ?>" title="可编辑" class="editable"><?php echo $val['class_sort'];?></span></td>
          <td class="name"><span im_type="class_name" column_id="<?php echo $val['class_id']; ?>" title="可编辑" class="editable"><?php echo $val['class_name']; ?></span></td>
          <td></td>
        </tr>
        ...
        <tr class="<?php echo 'class_id'.$val['class_id'];?>" style="display:none;" data-id="<?php echo $val1['class_id']; ?>">
          ...
          <td class="sort"><span im_type="class_sort" column_id="<?php echo $val1['class_id']; ?>" title="可编辑" class="editable"><?php echo $val1['class_sort'];?></span></td>
          <td class="name"><span im_type="class_name" column_id="<?php echo $val1['class_id']; ?>" title="可编辑" class="editable"><?php echo $val1['class_name']; ?></span></td>
          <td></td>
        </tr>
        <?php } ?>
        <?php } ?>
        ...
        <?php } else { ?>
        <tr class="no_data">
          <td class="no-data" colspan="100"><i class="fa fa-exclamation-circle"></i><?php echo $lang['im_no_record']; ?></td>
        </tr>
        <?php } ?>
      </tbody>
    </table>
...
$(function() {
    ...
    //行内ajax编辑
    $('span[im_type="class_sort"]').inline_edit({act: 'vr_groupbuy', op: 'update_class_sort'});
    $('span[im_type="class_name"]').inline_edit({act: 'vr_groupbuy', op: 'update_class_name'});
