...
<table class="flex-table">
  ...
  <tbody>
    ...
    <tr class="hover edit">
      ...
      <td class="sort"><span im_type="commis_rate" column_id="<?php echo $value['bid'];?>" title="<?php echo $lang['im_editable'];?>" class="editable" style="vertical-align: middle; margin-right: 4px; width:40px;"><?php echo $value['commis_rate'];?></span>% </td>
...
<div class="imap-form-default" >
  ...
  <div class="bot"><a id="btn_add_category" class="imap-btn imap-btn-green" href="JavaScript:void(0);" />确认</a></div>
</div>
...
$(document).ready(function(){
    ...
    // 修改分佣比例
    $('span[im_type="commis_rate"]').inline_edit({act: 'store',op: 'store_bind_class_update'});
});
