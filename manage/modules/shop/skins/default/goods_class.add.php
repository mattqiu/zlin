...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=goods_class&op=goods_class" title="返回商品分类列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['goods_class_index_class'];?> - <?php echo $lang['im_new'];?></h3>
  ...
  <form id="goods_class_form" enctype="multipart/form-data" method="post">
    ...
    <div class="imap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="gc_recommend1" class="cb-enable" ><?php echo $lang['im_yes'];?></label>
            <label for="gc_recommend0" class="cb-disable selected" ><?php echo $lang['im_no'];?></label>
            <input id="gc_recommend1" name="gc_recommend" value="1" type="radio">
            <input id="gc_recommend0" name="gc_recommend" checked="checked" value="0" type="radio">
          </div>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="input-file-show">
            ...
            <input class="type-file-file" id="pic" name="pic" type="file" size="30" im_type="change_pic" hidefocus="true" title="点击按钮选择文件上传">
            <input type="text" name="textfield" id="textfield1" class="type-file-text" />
            <input type="button" name="button" id="button1" value="选择上传..." class="type-file-button" />
            </span>
          </div>
          <span class="err"></span>
          <p class="notic">只有第一级分类可以上传图片，建议用16px * 16px，超出后自动隐藏</p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <p class="notic"><?php echo $lang['goods_class_add_type_desc_one'];?><a onclick="window.parent.openItem('shop|type')" href="JavaScript:void(0);" class="imap-btn mr5 ml5"><?php echo $lang['im_type_manage'];?></a><?php echo $lang['goods_class_add_type_desc_two'];?></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
          <label><?php echo $lang['im_sort'];?></label>
        </dt>
        <dd class="opt">
