...
<div class="page">
  ...
  <form id="live_form" method="post" enctype="multipart/form-data">
    ...
    <div class="imap-form-default">
      ...
      <div class="bot"><a href="JavaScript:void(0);" class="imap-btn-big imap-btn-green" id="submitBtn"><?php echo $lang['im_submit'];?></a> <a href="JavaScript:void(0);" class="imap-btn-big imap-btn-red ml10" id="clearBtn">清空数据</a></div>
    </div>
  </form>
</div>
