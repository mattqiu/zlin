...
<ul id="show_list" class="floor_list">
  ...
  <li><i class="fa fa-list-alt"></i>模块：<?php echo $v['web_name'];?><a href="###" class="imap-btn-mini imap-btn-green" onclick="select_floor(<?php echo $v['web_id'];?>);" f_id="<?php echo $v['web_id'];?>" f_name="<?php echo $v['web_name'];?>"><i class="fa fa-plus-square-o"></i>添加</a><span class="ok"><i class="fa fa-check-circle-o"></i>已添加</span></li>
  <?php } ?>
</ul>
<div id="show_page_floor" class="pagination"> <?php echo $output['show_page'];?> </div>
<div class="clear"></div>
<?php }else { ?>
<?php echo $lang['im_no_record'];?>
<?php } ?>
