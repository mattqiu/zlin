...
$(document).ready(function(){
  ...
  <div class="imap-order-details">
    ...
    <div class="tabs-panels">
      <div class="misc-info">
        <dl>
          <dt><?php echo $lang['order_shop_name'];?></dt>
          ...
          <dt><?php echo $lang['order_state'];?></dt>
          ...
          <dt><?php echo $lang['order_datetime'];?></dt>
          <dd><?php echo date('Y-m-d H:i:s',$output['order_info']['add_time']);?>
          <dt><?php echo $lang['order_price'];?></dt>
          ...
          <dt><?php echo $lang['order_voucher_price'];?></dt>
          <dd><?php echo $lang['currency'].$output['order_info']['voucher_price'].'.00';?>
          <dt><?php echo $lang['order_voucher_sn'];?></dt>
  ...
  <div class="imap-form-default">
    ...
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_datetime'];?></dt>
  ...
  <div class="imap-form-default">
    ...
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_accused'];?></dt>
      <dd class="opt"><?php echo $output['complain_info']['accused_name'];?></dd>
    </dl>
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_appeal_evidence'];?></dt>
      <?php
    ...
    <dl class="row">
      <dt class="tit"> <?php echo $lang['complain_appeal_datetime'];?></dt>
      <dd class="opt"><?php echo date('Y-m-d H:i:s',$output['complain_info']['appeal_datetime']);?></dd>
    </dl>
    <dl class="row">
      <dt class="tit"><?php echo $lang['complain_appeal_content'];?></dt>
  ...
  <div class="imap-form-default">
    ...
    <dl class="row">
      <dt class="tit"><?php echo $lang['talk_list'];?></dt>
      <dd class="opt">
    ...
    <dl cass="row">
      <dt class="tit"><?php echo $lang['talk_send'];?></dt>
      <dd class="opt">
        <textarea id="complain_talk" class="tarea"></textarea>
        <div>
        <a href="JavaScript:void(0);" id="btn_refresh" class="imap-btn"><?php echo $lang['talk_refresh'];?></a><a href="JavaScript:void(0);" id="btn_publish" class="imap-btn"><?php echo $lang['talk_send'];?></a>
        </div>
        </dd>
    </dl>
    <?php } ?>
...
function forbit_talk(talk_id) {
  ...
  <div class="imap-form-default">
    ...
    <dl class="row">
      <dt class="tit"><?php echo $lang['final_handle_message'];?></dt>
      <dd class="opt"><?php echo $output['complain_info']['final_handle_message'];?></dd>
    </dl>
    <dl>
      <dt class="tit"><?php echo $lang['final_handle_datetime'];?></dt>
      <dd class="opt"><?php echo date('Y-m-d H:i:s',$output['complain_info']['final_handle_datetime']);?></dd>
    </dl>
    <div class="bot"><a href="JavaScript:void(0);" class="imap-btn-big imap-btn-green" onclick="history.go(-1)"><?php echo $lang['im_back'];?></a></div>
  </div>
  <?php } ?>
  <?php if(intval($output['complain_info']['complain_state']) !== 99) { ?>
  <div class="imap-form-default">
    ...
    <dl class="row" id="close_complain">
      ...
      <form method='post' id="verify_form" action="index.php?act=complain&op=complain_verify">
          ...
          <a id="verify_button" class="imap-btn-big imap-btn-green" href="javascript:void(0)"><span><?php echo $lang['complain_text_verify'];?></span></a>
          <?php } ?>
          <?php if(intval($output['complain_info']['complain_state']) !== 99) { ?>
          <a id="close_button" class="imap-btn-big imap-btn-green" href="javascript:void(0)"><span><?php echo $lang['complain_text_close'];?></span></a>
          <?php } ?>
          <a href="JavaScript:void(0);" class="imap-btn-big imap-btn-green" onclick="history.go(-1)"><span><?php echo $lang['im_back'];?></span></a>
        </form></div></dd>
    </dl>
    <form method='post' id="close_form" action="index.php?act=complain&op=complain_close">
      ...
      <dd class="opt">
        ...
        <div class="bot complain_dialog"><a id="btn_handle_submit" class="imap-btn-big imap-btn-green" href="javascript:void(0)"><?php echo $lang['im_submit'];?></a> <a id="btn_close_cancel" class="imap-btn-big imap-btn-green" href="javascript:void(0)"><?php echo $lang['im_cancel'];?></a></div>
    </form>
  </div>
  <?php } ?>
</div>
