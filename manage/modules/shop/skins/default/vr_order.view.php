    ...
    <div class="imap-order-details">
      ...
      <div class="tabs-panels">
        <div class="misc-info">
          ...
          <?php if ($output['order_info']['order_state'] == ORDER_STATE_CANCEL) { ?>
          <dl>
            <dt>订单取消日志<?php echo $lang['im_colon'];?></dt>
        ...
        <div class="addr-note">
          ...
          <dl>
            ...
            <dt>接收手机<?php echo $lang['im_colon'];?></dt>
        ...
        <div class="contact-info">
          ...
          <dl>
            ...
            <dt>店主名称<?php echo $lang['im_colon'];?></dt>
          ...
          <dl>
            <dt>地&#12288;&#12288;址<?php echo $lang['im_colon'];?></dt>
          ...
          <dl>
            <dt>交通信息<?php echo $lang['im_colon'];?></dt>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td style="text-align: left;"><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=goods&goods_id=<?php echo $output['order_info']['goods_id'];?>" target="_blank"><?php echo $output['order_info']['goods_name'];?></a>
                  ...
                  ，过期不退款
                  <?php } ?></td>
                <td class="w80"><?php echo $lang['currency'].imPriceFormat($output['order_info']['goods_price']);?></td>
                ...
                <td class="w80"><?php echo $output['order_info']['commis_rate'] == 200 ? '' : imPriceFormat($output['order_info']['goods_price']*$output['order_info']['commis_rate']/100);?></td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div class="tabs-panels tabs-hide">
        <div>
          ...
          <dl>
            ...
            <dt>管理员操作时间<?php echo $lang['im_colon'];?></dt>
