  ...
  <form method="post" id="settingForm" name="settingForm">
    ...
    <div class="imap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="guest_comment_enable" class="cb-enable <?php if($output['list_setting']['guest_comment'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['im_yes'];?>"><?php echo $lang['im_yes'];?></label>
            <label for="guest_comment_disabled" class="cb-disable <?php if($output['list_setting']['guest_comment'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['im_no'];?>"><?php echo $lang['im_no'];?></label>
