  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base im-row">
        <li><a href="index.php?act=domain&op=store_domain_setting"><?php echo $lang['im_config'];?></a></li>
        <li><a href="JavaScript:void(0);" class="current"><?php echo $lang['im_domain_shop'];?></a></li>
      </ul>
    </div>
  </div>
