  ...
  <form id="web_form" method="post" name="form1">
    ...
    <div class="imap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="show1" class="cb-enable <?php if($output['channel']['channel_show'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['im_yes'];?>"><?php echo $lang['im_yes'];?></label>
            <label for="show0" class="cb-disable <?php if($output['channel']['channel_show'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['im_no'];?>"><?php echo $lang['im_no'];?></label>
