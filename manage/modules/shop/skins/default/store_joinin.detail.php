...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=store&op=store_joinin" title="返回<?php echo $lang['pending'];?>列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['im_store_manage'];?> - 查看会员“<?php echo $output['joinin_detail']['member_name'];?>”的店铺注册信息</h3>
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
      ...
      <tr>
        <th>营业执照<br />
          电子版：</th>
        <td colspan="20"><a imtype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['business_licence_number_elc']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['business_licence_number_elc']);?>" alt="" /> </a></td>
      </tr>
    </tbody>
  </table>
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
      ...
      <tr>
        <th>组织机构代码证<br/>
          电子版：</th>
        <td colspan="20"><a imtype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['organization_code_electronic']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['organization_code_electronic']);?>" alt="" /> </a></td>
      </tr>
    </tbody>
  </table>
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
      ...
      <tr>
        <th>税务登记证号<br />
          电子版：</th>
        <td><a imtype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['tax_registration_certif_elc']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['tax_registration_certif_elc']);?>" alt="" /> </a></td>
      </tr>
    </tbody>
  </table>
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
      <tr>
        <th>一般纳税人证明：</th>
        <td colspan="20"><a imtype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['general_taxpayer']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['general_taxpayer']);?>" alt="" /> </a></td>
      </tr>
    </tbody>
  </table>
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
      ...
      <tr>
        <th>开户银行许可证<br/>
          电子版：</th>
        <td colspan="20"><a imtype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['bank_licence_electronic']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['bank_licence_electronic']);?>" alt="" /> </a></td>
      </tr>
    </tbody>
  </table>
  <?php }else{?>
  ...
  <form id="form_store_verify" action="index.php?act=store&op=store_joinin_verify" method="post">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
      ...
      <tbody>
          ...
          <td colspan="2"><table border="0" cellpadding="0" cellspacing="0" id="table_category" class="type">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php if(intval($output['joinin_detail']['joinin_state']) === 10) {?>
                    <input type="text" imtype="commis_rate" value="<?php echo $store_class_commis_rates[$i];?>" name="commis_rate[]" class="w100" />
                    %
                    <?php } else { ?>
        ...
        <tr>
          <th>付款凭证：</th>
          <td><a imtype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['paying_money_certificate']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['paying_money_certificate']);?>" alt="" /> </a></td>
        </tr>
        <tr>
          <th>付款凭证说明：</th>
    ...
    <div class="bottom"><a id="btn_pass" class="imap-btn-big imap-btn-green mr10" href="JavaScript:void(0);">通过</a><a id="btn_fail" class="imap-btn-big imap-btn-red" href="JavaScript:void(0);">拒绝</a> </div>
    <?php } ?>
  </form>
</div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#btn_pass').on('click', function() {
            var valid = true;
            $('[imtype="commis_rate"]').each(function(commis_rate) {
                rate = $(this).val();
                if(rate == '') {
                    valid = false;
                    return false;
