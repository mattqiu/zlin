...
<div class="page">
  ...
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['im_voucher_price_manage'];?></h3>
        <h5><?php echo $lang['im_voucher_price_manage_subhead'];?></h5>
      </div>
...
$(function(){
    ...
    $("#flexigrid").flexigrid({
        ...
        colModel: [
            ...
            {display: '添加时间', name: 'add_time_text', width: 120, sortable: true, align: 'center'},
