    ...
    <table class="flex-table">
      <thead>
        <tr>
          ...
          <th width="150" class="handle" align="center"><?php echo $lang['im_handle'];?></th>
          ...
          <th width="80" align="center">充许开分店</th>
          <th width="80" align="center">分店数量</th>
          <th width="80" align="center">充许推广</th>
          <th width="80" align="center">推广员数量</th>  
          <th width="80" align="center">导购员数量</th>  
          <th width="120" align="center"><?php echo $lang['charges_standard'];?></th>
          <th width="80" align="center">申请条件</th>
          <th></th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr>
          ...
          <td class="handle"><?php if($v['sg_id'] == '1'){ ?>
            ...
            <?php }else { ?>
            <a class="btn red" href="javascript:if(confirm('<?php echo $lang['problem_del'];?>'))window.location = 'index.php?act=store_grade&op=store_grade_del&sg_id=<?php echo $v['sg_id'];?>';"><i class="fa fa-trash-o"></i><?php echo $lang['im_del'];?></a>
            <?php } ?>
            <span class="btn"><em><i class="fa fa-cog"></i><?php echo $lang['im_set'];?><i class="arrow"></i></em>
            <ul>
          ...
          <td><?php echo $v['branch_op']?'充许':'不充许';?></td>
          <td><?php if ($v['branch_op']){echo $v['branch_limit']==0?'不限':$v['branch_limit'];}?></td>
          <td><?php echo $v['extension_op']?'充许':'不充许';?></td>
          <td><?php if ($v['extension_op']){echo $v['promotion_limit']==0?'不限':$v['promotion_limit'];}?></td>
          <td><?php if ($v['extension_op']){echo $v['saleman_limit']==0?'不限':$v['saleman_limit'];}?></td>
          <td><?php echo $v['sg_price']==0?'免费':$v['sg_price'].'元/年';?></td>
          <td class="align-center"><?php echo $v['store_type']==1?'个人':'企业';?></td>
          <td></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no-data">
          <td colspan="100" class="no-data"><i class="fa fa-lightbulb-o"></i><?php echo $lang['im_no_record'];?></td>
        </tr>
        <?php } ?>
      </tbody>
    </table>
