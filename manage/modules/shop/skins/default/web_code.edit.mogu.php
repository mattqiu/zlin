...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <a class="back" href="index.php?act=web_config&op=web_config" title="返回<?php echo '板块区';?>列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <div class="imap-form-all">
    <div class="title">
      ...
      <a href="index.php?act=web_config&op=web_edit&web_id=<?php echo $output['web_array']['web_id'];?>">设置该板块色彩</a> 
    </div>
    <dl class="row">
      <dt class="tit">
        <label><?php echo $lang['web_config_edit_html'].$lang['im_colon'];?></label>
      </dt>
      <dd class="opt">
        <div class="mogu-templates-board-layout style-<?php echo $output['web_array']['style_name'];?>">
          <div class="left">
            <dl id="left_tit">
              <dt>
                <h4><?php echo $lang['web_config_picture_tit'];?></h4>
                <a href="JavaScript:show_dialog('upload_tit');"><i class="fa fa-pencil-square-o"></i><?php echo $lang['im_edit'];?></a>
              </dt>
            ...
            <dl>
              <dt>
                ...
                <a href="JavaScript:show_dialog('upload_act');"><i class="fa fa-picture-o"></i><?php echo $lang['im_edit'];?></a>
              </dt>
              <dd class="act-pic">
            ...
            <dl>
              <dt>
                ...
                <a href="JavaScript:show_dialog('category_list');"><i class="icon-th"></i><?php echo $lang['im_edit'];?></a>
              </dt>
            ...
            <div>
              ...
              <dl recommend_id="<?php echo $key;?>">
                <dt>
                  ...
                  <a href="JavaScript:show_recommend_dialog(<?php echo $key;?>);"><i class="fa fa-shopping-cart"></i><?php echo '商品块';?></a> 
              ...
              <div class="add-tab" id="btn_add_list">
                <a href="JavaScript:add_recommend();"><i class="icon-plus-sign-alt"></i><?php echo $lang['web_config_add_recommend'];?></a><?php echo $lang['web_config_recommend_max'];?>
              </div>
            </div>
          </div>
          <div class="right">
            ...
            <dl>
              <dt>
                ...
                <a href="JavaScript:show_dialog('brand_list');"><i class="icon-ticket"></i><?php echo $lang['im_edit'];?></a>
              </dt>
              <dd>
                <ul class="brands">
  ...
  <div class="bot"><a href="index.php?act=web_config&op=web_html&web_id=<?php echo $_GET['web_id'];?>" class="imap-btn-big imap-btn-green" id="submitBtn"><?php echo $lang['web_config_web_html'];?></a> </div>
</div>
...
<div id="upload_tit_dialog" style="display:none;">
  ...
  <form id="upload_tit_form" name="upload_tit_form" enctype="multipart/form-data" method="post" action="index.php?act=web_config&op=upload_pic" target="upload_pic">
    ...
    <div class="imap-form-default">
      <dl class="row">
        <dt class="tit"><?php echo $lang['web_config_upload_type'].$lang['im_colon'];?></dt>
        <dd class="opt">
          <label title="<?php echo $lang['web_config_upload_pic'];?>">
            ...
            <span><?php echo $lang['web_config_upload_pic'];?></span>
          </label>
      ...
      <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_tit_form').submit();" class="imap-btn-big imap-btn-green"><?php echo $lang['im_submit'];?></a></div>
    </div>
  </form>
</div>
<!-- 推荐分类模块 -->
<div id="category_list_dialog" style="display:none;">
  ...
  <form id="category_list_form">
    ...
    <div class="bot"><a href="JavaScript:void(0);" onclick="update_category();" class="imap-btn-big imap-btn-green"><?php echo $lang['web_config_save'];?></a></div>
  </form>
</div>
<!-- 活动图片 -->
<div id="upload_act_dialog" class="upload_act_dialog" style="display:none;">
  ...
  <form id="upload_act_form" name="upload_act_form" enctype="multipart/form-data" method="post" action="index.php?act=web_config&op=upload_pic" target="upload_pic">
    ...
    <div class="imap-form-default" id="upload_act_type_pic" <?php if($output['code_act']['code_info']['type'] == 'adv') { ?>style="display:none;"<?php } ?>>
      <dl class="row">
      ...
      <dl class="row">
        <dt class="tit">
          <label><?php echo $lang['web_config_upload_url'].$lang['im_colon'];?></label>
        </dt>
        <dd class="opt">
      ...
      <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_act_form').submit();" class="imap-btn-big imap-btn-green"><?php echo $lang['im_submit'];?></a></div>
    </div>
  </form>
</div>
<!-- 商品推荐模块 -->
<div id="recommend_list_dialog" style="display:none;">
  ...
  <form id="recommend_list_form">
    ...
    <div class="imap-form-default" select_recommend_id="<?php echo $key;?>" style="overflow:visible;">
      ...
      <dl class="row">
        <dt class="tit mt15">模块背景</dt>
        <dd class="opt">
          <input id="recommend_pic_bgcolor<?php echo $key;?>" name="recommend_list[<?php echo $key;?>][recommend][bgcolor]" value="<?php echo $val['recommend']['bgcolor'];?>" class="w50" type="text">
          <div class="input-file-show">
            <span class="show">
              <a class="nyroModal" rel="gal" id="bg_image_pre<?php echo $key;?>" href="JavaScript:void(0);"> 
                <i class="fa fa-picture-o" id="bg_image_load<?php echo $key;?>" onMouseOver="toolTip('<img src=<?php echo $val['recommend']['bgimg']?UPLOAD_SITE_URL.'/'.ATTACH_EDITOR."/".$val['recommend']['bgimg']:'';?>>')" onMouseOut="toolTip()"/></i> 
              </a>
            </span>
            <span class="type-file-box">
              <input type="text" name="recommend_list[<?php echo $key;?>][recommend][bgimg]" id="recommend_bgimg<?php echo $key;?>" value="<?php echo $val['recommend']['bgimg'];?>" class="type-bgfile-text" />
              <input type="button" name="button" id="button1" value="选择上传..." class="type-file-button" />
              <input class="type-bgfile-file" id="bg_image<?php echo $key;?>" name="bg_image<?php echo $key;?>" type="file" size="30" hidefocus="true" im_type="change_bg_image" title="点击前方预览图可查看大图，点击按钮选择文件并提交表单后上传生效">
            </span>
          </div>
          <span class="err"></span>
          <p class="notic">修改该区域推荐模块选项卡背景，仅限于瀑布流广告样式有用</p>
        </dd>
      </dl>
  ...
  <form id="recommend_pic_form" name="recommend_pic_form" enctype="multipart/form-data" method="post" action="index.php?act=web_config&op=recommend_pic" target="upload_pic">
    ...
    <div class="imap-form-default">
      ...
      <dl class="row">
        <dt class="tit mt15">模块背景</dt>
        <dd class="opt">
          <input id="recommend_pic_bgcolor" name="recommend_list[recommend][bgcolor]" value="<?php echo $val['recommend']['bgcolor'];?>" class="w50" type="text">
          <div class="input-file-show">
            <span class="show">
              <a class="nyroModal" rel="gal" id="bg_image_pre" href="JavaScript:void(0);"> 
                <i class="fa fa-picture-o" id="bg_image_load" onMouseOver="toolTip('<img src=<?php echo $val['recommend']['bgimg']?UPLOAD_SITE_URL.'/'.ATTACH_EDITOR."/".$val['recommend']['bgimg']:'';?>>')" onMouseOut="toolTip()"/></i> 
              </a>
            </span>
            <span class="type-file-box">
              <input type='text' name='recommend_list[recommend][bgimg]' id='recommend-bgimg' value='<?php echo $val['recommend']['bgimg'];?>' class='type-bgfile-text' />
              <input type="button" name="button" id="button1" value="选择上传..." class="type-file-button" />
              <input class="type-bgfile-file" id="bg_image" name="bg_image" type="file" size="30" hidefocus="true" im_type="change_bg_image" title="点击前方预览图可查看大图，点击按钮选择文件并提交表单后上传生效">
            </span>
          </div>
          <span class="err"></span>
          <p class="notic">修改该区域推荐模块选项卡背景，仅限于淘宝样式有用</p>
        </dd>
      </dl>
      ...
      <dl class="row">
        ...
        <dd class="opt" id="add_recommend_pic">
          ...
          <div select_recommend_pic_id="<?php echo $key;?>" class="middle-banner"> 
            ...
            <a recommend_pic_id="34" href="javascript:void(0);" class="bottom-d">
              <img pic_url="<?php echo $val['pic_list']['34']['pic_url'];?>" title="<?php echo $val['pic_list']['34']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['34']['pic_img'];?>"/>
            </a> 
          </div>
          <?php } ?>
          ...
          <ul class="brands dialog-brandslist-s1">
            ...
            <li>
              <div class="brands-pic">
                <span class="ac-ico" onclick="del_brand(<?php echo $val['brand_id'];?>);"></span>
                <span class="thumb size-88x29">
                  <i></i><img ondblclick="del_brand(<?php echo $val['brand_id'];?>);" select_brand_id="<?php echo $val['brand_id'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['brand_pic'];?>" onload="javascript:DrawImage(this,88,30);" />
                </span>
              </div>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="search-bar">
            ...
            <a href="JavaScript:void(0);" onclick="get_recommend_brand();" class="imap-btn"><?php echo $lang['im_query'];?></a> 
          </div>
          <div id="show_brand_list"></div>
        </dd>
      </dl>
      <div class="bot"> <a href="JavaScript:void(0);" onclick="update_brand();" class="imap-btn-big imap-btn-green"><?php echo $lang['web_config_save'];?></a></div>
    </div>
  </form>
</div>
<!-- 切换广告图片 -->
    ...
    <div class="imap-form-all">
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <a class="imap-btn" href="JavaScript:add_slide_adv();"><i class="fa fa-plus"></i><?php echo '新增图片';?>&nbsp;(最多5个)</a>
        </dd>
      </dl>
    </div>
