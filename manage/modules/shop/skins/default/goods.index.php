...
<div class="page">
  ...
  <div class="imap-search-bar">
    ...
    <form method="get" name="formSearch" id="formSearch">
      ...
      <div class="bottom">
        <a href="javascript:void(0);" id="ncsubmit" class="imap-btn imap-btn-green mr5">提交查询</a>
...
$(function(){
    $("#flexigrid").flexigrid({
        ...
        colModel : [
            ...
            {display: '平台货号', name : 'goods_commonid', width : 60, sortable : true, align: 'center'},
            ...
            {display: '预约商品', name : 'is_appoint', width : 60, sortable : true, align: 'center', className: 'column-c'},
            {display: '出售时间', name : 'appoint_satedate', width : 100, sortable : false, align: 'center', className: 'column-c'}
            ],
        buttons : [
            {display: '<i class="fa fa-file-excel-o"></i>导出数据', name : 'csv', bclass : 'csv', title : '将选定行数据导出CVS文件', onpress : fg_operation }
            ],
        searchitems : [
            {display: '平台货号', name : 'goods_commonid'},
