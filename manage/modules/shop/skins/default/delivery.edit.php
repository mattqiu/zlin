...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminShop('delivery', 'index');?>" title="返回<?php echo $lang['im_manage'];?>列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form id="delivery_form" method="post" action="<?php echo urlAdminShop('delivery', 'save_edit');?>">
    ...
    <div class="imap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt"><?php echo $output['dlyp_info']['dlyp_area_info'];?><span class="err"></span>
          <p class="notic"> </p>
        </dd>
      </dl>
      <dl class="row">
      ...
      <dl class="row" style="display: none;" imtype="fail_reason">
        <dt class="tit">
...
$(function(){
    ...
    $('input[name="dstate"]').change(function(){
        ...
        if (_val == 20) {
            $('[imtype="fail_reason"]').show();
        } else {
            $('[imtype="fail_reason"]').hide();
        }
    });
});
</script> 
