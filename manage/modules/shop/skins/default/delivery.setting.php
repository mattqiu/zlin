  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base im-row">
        <li><a href="<?php echo urlAdminShop('delivery', 'index');?>"><?php echo $lang['im_manage'];?></a></li>
    ...
    <div class="imap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <p class="notic">现在去设置物流自提服务站使用的快递公司，<a onclick="window.parent.openItem('shop|express');" href="JavaScript:void(0);" class="imap-btn"><i class="fa fa-truck"></i>
快递公司</a></p>
        </dd></dl>
        
      <div class="bot"><a href="JavaScript:void(0);" class="imap-btn-big imap-btn-green" id="submitBtn"><?php echo $lang['im_submit'];?></a></div></div>
  </form>
</div>
<script>
$(function(){
