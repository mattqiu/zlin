  ...
  <form id="web_form" method="post" name="form1">
    ...
    <div class="imap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <select id="web_layout" name="web_layout">
            <option selected="selected" value="floor">默认布局</option>
            <option value="tmall">天猫布局(分类+广告)</option>
            <option value="cat">天猫布局(分类)</option>
            <option value="adv">天猫布局(广告)</option>
            <option value="meituan">美团布局</option>
            <option value="vip">唯品会布局</option>
          </select>
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="show1" class="cb-enable selected" title="<?php echo $lang['im_yes'];?>"><?php echo $lang['im_yes'];?></label>
            <label for="show0" class="cb-disable" title="<?php echo $lang['im_no'];?>"><?php echo $lang['im_no'];?></label>
