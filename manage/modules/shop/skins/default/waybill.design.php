...
<div class="page"> 
  ...
  <div class="imap-form-default">
    <dl class="row">
      ...
      <dd class="opt">
        <form id="design_form" action="<?php echo urlAdminShop('waybill', 'waybill_design_save');?>" method="post">
          ...
          <ul id="waybill_item_list" class="im-row imap-waybill-list">
    ...
    <div class="bot"><a id="submit" href="javascript:;" class="imap-btn-big imap-btn-green"><?php echo $lang['im_submit'];?></a></div>
  </div>
</div>
<div id="dialog_item_edit" style="display:none;">
  ...
  <div class="imap-form-default">
    ...
    <div class="bot"><a id="btn_dialog_submit" href="javascript:;" class="imap-btn-big imap-btn-green">确定调整</a> <a id="btn_dialog_cancel" href="javascript:;" class="imap-btn-big imap-btn-orange ml20">取消微调</a> </div>
  </div>
</div>
