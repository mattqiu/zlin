...
$(function(){
    $("#flexigrid").flexigrid({
        ...
        sortname: "refund_id",
        sortorder: "desc",
        title: '<?php echo $_GET['ob_no'].'期';?>账单-退单列表'
    });
});
...
function fg_csv(ids) {
    id = ids.join(',');
    window.location.href = $("#flexigrid").flexSimpleSearchQueryString() + '&ob_no=<?php echo $_GET['ob_no'];?>&op=export_refund_order&refund_id='+id;
}
</script>
