      ...
      <dl class="row">
        ...
        <dd class="opt">
          <ul class="im-row">
            ...
            <li>
              <div class="grade-template-thumb"> 
                <a class="nyroModal" rel="gal" href="<?php echo SHOP_SITE_URL;?>/skins/<?php echo TPL_SHOP_NAME;?>/store/<?php echo $v;?>/screenshot.jpg">
                  <img src="<?php echo SHOP_SITE_URL;?>/skins/<?php echo TPL_SHOP_NAME;?>/store/<?php echo $v;?>/images/preview.jpg" >
                </a>
                <?php if ($v == 'default'){?>
