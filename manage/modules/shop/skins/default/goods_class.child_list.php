...
<div class="page">
	<div class="fixed-bar">
		<div class="item-title">
			<a class="back" href="index.php?act=goods_class&op=goods_class&gc_id=<?php echo $output['parent_id']?>" title="返回上级分类列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      		<div class="subject">
        		<h3><?php echo L('goods_class_index_class');?> - <?php echo $output['title']?></h3>
        		...
        		<?php if(!empty($output['class_list']) && is_array($output['class_list'])) {?>
        			<?php foreach($output['class_list'] as $k => $v) {?>
        				<tr data-id="<?php echo $v['gc_id'];?>">
          					...
          					<td class="handle">
            					<a class="btn red" href="javascript:;" onclick="fg_del(<?php echo $v['gc_id'];?>);"><i class="fa fa-trash-o"></i><?php echo L('im_del');?></a>
            					<span class="btn">
...
$(function() {
    $('.flex-table').flexigrid({
        ...
        striped: false,
        resizable: false,
        title: '分类<?php echo $output['title']?>',
        reload: false,
        columnControl: false,
        buttons: [
