...
<div class="page">
    ...
    <dl class="row">
      <dd class="opt">
        <ul class="im-row">
          ...
          <li title="下单金额：<?php echo imPriceFormat($output['statcount']['orderamount']);?>元">
            <h4>下单金额</h4>
            <h2 id="count-number" class="timer" data-speed="1500" data-to="<?php echo imPriceFormat($output['statcount']['orderamount']);?>"></h2>
            <h6>元</h6>
          </li>
        </ul>
      </dd>
  ...
  <div id="stat_tabs">
    <ul class="tab-base im-row">
      <li><a href="#ordernum_div" im_type="showlinelabels" data-param='{"type":"ordernum"}'>下单量</a></li>
      <li><a href="#goodsnum_div" im_type="showlinelabels" data-param='{"type":"goodsnum"}'>下单商品数</a></li>
      <li><a href="#orderamount_div" im_type="showlinelabels" data-param='{"type":"orderamount"}'>下单金额</a></li>
    </ul>
...
$(function() {
	...
	$("[im_type='showlinelabels']").click(function(){
