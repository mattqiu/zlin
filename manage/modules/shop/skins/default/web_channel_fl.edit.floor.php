...
<div class="page">
        ...
        <div class="channel-templates-board-layout">
          <div class="left">
            <dl id="left_tit">
              <dt>
                <h4>模块标题</h4>
                <a href="JavaScript:show_dialog('channel_tit');"><i class="fa fa-pencil-square-o"></i><?php echo $lang['im_edit'];?></a>
              </dt>
              <dd class="tit-txt">
            ...
            <dl>
              <dt>
                ...
                <a href="JavaScript:show_dialog('upload_channel_act');"><i class="fa fa-picture-o"></i><?php echo $lang['im_edit'];?></a>
              </dt>
              <dd class="act-pic">
            ...
            <div>
              ...
              <dl recommend_id="<?php echo $key;?>">
                <dt>
                  ...
                  <a href="JavaScript:del_recommend(<?php echo $key;?>);"><i class="fa fa-trash"></i><?php echo $lang['im_del'];?></a> <a href="JavaScript:show_recommend_dialog(<?php echo $key;?>);"><i class="fa fa-shopping-cart"></i><?php echo '商品块';?></a></dt>
                <dd>
          ...
          <div class="right">
            <dl>
              <dt>
                <h4>广告图片1</h4>
                <a href="JavaScript:show_dialog('upload_adv_a');"><i class="fa fa-picture-o"></i><?php echo $lang['im_edit'];?></a></dt>
              <dd class="adv-pic">
            ...
            <dl>
              <dt>
                <h4>广告图片2</h4>
                <a href="JavaScript:show_dialog('upload_adv_b');"><i class="fa fa-picture-o"></i><?php echo $lang['im_edit'];?></a></dt>
              <dd class="adv-pic">
            ...
            <dl>
              <dt>
                <h4>广告图片3</h4>
                <a href="JavaScript:show_dialog('upload_adv_c');"><i class="fa fa-picture-o"></i><?php echo $lang['im_edit'];?></a></dt>
              <dd class="adv-pic">
  ...
  <div class="bot"><a href="index.php?act=web_channel&op=html_update&web_id=<?php echo $_GET['web_id'];?>" class="imap-btn-big imap-btn-green" id="submitBtn">更新模块内容</a> </div>
</div>
...
<div id="channel_tit_dialog" style="display:none;">
  <form id="channel_tit_form" name="channel_tit_form">
    ...
    <div class="imap-form-default">
      ...
      <div class="bot"><a href="JavaScript:void(0);" onclick="update_channel_tit();" class="imap-btn-big imap-btn-green"><?php echo $lang['im_submit'];?></a></div>
    </div>
  </form>
</div>
<!-- 活动图片 -->
<div id="upload_channel_act_dialog" class="upload_channel_act_dialog" style="display:none;">
  <form id="upload_channel_act_form" name="upload_channel_act_form" enctype="multipart/form-data" method="post" action="index.php?act=web_channel&op=upload_pic" target="upload_pic">
    ...
    <div class="imap-form-default">
      ...
      <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_channel_act_form').submit();" class="imap-btn-big imap-btn-green"><?php echo $lang['im_submit'];?></a></div>
    </div>
  </form>
</div>
<!-- 商品推荐模块 -->
<div id="recommend_list_dialog" style="display:none;">
  ...
  <form id="recommend_list_form">
    ...
    <?php if (is_array($output['code_recommend_list']['code_info']) && !empty($output['code_recommend_list']['code_info'])) { ?>
    <?php foreach ($output['code_recommend_list']['code_info'] as $key => $val) { ?>
    <div class="imap-form-default" select_recommend_id="<?php echo $key;?>">
      <dl class="row">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="search-bar">
            ...
            <a href="JavaScript:void(0);" onclick="get_recommend_goods();" class="imap-btn"><?php echo $lang['im_query'];?></a>
          </div>
...
<div id="upload_adv_a_dialog" class="upload_adv_a_dialog" style="display:none;">
  <form id="upload_adv_a_form" name="upload_adv_a_form" enctype="multipart/form-data" method="post" action="index.php?act=web_channel&op=upload_pic" target="upload_pic">
    ...
    <div class="imap-form-default">
      ...
      <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_adv_a_form').submit();" class="imap-btn-big imap-btn-green"><?php echo $lang['web_config_save'];?></a></div>
    </div>
  </form>
</div>
<!-- 广告图片2 -->
<div id="upload_adv_b_dialog" class="upload_adv_b_dialog" style="display:none;">
  <form id="upload_adv_b_form" name="upload_adv_b_form" enctype="multipart/form-data" method="post" action="index.php?act=web_channel&op=upload_pic" target="upload_pic">
    ...
    <div class="imap-form-default">
      ...
      <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_adv_b_form').submit();" class="imap-btn-big imap-btn-green"><?php echo $lang['web_config_save'];?></a></div>
    </div>
  </form>
</div>
<!-- 广告图片3 -->
<div id="upload_adv_c_dialog" class="upload_adv_c_dialog" style="display:none;">
  <form id="upload_adv_c_form" name="upload_adv_c_form" enctype="multipart/form-data" method="post" action="index.php?act=web_channel&op=upload_pic" target="upload_pic">
    ...
    <div class="imap-form-default">
      ...
      <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_adv_c_form').submit();" class="imap-btn-big imap-btn-green"><?php echo $lang['web_config_save'];?></a></div>
    </div>
  </form>
</div>
