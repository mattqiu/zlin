...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['im_web_index'];?></h3>
        ...
        <dd class="opt sale-layout">
          ...
          <dl sale_id="<?php echo $key;?>">
            <dt class="title">
              ...
              <a href="JavaScript:del_sale_list(<?php echo $key;?>);" class="imap-btn-mini del"><i class="fa fa-trash"></i>删除</a>
              <a href="JavaScript:show_sale_dialog(<?php echo $key;?>);" class="imap-btn-mini edit"><i class="fa fa-pencil-square-o"></i><?php echo $lang['im_edit'];?></a> 
            </dt>
            <dd>
              <ul>
                ...
                <li>
                  ...
                  <input name="sale_list[<?php echo $key;?>][goods_list][<?php echo $v['goods_id'];?>][goods_salenum]" value="<?php echo $v['goods_salenum'];?>" type="hidden">
          ...
          <div class="add-sale"><a class="imap-btn" href="JavaScript:add_sale_list();"><?php echo $lang['web_config_add_recommend'];?></a><?php echo $lang['web_config_sale_max'];?></div>
        </dd>
      </dl>
      <div class="bot"><a href="index.php?act=web_config&op=html_update&web_id=<?php echo $output['code_sale_list']['web_id'];?>" class="imap-btn-big imap-btn-green"><?php echo $lang['web_config_web_html'];?></a></div>
    </div>
  </form>
</div>
...
<div id="sale_list_dialog" style="display:none;">
  ...
  <?php if (is_array($output['code_sale_list']['code_info']) && !empty($output['code_sale_list']['code_info'])) { ?>
  <?php foreach ($output['code_sale_list']['code_info'] as $key => $val) { ?>
  <div class="imap-form-default" select_sale_id="<?php echo $key;?>">
    <dl class="row">
  ...
  <div class="imap-form-all" select_sale_id="<?php echo $key;?>">
    <dl class="row">
      ...
      <dd class="opt">
        <ul class="dialog-goodslist-s1 goods-list">
          ...
          <?php foreach($val['goods_list'] as $k => $v){ ?>
          <li>
            <div ondblclick="del_sale_goods(<?php echo $v['goods_id'];?>);" class="goods-pic"> 
              <span class="ac-ico" onclick="del_sale_goods(<?php echo $v['goods_id'];?>);"></span> 
              <span class="thumb size-72x72">
                ...
                onload="javascript:DrawImage(this,72,72);" goods_price="<?php echo $v['goods_price'];?>" market_price="<?php echo $v['market_price'];?>" promotion_amount="<?php echo $v['promotion_amount'];?>" 
                goods_salenum="<?php echo $v['goods_salenum'];?>" goods_jingle="<?php echo $v['goods_jingle'];?>" have_gift="<?php echo $v['have_gift'];?>" 
                goods_freight="<?php echo $v['goods_freight'];?>" goods_commend="<?php echo $v['goods_commend'];?>" goods_advpic="<?php echo $v['goods_advpic'];?>" />
              </span>
            </div>
    ...
    <dl class="row">
      ...
      <dd class="opt">
        <div class="search-bar" id="gcategory">
          ...
          <a href="JavaScript:void(0);" onclick="get_goods_list();" class="imap-btn"><?php echo $lang['im_query'];?></a></div>
      </dd>
    </dl>
    <div id="show_sale_goods_list"></div>
  </div>
  <div class="bot"><a href="JavaScript:void(0);" onclick="update_sale();" class="imap-btn-big imap-btn-green"><span><?php echo $lang['web_config_save'];?></span></a></div>
</div>
