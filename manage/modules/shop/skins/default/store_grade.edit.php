  ...
  <form id="grade_form" method="post">
    ...
    <div class="imap-form-default">
        ...
        <dd class="opt">
          <ul style="margin:10px 0;">
            <li style="display:inline-block; margin-right:10px;">
              <input type="radio" name="store_type" value="1" <?php if ($output['grade_array']['store_type']==1){?>checked="checked" <?php }?> />
              <span>个人(无实体店)</span>
            </li>
            <li style="display:inline-block; margin-right:10px;">
              <input type="radio" name="store_type" value="2"  <?php if ($output['grade_array']['store_type']==2){?>checked="checked" <?php }?>/>
              <span>企业(有实体店)</span>
            </li>
          </ul>
          <span class="err"></span>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="sg_confirm1" class="cb-enable <?php if($output['grade_array']['sg_confirm'] == 1){ ?>selected<?php } ?>" ><span>是</span></label>
            <label for="sg_confirm0" class="cb-disable <?php if($output['grade_array']['sg_confirm'] == 0){?>selected<?php } ?>" ><span>否</span></label>
            <input id="sg_confirm1" name="sg_confirm" <?php if($output['grade_array']['sg_confirm'] == 1){ ?>checked="checked"<?php } ?> value="1" type="radio">
            <input id="sg_confirm0" name="sg_confirm" <?php if($output['grade_array']['sg_confirm'] == 0){ ?>checked="checked"<?php } ?> value="0" type="radio">
          </div>
          <span class="err"></span>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="branch_op1" class="cb-enable <?php if($output['grade_array']['branch_op'] == 1){ ?>selected<?php } ?>" ><span>是</span></label>
            <label for="branch_op0" class="cb-disable <?php if($output['grade_array']['branch_op'] == 0){ ?>selected<?php } ?>" ><span>否</span></label>
            <input id="branch_op1" name="branch_op" <?php if($output['grade_array']['branch_op'] == 1){ ?>checked="checked"<?php } ?> value="1" type="radio">
            <input id="branch_op0" name="branch_op" <?php if($output['grade_array']['branch_op'] == 0){ ?>checked="checked"<?php } ?> value="0" type="radio">
          </div>
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="<?php echo $output['grade_array']['branch_limit'];?>" id="branch_limit" name="branch_limit" class="txt">
          <span class="err"></span>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="extension_op1" class="cb-enable <?php if($output['grade_array']['extension_op'] == 1){ ?>selected<?php } ?>" ><span>是</span></label>
            <label for="extension_op0" class="cb-disable <?php if($output['grade_array']['extension_op'] == 0){ ?>selected<?php } ?>" ><span>否</span></label>
            <input id="extension_op1" name="extension_op" <?php if($output['grade_array']['extension_op'] == 1){ ?>checked="checked"<?php } ?> value="1" type="radio">
            <input id="extension_op0" name="extension_op" <?php if($output['grade_array']['extension_op'] == 0){ ?>checked="checked"<?php } ?> value="0" type="radio">
          </div>
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="<?php echo $output['grade_array']['promotion_limit'];?>" id="promotion_limit" name="promotion_limit" class="txt">
          <span class="err"></span>
          <p class="notic"><?php echo $lang['zero_said_no_limit'];?></p>
        </dd>
      </dl>
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="<?php echo $output['grade_array']['saleman_limit'];?>" id="saleman_limit" name="saleman_limit" class="txt">
          <span class="err"></span>
          <p class="notic"><?php echo $lang['zero_said_no_limit'];?></p>
        </dd>
      </dl>
