...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['im_statgeneral'];?></h3>
        <h5>商城统计最新情报及相关设置</h5>
      </div>
  ...
  <form method="post" action="index.php" name="pricerangeform" id="pricerangeform">
    ...
    <div class="imap-form-default" id="pricerang_table">
      <dl class="row">
        ...
        <dd class="opt">
          <ul class="imap-ajax-add">
            ...
            <li id="row_<?php echo $k; ?>">
              ...
              <label><a href="JavaScript:void(0);" onclick="delrow(<?php echo $k;?>);" class="imap-btn imap-btn-red"><?php echo $lang['im_del']; ?></a></label>
            </li>
            <?php } ?>
            <?php }?>
          </ul>
          <a id="addrow" href="javascript:void(0);" class="imap-btn"><i class="fa fa-plus"></i>增加一行</a> </dd>
      </dl>
      <div class="bot"><a id="ncsubmit" class="imap-btn-big imap-btn-green" href="JavaScript:void(0);"><?php echo $lang['im_submit'];?></a></div>
    </div>
  </form>
</div>
...
$(function(){
	...
	$('#addrow').click(function(){
		...
		html += '<label><a href="JavaScript:void(0);" onclick="delrow('+i+');" class="imap-btn imap-btn-red"><?php echo $lang['im_del']; ?></a></label></li>';
