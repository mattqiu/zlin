...
<?php }?>
<tr><td>商家应收</td><td><?php echo imPriceFormat($output['bill_info']['ob_result_totals']);?></td></tr>
<tr><td>结算明细</td><td colspan="4"> <?php echo imPriceFormat($output['bill_info']['ob_order_totals']);?> (消费金额) - <?php echo imPriceFormat($output['bill_info']['ob_commis_totals']);?> (佣金金额) </td></tr>
</table>