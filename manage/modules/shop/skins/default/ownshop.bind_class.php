...
<div class="fixed-bar">
  <div class="item-title"><a class="back" href="index.php?act=ownshop&op=list" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
    <div class="subject">
      <h3>自营店铺 - <?php echo $lang['im_edit'];?>“<?php echo $output['store_info']['store_name'];?>”经营类目</h3>
      <h5>商城自营店铺相关设置与管理</h5>
    </div>
  </div>
</div>
...
<table class="flex-table">
  <thead>
    <tr>
      ...
      <th width="60" class="handle-s" align="center"><?php echo $lang['im_handle'];?></th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="handle-s"><a class='btn red' imtype="btn_del_store_bind_class" href="javascript:;" data-bid="<?php echo $value['bid'];?>"><i class="fa fa-trash"></i>删除</a></td>
      <td class="sort"><span im_type="commis_rate" column_id="<?php echo $value['bid'];?>" title="<?php echo $lang['im_editable'];?>" class="editable " style="vertical-align: middle; margin-right: 4px;"><?php echo $value['commis_rate'];?></span>% </td>
...
<div class="imap-form-default" >
  ...
  <div class="bot"><a id="btn_add_category" class="imap-btn-big imap-btn-green" href="JavaScript:void(0);" /><span>确认提交</span></a></div>
</div>
...
$(function(){
    ...
    // 删除现有类目
    $('[imtype="btn_del_store_bind_class"]').on('click', function() {
    ...
    // 修改分佣比例
    $('span[im_type="commis_rate"]').inline_edit({act: 'ownshop',op: 'bind_class_update'});
});
