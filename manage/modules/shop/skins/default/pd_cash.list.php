...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['im_member_predepositmanage'];?></h3>
        <h5><?php echo $lang['im_member_predepositmanage_subhead'];?></h5>
      </div>
      <ul class="tab-base im-row">
        ...
        <li><a href="index.php?act=predeposit&op=pd_log_list"><?php echo $lang['im_member_predepositlog'];?></a></li>
      </ul>
    </div>
  </div>
  <!-- 操作说明 -->
  ...
  <div class="imap-search-bar">
    ...
    <form method="get" name="formSearch" id="formSearch">
      ...
      <div class="bottom"><a href="javascript:void(0);" id="ncsubmit" class="imap-btn imap-btn-green mr5">提交查询</a><a href="javascript:void(0);" id="ncreset" class="imap-btn imap-btn-orange" title="撤销查询结果，还原列表项所有内容"><i class="fa fa-retweet"></i><?php echo $lang['im_cancel_search'];?></a></div>
    </form>
  </div>
</div>
