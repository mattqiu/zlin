...
<div class="page">
  ...
  <div class="imap-search-bar">
    ...
    <form method="get" name="formSearch" id="formSearch">
      ...
      <div class="bottom"> <a href="javascript:void(0);" id="ncsubmit" class="imap-btn imap-btn-green">提交查询</a> <a href="javascript:void(0);" id="ncreset" class="imap-btn imap-btn-orange" title="撤销查询结果，还原列表项所有内容"><i class="fa fa-retweet"></i><?php echo $lang['im_cancel_search'];?></a> </div>
    </form>
  </div>
</div>
<script>
