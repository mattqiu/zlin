...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['im_binding_manage'];?></h3>
  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="handle-s">
          <a class="btn blue" href="index.php?act=sns_sharesetting&op=edit&state=1&key=<?php echo $k; ?>"><i class="fa fa-pencil-square-o"></i> <?php echo $lang['im_edit']?></a></td>
