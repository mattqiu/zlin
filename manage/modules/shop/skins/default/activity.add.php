...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <div class="subject">
        <h3><?php echo $lang['activity_index_manage'];?> - <?php echo $lang['im_new'];?></a></h3>
  ...
  <form id="add_form" method="post" enctype="multipart/form-data">
    ...
    <div class="imap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="input-file-show"><span class="type-file-box">
            <input type="file" class="type-file-file" id="activity_banner" name="activity_banner" size="30" hidefocus="true"  im_type="upload_activity_banner" title="点击按钮选择文件并提交表单后上传生效">
            </span></div>
          <span class="err"></span>
      ...
      <div class="bot"><a href="JavaScript:void(0);" class="imap-btn-big imap-btn-green" id="submitBtn"><span><?php echo $lang['im_submit'];?></span></a></div>
    </div>
  </form>
</div>
<script>
