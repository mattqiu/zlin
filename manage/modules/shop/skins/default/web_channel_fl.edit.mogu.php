...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <a class="back" href="index.php?act=web_channel&op=floor_list" title="返回模块列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <div class="imap-form-all">
    <dl class="row">
      <dd class="opt">
        <div class="mogu-templates-board-layout style-<?php echo $output['floor']['style_name'];?>">
          <div class="left">
            <dl id="left_tit">
              <dt>
