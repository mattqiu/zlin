<?php defined('InIMall') or exit('Access Invalid!');?>
  <div class="imap-form-default">
    ...
    <div class="bot" id="submit-holder"> <a class="imap-btn-big imap-btn-green" href="javascript:if (confirm('<?php echo $lang['admin_predeposit_cash_confirm'];?>')){window.location.href='index.php?act=predeposit&op=pd_cash_pay&id=<?php echo $output['info']['pdc_id']; ?>';}else{}"><?php echo $lang['admin_predeposit_payed'];?></a></div>
  <?php } ?>
  </div>