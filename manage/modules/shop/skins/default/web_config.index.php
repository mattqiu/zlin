  ...
  <table class="flex-table">
    <thead>
      <tr>
        ...
        <th width="60" align="center"><?php echo $lang['im_display'];?></th>
        <th></th>
      </tr>
    </thead>
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo $v['web_show']==1 ? '<span class="yes"><i class="fa fa-check-circle"></i>'.$lang['im_yes'].'</span>' : '<span class="no"><i class="fa fa-ban"></i>'.$lang['im_no'].'</span>';?></td>
        <td></td>
      </tr>
      <?php } ?>
      <?php }else { ?>
