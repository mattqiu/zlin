  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base im-row">
        <li><a href="index.php?act=bill">结算管理</a></li>
...
$(function(){
    ...
    $('#ncreset').click(function(){
        $("#flexigrid").flexOptions({url: 'index.php?act=bill&op=get_bill_xml&os_month=<?php echo $_GET['os_month'];?>'}).flexReload();
        $("#formSearch")[0].reset();
    });
    $("#flexigrid").flexigrid({
        url: 'index.php?act=bill&op=get_bill_xml&os_month=<?php echo $_GET['os_month'];?>',
        colModel : [
            {display: '操作', name : 'operation', width : 60, sortable : false, align: 'center', className: 'handle-s'},
            {display: '账单编号', name : 'ob_no', width : 60, sortable : true, align: 'center'}, 
