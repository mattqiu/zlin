...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['im_store_manage'];?></h3>
        <h5><?php echo $lang['im_store_manage_subhead'];?></h5>
      </div>
      <ul class="tab-base im-row">
        <li><a href="JavaScript:void(0);" class="current"><?php echo $lang['manage'];?></a></li>
        <li><a href="index.php?act=store&op=store_joinin" ><?php echo $lang['pending'];?></a></li>
        <li><a href="index.php?act=store&op=reopen_list" >续签申请</a></li>
        <li><a href="index.php?act=store&op=store_bind_class_applay_list" >经营类目申请</a></li>
      </ul>
    </div>
  </div>
    ...
    <div class="imap-search-bar">
      ...
      <form method="get" name="formSearch" id="formSearch">
        ...
        <div class="bottom">
          ...
          <a href="javascript:void(0);" id="ncreset" class="imap-btn imap-btn-orange" title="撤销查询结果，还原列表项所有内容"><i class="fa fa-retweet"></i><?php echo $lang['im_cancel_search'];?></a>
        </div>
      </form>
    </div>
</div>
...
$(function(){
    $("#flexigrid").flexigrid({
        ...
        colModel : [
			...
			{display: '店铺类型', name : 'store_type', width : 80, sortable : true, align: 'center'},
			{display: '充许开分店', name : 'branch_op', width : 80, sortable : true, align: 'center'},
			{display: '分店数量', name : 'branch_limit', width : 80, sortable : true, align: 'center'},
			{display: '充许推广', name : 'extension_op', width : 80, sortable : true, align: 'center'},
			{display: '推广员数量', name : 'promotion_limit', width : 80, sortable : true, align: 'center'},
			{display: '导购员数量', name : 'saleman_limit', width : 80, sortable : true, align: 'center'},
			{display: '支付方式', name : 'payment_method', width : 100, sortable : true, align: 'center'},
