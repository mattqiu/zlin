...
$(function(){
    $("#flexigrid").flexigrid({
        ...
        colModel : [
            ...
            {display: '云币', name : 'member_points',  width : 50, sortable : false, align: 'center'},
            {display: '可用积分(元)', name : 'available_predeposit',  width : 100, sortable : false, align: 'center'},
            {display: '冻结积分(元)', name : 'freeze_predeposit',  width : 100, sortable : false, align: 'center'}
            ],
        buttons : [
