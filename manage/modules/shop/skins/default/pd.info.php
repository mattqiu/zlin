...
<div class="imap-form-default">
  ...
  <div class="bot"><a  class="imap-btn-big imap-btn-green" href="index.php?act=predeposit&op=recharge_edit&id=<?php echo $output['info']['pdr_id']; ?>"><span><?php echo  $lang['admin_predeposit_payed'];?></span></a></div>
  <?php } ?>
</div>
