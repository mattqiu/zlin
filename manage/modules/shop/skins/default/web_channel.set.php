...
<div class="page">
  ...
  <form id="web_form" method="post" name="form1">
    ...
    <div class="imap-form-default">
      ...
      <dl class="row imap-channel-floor">
        <dt class="tit">
          <label>已选择中部模块</label>
        </dt>
        <dd class="opt">
          <ul id="floor_list">
            ...
            <li><div class="layout-name">模块：<?php echo $v['web_name'];?></div>
                ...
                <a href="JavaScript:void(0);" class="imap-btn-mini imap-btn-red" onclick="del_floor(<?php echo $v['web_id'];?>)"><i class="fa fa-trash"></i>删除</a></li>
            <?php } ?>
            <?php } ?>
            <?php } ?>
          </ul>
      ...
      <dl class="row  imap-channel-floor-list">
        <dt class="tit">
          <label>可选择模块</label>
        </dt>
        <dd class="opt">
          ...
          <a class="imap-btn vm" href="JavaScript:get_floor();"><i class="fa fa-search"></i></a></div>
...
function select_floor(floor_id) {
	...
	text_append += '<a href="JavaScript:void(0);" class="imap-btn-mini imap-btn-red" onclick="del_floor('+floor_id+')"><i class="fa fa-trash"></i>删除</a>';
