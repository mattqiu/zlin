...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      ...
      <li>列表展示了会员在搜索时间段内的有效订单总金额、积分和云币增减情况，并可以点击列表上方的“导出数据”将列表数据导出为Excel文件</li>
...
function update_flex(){
    $("#flexigrid").flexigrid({
        ...
        colModel : [
            ...
            {display: '增积分', name : 'predincrease',  width : 120, sortable : true, align: 'center'},
            {display: '减积分', name : 'predreduce',  width : 120, sortable : true, align: 'center'},
            {display: '增云币', name : 'pointsincrease',  width : 120, sortable : true, align: 'center'},
            {display: '减云币', name : 'pointsreduce',  width: 120, sortable : true, align : 'center'}
            ],
        buttons : [
