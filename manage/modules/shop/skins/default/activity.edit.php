...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=activity&op=activity" title="返回<?php echo $lang['im_manage'];?>列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['activity_index_manage'];?> - <?php echo $lang['im_edit'];?>活动“<?php echo $output['activity']['activity_title'];?>”</h3>
  ...
  <form id="add_form" method="post" enctype="multipart/form-data">
    ...
    <div class="imap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="activity_sort"><em>*</em><?php echo $lang['im_sort'];?></label>
        </dt>
        <dd class="opt">
