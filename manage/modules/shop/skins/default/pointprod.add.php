...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo urlAdminShop('pointprod', 'index'); ?>" title="返回列表"> <i class="fa fa-arrow-circle-o-left"></i> </a>
      <div class="subject">
        <h3><?php echo $lang['im_pointprod'];?> - <?php echo $lang['admin_pointprod_add_title'];?></h3>
        <h5><?php echo $lang['im_pointprod_subhead'];?></h5>
      </div>
    </div>
  </div>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="input-file-show"><span class="type-file-box">
            <input name="goods_images" type="file" class="type-file-file" id="goods_images" size="30" hidefocus="true" im_type="change_goods_image">
            </span></div>
        </dd>
      </dl>
      <dl class="row">
...
$(function(){
	$('input[im_type="change_goods_image"]').change(function(){
		var src = getFullPath($(this)[0]);
		$('img[im_type="goods_image"]').attr('src', src);
		$('input[im_type="change_goods_image"]').removeAttr('name');
