...
$(function(){
    $("#flexigrid").flexigrid({
        ...
        colModel : [
            ...
            {display: '会员云币', name : 'member_points', width : 60, sortable : true, align: 'center'},
            ...
            {display: '可用积分(元)', name : 'available_predeposit', width : 100, sortable : true, align: 'center', className: 'normal'},
            {display: '冻结积分(元)', name : 'freeze_predeposit', width : 100, sortable : true, align: 'center', className: 'abnormal'},
        ...
        searchitems : [
			...
			{display: '电子邮箱', name : 'member_email'}
            ],
        sortname: "member_id",
        sortorder: "desc",
        title: '商城会员列表'
...
function op_del(id) {
    ...
    $.getJSON('index.php?act=member&op=member_del', {member_id:id}, function(data){
        if (data.state) {
