...
<div class="page">
  ...
  <div class="homepage-focus" id="homepageFocusTab">
    ...
    <form id="upload_category_form" class="tab-content" name="upload_category_form">
      ...
      <div class="imap-form-default">
        <dl class="row">
          ...
          <dd class="opt">
            <div class="imap-channel-category">
              ...
              <dl select_class_id="<?php echo $val['gc_parent']['gc_id'];?>">
                ...
                <a href="javascript:void(0);" class="imap-btn-mini upload-pic" title="上传分类图片"><i id="form_<?php echo $val['gc_parent']['gc_id'];?>" class="fa fa-upload"></i></a>
                <a href="javascript:void(0);" class="imap-btn-mini del" onclick="del_gc_parent(<?php echo $val['gc_parent']['gc_id'];?>);" title="删除该分类块"><i class="fa fa-trash"></i></a>
                </dt>
                <dd>
      ...
      <div class="imap-form-default">
        <div class="bot"><a href="JavaScript:void(0);" onclick="update_channel_category();" class="imap-btn-big imap-btn-green"><span>保存</span></a> <a href="index.php?act=web_channel&op=html_update&web_id=<?php echo $output['code_channel_slide']['web_id'];?>" class="imap-btn-big imap-btn-green"><span>更新模块内容</span></a> <span class="web-save-succ" style="display:none;"><?php echo $lang['im_common_save_succ'];?></span> </div>
      </div>
    </form>
    ...
    <form id="upload_slide_form" class="tab-content" name="upload_slide_form" enctype="multipart/form-data" method="post" action="index.php?act=web_channel&op=channel_slide" target="upload_pic" style="display:none;">
      ...
      <div class="imap-form-default">
        <dl class="row">
          ...
          <dd class="opt">
            <div class="full-screen-slides">
              <ul>
                ...
                <li slide_id="<?php echo $val['pic_id'];?>" title="可上下拖拽更改显示顺序">
                  <div class="title">
                    <h4></h4>
                    <a class="imap-btn-mini del" href="JavaScript:del_slide(<?php echo $val['pic_id'];?>);"><i class="fa fa-trash"></i>删除</a></div>
            ...
            <p class="notic"><?php echo '小提示：单击图片选中修改，拖动可以排序，添加最多不超过6个，保存后生效。';?></p>
            <div class="mt20"><a class="imap-btn" href="JavaScript:add_slide();"><?php echo '图片调用';?></a> </div>
          </dd>
        </dl>
      </div>
      <div id="upload_slide" class="imap-form-default" style="display:none; overflow: visible;">
        <div class="title">
          <h3>新增/选中区域内容设置详情</h3>
        </div>
      ...
      <div class="imap-form-default">
        <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_slide_form').submit();" class="imap-btn-big imap-btn-green"><span>保存</span></a> <a href="index.php?act=web_channel&op=html_update&web_id=<?php echo $output['code_channel_slide']['web_id'];?>" class="imap-btn-big imap-btn-green"><span>更新模块内容</span></a> <span class="web-save-succ" style="display:none;"><?php echo $lang['im_common_save_succ'];?></span> </div>
      </div>
    </form>
    <form id="upload_adv_form" class="tab-content" name="upload_adv_form" enctype="multipart/form-data" method="post" action="index.php?act=web_channel&op=channel_adv" target="upload_pic" style="display:none;">
        ...
        <dl class="row">
          ...
          <dd class="opt focus-trigeminy">
            ...
            <div focus_id="<?php echo $key;?>" class="focus-trigeminy-group" title="<?php echo '可上下拖拽更改图片组显示顺序';?>">
              <div class="title">
                <h4></h4>
                <a class="imap-btn-mini del" href="JavaScript:del_adv(<?php echo $key;?>);"><i class="fa fa-trash"></i>删除</a></div>
              <ul>
            ...
            <div class="mt20"> <a class="imap-btn" href="JavaScript:add_adv();"><?php echo '图片组';?></a> </div>
          </dd>
        </dl>
      </div>
      <div id="upload_adv" class="imap-form-default" style="display:none;">
        <div class="title">
          <h3>新增/选中区域内容设置详情</h3>
        </div>
        <dl class="row">
      ...
      <div class="imap-form-default">
        <div class="bot"> <a href="JavaScript:void(0);" onclick="$('#upload_adv_form').submit();" class="imap-btn-big imap-btn-green"><span>保存</span></a> <a href="index.php?act=web_channel&op=html_update&web_id=<?php echo $output['code_channel_slide']['web_id'];?>" class="imap-btn-big imap-btn-green"><span>更新模块内容</span></a> <span class="web-save-succ" style="display:none;"><?php echo $lang['im_common_save_succ'];?></span> </div>
      </div>
    </form>
  </div>
</div>
