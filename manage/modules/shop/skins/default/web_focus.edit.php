...
<div class="page">
  ...
  <div class="homepage-focus" id="homepageFocusTab">
    ...
    <form id="upload_screen_form" class="tab-content" name="upload_screen_form" enctype="multipart/form-data" method="post" action="index.php?act=web_config&op=screen_pic" target="upload_pic">
      ...
      <div class="imap-form-default">
        <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_screen_form').submit();" class="imap-btn-big imap-btn-green"><?php echo $lang['web_config_save'];?></a> <a href="index.php?act=web_config&op=html_update&web_id=<?php echo $output['code_screen_list']['web_id'];?>" class="imap-btn-big imap-btn-green"><?php echo $lang['web_config_web_html'];?></a> <span class="web-save-succ" style="display:none;"><?php echo $lang['im_common_save_succ'];?></span> </div>
      </div>
    </form>
    <form id="upload_focus_form" class="tab-content" name="upload_screen_form" enctype="multipart/form-data" method="post" action="index.php?act=web_config&op=focus_pic" target="upload_pic" style="display:none;">
        ...
        <dl class="row">
          ...
          <dd class="opt focus-trigeminy">
              ...
              <div focus_id="<?php echo $key;?>" class="focus-trigeminy-group" title="<?php echo '可上下拖拽更改图片组显示顺序';?>">
                ...
                <div class="title"><h4>广告调用</h4><a class="imap-btn-mini del" href="JavaScript:del_focus(<?php echo $key;?>);" title="<?php echo $lang['im_del'];?>"><i class="fa fa-trash"></i>删除</a></div>
                <ul>
                ...
                <?php }else { ?>
                <div class="title"><h4>图片调用</h4><a class="imap-btn-mini del" href="JavaScript:del_focus(<?php echo $key;?>);"><i class="fa fa-trash"></i>删除</a></div>
                <ul>
                  <?php foreach($val['pic_list'] as $k => $v) { ?>
            ...
            <div class="mt20"> <a class="imap-btn" href="JavaScript:add_focus('pic');"><?php echo '图片组';?></a>
              <?php if(!empty($output['focus_adv_list']) && is_array($output['focus_adv_list'])){ ?>
              <a class="imap-btn" href="JavaScript:add_focus('adv');"><?php echo '广告组';?></a>
              <?php } ?>
            </div>
          </dd>
        </dl>
      </div>
      <div id="ap_focus" class="imap-form-default" style="display:none;">
        <div class="title">
          <h3>新增/选中区域内容设置详情</h3>
        </div>
        <dl class="row">
      ...
      <div id="upload_focus" class="imap-form-default" style="display:none;">
        <div class="title">
          <h3>新增/选中区域内容设置详情</h3>
        </div>
        <dl class="row">
      ...
      <div class="imap-form-default">
        <div class="bot"> <a href="JavaScript:void(0);" onclick="$('#upload_focus_form').submit();" class="imap-btn-big imap-btn-green"><?php echo $lang['web_config_save'];?></a> <a href="index.php?act=web_config&op=html_update&web_id=<?php echo $output['code_screen_list']['web_id'];?>" class="imap-btn-big imap-btn-green"><?php echo $lang['web_config_web_html'];?></a> <span class="web-save-succ" style="display:none;"><?php echo $lang['im_common_save_succ'];?></span> </div>
      </div>
    </form>
  </div>
</div>
