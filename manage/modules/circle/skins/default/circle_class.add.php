...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=circle_class&op=class_list" title="返回分类列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['im_circle_classmanage'];?> - <?php echo $lang['im_new'];?>圈子分类</h3>
  ...
  <form id="class_form" method="post">
    ...
    <div class="imap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="recommend1" class="cb-enable selected" ><?php echo $lang['im_yes'];?></label>
            <label for="recommend0" class="cb-disable" ><?php echo $lang['im_no'];?></label>
