  ...
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        ...
        <h5><?php echo $lang['im_circle_memberlevel_subhead'];?></h5>
      </div>
    ...
    <table class="flex-table">
      <thead>
        <tr>
          ...
          <th width="150" align="center"><?php echo $lang['im_status'];?></th>
          <th></th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr>
          ...
          <td class="handle"><a href="javascript:void(0);" onclick="if(confirm('<?php echo $lang['im_ensure_del'];?>')){location.href='index.php?act=circle_memberlevel&op=ref_del&mlref_id=<?php echo $val['mlref_id'];?>'}" class="btn red"><i class="fa fa-trash-o"></i><?php echo $lang['im_del'];?></a><a href="index.php?act=circle_memberlevel&op=ref_edit&mlref_id=<?php echo $val['mlref_id'];?>" class="btn blue"><i class="fa fa-pencil-square-o"></i><?php echo $lang['im_edit'];?></a></td>
          <td><?php echo $val['mlref_name'];?></td>
          <td><?php echo date('Y-m-d H:i:s', $val['mlref_addtime']);?></td>
          <td class="yes-onoff"><a href="JavaScript:void(0);" class="<?php echo $val['mlref_status']? 'enabled' : 'disabled' ;?>" ajax_branch="status" im_type="inline_edit" fieldname="mlref_status" fieldid="<?php echo $val['mlref_id']?>" fieldvalue="<?php echo $val['mlref_status']? '1' : '0' ;?>" title="<?php echo $lang['im_editable'];?>"><img src="<?php echo ADMIN_SKINS_URL;?>/images/transparent.gif" /></a></td>
          <td></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
