...
<div class="page">
  ...
  <form method="post" id="clmdForm" name="clmdForm">
    ...
    <div class="imap-form-all">
      ...
      <div class="fix-bot"><a href="JavaScript:void(0);" class="imap-btn-big imap-btn-green" id="submitBtn"><?php echo $lang['im_submit'];?></a>  <a href="index.php?act=circle_memberlevel&op=update_cache" class="imap-btn-big imap-btn-orange" ><?php echo $lang['im_circle_cache'];?></a></div>
    </div>
  </form>
</div>
<script>
