    ...
    public function ref_addOp(){
        if(chksubmit()){
            ...
            if($rs){
                ...
                showMessage(L('im_common_op_succ'), $url);
            }else{
                showMessage(L('im_common_op_fail'));
            }
        }
...
Tpl::showpage('circle_memberlevel.ref_add');
    ...
    public function ref_editOp(){
        ...
        if(chksubmit()){
            ...
            if($rs){
                showMessage(L('im_common_op_succ'), 'index.php?act=circle_memberlevel&op=ref');
            }else{
                showMessage(L('im_common_op_fail'));
            }
        }
...
Tpl::showpage('circle_memberlevel.ref_edit');
    ...
    public function update_cacheOp() {
        ...
        showMessage(L('im_common_op_succ'), 'index.php?act=circle_memberlevel');
