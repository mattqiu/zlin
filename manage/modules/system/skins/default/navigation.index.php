    ...
    <table class="flex-table">
      <thead>
        <tr>
          ...
          <th width="100" align="center"><?php echo $lang['im_sort'];?></th>
      ...
      <tbody>
        ...
        <tr data-id="<?php echo $v['nav_id'];?>">
          ...
          <td class="handle"><a href="javascript:submit_delete(<?php echo $v['nav_id'];?>);" class="btn red"><i class="fa fa-trash-o"></i><?php echo $lang['im_del'];?></a>
          <a class="btn blue" href="index.php?act=navigation&op=navigation_edit&nav_id=<?php echo $v['nav_id'];?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['im_edit'];?></a>
          </td>
          <td class="sort"><span im_type="tag_sort" column_id="<?php echo $v['nav_id'];?>" title="<?php echo $lang['im_editable'];?>" class="editable "><?php echo $v['nav_sort'];?></span></td>
...
$(document).ready(function(){
    ...
    //行内ajax编辑
    $('span[im_type="tag_sort"]').inline_edit({act: 'navigation',op: 'ajax'});
    $('span[im_type="tag_name"]').inline_edit({act: 'navigation',op: 'ajax'});
});
