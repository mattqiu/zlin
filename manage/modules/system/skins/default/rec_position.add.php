...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=rec_position&op=rec_list" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['rec_position'];?> - <?php echo $lang['im_new'];?></h3>
      ...
      <dl class="row" id="local_pic" style="display:none">
        ...
        <dd class="opt">
          <ul class="imap-ajax-add" id="UpFileBox">
            ...
            <a id="addUpFile" class="imap-btn" href="javascript:void(0);"><i class="fa fa-plus"></i><?php echo $lang['rec_ps_addjx'];?></a>
          </ul>
        </dd>
      </dl>
...
<script type="text/javascript">
$(function(){
	$('input[im_type="change_default_goods_image"]').live("change", function(){
