...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=admin&op=gadmin" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['im_limit_manage'];?> - <?php echo $lang['im_add'];?>权限组</h3>
  ...
  <form id="add_form" method="post" style="margin-bottom: 50px;">
    ...
    <div class="imap-form-all">
      ...
      <?php } ?>
      <div class="fix-bot"><a href="JavaScript:void(0);" class="imap-btn-big imap-btn-green" id="submitBtn"><?php echo $lang['im_submit'];?></a></div>
    </div>
  </form>
</div>
<script>
