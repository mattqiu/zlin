...
<div class="page">
  ...
  <form id="adv_form" enctype="multipart/form-data" method="post">
    ...
    <div class="imap-form-default" id="main_table">
      <dl class="row">
        <dt class="tit">
      ...
      <dl class="row" id="adv_pic">
        ...
        <dd class="opt">
          <div class="input-file-show"><span class="type-file-box">
            <input type="file" class="type-file-file" id="file_adv_pic" name="adv_pic" size="30" hidefocus="true"  im_type="upload_file_adv_pic" title="点击按钮选择文件并提交表单后上传生效">
            </span></div>
          <span class="err"></span>
