  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="handle-s"><a class="btn blue" href="index.php?act=document&op=edit&doc_id=<?php echo $v['doc_id']; ?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['im_edit'];?></a></td>
...
$(function(){
	$('.flex-table').flexigrid({
		...
		title: '<?php echo $lang['im_list'];?>',// 表格标题
		reload: false,// 不使用刷新
