...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=navigation&op=navigation" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['navigation_index_nav'];?> - <?php echo $lang['im_new'];?></h3>
  ...
  <form id="navigation_form" method="post">
    ...
    <div class="imap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="nav_new_open1" class="cb-enable selected" ><?php echo $lang['im_yes'];?></label>
            <label for="nav_new_open0" class="cb-disable" ><?php echo $lang['im_no'];?></label>
