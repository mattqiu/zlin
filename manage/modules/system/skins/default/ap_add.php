      ...
      <dl class="row" id="default_pic">
        ...
        <div class="type-file-box">
          <div class="input-file-show"><span class="type-file-box">
            <input type="file" class="type-file-file" id="change_default_pic" name="default_pic" size="30" hidefocus="true"  im_type="change_default_pic" title="点击按钮选择文件并提交表单后上传生效">
            </span></div></div>
          <span class="err"></span>
