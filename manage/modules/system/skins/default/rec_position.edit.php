...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=rec_position&op=rec_list" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['rec_position'];?> - <?php echo $lang['im_edit'];?>“<?php echo $output['info']['title'];?>”</h3>
  ...
  <form id="rec_form" enctype="multipart/form-data" method="post" action="index.php?act=rec_position&op=rec_edit_save">
    ...
    <div class="imap-form-default">
      ...
      <dl class="row" id="local_txt" style="display:none">
        ...
        <dd class="opt">
          <ul class="imap-ajax-add" id="RemoteBoxTxt">
            <li>
              <label>
            ...
            <a id="addRemoteTxt" class="imap-btn" href="javascript:void(0);"><i class="fa fa-plus"></i><?php echo $lang['rec_ps_addjx'];?></a>
          </ul>
        </dd>
      </dl>
      <dl class="row" id="local_pic" style="display:none">
        ...
        <dd class="opt">
          <ul class="imap-ajax-add" id="UpFileBox">
            <li>
              <label>
              <div class="input-file-show"><span class="type-file-box">
                <input class="type-file-file" id="pic[]" name="pic[]" type="file" size="30" im_type="change_default_goods_image"  hidefocus="true" title="点击按钮选择文件上传">
            ...
            <a id="addUpFile" href="javascript:void(0);" class="imap-btn"><i class="fa fa-plus"></i><?php echo $lang['rec_ps_addjx'];?></a>
          </ul>
        </dd>
      </dl>
      <dl id="remote_pic" class="row" style="display:none">
        ...
        <dd class="opt">
          <ul class="imap-ajax-add" id="RemoteBox">
            <li>
              <label>
            ...
            <a id="addRemote" class="imap-btn"  href="javascript:void(0);"><i class="fa fa-plus"></i><?php echo $lang['rec_ps_addjx'];?></a>
          </ul>
        </dd>
      </dl>
...
$(function(){
	...
	$("#remote_pic,#local_pic").on('click','#addUpFile',function(){
		...
		$(this).remove();
   		$('#UpFileBox').append("<li><label><div class=\"input-file-show\"><span class=\"type-file-box\"><input type=\"text\" name=\"textfield\" class=\"type-file-text\"><input type=\"button\" name=\"button\" value=\"选择上传...\" class=\"type-file-button\"><input class=\"type-file-file\" type=\"file\" title=\"\" im_type=\"change_default_goods_image\" hidefocus=\"true\" size=\"30\" name=\"pic[]\"></span></div></label><label title=\"<?php echo $lang['rec_ps_gourl'];?>\"><i class=\"fa fa-link\"></i><input type=\"text\" value=\"http://\" name=\"urlup[]\" placeholder=\"<?php echo $lang['rec_ps_gourl'];?>\" class=\"input-txt\"></label><a id=\"delUpFile\" href=\"javascript:void(0);\" class=\"imap-btn imap-btn-red\"><?php echo $lang['im_del'];?></a></li><a id=\"addUpFile\" class=\"imap-btn\" href=\"javascript:void(0);\"><i class=\"fa fa-plus\"></i><?php echo $lang['rec_ps_addjx'];?></a>");
	});
...
<script type="text/javascript">
$(function(){
	$('input[im_type="change_default_goods_image"]').on("change", function(){
