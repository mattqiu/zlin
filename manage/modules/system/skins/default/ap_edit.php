  ...
  <form id="link_form" enctype="multipart/form-data" method="post" name="form1">
    ...
    <div class="imap-form-default">
      ...
      <?php
            ...
            <input type='file' class='type-file-file' id='change_default_pic' name='default_pic' size='30' hidefocus='true'  im_type='change_default_pic' title='点击前方预览图可查看大图，点击按钮选择文件并提交表单后上传生效'>
            </span></div>
          <span class='err'></span>
      ...
      <?php }?>
      <div class="bot"><a href="JavaScript:void(0);" class="imap-btn-big imap-btn-green" id="submitBtn" onclick="document.form1.submit()"><?php echo $lang['adv_change'];?></a></div>
    </div>
  </form>
</div>
