...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=article&op=article" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['article_index_manage'];?> - <?php echo $lang['im_edit'];?>文章“<?php echo $output['article_array']['article_title'];?>”</h3>
  ...
  <form id="article_form" method="post">
    ...
    <div class="imap-form-default">
      ...
      <dl class="row" imtype="article_position" style="display: none">
        <dt class="tit">
          <label>显示位置:</label>
        </dt>
        <dd class="opt">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="article_show1" class="cb-enable <?php if($output['article_array']['article_show'] == '1'){ ?>selected<?php } ?>" ><?php echo $lang['im_yes'];?></label>
            <label for="article_show0" class="cb-disable <?php if($output['article_array']['article_show'] == '0'){ ?>selected<?php } ?>" ><?php echo $lang['im_no'];?></label>
      ...
      <dl class="row">
        <dt class="tit"><?php echo $lang['im_sort'];?></dt>
        <dd class="opt">
      ...
      <dl class="row">
        ...
        <dd class="opt" id="divComUploadContainer">
          ...
          <div id="thumbnails" class="imap-thumb-list">
            ...
            <ul>
              ...
              <li id="<?php echo $v['upload_id'];?>">
                ...
                <a href="javascript:del_file_upload('<?php echo $v['upload_id'];?>');" class="del" title="<?php echo $lang['im_del'];?>">X</a><a href="javascript:insert_editor('<?php echo $v['upload_path'];?>');" class="inset"><i class="fa fa-trash"></i>插入图片</a> </li>
              <?php } ?>
              <?php } ?>
            </ul>
          </div>
...
$(document).ready(function(){
	$('#ac_id').on('change',function(){
		if($(this).val() == '1') {
			$('dl[imtype="article_position"]').show();
		}else{
			$('dl[imtype="article_position"]').hide();
		}
	});
...
{
    if(!window.confirm('<?php echo $lang['im_ensure_del'];?>')){
        return;
    }
