...
class article_classControl extends SystemControl{
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    $this->log(l('im_add,article_class_index_class').'['.$_POST['ac_name'].']',1);
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    $this->log(l('im_edit,article_class_index_class').'['.$_POST['ac_name'].']',1);
    ...
    public function article_class_delOp(){
        ...
        if (intval($_GET['ac_id']) > 0){
            ...
            $this->log(l('im_add,article_class_index_class').'[ID:'.intval($_GET['ac_id']).']',1);
