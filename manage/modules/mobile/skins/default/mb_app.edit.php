...
<div class="page">
  ...
  <form id="post_form" method="post">
    ...
    <div class="imap-form-default">
      ...
      <div class="bot"> <a href="JavaScript:void(0);" class="imap-btn-big imap-btn-green" id="submitBtn"><?php echo $lang['im_submit'];?></a><a href="index.php?act=mb_app&op=mb_qr"  class="imap-btn-big imap-btn-orange ml10">生成二维码</a> </div>
    </div>
  </form>
</div>
<script>
