    ...
    <table class="flex-table">
      ...
      <tbody id="treet1">
        ...
        <tr>
          ...
          <td class="handle"><a href="javascript:;" imtype="btn_del" data-special-id="<?php echo $value['special_id'];?>" class="btn red"><i class="fa fa-trash-o"></i>删除</a><a href="<?php echo urlAdminMobile('mb_special', 'special_edit', array('special_id' => $value['special_id']));?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a></td>
          <td><?php echo $value['special_id'];?></td>
          <td class="name"><span im_type="edit_special_desc" column_id="<?php echo $value['special_id'];?>" title="<?php echo $lang['im_editable'];?>" class="editable tooltip w270"><?php echo $value['special_desc'];?></span></td>
          <td></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        ...
        buttons : [
            {
                ...
                title : '新增专题',
                onpress : function() {
                    $('#dialog_add_mb_special').im_show_dialog({title: '新增专题'});
                }
            }
        ]
    });
