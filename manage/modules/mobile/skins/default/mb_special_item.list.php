    ...
    <div class="mb-item-box">
      <div id="item_list" class="item-list">
        ...
        <div imtype="special_item" class="special-item <?php echo $value['item_type'];?> <?php echo $value['usable_class'];?>" data-item-id="<?php echo $value['item_id'];?>">
          ...
          <div class="handle"><a imtype="btn_move_up" href="javascript:;"><i class="fa fa-arrow-up
"></i>上移</a> <a imtype="btn_move_down" href="javascript:;"><i class="fa fa-arrow-down 
"></i>下移</a> <a imtype="btn_usable" data-item-id="<?php echo $value['item_id'];?>" href="javascript:;"><i class="fa fa-toggle-on 
"></i><?php echo $value['usable_text'];?></a> <a imtype="btn_edit_item" data-item-id="<?php echo $value['item_id'];?>" href="javascript:;"><i class="fa fa-pencil-square-o"></i>编辑</a> <a imtype="btn_del_item" data-item-id="<?php echo $value['item_id'];?>" href="javascript:;"><i class="fa fa-trash-o
"></i>删除</a></div>
          </td>
        </div>
        <?php } ?>
