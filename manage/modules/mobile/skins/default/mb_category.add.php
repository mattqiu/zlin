...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <a class="back" href="index.php?act=mb_category&op=mb_category_list" title="返回分类图片列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['link_index_mb_category'];?> - <?php echo $lang['im_new'];?></h3>
