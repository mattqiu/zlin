...
<div class="page"> 
  ...
  <form id="form_item" action="<?php echo urlAdminMobile('mb_special', 'special_item_save');?>" method="post">
    ...
    <div class="bot"><a id="btn_save" class="imap-btn-big imap-btn-green" href="javascript:;">保存编辑</a> </div>
  </form>
</div>
<div id="dialog_item_edit_image" style="display:none;">
  ...
  <form id="form_image" action="">
    <div class="imap-form-default">
      ...
      <div class="bot"><a id="btn_save_item" class="imap-btn-big imap-btn-green" href="javascript:;">保存</a></div>
    </div>
  </form>
</div>
