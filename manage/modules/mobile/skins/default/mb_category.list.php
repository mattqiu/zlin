    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr class="edit">
          ...
          <td class="handle">
            <a href="javascript:if(confirm('<?php echo $lang['im_ensure_del'];?>'))window.location = 'index.php?act=mb_category&op=mb_category_del&gc_id=<?php echo $v['gc_id'];?>';" class="btn red"><i class="fa fa-trash-o"></i><?php echo $lang['im_del'];?></a>
            <a href="index.php?act=mb_category&op=mb_category_edit&gc_id=<?php echo $v['gc_id'];?>" class="btn blue"><i class="fa fa-pencil-square-o"></i><?php echo $lang['im_edit'];?></a>
          </td>
