...
<ul class="search-goods-list">
  ...
  <li>
    ...
    <a imtype="btn_add_goods" data-goods-id="<?php echo $value['goods_id'];?>" data-goods-name="<?php echo $value['goods_name'];?>" data-goods-price="<?php echo $value['goods_promotion_price'];?>" data-goods-image="<?php echo thumb($value, 240);?>" href="javascript:;">添加</a> </li>
  <?php } ?>
</ul>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#goods_pagination').find('.demo').ajaxContent({
            event:'click', 
            loaderType:"img",
            loadingMsg:"<?php echo ADMIN_SKINS_URL;?>/images/transparent.gif",
