...
class mb_specialControl extends SystemControl{
    ...
    public function special_listOp() {
        ...
        $mb_special_list = $model_mb_special->getMbSpecialList($array, $model_mb_special::INDEX_SPECIAL_ID, 10);
    ...
    public function special_saveOp() {
        ...
        if($result) {
            ...
            showMessage(L('im_common_save_succ'), urlAdminMobile('mb_special', 'special_list'));
        } else {
            $this->log('添加手机专题' . '[ID:' . $result. ']', 0);
            showMessage(L('im_common_save_fail'), urlAdminMobile('mb_special', 'special_list'));
        }
    }
    ...
    public function special_delOp() {
        ...
        if($result) {
            ...
            showMessage(L('im_common_del_succ'), urlAdminMobile('mb_special', 'special_list'));
        } else {
            $this->log('删除手机专题' . '[ID:' . $_POST['special_id'] . ']', 0);
            showMessage(L('im_common_del_fail'), urlAdminMobile('mb_special', 'special_list'));
        }
    }
    ...
    public function special_item_saveOp() {
        ...
        if($result) {
            if($_POST['special_id'] == $model_mb_special::INDEX_SPECIAL_ID) {
                showMessage(L('im_common_save_succ'), urlAdminMobile('mb_special', 'index_edit'));
            } else {
                showMessage(L('im_common_save_succ'), urlAdminMobile('mb_special', 'special_edit', array('special_id' => $_POST['special_id'])));
            }
        } else {
