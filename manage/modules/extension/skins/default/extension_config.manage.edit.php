<?php defined('InIMall') or exit('Access Invalid!');?>
  ...
  <form id="extension_config_form" name="extension_config_form" enctype="multipart/form-data" method="post" action="<?php echo urlAdminExtension('extension_config', 'manage_save');?>">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr class="noborder">
          <td class="required tr"><label class="validation" for="sub_nums">一级代理人数：</td>
          <td>
        ...
        <!-- 
        <tr class="noborder">
          <td class="required tr"><label class="validation" for="points_rate">购物云币比率：</td>
          <td>
            <input class="text w100" type="text" name="points_rate" id="points_rate" value="<?php echo $output['manage_info']['points_rate']; ?>" />%
          </td>
          <td class="vatop tips"></td>
        </tr>
         -->
