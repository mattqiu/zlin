...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['im_microshop_personal_class'];?></h3>
        <h5><?php echo $lang['im_microshop_personal_class_subhead'];?></h5>
      </div>
    </div>
  </div>
  <!-- 操作说明 -->
...
$(function(){
    ...
    //行内ajax编辑
    $('span[im_type="class_sort"]').inline_edit({act: 'personal_class',op: 'personalclass_sort_update'});
    $('span[im_type="class_name"]').inline_edit({act: 'personal_class',op: 'personalclass_name_update'});
