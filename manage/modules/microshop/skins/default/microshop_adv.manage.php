...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['im_microshop_adv_manage'];?></h3>
        <h5><?php echo $lang['im_microshop_adv_manage_subhead'];?></h5>
      </div>
    </div>
  </div>
  <!-- 操作说明 -->
    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr data-id="<?php echo $val['adv_id']; ?>">
          ...
          <td class="handle"><a href="index.php?act=adv&op=adv_drop&adv_id=<?php echo $val['adv_id'];?>" class="btn red confirm-del"><i class="fa fa-trash-o"></i><?php echo $lang['im_del'];?></a><a href="index.php?act=adv&op=adv_edit&adv_id=<?php echo $val['adv_id'];?>" class="btn blue"><i class="fa fa-pencil-square-o"></i><?php echo $lang['im_edit'];?></a></td>
          <td class="sort"><span im_type="adv_sort" column_id="<?php echo $val['adv_id'];?>" title="<?php echo $lang['im_editable'];?>" class="editable "><?php echo $val['adv_sort'];?></span>
...
$(function(){
    ...
    //行内ajax编辑
    $('span[im_type="adv_sort"]').inline_edit({act: 'adv',op: 'adv_sort_update'});
