...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['im_microshop_manage'];?></h3>
        <h5><?php echo $lang['im_microshop_manage_subhead'];?></h5>
      </div>
    </div>
  </div>
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?act=manage&op=manage_save">
    <div class="imap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="isuse_1" class="cb-enable <?php if($output['setting']['microshop_isuse'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['im_open'];?>"><?php echo $lang['im_open'];?></label>
            <label for="isuse_0" class="cb-disable <?php if($output['setting']['microshop_isuse'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['im_close'];?>"><?php echo $lang['im_close'];?></label>
      ...
      <dl class="row">
        <dt class="tit">
          <label for="class_image"><?php echo $lang['im_microshop'].'LOGO';?></label>
        </dt>
        <dd class="opt">
          <div class="input-file-show"><span class="show">
            ...
            <input name="microshop_logo" type="file" class="type-file-file" id="microshop_logo" size="30" hidefocus="true" im_type="microshop_image">
            </span></div>
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="input-file-show"><span class="show">
            ...
            <input name="microshop_header_pic" type="file" class="type-file-file" id="microshop_header_pic" size="30" hidefocus="true" im_type="microshop_image">
            </span></div>
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
...
$(document).ready(function(){
    ...
    $("input[im_type='microshop_image']").live("change", function(){
