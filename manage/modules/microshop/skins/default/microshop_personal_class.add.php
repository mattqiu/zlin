...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=personal_class&op=personalclass_list" title="返回分类列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['im_microshop_personal_class'];?> - 新增/编辑个人秀分类<?php if(isset($output['class_info']['class_name'])) echo $output['class_info']['class_name'];?></h3>
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?act=personal_class&op=personalclass_save">
    ...
    <div class="imap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="input-file-show"> <span class="show">
            ...
            <input name="class_image" type="file" class="type-file-file" id="class_image" size="30" hidefocus="true" im_type="microshop_goods_class_image" title="点击前方预览图可查看大图，点击按钮选择文件并提交表单后上传生效">
            </span> </div>
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      ...
      <dl class="row">
        <dt class="tit">
          <label for="class_sort"><em>*</em><?php echo $lang['im_sort'];?></label>
        </dt>
        <dd class="opt">
...
$(document).ready(function(){
    ...
    $("input[im_type='microshop_goods_class_image']").live("change", function(){
