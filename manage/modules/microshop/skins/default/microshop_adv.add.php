...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=adv&op=adv_manage" title="返回广告列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['im_microshop_adv_manage'];?> - 新增/编辑广告条<?php if(isset($output['adv_info']['adv_name'])) echo $output['adv_info']['adv_name'];?></h3>
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?act=adv&op=adv_save">
    ...
    <div class="imap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="input-file-show">
            ...
            <input name="adv_image" type="file" class="type-file-file" id="adv_image" size="30" hidefocus="true" im_type="microshop_goods_adv_image" title="点击前方预览图可查看大图，点击按钮选择文件并提交表单后上传生效">
            </span> </div>
          <span class="err"></span>
      ...
      <dl class="row">
        <dt class="tit">
          <label for="adv_sort"><em>*</em><?php echo $lang['im_sort'];?></label>
        </dt>
        <dd class="opt">
...
$(document).ready(function(){
    ...
    $("input[im_type='microshop_goods_adv_image']").live("change", function(){
