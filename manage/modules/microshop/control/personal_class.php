...
Tpl::showpage("microshop_personal_class.add");
     ...
     **/
     ...
     private function show_menu_personal_class($menu_key) {
         $menu_array = array(
                 'personal_class_list'=>array('menu_type'=>'link','menu_name'=>Language::get('im_manage'),'menu_url'=>'index.php?act=personal_class&op=personalclass_list'),
                 'personal_class_add'=>array('menu_type'=>'link','menu_name'=>Language::get('im_new'),'menu_url'=>'index.php?act=personal_class&op=personalclass_add'),
         );
         if($menu_key == 'personal_class_edit') {
             $menu_array['personal_class_edit'] = array('menu_type'=>'link','menu_name'=>Language::get('im_edit'),'menu_url'=>'###');
         }
