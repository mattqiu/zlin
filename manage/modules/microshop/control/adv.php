...
Tpl::showpage("microshop_adv.add");
    ...
    public function adv_saveOp() {
        ...
        if($result) {
            showMessage(Language::get('im_common_save_succ'),"index.php?act=adv&op=adv_manage");
        } else {
            showMessage(Language::get('im_common_save_fail'),"index.php?act=adv&op=adv_manage",'','error');
        }
    }
    ...
    public function adv_dropOp() {
        ...
        if($result) {
            ...
            showMessage(Language::get('im_common_del_fail'),'','','error');
        }
    }
    ...
    private function show_menu_adv($menu_key) {
        $menu_array = array(
            'adv_manage'=>array('menu_type'=>'link','menu_name'=>Language::get('im_manage'),'menu_url'=>'index.php?act=adv&op=adv_manage'),
            'adv_add'=>array('menu_type'=>'link','menu_name'=>Language::get('im_new'),'menu_url'=>'index.php?act=adv&op=adv_add'),
        );

        if($menu_key == 'adv_edit') {
            $menu_array['adv_edit'] = array('menu_type'=>'link','menu_name'=>Language::get('im_edit'),'menu_url'=>'###');
