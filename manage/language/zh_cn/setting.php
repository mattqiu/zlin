...
$lang['wxSettings']         = '微信互联';
$lang['wxSettings_notice']  = '开启后可使用微信扫码登录商城系统';
...
$lang['payment_method'] = '统一支付';
$lang['payment_method_notice'] = '启用统一支付功能后，买家的所有支付都将直接进入总平台帐户，关闭统一支付，则买家的所有支付都将进入各个卖家的帐户';
...
$lang['site_bank_account_notice']           = '用半角逗号","分隔项目，用半角冒号":"分隔标题和内容，例："银行:中国银行,币种:人民币,账号:xxxxxxxxxxx,姓名:imall,开户行:中国银行杭州市分行"';
...
$lang['if_smtp_authentication']  = '使用SMTP协议发送的邮件地址，如 imall@163.com';
$lang['smtp_user_name']          = 'SMTP 身份验证用户名';
$lang['smtp_user_name_tip']      = '如 imall';
$lang['smtp_user_pwd']           = 'SMTP 身份验证密码';
$lang['smtp_user_pwd_tip']       = 'imall@163.com邮件的密码，如 123456';
...
$lang['wx_ucenter_error']    	= '请关闭会员整合，才可启用微信互联功能';
