...
$lang['admin_predeposit_unavailable']	 	= '系统未开启积分功能，正在跳转到积分设置 。。。';
...
$lang['admin_predeposit_shortprice_error']		= '积分金额不足，请查看用户积分信息';
$lang['admin_predeposit_pricetype']				= '积分类型';
...
$lang['admin_predeposit_check_tips'] 				= '审核后，等额的会员积分将会被冻结，进入财务支付环节，确认操作吗?';
$lang['admin_predeposit_pay_tips'] 				= '提交后，提现单会被置为已经支付状态，同时系统从会员积分中扣除相应的提现金额，确认操作吗?';
/**
 * 充值功能公用
 */
 ...
 * 充值信息编辑
 */
$lang['admin_predeposit_recharge_edit_logdesc']		= '会员充值支付状态修改减少积分';
...
$lang['admin_predeposit_cash_remark_tip2']			= '备注信息将在积分明细相关页显示，会员和管理员都可见';
...
$lang['admin_predeposit_cash_del_reducefreezelogdesc']		= '会员提现记录删除成功减少冻结积分金额';
$lang['admin_predeposit_cash_del_adddesc']	= '会员提现记录删除成功增加积分金额';
/**
 * 提现信息编辑
 */
$lang['admin_predeposit_cash_edit_reducefreezelogdesc']	= '会员提现记录状态修改为支付成功减少冻结积分金额';
...
$lang['admin_predeposit_artificial_success']				= '修改会员积分成功';
$lang['admin_predeposit_artificial_fail']					= '修改会员积分失败';
...
$lang['admin_predeposit_artificial_member_tip_2']			= ', 当前可用积分为';
$lang['admin_predeposit_artificial_member_tip_3']			= ',  冻结积分为';
$lang['admin_predeposit_artificial_notice']					= '你可以选择修改可用金额或冻结金额';
/**
 * 出入明细 
 */
$lang['admin_predeposit_log_help1']			= '此处展示了积分详细的变更日志信息';
