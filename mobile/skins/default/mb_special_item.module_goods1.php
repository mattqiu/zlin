...
background: #EFFAFE url(<?php echo ADMIN_SKINS_URL;
...
<div class="index_block goods-list">
  ...
  <div imtype="item_content" class="content">
    ...
    <div imtype="item_image" class="item">
      ...
      <a imtype="btn_del_item_image" href="javascript:;"><i class="fa fa-trash-o
"></i>删除</a>
      <?php } ?>
    </div>
    <?php } ?>
...
<div class="search-goods">
  ...
  <a id="btn_mb_special_goods_search" class="imap-btn" href="javascript:;" style="vertical-align: top; margin-left: 5px;">搜索</a>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#btn_mb_special_goods_search').on('click', function() {
            var url = '<?php echo urlAdminMobile('mb_special', 'fxgoods_list');?>';
