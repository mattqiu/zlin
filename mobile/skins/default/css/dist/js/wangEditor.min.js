...
!function (a) {
    ...
    return function (a, b) {
        ...
        a.fn.currentRange = function (a) {
            ...
            b = b || "end", b = "start" === b ? !0 : !1, a = a || this.currentRange(), a && (a.collapse(b), this.currentRange(a))
            ...
            return a = a || this.currentRange(), a && a.startContainer && a.startContainer === a.endContainer && a.startOffset === a.endOffset ? !0 : !1
        ...
        a.w3cRange || (a.fn.getRangeText = function (a) {
            ...
            return a = a || this.currentRange(), a && a.text ? !1 : !0
        ...
        a.fn.undoRecord = function () {
            var a = this, b = a.txt.$txt, c = b.html(), g = e.length ? e[0] : "";
            c !== g.val && (d.length && (d = []), e.unshift({range: a.currentRange(), val: c}), e.length > f && e.pop())
        }, a.fn.undo = function () {
            if (e.length) {
                var a = e.shift();
                d.unshift(a), c(this, a, "undo")
            }
        }, a.fn.redo = function () {
            if (d.length) {
                var a = d.shift();
                e.unshift(a), c(this, a, "redo")
            }
        }
    }), b(function (a, b) {
        ...
        c.fn.init = function () {
            ...
            f.css({width:300, height: e ? e : "auto"}), f.append(g), f.append(c), a.$panel = f, a.$triangle = g
        }, c.fn.initHideEvent = function () {
        ...
        c.fn.init = function () {
            ...
            function a(e) {
                if (e && e.nodeType && e.nodeName) {
                    var f, h = e.nodeName.toLowerCase(), i = e.nodeType;
                    if (3 === i || 1 === i) {
                        if (f = b(e), "div" === h)return void b.each(e.childNodes, function () {
                            a(this)
                        });
                        if (j.indexOf(h) >= 0)g += c(e); else if (3 === i)g += "<p>" + e.textContent + "</p>"; else if ("br" === h)g += "<br/>"; else {
        ...
        c.fn.render = function () {
            ...
            e = 50 > e ? 50 : e, b.height(e), a.valueContainerHeight = c, this.initMaxHeight(e, d)
            ...
            for (e.length && e.each(function () {
                b(this).wrap("<p>")
            }), a = 0; h > a; a++)c = g[a], 3 === c.nodeType && c.textContent && b.trim(c.textContent) && b(c).wrap("<p>")
        ...
        a.config = {}, a.config.zindex = 1e4, a.config.printLog = !0, a.config.menuFixed = 0, a.config.jsFilter = !0, a.config.legalTags = "p,h1,h2,h3,h4,h5,h6,blockquote,table,ul,ol,pre", a.config.lang = a.langs["zh-cn"], a.config.menus = ["source", "|", "bold", "underline", "italic", "strikethrough", "eraser", "forecolor", "bgcolor", "|", "quote", "fontfamily", "fontsize", "head", "unorderlist", "orderlist", "alignleft", "aligncenter", "alignright", "|", "link", "unlink", "table", "emotion", "|", "img", "video", "location", "insertcode", "|", "undo", "redo", "fullscreen"], a.config.colors = {
            ...
            "#000000": "黑色",
            "#ffffff": "白色"
        }, a.config.familys = ["宋体", "黑体", "楷体", "微软雅黑", "Arial", "Verdana", "Georgia", "Times New Roman", "Microsoft JhengHei", "Trebuchet MS", "Courier New", "Impact", "Comic Sans MS"], a.config.fontsizes = {
            1: "10px",
            2: "13px",
            3: "16px",
            4: "19px",
            ...
            a.config.uploadImgUrl = "", a.config.uploadTimeout = 2e4, a.config.uploadImgFns = {}, a.config.customUpload = !1, a.config.uploadParams = {}, a.config.uploadHeaders = {}, a.config.pasteFilter = !0, a.config.pasteText = !1
    }), b(function (a, b) {
        a.UI = {}, a.UI.menus = {
            "default": {
        ...
        a.createMenu(function (c) {
            ...
            if (c(d)) {
                ...
                b.each(g, function (a, b) {
                    ...
                    return a = e.getSelfOrParentByName(a, "font[color]"), a ? !0 : !1
                }, e.menus[d] = h
            }
        })
    }), b(function (a, b) {
        a.createMenu(function (c) {
            ...
            if (c(e)) {
                ...
                b.each(h, function (a, b) {
                    ...
                    return a = f.getSelfOrParentByName(a, "span,font", d), a ? !0 : !1
                }, f.menus[e] = i
            }
        })
    }), b(function (a, b) {
        ...
        a.createMenu(function (c) {
            function d() {
                ...
                d || (d = "<p><br></p>"), g.config.jsFilter && (d = d.replace(/<script[\s\S]*?<\/script>/gi, "")), c.html(d)
            }
            ...
            if (c(e)) {
                ...
                i.isShowCode = !1, i.clickEvent = function (a) {
                    var c = this, d = c.editor, e = d.txt.$txt, g = e.outerHeight(), h = e.height();
                    c.$codeTextarea || (c.$codeTextarea = b('<textarea class="code-textarea"></textarea>'));
                    var j = c.$codeTextarea;
                    j.css({
                        height: h,
                        "margin-top": g - h
                    }), j.val(e.html()), e.after(j).hide(), j.show(), i.isShowCode = !0, this.updateSelected(), d.disableMenusExcept("source"), f = e.html()
        ...
        a.createMenu(function (c) {
            ...
            if (c(d)) {
                ...
                g.clickEvent = function (a) {
                    ...
                    function c() {
                        var a, c;
                        return a = b(g), c = a.children(), c.length ? (c.each(function (c) {
                            var d = b(this);
                    ...
                    return a = c.getRangeElem(), a = c.getSelfOrParentByName(a, "blockquote"), a ? !0 : !1
        ...
        a.createMenu(function (c) {
            ...
            if (c(d)) {
                ...
                h.dropList = new a.DropList(e, h, {
                    ...
                    var a = e.getRangeElem();
                    return a = e.getSelfOrParentByName(a, "font[face]"), a ? !0 : !1
                }, e.menus[d] = h
            }
        })
    }), b(function (a, b) {
        a.createMenu(function (b) {
            ...
            if (b(c)) {
                ...
                g.dropList = new a.DropList(d, g, {
                    ...
                    return a = d.getSelfOrParentByName(a, "font[size]"), a ? !0 : !1
                }, d.menus[c] = g
            }
        })
    }), b(function (a, b) {
        a.createMenu(function (b) {
            ...
            if (b(e)) {
                ...
                i.dropList = new a.DropList(g, i, {
                    ...
                    return a = g.getSelfOrParentByName(a, "h1,h2,h3,h4,h5"), a ? !0 : !1
                }, g.menus[e] = i
            }
        })
    }), b(function (a, b) {
        ...
        a.createMenu(function (c) {
            ...
            if (c(d)) {
                ...
                i.append(l), j.append(m), k.append(n).append(o), h.append(i).append(j).append(k), g.dropPanel = new a.DropPanel(e, g, {
                    ...
                    var a = e.getRangeElem();
                    return a = e.getSelfOrParentByName(a, "a"), a ? !0 : !1
                }, o.click(function (a) {
        ...
        a.createMenu(function (d) {
            function e() {
                n.click(function (a) {
                    l.children().removeClass("selected"), m.children().removeClass("selected"), p.addClass("selected"), n.addClass("selected"), a.preventDefault()
                }), o.click(function (b) {
                    l.children().removeClass("selected"), m.children().removeClass("selected"), q.addClass("selected"), o.addClass("selected"), b.preventDefault(), a.placeholder && q.find("input[type=text]").focus()
                }), n.click()
            }

            function f() {
                l.remove(), p.remove(), q.addClass("selected")
            }

            var g = "img";
            if (d(g)) {
                var h = this, i = h.config.lang, j = new a.Menu({
                    editor: h,
                    id: g,
                    title: i.img
                }), k = b('<div class="panel-tab"></div>'), l = b('<div class="tab-container"></div>'), m = b('<div class="content-container"></div>');
                k.append(l).append(m);
                var n = b('<a href="#">上传图片</a>'), o = b('<a href="#">网络图片</a>');
                l.append(n).append(o);
                var p = b('<div class="content"></div>');
                m.append(p);
                var q = b('<div class="content"></div>');
                m.append(q), c(h, j, q), j.dropPanel = new a.DropPanel(h, j, {
                    $content: k,
                    width: 400,
                    onRender: function () {
                        var a = h.config.customUploadInit;
                        a && a.call(h)
                    }
                }), h.menus[g] = j, h.ready(function () {
                    function a() {
                        j.dropPanel.hide()
                    }

                    var b = this, c = b.config, d = c.uploadImgUrl, g = c.customUpload;
                    d || g ? (b.$uploadContent = p, e()) : f(), p.click(function () {
                        setTimeout(a)
                    })
                })
            }
        ...
        a.createMenu(function (c) {
            ...
            if (c(d)) {
                ...
                o.append(p).append(q).append(r), i.append(j).append(l).append(o), r.click(function (a) {
                    ...
                    a.preventDefault();
                    var c, d = b.trim(k.val()), f = parseInt(m.val()), i = parseInt(n.val()), j = b("<div>"), l = '<p style="text-align:center;">{content}</p>';
        ...
        a.baiduMapAk = "TVhjYjq1ICT2qqL5LdS8mwas", a.numberOfLocation = 0, a.createMenu(function (d) {
            ...
            if (d(f)) {
                ...
                window.baiduMapCallBack = function () {
                    ...
                    b.type = "text/javascript", b.src = "http://api.map.baidu.com/api?v=2.0&ak=" + j + "&callback=baiduMapCallBack";
                    try {
        ...
        a.createMenu(function (d) {
            function e(a) {
                var c = b("<div></div>");
                c.css({margin: "15px 5px 5px 5px", height: "160px", "text-align": "center"}), m.css({
                    width: "100%",
                    height: "100%",
                    padding: "10px"
                ...
                var d = b("<div></div>"), e = b('<button class="right">' + i.submit + "</button>"), f = b('<button class="right gray">' + i.cancel + "</button>");
                d.append(e).append(f).append(n), a.append(d), f.click(function (a) {
                    a.preventDefault(), k.dropPanel.hide()
                });
            ...
            if (d(g)) {
                setTimeout(c, 0);
                var h = this, i = h.config.lang, j = h.txt.$txt, k = new a.Menu({
                    editor: h,
                    id: g,
                    title: i.insertcode
                });
                k.clickEvent = function (a) {
                    ...
                    if (e && e.listLanguages) {
                        ...
                        n.css({"margin-top": "9px", "margin-left": "5px"}), b.each(e.listLanguages(), function (a, b) {
                    ...
                    i && (i = h.getSelfOrParentByName(g, "code")), i && (e = b(i), m.val(e.text()), n && (f = e.attr("class"), f && n.val(f.split(" ")[0])))
                }, k.updateSelectedEvent = function () {
                    var a, b = this, c = b.editor;
                    return a = c.getRangeElem(), a = c.getSelfOrParentByName(a, "pre"), a ? !0 : !1
                };
                var l = b("<div></div>"), m = b("<textarea></textarea>"), n = b("<select></select>");
                e(l), k.dropPanel = new a.DropPanel(h, k, {
                    $content: l,
                    width: 500
                }), h.menus[g] = k, j.on("keydown", function (a) {
                    if (13 === a.keyCode) {
                        var b = h.getRangeElem(), c = h.getSelfOrParentByName(b, "code");
                        c && h.command(a, "insertHtml", "\n")
                    }
                }), j.on("keydown click", function (a) {
                    setTimeout(f)
                })
            }
        })
        ...
        a.createMenu(function (b) {
            ...
            if (b(d)) {
                ...
                m.clickEvent = function (b) {
                    ...
                    var d = g.$editorContainer;
                    d.removeClass("wangEditor-fullscreen"), d.css("z-index", e), g.useMaxHeight ? h.css("max-height", f) : g.$valueContainer.css("height", g.valueContainerHeight),
                        g.txt.initHeight(), l = !1, g.isFullScreen = !1, null != c && a.$window.scrollTop(c)
        ...
        window.FileReader && window.FormData && a.plugin(function () {
            ...
            h && (f.xhrUploadImg = function (g) {
                ...
                }), z.send(A), y = setTimeout(j, i), a.log("开始上传...并开始超时计算")
            })
        })
    }), b(function (a, b) {
        a.plugin(function () {
        ...
        a.plugin(function () {
            ...
            if (f) {
                ...
                if (h) {
                    ...
                    h.append(i);
                    var j = new a.UploadFile({editor: d, uploadUrl: f, timeout: g, fileAccept: "image/*"});
                    i.click(function (a) {
                        c = a, j.selectFiles()
                    })
                }
        ...
        a.plugin(function () {
            ...
            function e() {
                if (!h._disabled && null != g) {
                    g.addClass("clicked");
                    var a = g.position(), b = a.top, c = a.left, d = g.outerHeight(), e = g.outerWidth(), f = b + d, i = c, j = 0, l = k.position().top, o = k.outerHeight();
                    f > l + o && (f = l + o), m.show();
                    var p = m.outerWidth();
                    j = e / 2 - p / 2, m.css({
                        top: f + 5,
            ...
            var g, h = this, i = h.txt, j = i.$txt, k = h.useMaxHeight ? j.parent() : j, l = !1, m = b('<div class="txt-toolbar"></div>'), n = b('<div class="tip-triangle"></div>'), o = b('<a href="#"><i class="wangeditor-menu-img-trash-o"></i></a>'), p = b('<a href="#"><i class="wangeditor-menu-img-search-minus"></i></a>'), q = b('<a href="#"><i class="wangeditor-menu-img-search-plus"></i></a>');
            k.on("click", "table", function (a) {
        ...
        a.userAgent.indexOf("MSIE 8") > 0 || a.plugin(function () {
            ...
            function e() {
                ...
                v.click(function (b) {
                    ...
                    a.preventDefault(), p = c(a), E.val(p), u.hide(), D.show()
                }), F.click(function (a) {
                    a.preventDefault();
                    var d = b.trim(E.val());
                    d && c(a, d), setTimeout(h)
                }), G.click(function (a) {
                    a.preventDefault(), E.val(p), u.show(), D.hide()
                }), C.click(function (a) {
            ...
            function f() {
                function b(a) {
                    ...
                    var k = e + b, l = f + h;
                    r.css({"margin-left": k, "margin-top": l});
                    var m = g + b, n = i + h;
                    j && j.css({width: m, height: n})
                }

                var c, d, e, f, g, i;
                r.on("mousedown", function (k) {
                    j && (c = k.pageX, d = k.pageY, e = parseFloat(r.css("margin-left"), 10), f = parseFloat(r.css("margin-top"), 10), g = j.width(), i = j.height(), s.hide(), a.$document.on("mousemove._dragResizeImg", b), a.$document.on("mouseup._dragResizeImg", function (b) {
                        a.$document.off("mousemove._dragResizeImg"), a.$document.off("mouseup._dragResizeImg"), h(), r.css({
                            "margin-left": e,
                            "margin-top": f
                        }), H = !1
                    }), H = !0)
            ...
            function g() {
                if (!k._disabled && null != j) {
                    ...
                    var f = b + d, g = c, h = 0, i = o.position().top, l = o.outerHeight();
                    f > i + l ? f = i + l : r.show(), s.show();
                    var m = s.outerWidth();
                    h = e / 2 - m / 2, s.css({
                        top: f + 5,
                        left: g,
                        "margin-left": h
                    }), 0 > h ? (s.css("margin-left", "0"), t.hide()) : t.show(), k.disableMenusExcept()
                }
            }
            ...
            function i(a) {
                ...
                return k.emotionUrls ? (b.each(k.emotionUrls, function (b, d) {
                    var e = !1;
                    return a === d && (c = !0, e = !0), e ? !1 : void 0
                }), c) : c
            }

            var j, k = this, l = k.config.lang, m = k.txt, n = m.$txt, o = k.useMaxHeight ? n.parent() : n, p = (k.$editorContainer, ""), q = !1, r = b('<div class="img-drag-point"></div>'), s = b('<div class="txt-toolbar"></div>'), t = b('<div class="tip-triangle"></div>'), u = b("<div></div>"), v = b('<a href="#"><i class="wangeditor-menu-img-trash-o"></i></a>'), w = b('<a href="#"><i class="wangeditor-menu-img-search-minus"></i></a>'), x = b('<a href="#"><i class="wangeditor-menu-img-search-plus"></i></a>'), y = b('<a href="#"><i class="wangeditor-menu-img-align-left"></i></a>'), z = b('<a href="#"><i class="wangeditor-menu-img-align-center"></i></a>'), A = b('<a href="#"><i class="wangeditor-menu-img-align-right"></i></a>'), B = b('<a href="#"><i class="wangeditor-menu-img-link"></i></a>'), C = b('<a href="#"><i class="wangeditor-menu-img-unlink"></i></a>'), D = b('<div style="display:none;"></div>'), E = b('<input type="text" style="height:26px; margin-left:10px; width:200px;"/>'), F = b('<button class="right">' + l.submit + "</button>"), G = b('<button class="right gray">' + l.cancel + "</button>"), H = !1;
            o.on("mousedown", "img", function (a) {
                a.preventDefault()
            }).on("click", "img", function (a) {
                var c = b(a.currentTarget), e = c.attr("src");
                if (e && !i(e)) {
                    if (d(), j && j.get(0) === c.get(0))return void setTimeout(h, 100);
                    j = c, g(), u.show(), D.hide(), a.preventDefault(), a.stopPropagation()
                }
            }).on("click keydown scroll", function (a) {
                H || setTimeout(h, 100)
            })
            ...
            if (c !== !1 && "number" == typeof c) {
                ...
                a.$window.scroll(function () {
                    if (!b.isFullScreen) {
                        ...
                        0 === k && (k = h.offset().top, f = e.offset().top, g = e.outerHeight(), l = h.outerHeight()), m >= k && f + g > m + c + l + 30 ? (h.css({
                            position: "fixed",
                            top: c
