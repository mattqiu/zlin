...
<div class="wrapper_search">
  ...
  <div class="wp_confirm">
    <form method="get">
      ...
      <label class="submit-border"><input disabled="disabled" nctype="buttonNextStep" value="确定选择" type="submit" class="submit"style=" width: 200px;" /></label>
      </div>
    </form>
  </div>
</div>
