...
<meta name="author" content="EcOps">
<meta name="copyright" content="EcOps Inc. All Rights Reserved">
...
<![endif]-->
<style type="text/css">
body, .header-wrap { background-color: #FAFAFA;min-width:100%;}
.wrapper { width: 1000px;}
#faq { display: none;}
.msg { font: 100 36px/48px arial,"microsoft yahei"; color: #555; background-color: #FFF; text-align: center; width: 100%; border: solid 1px #E6E6E6; margin-bottom: 10px; padding: 120px 0;min-width: 100%;}
