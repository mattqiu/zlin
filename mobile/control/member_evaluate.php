...
class member_evaluateControl extends mobileMemberControl{
    ...
    public function indexOp(){
		...
		$evaluate_data = array();
		//$evaluate_data['ruleexplain'] = $ruleexplain;
		//$evaluate_data['order_info'] = $order_info;
		$evaluate_data['order_goods'] = $order_goods;
		$evaluate_data['store_info'] = $store_info;
		
		output_data($evaluate_data);
	}
...
//             }
    ...
    public function add_image_saveOp() {
        ...
        $content = "
            ...
            <dd>价格".Language::get('im_colon').Language::get('currency').$geval_info['geval_goodsprice']."</dd>
        ...
        if($result) {
            showDialog(L('im_common_save_succ'), urlShop('member_evaluate', 'list'), 'succ');
        } else {
            showDialog(L('im_common_save_succ'), urlShop('member_evaluate', 'list'));
        }
    }
}