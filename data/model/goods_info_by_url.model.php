...
class goods_info_by_urlModel extends Model {
	...
	$member_info = $member->getMemberInfo(array('member_id' => intval($goods_info['store_id'])));
            if(!empty($goods_info)) {
                $result = array();
                $result['result'] = 'true';
                ...
                $result['goods_salenum'] = $goods_info['goods_salenum'];
                $result['goods_freight'] = $goods_info['goods_freight'];
