...
class weixin_Material_uploadModel{
	/**
	 * 列表
	 *
	...
	public function add($param){
		...
		if (is_array($param)){
			$result = Db::insert('weixin_material',$param);
			return $result;
		}else {
			return false;
		}
	...
	public function update($param){
		...
		if (is_array($param)){
			...
			$result = Db::update('weixin_material',$tmp,$where);
			return $result;
		}else {
			return false;
		}
	...
	public function updatebywhere($param,$conditionarr){
		...
		if (is_array($param)){
			...
			$result = Db::update('weixin_material',$tmp,$condition_str);
			return $result;
		}else {
			return false;
		}
	...
	public function del($id){
		if (intval($id) > 0){
			...
			$result = Db::delete('weixin_material',$where);
			return $result;
		}else {
			return false;
		}
	...
	public function dropUploadById($id){
		...
		$result = Db::delete('weixin_material',$condition_str);
		return $result;
	}
	//
	//
