...
class rechargecardModel extends Model{
     ...
     * @return mixed
     */
    public function getVipCardList($condition = array(), $fields = '*', $limit = 0, $page = 0, $order = '', $group = '') {
    	
    	return $this->where($condition)->field($fields)->limit($limit)->page($page)->order($order)->group($group)->select();
    }
     ...
     */
    public function getRechargeCardByID($id)
    {
