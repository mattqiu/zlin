...
class specModel extends Model {
	...
	private function getCondition($condition_array) {
        ...
        if($condition_array['sp_name'] != ''){
        	$condition_str .= " and sp_name = '{$condition_array['sp_name']}'";
        }
        if ($condition_array['like_spec_name'] != '') {
            $condition_str .= " and sp_name like '%".$condition_array['like_spec_name']."%'";
        }
        if($condition_array['sp_value_name'] != ''){
        	$condition_str .= " and sp_value_name = '{$condition_array['sp_value_name']}'";
        }
        if ($condition_array['like_sp_value_name'] != '') {
        	$condition_str .= " and sp_value_name like '%".$condition_array['like_sp_value_name']."%'";
        }
        if ($condition_array['store_id'] != '') {
        	$condition_str .= " and store_id = '{$condition_array['store_id']}'";
        }
