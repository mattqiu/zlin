...
class mb_adModel extends Model{
     ...
     * @return array
	 */
	public function getMbAdList($condition, $page = null, $order = 'link_id asc', $field = '*', $store_id=0){
	 ...
	 * @return array 数组类型的返回结果
	 */
	public function getMbAdCount($store_id=0){
		$condition = array('store_id' => $store_id);
		return $this->where($condition)->Count('link_id');
	}
	/**
	 * 新增
	 *
