$(document).ready(function(){
    ...
    $("[imtype='btn_show_image_insert_hot_point']").live('click', function(){
        ...
        dialog_object.find("[imtype='btn_hot_point_commit']").click(function(){
            ...
            dialog_object.find("[imtype='list']").append('<li class="'+key+'"><i></i>热点区域'+count+'<span>('+url.val()+')</span><a imtype="select_hot_point" name="'+xy+'" href="###" class="btn-select-hot-point">选中</a><a imtype="delete_hot_point" class="btn-delete-hot-point" name="'+key+'" href="###">删除</a></li>');
    ...
    $("[imtype='btn_special_goods']").live('click', function(){
        var goods_list = $(this).parents("table").find("[imtype='_special_goods_list']");
        var link_item = $(this).parents("table").find("[imtype='_input_goods_link']");
    ...
    $("[imtype='btn_special_insert_goods']").live('click', function(){
        ...
        var goods_list = $("<div />").append($(this).parents("table").find("[imtype='_special_goods_list']").clone());
