...
EditableTable.prototype = {
    ...
    'getColumnsInfo'    : function(){
        ...
        table_header = $(_self.table).find('tr[im_type="table_header"]');
        ...
        tds.each(function(){
            columns[$(this).attr('column')] = {
                ...
                'expr'      : $(this).attr('expr') ? $(this).attr('expr') : '[im_type="editobj"]',
    ...
    'getColItems'       : function(column_info){
        ...
        /* 所有的表格项 */
        table_items = $(_self.table).find('tr[im_type="table_item"]');
        /* 所有本列的项 */
