			...
			$.ajax({
				...
				success: function(data){
					...
					for(var i = 0; i < data.length; i++){
						...
						src += "</td><td class='w36'><input type='checkbox' name='check_gc_id[]' value='"+data[i].gc_id+"' class='checkitem'>";
						//图片
						...
						//推荐
						if (data[i].gc_recommend==1){
							recommendstr = "是";
						}else{
							recommendstr = "";
						}
						src += "<td>"+recommendstr+"</td>";	
						//操作
						src += "<td class='w84'>";
