$(function(){
    ...
    /* 批量操作按钮 */
    $('a[im_type="batchbutton"]').click(function(){
        /* 是否有选择 */
...
//	        window.location.href=uri + '&' + name + '=' + items;
    ...
    $('*[im_type="gselector"]').focus(function(){
    ...
    $('span[im_type="order_by"]').each(function(){
    ...
    $('span[im_type="order_by"]').click(function(){
...
function trigger_uploader(){
    ...
    $('*[ecm_title]').hover(function(){
        ...
        $(this).parent().parent().append('<div class="titles" im_type="explain_layer" style="display:none; z-index:999">' + $(this).attr('ecm_title') + '<div class="line"></div></div>');
        $('*[im_type="explain_layer"]').fadeIn();
    },
    function(){
        $('*[im_type="explain_layer"]').fadeOut();
    }
    );
}
