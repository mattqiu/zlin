...
function getSystemYearArr(){
	$year_arr = array('2015'=>'2015','2016'=>'2016','2017'=>'2017','2018'=>'2018','2019'=>'2019','2020'=>'2020','2021'=>'2021','2022'=>'2022','2023'=>'2023','2024'=>'2024','2025'=>'2025');
	return $year_arr;
}
/**
 * 获得系统季度数组
 */
function getSystemQuarterArr(){
	$quarter_arr = array('1'=>'一季度','2'=>'二季度','3'=>'三季度','4'=>'四季度');
	return $quarter_arr;
}
/**
 * 获得系统月份数组
